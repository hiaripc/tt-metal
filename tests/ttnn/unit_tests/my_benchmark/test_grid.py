...
def  test_grid_size(
    ...
    conf_infos = ["conf", "m", "grid_size", "in0_storage_type", "in1_storage_type", 
                  "out_storage_type", "dtype", "math_fidelity"]
    
    timing_infos = ["conversion_in0", "conversion_in1", "transfer_in0",
                    "transfer_in1", "tilization_in0", "tilization_in1", "run"]
...
def test_grid_run_only(
    ...
    conf_infos = ["conf", "m", "cores", "grid_size", "in0_storage_type", "in1_storage_type", 
