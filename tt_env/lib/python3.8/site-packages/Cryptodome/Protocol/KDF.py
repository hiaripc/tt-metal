...
class _S2V(object):
    ...
    def update(self, item):
        ...
        mac = CMAC.new(self._key, msg=self._last_string, ciphermod=self._ciphermod, cipher_params=self._cipher_params)
...
def scrypt(password, salt, key_len, N, r, p, num_keys=1):
    ...
    kol = [dk[idx : idx + key_len] for idx in iter_range(0, key_len * num_keys, key_len)]
    return kol
