...
from Cryptodome.Math.Primality import test_probable_prime, COMPOSITE, PROBABLY_PRIME
...
def generate(bits, randfunc=None, domain=None):
    ...
    if (L, N) not in [(1024, 160), (2048, 224), (2048, 256), (3072, 256)]:
        raise ValueError("Lengths of p and q (%d, %d) are not compatible" "to FIPS 186-3" % (L, N))
