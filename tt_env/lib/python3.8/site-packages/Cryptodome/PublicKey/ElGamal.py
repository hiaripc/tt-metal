...
from Cryptodome.Math.Primality import generate_probable_safe_prime, test_probable_prime, COMPOSITE
...
class ElGamalKey(object):
    ...
    def __eq__(self, other):
        ...
        for comp in self._keydata:
            result = result and (getattr(self.key, comp, None) == getattr(other.key, comp, None))
        return result
