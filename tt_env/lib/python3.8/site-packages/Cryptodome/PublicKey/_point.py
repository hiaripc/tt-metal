...
from Cryptodome.Util._raw_api import VoidPointer, null_pointer, SmartPointer, c_size_t, c_uint8_ptr, c_ulonglong
...
class EccXPoint(object):
    ...
    * In-place multiplication by a scalar: ``T *= k``
    ...
    def __init__(self, x, curve):
        ...
        self._point = VoidPointer()
        result = new_point(self._point.address_of(), xb, c_size_t(modulus_bytes), context)
