...
test_data = [
    ...
    ("0b" * 16, "4869205468657265", dict(default_hash="9294727a3638bb1c13f48ef8158bfc9d"), "default-is-MD5"),
    # Test case 1 (MD5)
    ("0b" * 16, "4869205468657265", dict(MD5="9294727a3638bb1c13f48ef8158bfc9d"), "RFC 2202 #1-MD5 (HMAC-MD5)"),
    # Test case 1 (SHA1)
    (
        "0b" * 20,
        "4869205468657265",
    ...
    # Test case 3 (MD5)
    ("aa" * 16, "dd" * 50, dict(MD5="56be34521d144c88dbb8c733f0e8b3f6"), "RFC 2202 #3-MD5 (HMAC-MD5)"),
    # Test case 3 (SHA1)
    ("aa" * 20, "dd" * 50, dict(SHA1="125d7342b9ac11cd91a39af48aa17b4f63f175d3"), "RFC 2202 #3-SHA1 (HMAC-SHA1)"),
    # Test case 4
    (
