...
def get_tests(config={}):
    ...
    test_data = [
        ...
        ("cdc76e5c9914fb9281a1c7e284d73e67f1809a48a497200e046d39ccc7112cd0", "a" * 10**6, '"a" * 10**6'),
    ...
    tests = make_hash_tests(SHA256, "SHA256", test_data, digest_size=32, oid="2.16.840.1.101.3.4.2.1")
