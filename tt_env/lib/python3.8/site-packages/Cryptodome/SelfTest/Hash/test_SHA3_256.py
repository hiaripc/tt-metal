...
def get_tests(config={}):
    ...
    test_vectors = (
        load_test_vectors(("Hash", "SHA3"), "ShortMsgKAT_SHA3-256.txt", "KAT SHA-3 256", {"len": lambda x: int(x)})
        or []
    )
    ...
    tests += make_hash_tests(SHA3, "SHA3_256", test_data, digest_size=SHA3.digest_size, oid="2.16.840.1.101.3.4.2.8")
