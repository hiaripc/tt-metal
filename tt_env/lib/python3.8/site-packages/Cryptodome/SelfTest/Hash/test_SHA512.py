...
def get_tests_SHA512():
    test_vectors = (
        load_test_vectors(("Hash", "SHA2"), "SHA512ShortMsg.rsp", "KAT SHA-512", {"len": lambda x: int(x)}) or []
    )
...
def get_tests_SHA512_224():
    test_vectors = (
        load_test_vectors(("Hash", "SHA2"), "SHA512_224ShortMsg.rsp", "KAT SHA-512/224", {"len": lambda x: int(x)})
        or []
    )
    ...
    tests = make_hash_tests(
        SHA512, "SHA512/224", test_data, digest_size=28, oid="2.16.840.1.101.3.4.2.5", extra_params={"truncate": "224"}
    )
    return tests
...
def get_tests_SHA512_256():
    test_vectors = (
        load_test_vectors(("Hash", "SHA2"), "SHA512_256ShortMsg.rsp", "KAT SHA-512/256", {"len": lambda x: int(x)})
        or []
    )
    ...
    tests = make_hash_tests(
        SHA512, "SHA512/256", test_data, digest_size=32, oid="2.16.840.1.101.3.4.2.6", extra_params={"truncate": "256"}
    )
    return tests
