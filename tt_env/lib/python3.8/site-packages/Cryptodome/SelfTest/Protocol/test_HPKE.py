...
class HPKE_Tests(unittest.TestCase):
    ...
    def test_neg_psk(self):
        ...
        with self.assertRaises(ValueError) as cm:
            HPKE.new(receiver_key=self.key1.public_key(), psk=(b"JJJ", b"Y" * 31), aead_id=HPKE.AEAD.AES128_GCM)
    ...
    def test_x25519_mode_2(self):
        ...
        decryptor = HPKE.new(receiver_key=keyR, sender_key=keyS.public_key(), aead_id=aead_id, info=info, enc=enc)
    ...
    def test_x25519_mode_3(self):
        ...
        decryptor = HPKE.new(
            receiver_key=keyR, sender_key=keyS.public_key(), aead_id=aead_id, psk=(psk_id, psk), info=info, enc=enc
        )
