...
class ECDH_Tests(unittest.TestCase):
    ...
    def test_6(self):
        ...
        kdf = lambda x: SHA256.new(x).digest()
        self.assertRaises(
            ValueError, key_agreement, kdf=kdf, static_pub=self.static_pub, eph_pub=self.eph_pub, eph_priv=self.eph_priv
        )
...
class X25519_Tests(unittest.TestCase):
    ...
    def test_rfc7748_2(self):
        ...
        result = key_agreement(static_pub=pub_key, static_priv=priv_key, kdf=lambda x: x)
        self.assertEqual(result, unhexlify("422c8e7a6227d7bca1350b3e2bb7279f7897b87bb6854b783c60e80311ae3079"))
        ...
        self.assertEqual(result, unhexlify("684cf59ba83309552800ef566f2f4d3c1c3887c49360e3875f2eb94d99532c51"))
