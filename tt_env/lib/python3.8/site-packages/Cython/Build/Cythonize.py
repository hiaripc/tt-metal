...
Environment variables:
  ...
  https://setuptools.pypa.io/en/latest/userguide/ext_modules.html#compiler-and-linker-options""",
    ...
    parser.add_argument(
        "-3", dest="language_level", action="store_const", const=3, help="use Python 3 syntax mode by default"
    )
    parser.add_argument(
        "--3str", dest="language_level", action="store_const", const="3str", help="use Python 3 syntax mode by default"
    )
    parser.add_argument(
        "-+",
        "--cplus",
    ...
    parser.add_argument(
        "-q", "--quiet", dest="quiet", action="store_true", default=None, help="be less verbose during compilation"
    )
    ...
    parser.add_argument(
        "--no-docstrings", dest="no_docstrings", action="store_true", default=None, help="strip docstrings"
    )
