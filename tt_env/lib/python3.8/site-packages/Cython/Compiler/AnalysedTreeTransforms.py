...
class AutoTestDictTransform(ScopeTrackingTransform):
    ...
    excludelist = ["__cinit__", "__dealloc__", "__richcmp__", "__nonzero__", "__bool__", "__len__", "__contains__"]
    ...
    def visit_ModuleNode(self, node):
        ...
        test_dict_entry = node.scope.declare_var(EncodedString("__test__"), py_object_type, pos, visibility="public")
        create_test_dict_assignment = SingleAssignmentNode(
            pos,
            lhs=NameNode(pos, name=EncodedString("__test__"), entry=test_dict_entry),
