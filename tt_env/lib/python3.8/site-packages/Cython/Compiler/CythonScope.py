...
class CythonScope(ModuleScope):
    ...
    def find_submodule(self, module_name, as_package=False):
        ...
        if entry and entry.as_module:
            ...
            # for now.
            raise error((StringSourceDescriptor("cython", ""), 0, 0), "cython.%s is not available" % module_name)
    ...
    def populate_cython_scope(self):
        ...
        self.declare_cfunction(
            ...
            CFuncType(
                c_bint_type,
                [CFuncTypeArg("o", py_object_type, None), CFuncTypeArg("t", c_ptr_type(type_object_type), None)],
            ),
            pos=None,
            defining=1,
...
cython_test_extclass_utility_code = load_testscope_utility(
    "TestClass", name="TestClass", requires=[undecorated_methods_protos, test_cython_utility_dep]
)
