...
class TestTypeIdentifiers(unittest.TestCase):
    ...
    def test_type_identifier_for_declaration(self):
        ...
        test_data = [
            ...
            ("const &&std::vector", "const__fwrefstd__in_vector"),
            ("void (*func)(int x, float y)", "975d51__void__lParen__ptrfunc__rParen__lParenint__spac__etc"),
            ("float ** (*func)(int x, int[:] y)", "31883a__float__ptr__ptr__lParen__ptrfunc__rParen__lPar__etc"),
        ]
