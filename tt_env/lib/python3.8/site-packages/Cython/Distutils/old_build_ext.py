...
class old_build_ext(_build_ext.build_ext):
    ...
    user_options.extend(
        [
            ...
            ("cython-include-dirs=", None, "path to the Cython include files" + sep_by),
            ...
            ("pyrex-cplus", None, "generate C++ source files"),
            ("pyrex-create-listing", None, "write errors to a listing file"),
            ("pyrex-line-directives", None, "emit source line directives"),
            ("pyrex-include-dirs=", None, "path to the Cython include files" + sep_by),
            ("pyrex-c-in-temp", None, "put generated C files in temp directory"),
            ("pyrex-gen-pxi", None, "generate .pxi file for public declarations"),
            ("pyrex-directives=", None, "compiler directive overrides"),
            ("pyrex-gdb", None, "generate debug information for cygdb"),
        ]
    )
