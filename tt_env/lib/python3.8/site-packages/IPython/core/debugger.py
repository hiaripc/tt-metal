        ...
        try:
            ...
            for hidden, frame_lineno in zip(self.hidden_frames(self.stack), self.stack):
                if hidden and self.skip_hidden:
                    ...
                    continue
                if skipped:
                    print(f"{Colors.excName}    [... skipping {skipped} hidden frame(s)]{ColorsNormal}\n")
                    skipped = 0
    ...
    def do_up(self, arg):
        ...
        if count < 0:
            ...
            for i in range(self.curindex - 1, -1, -1):
                ...
                self.error("all frames above hidden, use `skip_hidden False` to get get into those.")
                return
        ...
        if skipped:
            print(f"{Colors.excName}    [... skipped {skipped} hidden frame(s)]{ColorsNormal}\n")
    ...
    def do_down(self, arg):
        ...
        if count < 0:
            ...
            for i in range(self.curindex + 1, len(self.stack)):
                ...
                self.error("all frames below hidden, use `skip_hidden False` to get get into those.")
                return
