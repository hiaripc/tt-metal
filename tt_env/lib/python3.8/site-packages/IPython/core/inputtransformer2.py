...
classic_prompt = PromptStripper(prompt_re=re.compile(r"^(>>>|\.\.\.)( |$)"), initial_re=re.compile(r"^>>>( |$)"))
...
class TransformerManager:
    ...
    def do_token_transforms(self, lines):
        ...
        raise RuntimeError(
            "Input transformation still changing after " "%d iterations. Aborting." % TRANSFORM_LOOP_LIMIT
        )
