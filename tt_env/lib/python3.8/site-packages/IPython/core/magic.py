...
class Magics(Configurable):
    ...
    def __init__(self, shell=None, **kwargs):
        if not (self.__class__.registered):
            raise ValueError("Magics subclass without registration - " "did you forget to apply @magics_class?")
    ...
    def parse_options(self, arg_str, opt_str, *long_opts, **kw):
        ...
        if len(args) >= 1:
            ...
            try:
                ...
                raise UsageError('%s ( allowed: "%s" %s)' % (e.msg, opt_str, " ".join(long_opts))) from e
            for o, a in opts:
