...
from IPython.core.magic import Magics, compress_dhist, magics_class, line_magic, cell_magic, line_cell_magic
...
class OSMagics(Magics):
    ...
    cd_force_quiet = Bool(False, help="Force %cd magic to be quiet even if -q is not passed.").tag(config=True)
        ...
        # jump to bookmark if needed
            ...
            if not os.path.isdir(ps) or "b" in opts:
                ...
                if ps in bkms:
                    ...
                    if "b" in opts:
                        raise UsageError("Bookmark '%s' not found.  " "Use '%%bookmark -l' to see your bookmarks." % ps)
    ...
    @magic_arguments.argument(
        ...
        action="store_true",
        default=False,
        help="Append contents of the cell to an existing file. " "The file will be created if it does not exist.",
    )
