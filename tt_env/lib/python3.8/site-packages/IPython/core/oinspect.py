...
def getargspec(obj):
    ...
    warnings.warn(
        "`getargspec` function is deprecated as of IPython 7.10" "and will be removed in future versions.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def format_argspec(argspec):
    ...
    warnings.warn(
        "`format_argspec` function is deprecated as of IPython 7.10" "and will be removed in future versions.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def call_tip(oinfo, format_call=True):
    ...
    warnings.warn(
        "`call_tip` function is deprecated as of IPython 6.0" "and will be removed in future versions.",
        DeprecationWarning,
        stacklevel=2,
    )
    # Get call definition
