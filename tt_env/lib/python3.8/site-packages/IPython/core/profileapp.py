...
class ProfileList(Application):
    ...
    flags = Dict(
        dict(debug=({"Application": {"log_level": 0}}, "Set Application.log_level to 0, maximizing log output."))
    )
...
create_flags["reset"] = ({"ProfileCreate": {"overwrite": True}}, "reset config files in this profile to the defaults.")
