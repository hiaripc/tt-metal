...
class InteractiveShellApp(Configurable):
    ...
    gui = CaselessStrEnum(
        gui_keys, allow_none=True, help="Enable GUI event loop integration with any of {0}.".format(gui_keys)
    ).tag(config=True)
                ...
                with preserve_keys(self.shell.user_ns, "__file__"):
                    ...
                    if full_filename.endswith(".ipy") or full_filename.endswith(".ipynb"):
                        ...
                        self.shell.safe_execfile(
                            full_filename, self.shell.user_ns, shell_futures=shell_futures, raise_exceptions=True
                        )
        finally:
            sys.argv = save_argv
