...
def test_get_ipython_dir_2():
    ...
    with patch_get_home_dir("someplace"), patch.object(paths, "get_xdg_dir", return_value=None), patch.object(
        paths, "_writable_dir", return_value=True
    ), patch("os.name", "posix"), modified_env({"IPYTHON_DIR": None, "IPYTHONDIR": None, "XDG_CONFIG_HOME": None}):
        ipdir = paths.get_ipython_dir()
...
def test_get_ipython_dir_6():
    ...
    with patch_get_home_dir(HOME_TEST_DIR), patch.object(paths, "get_xdg_dir", return_value=xdg), patch(
        "os.name", "posix"
    ), modified_env(
        {
            "IPYTHON_DIR": None,
