...
class CUnicodeIO(StringIO):
    def __init__(self, *args, **kwargs):
        ...
        warn(
            ("CUnicodeIO is deprecated since IPython 6.0. " "Please use io.StringIO instead."),
            DeprecationWarning,
            stacklevel=2,
        )
...
try:
    ...
    _type_pprinters.setdefault(types.DictProxyType, _dict_pprinter_factory("dict_proxy({", "})"))
