...
class ImageDraw:
    ...
    def pieslice(self, xy: Coords, start, end, fill=None, outline=None, width=1) -> None:
        """Draw a pieslice."""
        ink, fill = self._getink(outline, fill)
        if fill is not None:
    ...
    def regular_polygon(self, bounding_circle, n_sides, rotation=0, fill=None, outline=None, width=1) -> None:
    ...
    def rounded_rectangle(self, xy: Coords, radius=0, fill=None, outline=None, width=1, *, corners=None) -> None:
