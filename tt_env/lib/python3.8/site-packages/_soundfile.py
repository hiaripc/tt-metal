...
ffi = _cffi_backend.FFI(
    ...
    _globals=(
        ...
        4097,
        b"\xFF\xFF\xFF\x0BSFC_SET_BITRATE_MODE",
        4869,
        b"\xFF\xFF\xFF\x0BSFC_SET_CLIPPING",
        4288,
        b"\xFF\xFF\xFF\x0BSFC_SET_COMPRESSION_LEVEL",
        4865,
        ...
        32,
        b"\xFF\xFF\xFF\x0BSF_BITRATE_MODE_AVERAGE",
        1,
        b"\xFF\xFF\xFF\x0BSF_BITRATE_MODE_CONSTANT",
        0,
        b"\xFF\xFF\xFF\x0BSF_BITRATE_MODE_VARIABLE",
        2,
    ...
    _enums=(
        ...
        b"\x00\x00\x00\x6D\x00\x00\x00\x16$2\x00SFC_GET_LIB_VERSION,SFC_GET_LOG_INFO,SFC_GET_FORMAT_INFO,SFC_GET_FORMAT_MAJOR_COUNT,SFC_GET_FORMAT_MAJOR,SFC_GET_FORMAT_SUBTYPE_COUNT,SFC_GET_FORMAT_SUBTYPE,SFC_FILE_TRUNCATE,SFC_SET_CLIPPING,SFC_SET_SCALE_FLOAT_INT_READ,SFC_SET_SCALE_INT_FLOAT_WRITE,SFC_SET_COMPRESSION_LEVEL,SFC_SET_BITRATE_MODE",
        b"\x00\x00\x00\x6E\x00\x00\x00\x16$3\x00SF_FALSE,SF_TRUE,SFM_READ,SFM_WRITE,SFM_RDWR,SF_BITRATE_MODE_CONSTANT,SF_BITRATE_MODE_AVERAGE,SF_BITRATE_MODE_VARIABLE",
    ),
    _typenames=(
