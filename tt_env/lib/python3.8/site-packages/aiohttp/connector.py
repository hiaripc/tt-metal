...
class Connection:
    ...
    def loop(self) -> asyncio.AbstractEventLoop:
        warnings.warn("connector.loop property is deprecated", DeprecationWarning, stacklevel=2)
        return self._loop
...
class BaseConnector:
    ...
    def __init__(
        ...
        *,
        ...
        self._waiters: DefaultDict[ConnectionKey, OrderedDict[asyncio.Future[None], None]] = defaultdict(OrderedDict)
    ...
    def __enter__(self) -> "BaseConnector":
        warnings.warn(
            '"with Connector():" is deprecated, ' 'use "async with Connector():" instead',
            DeprecationWarning,
        )
        return self
    ...
    async def _get(self, key: "ConnectionKey", traces: List["Trace"]) -> Optional[Connection]:
...
class TCPConnector(BaseConnector):
    ...
    def _convert_hosts_to_addr_infos(self, hosts: List[ResolveResult]) -> List[aiohappyeyeballs.AddrInfoType]:
...
class NamedPipeConnector(BaseConnector):
    ...
    def __init__(
        ...
        if not isinstance(self._loop, asyncio.ProactorEventLoop):  # type: ignore[attr-defined]
