...
ENCODING_EXTENSIONS = MappingProxyType({ext: CONTENT_TYPES.encodings_map[ext] for ext in (".br", ".gz")})
...
class FileResponse(StreamResponse):
    ...
    def _get_file_path_stat_encoding(self, accept_encoding: str) -> Tuple[pathlib.Path, os.stat_result, Optional[str]]:
    ...
    async def prepare(self, request: "BaseRequest") -> Optional[AbstractStreamWriter]:
        ...
        if hdrs.CONTENT_TYPE not in self.headers:
            self.content_type = CONTENT_TYPES.guess_type(self._path)[0] or FALLBACK_CONTENT_TYPE
