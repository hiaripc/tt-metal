...
class RequestHandler(BaseProtocol):
    ...
    def __init__(
        ...
        *,
        ...
        if access_log:
            self.access_logger: Optional[AbstractAccessLogger] = access_log_class(access_log, access_log_format)
        else:
                ...
                if not payload.is_eof():
                    ...
                    if not self._force_close and lingering_time:
                        ...
                        try:
                            ...
                            if sys.version_info >= (3, 11) and (t := asyncio.current_task()) and t.cancelling():
                                raise
