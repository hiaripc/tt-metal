...
def ensure_type(value, *types, varname="value"):
    if not isinstance(value, types):
        ...
        raise TypeError(
            ("Expected '{}' to be of type '{}', " "got '{}'").format(varname, expected_types_str, type(value).__name__)
        )
    return value
...
def deprecation_message(old_name, deprecated_in, removed_in, extra_msg):  # pragma: no cover
    return "'{}' has been deprecated in 'v{}' and will be removed in 'v{}'. " "{}".format(
