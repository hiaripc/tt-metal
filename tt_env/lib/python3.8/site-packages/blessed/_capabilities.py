...
CAPABILITIES_ADDITIVES = {
    "link": ("link", re.escape("\x1b") + r"\]8;" + _ANY_NOTESC + ";" + _ANY_NOTESC + re.escape("\x1b") + "\\\\"),
    ...
    "set_a_attributes1": ("sgr", re.escape("\x1b") + r"\[\d+m"),
    "set_a_attributes2": ("sgr", re.escape("\x1b") + r"\[\d+\;\d+m"),
    "set_a_attributes3": ("sgr", re.escape("\x1b") + r"\[\d+\;\d+\;\d+m"),
    "set_a_attributes4": ("sgr", re.escape("\x1b") + r"\[\d+\;\d+\;\d+\;\d+m"),
