...
class Sequence(six.text_type):
    ...
    def ljust(self, width, fillchar=" "):
        ...
        :rtype: str
        """
        rightside = fillchar * int((max(0.0, float(width.__index__() - self.length()))) / float(len(fillchar)))
    ...
    def rjust(self, width, fillchar=" "):
        ...
        :rtype: str
        """
        leftside = fillchar * int((max(0.0, float(width.__index__() - self.length()))) / float(len(fillchar)))
    ...
    def center(self, width, fillchar=" "):
        ...
        leftside = fillchar * int((max(0.0, math.floor(split))) / float(len(fillchar)))
        rightside = fillchar * int((max(0.0, math.ceil(split))) / float(len(fillchar)))
