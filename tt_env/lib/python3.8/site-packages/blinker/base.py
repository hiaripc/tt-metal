...
class Signal:
    ...
    def __init__(self, doc: str | None = None) -> None:
        ...
        self.receivers: dict[t.Any, weakref.ref[c.Callable[..., t.Any]] | c.Callable[..., t.Any]] = {}
    ...
    def connect(self, receiver: F, sender: t.Any = ANY, weak: bool = True) -> F:
        ...
        if _receiver_connected.receivers and self is not _receiver_connected:
            try:
                _receiver_connected.send(self, receiver_arg=receiver, sender_arg=sender, weak_arg=weak)
            except TypeError:
                self.disconnect(receiver, sender)
                raise
    ...
    def send(
        ...
        /,
        *,
        _async_wrapper: c.Callable[[c.Callable[..., c.Coroutine[t.Any, t.Any, t.Any]]], c.Callable[..., t.Any]]
        | None = None,
        **kwargs: t.Any,
    ...
    async def send_async(
        ...
        /,
        *,
        _sync_wrapper: c.Callable[[c.Callable[..., t.Any]], c.Callable[..., c.Coroutine[t.Any, t.Any, t.Any]]]
        | None = None,
        **kwargs: t.Any,
    ) -> list[tuple[c.Callable[..., t.Any], t.Any]]:
...
class _WeakNamespace(WeakValueDictionary):  # type: ignore[type-arg]
    ...
    def __init__(self) -> None:
        warnings.warn(
            "'WeakNamespace' is deprecated and will be removed in Blinker 1.9." " Use 'Namespace' instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        super().__init__()
