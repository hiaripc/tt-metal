...
class Property(PropertyDescriptorFactory[T]):
    ...
    def themed_default(
        self, cls: type[HasProps], name: str, theme_overrides: dict[str, Any] | None, *, no_eval: bool = False
    ) -> T:
    ...
    def prepare_value(
        self, owner: HasProps | type[HasProps], name: str, value: Any, *, hint: DocumentPatchedEvent | None = None
    ) -> T:
    ...
    def asserts(
        self, fn: Callable[[HasProps, T], bool], msg_or_fn: str | Callable[[HasProps, str, T], None]
    ) -> Property[T]:
...
class ParameterizedProperty(Property[T]):
    ...
    def __init__(
        self, *type_params: TypeOrInst[Property[T]], default: Init[T] = Intrinsic, help: str | None = None
    ) -> None:
    ...
    def _may_have_unstable_default(self) -> bool:
        return super()._may_have_unstable_default() or any(
            type_param._may_have_unstable_default() for type_param in self.type_params
        )
