...
class Seq(ContainerProperty[T]):
    ...
    def __init__(
        self, item_type: TypeOrInst[Property[T]], *, default: Init[T] = Undefined, help: str | None = None
    ) -> None:
...
class Set(Seq[T]):
    ...
    def __init__(
        self, item_type: TypeOrInst[Property[T]], *, default: Init[T] = set(), help: str | None = None
    ) -> None:
        # TODO: refactor to not use mutable objects as default values.
        # Left in place for now because we want to allow None to express
        # optional values. Also in Dict.
...
class Dict(ContainerProperty[Any]):
    ...
    def __init__(
        self,
        keys_type: TypeOrInst[Property[Any]],
...
class Tuple(ContainerProperty):
    ...
    def __init__(
        self, *type_params: TypeOrInst[Property[Any]], default: Init[T] = Undefined, help: str | None = None
    ) -> None:
...
class NonEmpty(SingleParameterizedProperty[TSeq]):
    ...
    def __init__(
        self, type_param: TypeOrInst[TSeq], *, default: Init[TSeq] = Intrinsic, help: str | None = None
    ) -> None:
