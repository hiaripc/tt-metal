...
class Either(ParameterizedProperty[Any]):
    ...
    def __init__(
        self,
        type_param0: TypeOrInst[Property[Any]],
        *type_params: TypeOrInst[Property[Any]],
    ...
    def validate(self, value: Any, detail: bool = True) -> None:
        ...
        msg = (
            ""
            if not detail
            else f"expected an element of either {nice_join([ str(param) for param in self.type_params ])}, got {value!r}"
        )
