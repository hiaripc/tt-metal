...
class Nullable(SingleParameterizedProperty[Union[T, None]]):
    ...
    def __init__(
        self, type_param: TypeOrInst[Property[T]], *, default: Init[T | None] = None, help: str | None = None
    ) -> None:
...
class NonNullable(Required[T]):
    ...
    def __init__(
        self, type_param: TypeOrInst[Property[T]], *, default: Init[T] = Undefined, help: str | None = None
    ) -> None:
