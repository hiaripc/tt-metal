...
class DocumentChangedEvent:
    ...
    def __init__(
        self, document: Document, setter: Setter | None = None, callback_invoker: Invoker | None = None
    ) -> None:
        """
...
class MessageSentEvent(DocumentPatchedEvent):
    ...
    def __init__(
        ...
        callback_invoker: Invoker | None = None,
    ):
...
class TitleChangedEvent(DocumentPatchedEvent):
    ...
    def __init__(
        self, document: Document, title: str, setter: Setter | None = None, callback_invoker: Invoker | None = None
    ):
        """
...
class RootAddedEvent(DocumentPatchedEvent):
    ...
    def __init__(
        self, document: Document, model: Model, setter: Setter | None = None, callback_invoker: Invoker | None = None
    ) -> None:
        """
