...
def components(
    models: Model,
    wrap_script: bool = ...,  # type: ignore[misc] # XXX: mypy bug
...
@overload
def components(
    models: Model, wrap_script: bool = ..., wrap_plot_info: Literal[False] = ..., theme: ThemeLike = ...
) -> tuple[str, RenderRoot]:
    ...
...
) -> tuple[str, dict[str, RenderRoot]]:
    ...


def components(
    models: Model | Sequence[Model] | dict[str, Model],
