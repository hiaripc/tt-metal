...
@contextmanager
def OutputDocumentFor(
    objs: Sequence[Model], apply_theme: Theme | type[FromCurdoc] | None = None, always_new: bool = False
) -> Iterator[Document]:
...
class RenderItem:
    def __init__(
        ...
        docid: ID | None = None,
        token: str | None = None,
        elementid: ID | None = None,
        roots: list[Model] | dict[Model, ID] | None = None,
        use_for_title: bool | None = None,
    ):
...
def standalone_docs_json_and_render_items(
    models: Model | Document | Sequence[Model | Document], *, suppress_callback_warning: bool = False
) -> tuple[dict[ID, DocJson], list[RenderItem]]:
    """ """
