...
import_required(
    "selenium.webdriver",
    "To use bokeh.io image export functions you need selenium " "('conda install selenium' or 'pip install selenium')",
)
...
class _WebdriverState:
    ...
    def _create(self, kind: DriverKind | None) -> WebDriver:
        ...
        if driver_kind is None:
            ...
            raise RuntimeError(
                "Neither firefox and geckodriver nor a variant of chromium browser and "
