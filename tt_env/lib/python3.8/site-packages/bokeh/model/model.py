...
class Model(HasProps, HasDocumentRef, PropertyCallbackManager, EventCallbackManager):
    ...
    js_event_callbacks = p.Dict(
        p.String,
        p.List(p.Instance("bokeh.models.callbacks.Callback")),
        help="""
    ...
    def parameters(cls: type[Model]) -> list[Parameter]:
        ...
        for kw in kws:
            ...
            param = Parameter(name=kw, kind=Parameter.KEYWORD_ONLY, default=default)
            del default
            typ = type_link(descriptor.property)
    ...
    def trigger(
        self, attr: str, old: Any, new: Any, hint: DocumentPatchedEvent | None = None, setter: Setter | None = None
    ) -> None:
        """ """
