...
class BaseColorBar(Annotation):
    ...
    major_label_policy = Instance(
        LabelingPolicy,
        default=InstanceDefault(NoOverlap),
        help="""
...
class Legend(Annotation):
    ...
    item_background_props = Include(
        ScalarFillProps,
        prefix="item_background",
        help="""
    The {prop} for the legend items' background style.
    """,
    )

    inactive_props = Include(
        ScalarFillProps,
        prefix="inactive",
        help="""
