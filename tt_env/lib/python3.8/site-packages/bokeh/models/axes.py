...
class Axis(GuideRenderer):
    ...
    major_label_orientation = Either(
    ...
    major_label_policy = Instance(
        LabelingPolicy,
        default=InstanceDefault(AllLabels),
        help="""
...
class CategoricalAxis(Axis):
    ...
    group_label_orientation = Either(
    ...
    subgroup_label_orientation = Either(
        Enum(TickLabelOrientation),
        Float,
        default="parallel",
        help="""
