...
class DatetimeTickFormatter(TickFormatter):
    ...
    microseconds = String(help=_DATETIME_TICK_FORMATTER_HELP("``microseconds``"), default="%fus").accepts(
        List(String), _deprecated_datetime_list_format
    )

    milliseconds = String(help=_DATETIME_TICK_FORMATTER_HELP("``milliseconds``"), default="%3Nms").accepts(
        List(String), _deprecated_datetime_list_format
    )

    seconds = String(help=_DATETIME_TICK_FORMATTER_HELP("``seconds``"), default="%Ss").accepts(
        List(String), _deprecated_datetime_list_format
    )

    minsec = String(
        help=_DATETIME_TICK_FORMATTER_HELP("``minsec`` (for combined minutes and seconds)"), default=":%M:%S"
    ).accepts(List(String), _deprecated_datetime_list_format)

    minutes = String(help=_DATETIME_TICK_FORMATTER_HELP("``minutes``"), default=":%M").accepts(
        List(String), _deprecated_datetime_list_format
    )

    hourmin = String(
        help=_DATETIME_TICK_FORMATTER_HELP("``hourmin`` (for combined hours and minutes)"), default="%H:%M"
    ).accepts(List(String), _deprecated_datetime_list_format)

    hours = String(help=_DATETIME_TICK_FORMATTER_HELP("``hours``"), default="%Hh").accepts(
        List(String), _deprecated_datetime_list_format
    )

    days = String(help=_DATETIME_TICK_FORMATTER_HELP("``days``"), default="%m/%d").accepts(
        List(String), _deprecated_datetime_list_format
    )

    months = String(help=_DATETIME_TICK_FORMATTER_HELP("``months``"), default="%m/%Y").accepts(
        List(String), _deprecated_datetime_list_format
    )

    years = String(help=_DATETIME_TICK_FORMATTER_HELP("``years``"), default="%Y").accepts(
        List(String), _deprecated_datetime_list_format
    )
    ...
    context = Nullable(
        Either(String, Instance("bokeh.models.formatters.DatetimeTickFormatter")),
        default=None,
        help="""
