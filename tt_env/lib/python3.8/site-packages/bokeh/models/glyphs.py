...
class Image(ImageBase):
    ...
    color_mapper = Instance(
        ColorMapper,
        default=InstanceDefault(LinearColorMapper, palette="Greys9"),
        help="""
...
class Text(XYGlyph, TextGlyph):
    ...
    background_hatch_props = Include(
        HatchProps,
        prefix="background",
        help="""
    The {prop} values for the text bounding box.
