...
class LayoutDOM(UIElement):
    ...
    margin = Nullable(
        Either(Int, Tuple(Int, Int), Tuple(Int, Int, Int, Int)),
        help="""
...
class GridBox(LayoutDOM, GridCommon):
    ...
    children = List(
        Either(Tuple(Instance(UIElement), Int, Int), Tuple(Instance(UIElement), Int, Int, Int, Int)),
        default=[],
        help="""
...
class HBox(LayoutDOM):
    ...
    children = List(
        Struct(child=Instance(UIElement), col=Optional(Int), span=Optional(Int)),
        default=[],
        help="""
...
class VBox(LayoutDOM):
    ...
    children = List(
        Struct(child=Instance(UIElement), row=Optional(Int), span=Optional(Int)),
        default=[],
        help="""
...
class Tabs(LayoutDOM):
    ...
    """,
        ...
        List(Tuple(String, Instance(UIElement))),
