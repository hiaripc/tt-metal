...
class Plot(LayoutDOM):
    ...
    def add_glyph(
        self, source_or_glyph: Glyph | ColumnarDataSource, glyph: Glyph | None = None, **kwargs: Any
    ) -> GlyphRenderer:
    ...
    def add_tile(
        self, tile_source: TileSource | xyzservices.TileProvider | str, retina: bool = False, **kwargs: Any
    ) -> TileRenderer:
    ...
    x_range = Instance(
        Range,
        default=InstanceDefault(DataRange1d),
        help="""
    ...
    x_scale = Instance(
        Scale,
        default=InstanceDefault(LinearScale),
        help="""
    ...
    toolbar = Instance(
        Toolbar,
        default=InstanceDefault(Toolbar),
        help="""
