...
class Range1d(Range):
    ...
    bounds = Nullable(
        MinMaxBounds(accept_datetime=True),
        help="""
...
class FactorRange(Range):
    ...
    bounds = Nullable(
        MinMaxBounds(accept_datetime=False),
        help="""
