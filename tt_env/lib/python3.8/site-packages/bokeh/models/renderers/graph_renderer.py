...
class GraphRenderer(DataRenderer):
    ...
    node_renderer = Instance(
        GlyphRenderer,
        default=_DEFAULT_NODE_RENDERER,
        help="""
    ...
    edge_renderer = Instance(
        GlyphRenderer,
        default=_DEFAULT_EDGE_RENDERER,
        help="""
    ...
    selection_policy = Instance(
        GraphHitTestPolicy,
        default=InstanceDefault(NodesOnly),
        help="""
