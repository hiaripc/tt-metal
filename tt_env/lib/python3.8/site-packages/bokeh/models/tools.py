...
class Tool(Model):
    ...
    icon = Nullable(
        Either(Image, Enum(ToolIcon), Regex(r"^\.")),
        help="""
...
class Toolbar(UIElement):
    ...
    tools = List(
        Either(Instance(Tool), Instance(ToolProxy)),
        help="""
    A list of tools to add to the plot.
    """,
    )

    active_drag: Literal["auto"] | Drag | None = Either(
        Null,
        Auto,
        Instance(Drag),
        default="auto",
    ...
    active_inspect: Literal["auto"] | InspectTool | tp.Sequence[InspectTool] | None = Either(
        Null,
        Auto,
        Instance(InspectTool),
        Seq(Instance(InspectTool)),
        default="auto",
        help="""
    ...
    active_scroll: Literal["auto"] | Scroll | None = Either(
        Null,
        Auto,
        Instance(Scroll),
        default="auto",
    ...
    active_tap: Literal["auto"] | Tap | None = Either(
        Null,
        Auto,
        Instance(Tap),
        default="auto",
    ...
    active_multi: Literal["auto"] | GestureTool | None = Either(
        Null,
        Auto,
        Instance(GestureTool),
        default="auto",
        help="""
...
DEFAULT_RANGE_OVERLAY = InstanceDefault(
    BoxAnnotation,
    syncable=False,
    level="overlay",
    visible=True,
...
class CrosshairTool(InspectTool):
    ...
    *toolbar icon* shown above.
    ...
    overlay = Either(
        Auto,
        Instance(Span),
        Tuple(Instance(Span), Instance(Span)),
        default="auto",
        help="""
...
DEFAULT_BOX_ZOOM_OVERLAY = InstanceDefault(
    BoxAnnotation,
    syncable=False,
    level="overlay",
    visible=False,
...
DEFAULT_BOX_SELECT_OVERLAY = InstanceDefault(
    BoxAnnotation,
    syncable=False,
    level="overlay",
    visible=False,
...
class BoxZoomTool(Drag):
    ...
    overlay = Instance(
        BoxAnnotation,
        default=DEFAULT_BOX_ZOOM_OVERLAY,
        help="""
...
class BoxSelectTool(Drag, RegionSelectTool):
    ...
    overlay = Instance(
        BoxAnnotation,
        default=DEFAULT_BOX_SELECT_OVERLAY,
        help="""
    A shaded annotation drawn to indicate the selection region.
    """,
    )
...
DEFAULT_POLY_OVERLAY = InstanceDefault(
    PolyAnnotation,
    syncable=False,
    level="overlay",
    visible=False,
...
class HoverTool(InspectTool):
    ...
    *toolbar icon* shown above.
    ...
    formatters = Dict(
        String,
        Either(Enum(TooltipFieldFormatter), Instance(CustomJSHover)),
        default=lambda: dict(),
        help="""
...
class LineEditTool(EditTool, Drag, Tap):
    ...
    * Move point: Drag an existing point and let go of the mouse button to
    ...
    intersection_renderer = Instance(
        GlyphRenderer,
        help="""
