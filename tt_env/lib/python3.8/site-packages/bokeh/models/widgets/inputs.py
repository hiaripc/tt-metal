...
class InputWidget(Widget):
    ...
    description = Nullable(
        Either(String, Instance(Tooltip)),
        default=None,
        help="""
...
class Spinner(NumericInput):
    ...
    value_throttled = Readonly(
        Either(Null, Float, Int),
        help="""
...
class Select(InputWidget):
    ...
    options = Either(
        ...
        Dict(String, List(Either(String, Tuple(String, String)))),
        help="""
