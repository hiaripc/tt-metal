...
class TableColumn(Model):
    ...
    formatter = Instance(
        CellFormatter,
        InstanceDefault(StringFormatter),
        help="""
...
class TableWidget(Widget):
    ...
    source = Instance(
        DataSource,
        default=InstanceDefault(ColumnDataSource),
        help="""
    ...
    view = Instance(
        CDSView,
        default=InstanceDefault(CDSView),
        help="""
