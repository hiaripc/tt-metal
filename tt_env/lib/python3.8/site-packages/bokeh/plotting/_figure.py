...
class figure(Plot, GlyphAPI):
    ...
    * :func:`~bokeh.plotting.figure.hexbin`
    ...
    def subplot(
        self,
        *,
        x_source: Range | None = None,
        y_source: Range | None = None,
...
class BaseFigureOptions(Options):
    ...
    active_drag = Nullable(
        Either(Auto, String, Instance(Drag)),
        default="auto",
        help="""
    ...
    active_inspect = Nullable(
        Either(Auto, String, Instance(InspectTool), Seq(Instance(InspectTool))),
        default="auto",
        help="""
    Which drag tool should initially be active.
    """,
    ...
    active_scroll = Nullable(
        Either(Auto, String, Instance(Scroll)),
        default="auto",
        help="""
    ...
    active_tap = Nullable(
        Either(Auto, String, Instance(Tap)),
        default="auto",
        help="""
    ...
    active_multi = Nullable(
        Either(Auto, String, Instance(GestureTool)),
        default="auto",
        help="""
    ...
    tooltips = Nullable(
        Either(Instance(Template), String, List(Tuple(String, String))),
        help="""
