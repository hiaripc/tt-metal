...
def process_active_tools(
    toolbar: Toolbar,
    tool_map: dict[str, Tool],
    active_drag: ActiveDrag,
    active_inspect: ActiveInspect,
    ...
    if active_drag in ["auto", None] or isinstance(active_drag, Tool):
        ...
        raise ValueError(
            f"Got unknown {active_drag!r} for 'active_drag', which was not a string supplied in 'tools' argument"
        )

    if (
        active_inspect in ["auto", None]
        or isinstance(active_inspect, Tool)
        or (isinstance(active_inspect, list) and all(isinstance(t, Tool) for t in active_inspect))
    ):
        ...
        raise ValueError(
            f"Got unknown {active_inspect!r} for 'active_inspect', which was not a string supplied in 'tools' argument"
        )
    ...
    if active_scroll in ["auto", None] or isinstance(active_scroll, Tool):
        ...
        raise ValueError(
            f"Got unknown {active_scroll!r} for 'active_scroll', which was not a string supplied in 'tools' argument"
        )
    ...
    if active_tap in ["auto", None] or isinstance(active_tap, Tool):
        ...
        raise ValueError(
            f"Got unknown {active_tap!r} for 'active_tap', which was not a string supplied in 'tools' argument"
        )
    ...
    if active_multi in ["auto", None] or isinstance(active_multi, Tool):
        ...
        raise ValueError(
            f"Got unknown {active_multi!r} for 'active_multi', which was not a string supplied in 'tools' argument"
        )


def process_tools_arg(
    plot: Plot, tools: str | Sequence[Tool | str], tooltips: str | tuple[str, str] | None = None
