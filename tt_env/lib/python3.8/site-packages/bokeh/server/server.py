...
class BaseServer:
    ...
    * a Tornado ``HTTPServer`` to direct HTTP requests
    ...
    def port(self) -> int | None:
        ...
        sock = next(sock for sock in self._http._sockets.values() if sock.family in (socket.AF_INET, socket.AF_INET6))
...
class _ServerOpts(Options):
    ...
    allow_websocket_origin: list[str] | None = Nullable(
        p.List(String),
        help="""
    ...
    ssl_certfile: str | None = Nullable(
        String,
        help="""
    ...
    ssl_password: str | None = Nullable(
        String,
        help="""
