...
export declare abstract class ColorMapper extends Mapper<Color> {
    ...
    protected abstract _v_compute<T>(xs: Arrayable<uint32> | Arrayable<Factor>, values: Arrayable<T>, palette: Arrayable<T>, colors: {
        nan_color: T;
    }): void;
    protected _v_compute_uint32(xs: Arrayable<uint32> | Arrayable<Factor>, values: Arrayable<uint32>, palette: Arrayable<uint32>, colors: {
        nan_color: uint32;
    }): void;
}
