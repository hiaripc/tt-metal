...
export { EqHistColorMapper } from "./eqhist_color_mapper";
export { StackColorMapper } from "./stack_color_mapper";
export { WeightedStackColorMapper } from "./weighted_stack_color_mapper";
