...
class WSHandler(AuthRequestHandler, WebSocketHandler):
    ...
    def open(self) -> None:
        ...
        if "session_expiry" not in payload:
            ...
            token, signed=self.application.sign_sessions, secret_key=self.application.secret_key
        ):
    ...
    async def write_message(
        self, message: bytes | str | dict[str, Any], binary: bool = False, locked: bool = True
    ) -> None:
