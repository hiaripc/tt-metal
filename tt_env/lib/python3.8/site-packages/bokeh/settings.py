...
class PrioritizedSetting(Generic[T]):
    ...
    def __init__(
        ...
        dev_default: Unset[T] = _Unset,
        convert: Callable[[T | str], T] | None = None,
        help: str = "",
    ) -> None:
...
_config_user_locations: Sequence[str] = (join(expanduser("~"), ".bokeh", "bokeh.yaml"),)
...
class Settings:
    ...
    allowed_ws_origin: PrioritizedSetting[list[str]] = PrioritizedSetting(
        "allowed_ws_origin",
        "BOKEH_ALLOW_WS_ORIGIN",
        default=[],
        convert=convert_str_seq,
        help="""
    A comma-separated list of allowed websocket origins for Bokeh server applications.
    """,
    )

    auth_module: PrioritizedSetting[str | None] = PrioritizedSetting(
        "auth_module",
        "BOKEH_AUTH_MODULE",
        default=None,
        help="""
    ...
    browser: PrioritizedSetting[str | None] = PrioritizedSetting(
        "browser",
        "BOKEH_BROWSER",
        default=None,
        dev_default="none",
    ...
    cdn_version: PrioritizedSetting[str | None] = PrioritizedSetting(
        "version",
        "BOKEH_CDN_VERSION",
        default=None,
        help="""
    ...
    cookie_secret: PrioritizedSetting[str | None] = PrioritizedSetting(
        "cookie_secret",
        "BOKEH_COOKIE_SECRET",
        default=None,
        help="""
    ...
    docs_cdn: PrioritizedSetting[str | None] = PrioritizedSetting(
        "docs_cdn",
        "BOKEH_DOCS_CDN",
        default=None,
        help="""
    ...
    docs_version: PrioritizedSetting[str | None] = PrioritizedSetting(
        "docs_version",
        "BOKEH_DOCS_VERSION",
        default=None,
        help="""
    ...
    ico_path: PrioritizedSetting[str] = PrioritizedSetting(
        "ico_path",
        "BOKEH_ICO_PATH",
        default="default",
        dev_default="default-dev",
        convert=convert_ico_path,
        help="""
    ...
    ignore_filename: PrioritizedSetting[bool] = PrioritizedSetting(
        "ignore_filename",
    ...
    log_level: PrioritizedSetting[LogLevel] = PrioritizedSetting(
        "log_level",
        "BOKEH_LOG_LEVEL",
        default="info",
        dev_default="debug",
    ...
    minified: PrioritizedSetting[bool] = PrioritizedSetting(
        "minified",
        "BOKEH_MINIFIED",
        convert=convert_bool,
        default=True,
    ...
    nodejs_path: PrioritizedSetting[str | None] = PrioritizedSetting(
        "nodejs_path",
        "BOKEH_NODEJS_PATH",
        default=None,
        help="""
    ...
    perform_document_validation: PrioritizedSetting[bool] = PrioritizedSetting(
        "validate_doc",
        "BOKEH_VALIDATE_DOC",
        convert=convert_bool,
        default=True,
    ...
    pretty: PrioritizedSetting[bool] = PrioritizedSetting(
        "pretty",
        "BOKEH_PRETTY",
        default=False,
        dev_default=True,
    ...
    py_log_level: PrioritizedSetting[PyLogLevel] = PrioritizedSetting(
        "py_log_level",
        "BOKEH_PY_LOG_LEVEL",
        default="none",
        dev_default="debug",
    ...
    resources: PrioritizedSetting[ResourcesMode] = PrioritizedSetting(
        "resources",
        "BOKEH_RESOURCES",
        default="cdn",
        dev_default="absolute-dev",
        help="""
    ...
    rootdir: PrioritizedSetting[PathLike | None] = PrioritizedSetting(
        "rootdir",
        "BOKEH_ROOTDIR",
        default=None,
        help="""
    ...
    secret_key: PrioritizedSetting[str | None] = PrioritizedSetting(
        "secret_key",
        "BOKEH_SECRET_KEY",
        default=None,
        help="""
    ...
    sign_sessions: PrioritizedSetting[bool] = PrioritizedSetting(
        "sign_sessions",
        "BOKEH_SIGN_SESSIONS",
        default=False,
        help="""
    ...
    simple_ids: PrioritizedSetting[bool] = PrioritizedSetting(
        "simple_ids",
        "BOKEH_SIMPLE_IDS",
        default=True,
        convert=convert_bool,
    ...
    ssl_certfile: PrioritizedSetting[str | None] = PrioritizedSetting(
        "ssl_certfile",
        "BOKEH_SSL_CERTFILE",
        default=None,
        help="""
    ...
    ssl_keyfile: PrioritizedSetting[str | None] = PrioritizedSetting(
        "ssl_keyfile",
        "BOKEH_SSL_KEYFILE",
        default=None,
        help="""
    ...
    ssl_password: PrioritizedSetting[str | None] = PrioritizedSetting(
        "ssl_password",
        "BOKEH_SSL_PASSWORD",
        default=None,
        help="""
    ...
    validation_level: PrioritizedSetting[ValidationLevel] = PrioritizedSetting(
        "validation_level",
        "BOKEH_VALIDATION_LEVEL",
        default="none",
        convert=convert_validation,
        help="""
    ...
    xsrf_cookies: PrioritizedSetting[bool] = PrioritizedSetting(
        "xsrf_cookies",
        "BOKEH_XSRF_COOKIES",
        default=False,
        convert=convert_bool,
...
if _secret_key is not None and len(_secret_key) < 32:
    ...
    warn(
        "BOKEH_SECRET_KEY is recommended to have at least 32 bytes of entropy chosen with a cryptographically-random algorithm"
    )
del _secret_key
