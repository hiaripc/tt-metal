...
def bokeh_issue(name, rawtext, text, lineno, inliner, options=None, content=None):
    ...
    try:
        ...
        msg = inliner.reporter.error(
            f"Github issue number must be a number greater than or equal to 1; {text!r} is invalid.", line=lineno
        )
...
def bokeh_pull(name, rawtext, text, lineno, inliner, options=None, content=None):
    ...
    try:
        ...
        msg = inliner.reporter.error(
            f"Github pull request number must be a number greater than or equal to 1; {text!r} is invalid.", line=lineno
        )
        prb = inliner.problematic(rawtext, rawtext, msg)
        return [prb], [msg]
