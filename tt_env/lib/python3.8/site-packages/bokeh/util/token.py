...
def generate_session_id(
    secret_key: bytes | None = settings.secret_key_bytes(), signed: bool = settings.sign_sessions()
) -> ID:
...
def check_token_signature(
    token: str, secret_key: bytes | None = settings.secret_key_bytes(), signed: bool = settings.sign_sessions()
) -> bool:
...
def check_session_id_signature(
    session_id: str,
    secret_key: bytes | None = settings.secret_key_bytes(),
    signed: bool | None = settings.sign_sessions(),
) -> bool:
