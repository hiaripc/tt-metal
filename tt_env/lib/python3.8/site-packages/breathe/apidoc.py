...
def recurse_tree(args):
    ...
    for compound in index.getroot():
        create_package_file(compound.findtext("name"), compound.get("kind"), compound.get("refid"), args)
...
Note: By default this script will not overwrite already created files.""",
    ...
    parser.add_argument("-q", "--quiet", action="store_true", dest="quiet", help="suppress informational messages")
    parser.add_argument("--version", action="version", version="Breathe (breathe-apidoc) %s" % __version__)
