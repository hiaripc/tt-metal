...
def setup(app: Sphinx) -> None:
    ...
    def set_temp_data(app: Sphinx, project_info_factory=project_info_factory, parser_factory=parser_factory):
    ...
    doxygen_handle = AutoDoxygenProcessHandle(subprocess.check_call, write_file, project_info_factory)
