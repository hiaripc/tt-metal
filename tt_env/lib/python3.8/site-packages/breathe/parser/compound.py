...
class memberdefTypeSub(supermod.memberdefType):
    ...
    def buildChildren(self, child_, nodeName_):
        ...
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "param":
            ...
            # Add parameter name
            obj_ = paramname.mixedclass_(MixedContainer.CategoryText, MixedContainer.TypeNone, "", param.declname)
...
class docParaTypeSub(supermod.docParaType):
    ...
    def buildChildren(self, child_, nodeName_):
        ...
        if child_.nodeType == Node.TEXT_NODE:
            ...
            childobj_.build(child_)
            obj_ = self.mixedclass_(MixedContainer.CategoryComplex, MixedContainer.TypeNone, "verbatim", childobj_)
            self.content.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "formula":
            childobj_ = docFormulaTypeSub.factory()
            childobj_.build(child_)
            obj_ = self.mixedclass_(MixedContainer.CategoryComplex, MixedContainer.TypeNone, "formula", childobj_)
            self.content.append(obj_)
            ...
            obj_.build(child_)
            self.content.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and (nodeName_ == "ndash" or nodeName_ == "mdash"):
