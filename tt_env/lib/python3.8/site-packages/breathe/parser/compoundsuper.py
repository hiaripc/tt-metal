...
class compounddefType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "compoundname":
            ...
            obj_ = graphType.factory(caption=f"Include dependency graph for {self.get_compoundname()}:")
            obj_.build(child_)
            self.set_incdepgraph(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "invincdepgraph":
            obj_ = graphType.factory(
                direction="back",
                caption=f"This graph shows which files directly " f"or indirectly include {self.get_compoundname()}:",
            )
            obj_.build(child_)
            ...
            obj_ = graphType.factory(caption=f"Inheritence diagram for {self.get_compoundname()}:")
            obj_.build(child_)
            self.set_inheritancegraph(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "collaborationgraph":
            obj_ = graphType.factory(caption=f"Collaboration diagram for {self.get_compoundname()}:")
            obj_.build(child_)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "name":
            ...
            obj_ = self.mixedclass_(
                MixedContainer.CategoryComplex, MixedContainer.TypeNone, "briefdescription", childobj_
            )
            self.content_.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "detaileddescription":
            childobj_ = descriptionType.factory()
            childobj_.build(child_)
            obj_ = self.mixedclass_(
                MixedContainer.CategoryComplex, MixedContainer.TypeNone, "detaileddescription", childobj_
            )
            self.content_.append(obj_)
...
class childnodeType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="childnodeType"):
        ...
        if self.refid is not None:
            outfile.write(
                " refid=%s"
                % (self.format_string(quote_attrib(self.refid).encode(ExternalEncoding), input_name="refid"),)
            )
    ...
    def exportChildren(self, outfile, level, namespace_="", name_="childnodeType"):
        for edgelabel_ in self.edgelabel:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.format_string(quote_xml(edgelabel_).encode(ExternalEncoding), input_name="edgelabel"),
                    namespace_,
                )
            )
...
class linkType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="linkType"):
        ...
        if self.external is not None:
            outfile.write(
                " external=%s"
                % (self.format_string(quote_attrib(self.external).encode(ExternalEncoding), input_name="external"),)
            )
...
class referenceType(GeneratedsSuper):
    ...
    def __init__(
        self, endline=None, startline=None, refid=None, compoundref=None, valueOf_="", mixedclass_=None, content_=None
    ):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="referenceType"):
        ...
        if self.compoundref is not None:
            outfile.write(
                ...
                % (
                    self.format_string(
                        quote_attrib(self.compoundref).encode(ExternalEncoding), input_name="compoundref"
                    ),
                )
            )
...
class locationType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="locationType"):
        ...
        if self.bodyfile is not None:
            outfile.write(
                " bodyfile=%s"
                % (self.format_string(quote_attrib(self.bodyfile).encode(ExternalEncoding), input_name="bodyfile"),)
            )
        if self.file is not None:
            outfile.write(
                " file=%s" % (self.format_string(quote_attrib(self.file).encode(ExternalEncoding), input_name="file"),)
            )
...
class docSect1Type(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="docSect1Type"):
        if self.id is not None:
            outfile.write(
                " id=%s" % (self.format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name="id"),)
            )
...
class docURLLink(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="docURLLink"):
        if self.url is not None:
            outfile.write(
                " url=%s" % (self.format_string(quote_attrib(self.url).encode(ExternalEncoding), input_name="url"),)
            )
    ...
    def exportChildren(self, outfile, level, namespace_="", name_="docIndexEntryType"):
        if self.primaryie is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.format_string(quote_xml(self.primaryie).encode(ExternalEncoding), input_name="primaryie"),
                    namespace_,
                )
            )
        if self.secondaryie is not None:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.format_string(quote_xml(self.secondaryie).encode(ExternalEncoding), input_name="secondaryie"),
                    namespace_,
                )
            )
...
class docImageType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="docImageType"):
        if self.width is not None:
            outfile.write(
                " width=%s"
                % (self.format_string(quote_attrib(self.width).encode(ExternalEncoding), input_name="width"),)
            )
        if self.type_ is not None:
            outfile.write(" type=%s" % (quote_attrib(self.type_),))
        if self.name is not None:
            outfile.write(
                " name=%s" % (self.format_string(quote_attrib(self.name).encode(ExternalEncoding), input_name="name"),)
            )
        if self.height is not None:
            outfile.write(
                " height=%s"
                % (self.format_string(quote_attrib(self.height).encode(ExternalEncoding), input_name="height"),)
            )
...
class docDotType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="docDotType"):
        if self.caption is not None:
            outfile.write(
                " caption=%s"
                % (self.format_string(quote_attrib(self.caption).encode(ExternalEncoding), input_name="caption"),)
            )
...
class docLanguageType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="docLanguageType"):
        if self.langid is not None:
            outfile.write(
                " langid=%s"
                % (self.format_string(quote_attrib(self.langid).encode(ExternalEncoding), input_name="langid"),)
            )
        ...
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "ref":
            ...
            if d is not None:
                self.content_.insert(
                    0,
                    self.mixedclass_(MixedContainer.CategoryText, MixedContainer.TypeNone, "", "[{}] ".format(d.value)),
                )
    ...
    def exportChildren(self, outfile, level, namespace_="", name_="docXRefSectType"):
        for xreftitle_ in self.xreftitle:
            ...
            outfile.write(
                ...
                % (
                    namespace_,
                    self.format_string(quote_xml(xreftitle_).encode(ExternalEncoding), input_name="xreftitle"),
                    namespace_,
                )
            )
...
class docCopyType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, namespace_="", name_="docCopyType"):
        if self.link is not None:
            outfile.write(
                " link=%s" % (self.format_string(quote_attrib(self.link).encode(ExternalEncoding), input_name="link"),)
            )
...
class docBlockQuoteType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and nodeName_ == "para":
            obj_ = docParaType.factory()
            obj_.build(child_)
            obj_ = self.mixedclass_(MixedContainer.CategoryComplex, MixedContainer.TypeNone, "para", obj_)
            self.para.append(obj_)
