...
class Element(BeautifulSoupNode):
    ...
    def appendChild(self, node: "BeautifulSoupNode") -> None:
        ...
        if string_child is not None and self.element.contents and type(self.element.contents[-1]) is NavigableString:
    ...
    def reparentChildren(self, new_parent: "Element") -> None:
        ...
        if len(to_append) > 0:
            ...
            # descendant had.
            last_childs_last_descendant = to_append[-1]._last_descendant(is_initialized=False, accept_self=True)
