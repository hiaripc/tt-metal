...
class Formatter(EntitySubstitution):
    ...
    def __init__(
        ...
        self.cdata_containing_tags = self._default(self.language, cdata_containing_tags, "cdata_containing_tags")
    ...
    def substitute(self, ns: str) -> str:
        ...
        if isinstance(ns, NavigableString) and ns.parent is not None and ns.parent.name in self.cdata_containing_tags:
            # Do nothing.
            return ns
        # Substitute.
    ...
    def attributes(self, tag: bs4.element.Tag) -> Iterable[Tuple[str, Optional[_AttributeValue]]]:
        ...
        return sorted((k, (None if self.empty_attributes_are_booleans and v == "" else v)) for k, v in items)
...
HTMLFormatter.REGISTRY["html"] = HTMLFormatter(entity_substitution=EntitySubstitution.substitute_html)
...
HTMLFormatter.REGISTRY["minimal"] = HTMLFormatter(entity_substitution=EntitySubstitution.substitute_xml)
...
XMLFormatter.REGISTRY["minimal"] = XMLFormatter(entity_substitution=EntitySubstitution.substitute_xml)
