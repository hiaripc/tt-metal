...
class SoupTest(object):
    ...
    def assert_soup(self, to_parse: _IncomingMarkup, compare_parsed_to: Optional[str] = None) -> None:
...
"""
    ...
    def test_correctly_nested_tables(self):
        ...
        markup = (
            '<table id="1">' "<tr>" "<td>Here's another table:" '<table id="2">' "<tr><td>foo</td></tr>" "</table></td>"
        )
