...
class TestParentOperations(SoupTest):
    ...
    def test_self_and_parent_generator(self):
        results = [
            parent["id"] for parent in self.start.self_and_parents if parent is not None and "id" in parent.attrs
        ]
...
class TestTreeModification(SoupTest):
    ...
    def test_extend_with_a_single_non_tag_element(self, string_source, result):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert warning.filename == __file__
            msg = str(warning.message)
            assert msg == "A single non-Tag item was passed into Tag.extend. Use Tag.append instead."
