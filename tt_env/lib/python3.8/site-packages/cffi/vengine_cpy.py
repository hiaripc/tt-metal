...
class VCPythonEngine(object):
    ...
    def _generate_cpy_function_decl(self, tp, name):
        ...
        prnt("  { %s%s(%s); }" % (result_code, name, ", ".join(["x%d" % i for i in range(len(tp.args))])))
    ...
    def _generate_cpy_const(
        self, is_int, name, tp=None, category="const", vartp=None, delayed=True, size_too=False, check_value=None
    ):
        prnt = self._prnt
