...
class Context:
    ...
    def forward(__self, __cmd: "Command", *args: t.Any, **kwargs: t.Any) -> t.Any:  # noqa: B902
...
class BaseCommand:
    ...
    def make_context(
        ...
        **extra: t.Any,
        ...
        ctx = self.context_class(self, info_name=info_name, parent=parent, **extra)  # type: ignore
