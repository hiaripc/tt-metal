...
if(GTestAlt_FOUND AND GTestAlt_NEED_CXX_STANDARD_CHECK)
    ...
    set(GTestAlt_CXX_STANDARD_TEST_SOURCE "${CMAKE_CURRENT_BINARY_DIR}/gtest_cxx_standard_test.cc")
    file(
        WRITE
        ${GTestAlt_CXX_STANDARD_TEST_SOURCE}
        "
#include <string_view>
...
TEST(CXX_STANDARD, MatcherStringView) {
  testing::Matcher matcher(std::string_view(\"hello\"));
    ...
    if(NOT GTestAlt_CXX_STANDARD_AVAILABLE)
        ...
        find_package_handle_standard_args(GTestAlt REQUIRED_VARS GTestAlt_CXX_STANDARD_AVAILABLE)
    endif()
