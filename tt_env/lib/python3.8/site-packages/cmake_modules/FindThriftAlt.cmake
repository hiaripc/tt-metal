...
function(extract_thrift_version)
    if(ThriftAlt_INCLUDE_DIR)
        ...
        set(ThriftAlt_VERSION "${ThriftAlt_VERSION}" PARENT_SCOPE)
    else()
        set(ThriftAlt_VERSION "" PARENT_SCOPE)
    endif()
endfunction()
...
if(ARROW_THRIFT_USE_SHARED)
    if(CMAKE_IMPORT_LIBRARY_SUFFIX)
        set(ThriftAlt_LIB_NAME "${CMAKE_IMPORT_LIBRARY_PREFIX}${ThriftAlt_LIB_NAME_BASE}${CMAKE_IMPORT_LIBRARY_SUFFIX}")
    else()
        set(ThriftAlt_LIB_NAME "${CMAKE_SHARED_LIBRARY_PREFIX}${ThriftAlt_LIB_NAME_BASE}${CMAKE_SHARED_LIBRARY_SUFFIX}")
    endif()
else()
    set(ThriftAlt_LIB_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}${ThriftAlt_LIB_NAME_BASE}${CMAKE_STATIC_LIBRARY_SUFFIX}")
endif()
...
if(Thrift_ROOT)
    ...
    find_path(ThriftAlt_INCLUDE_DIR thrift/Thrift.h PATHS ${Thrift_ROOT} PATH_SUFFIXES "include")
    ...
    if(THRIFT_PC_FOUND)
        ...
        find_library(ThriftAlt_LIB NAMES ${ThriftAlt_LIB_NAME} PATHS ${THRIFT_PC_LIBRARY_DIRS} NO_DEFAULT_PATH)
        find_program(THRIFT_COMPILER thrift HINTS ${THRIFT_PC_PREFIX} NO_DEFAULT_PATH PATH_SUFFIXES "bin")
...
if(ThriftAlt_FOUND)
    ...
    set_target_properties(
        thrift::thrift
        PROPERTIES
            ${ThriftAlt_IMPORTED_PROPERTY_NAME}
                "${ThriftAlt_LIB}"
