...
if(GRPCPP_PC_FOUND)
    ...
    find_program(GRPC_CPP_PLUGIN grpc_cpp_plugin HINTS ${GRPCPP_PC_PREFIX} NO_DEFAULT_PATH PATH_SUFFIXES "bin")
endif()
set(gRPCAlt_FIND_PACKAGE_ARGS
    gRPCAlt
    REQUIRED_VARS
...
if(gRPCAlt_FOUND)
    ...
    if(ARROW_GRPC_USE_SHARED)
        set(GRPCPP_REFLECTION_LIB_NAME "${CMAKE_SHARED_LIBRARY_PREFIX}grpc++_reflection${CMAKE_SHARED_LIBRARY_SUFFIX}")
    else()
        set(GRPCPP_REFLECTION_LIB_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}grpc++_reflection${CMAKE_STATIC_LIBRARY_SUFFIX}")
    endif()
    find_library(
        GRPCPP_REFLECTION_IMPORTED_LOCATION
        NAMES
            grpc++_reflection
            ${GRPCPP_REFLECTION_LIB_NAME}
        PATHS
            ${GRPCPP_IMPORTED_DIRECTORY}
        NO_DEFAULT_PATH
    )
