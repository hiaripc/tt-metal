...
if(ARROW_JEMALLOC_USE_SHARED)
    ...
    if(CMAKE_IMPORT_LIBRARY_SUFFIX)
        list(APPEND jemallocAlt_LIB_NAMES "${CMAKE_IMPORT_LIBRARY_PREFIX}jemalloc${CMAKE_IMPORT_LIBRARY_SUFFIX}")
    endif()
    list(APPEND jemallocAlt_LIB_NAMES "${CMAKE_SHARED_LIBRARY_PREFIX}jemalloc${CMAKE_SHARED_LIBRARY_SUFFIX}")
else()
    set(jemallocAlt_LIB_NAMES "${CMAKE_STATIC_LIBRARY_PREFIX}jemalloc${CMAKE_STATIC_LIBRARY_SUFFIX}")
endif()
    ...
    if(jemallocAlt_PC_FOUND)
        ...
        find_library(
            ...
            NAMES
                ${jemallocAlt_LIB_NAMES}
            PATHS
                ${jemallocAlt_PC_LIBRARY_DIRS}
            NO_DEFAULT_PATH
            PATH_SUFFIXES
                ${ARROW_LIBRARY_PATH_SUFFIXES}
        )
    else()
        find_library(jemallocAlt_LIB NAMES ${jemallocAlt_LIB_NAMES} PATH_SUFFIXES ${ARROW_LIBRARY_PATH_SUFFIXES})
        find_path(jemallocAlt_INCLUDE_DIR NAMES jemalloc/jemalloc.h PATH_SUFFIXES ${ARROW_INCLUDE_PATH_SUFFIXES})
    endif()
endif()
