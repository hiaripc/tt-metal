...
foreach(_INST_DIR ${_INST_BUILD_DIR} ${_INST_SOURCE_DIR} ${_INST_VCPKG_ROOT} "notfound")
    if(_INST_DIR STREQUAL "notfound")
        message(
            FATAL_ERROR
            "vcpkg installed libraries directory not found. "
            "Install packages with vcpkg before executing cmake."
        )
    elseif(NOT EXISTS "${_INST_DIR}")
        continue()
    elseif((_INST_DIR STREQUAL _INST_BUILD_DIR OR _INST_DIR STREQUAL _INST_SOURCE_DIR) AND NOT VCPKG_MANIFEST_MODE)
...
set(VCPKG_TARGET_TRIPLET "${VCPKG_TARGET_TRIPLET}" CACHE STRING "vcpkg triplet for the target environment")

if(NOT DEFINED VCPKG_BUILD_TYPE)
    set(VCPKG_BUILD_TYPE "${LOWERCASE_BUILD_TYPE}" CACHE STRING "vcpkg build type (release|debug)")
endif()
...
set(ARROW_DEPENDENCY_SOURCE "SYSTEM" CACHE STRING "The specified value VCPKG is implemented internally as SYSTEM" FORCE)
...
set(BROTLI_ROOT "${ARROW_VCPKG_PREFIX}" CACHE STRING "")
set(LZ4_ROOT "${ARROW_VCPKG_PREFIX}" CACHE STRING "")
