...
class BaseComm:
    ...
    def open(self, data: MaybeDict = None, metadata: MaybeDict = None, buffers: BuffersType = None) -> None:
    ...
    def send(self, data: MaybeDict = None, metadata: MaybeDict = None, buffers: BuffersType = None) -> None:
