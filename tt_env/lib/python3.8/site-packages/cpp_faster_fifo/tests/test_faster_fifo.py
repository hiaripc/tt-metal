...
class TestFastQueue(TestCase):
    ...
    def test_max_size(self):
        q = Queue(max_size_bytes=1000, maxsize=5)  # Create a queue with a maximum of 5 messages
        ...
        with self.assertRaises(Full):  # Check that adding another message raises the Full exception
