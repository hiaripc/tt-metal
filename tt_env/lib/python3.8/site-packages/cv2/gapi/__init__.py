        ...
        def on(*args):
            ...
            for i, (t, a) in enumerate(zip(in_types, args)):
                if t in garray_types:
                    if not isinstance(a, cv.GArrayT):
                        raise Exception(
                            "{} invalid type for argument {}.\nExpected: {}, Actual: {}".format(
                                cls.__name__, i, cv.GArrayT.__name__, type(a).__name__
                            )
                        )

                    elif a.type() != garray_types[t]:
                        raise Exception(
                            "{} invalid GArrayT type for argument {}.\nExpected: {}, Actual: {}".format(
                                cls.__name__, i, type2str[garray_types[t]], type2str[a.type()]
                            )
                        )
                    ...
                    if not isinstance(a, cv.GOpaqueT):
                        raise Exception(
                            "{} invalid type for argument {}.\nExpected: {}, Actual: {}".format(
                                cls.__name__, i, cv.GOpaqueT.__name__, type(a).__name__
                            )
                        )

                    elif a.type() != gopaque_types[t]:
                        raise Exception(
                            "{} invalid GOpaque type for argument {}.\nExpected: {}, Actual: {}".format(
                                cls.__name__, i, type2str[gopaque_types[t]], type2str[a.type()]
                            )
                        )
                    ...
                    if t != type(a):
                        raise Exception(
                            "{} invalid input type for argument {}.\nExpected: {}, Actual: {}".format(
                                cls.__name__, i, t.__name__, type(a).__name__
                            )
                        )
            ...
            for i, out_type in enumerate(out_types):
                if out_type == cv.GMat:
                    ...
                    raise Exception(
                        """In {}: G-API operation can't produce the output with type: {} in position: {}""".format(
                            cls.__name__, out_type.__name__, i
                        )
                    )
