    ...
    [
        {
            ...
            "external_url": ("https://unpkg.com/dash-core-components@{}" "/dash_core_components/async-{}.js").format(
                __version__, async_resource
            ),
            "namespace": "dash",
            "async": True,
        }
    ...
    [
        {
            ...
            "external_url": (
                "https://unpkg.com/dash-core-components@{}" "/dash_core_components/async-{}.js.map"
    ...
    [
        {
            ...
            "external_url": (
                "https://unpkg.com/dash-core-components@{}" "/dash_core_components/dash_core_components.js"
            ).format(__version__),
            "namespace": "dash",
        },
        {
            ...
            "external_url": (
                "https://unpkg.com/dash-core-components@{}" "/dash_core_components/dash_core_components.js.map"
            ).format(__version__),
            "namespace": "dash",
            "dynamic": True,
        },
        {
            ...
            "external_url": (
                "https://unpkg.com/dash-core-components@{}" "/dash_core_components/dash_core_components-shared.js"
            ).format(__version__),
            "namespace": "dash",
        },
        {
            ...
            "external_url": (
                "https://unpkg.com/dash-core-components@{}" "/dash_core_components/dash_core_components-shared.js.map"
            ).format(__version__),
            "namespace": "dash",
            "dynamic": True,
        },
