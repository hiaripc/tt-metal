...
_js_dist = [
    {
        ...
        "external_url": (
            "https://unpkg.com/dash-html-components@{}" "/dash_html_components/dash_html_components.min.js"
        ).format(__version__),
        "namespace": "dash",
    },
    {
        ...
        "external_url": (
            "https://unpkg.com/dash-html-components@{}" "/dash_html_components/dash_html_components.min.js.map"
        ).format(__version__),
        "namespace": "dash",
        "dynamic": True,
    },
