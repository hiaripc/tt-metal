...
def pytest_addoption(parser):
    ...
    dash.addoption("--remote", action="store_true", help="instruct pytest to use selenium grid")
    ...
    dash.addoption("--headless", action="store_true", help="set this flag to run in headless mode")
