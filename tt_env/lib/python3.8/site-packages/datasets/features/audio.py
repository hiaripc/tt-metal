...
class Audio:
    ...
    def decode_example(
        ...
        if path is None and file is None:
            ...
            if file:
                ...
                array, sampling_rate = self._decode_non_mp3_path_like(path, "opus", token_per_repo_id=token_per_repo_id)
        else:
            if file:
    ...
    def _decode_non_mp3_file_like(self, file, format=None):
        ...
        if self.sampling_rate and self.sampling_rate != sampling_rate:
            array = librosa.resample(array, orig_sr=sampling_rate, target_sr=self.sampling_rate, res_type="kaiser_best")
