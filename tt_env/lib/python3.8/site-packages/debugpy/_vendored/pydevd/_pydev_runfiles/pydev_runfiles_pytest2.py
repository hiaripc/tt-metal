...
def pytest_runtest_logreport(report):
    ...
    # come from here...
    captured_output, error_contents = getattr(report, "pydev_captured_output", ""), getattr(
...
if not hasattr(pytest, "hookimpl"):
    raise AssertionError(
        "Please upgrade pytest (the current version of pytest: %s is unsupported)" % (pytest.__version__,)
    )
