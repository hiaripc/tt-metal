...
if sys.version_info[:2] <= (3, 9):
    ...
    def _get_except_target_info(instructions, exception_end_instruction_index, offset_to_instruction_idx):
        next_3 = [
            ...
            for j_instruction in instructions[exception_end_instruction_index : exception_end_instruction_index + 3]
        ]
            ...
            if curr_op_name in (
                ...
                if except_end_instruction is not None:
                    ...
                    try_except_info.except_end_line = _get_line(
                        op_offset_to_line, except_end_instruction.offset, firstlineno, search=True
                    )
                    try_except_info_lst.append(try_except_info)

                    for raise_instruction in instructions[
                        i : offset_to_instruction_idx[try_except_info.except_end_bytecode_offset]
                    ]:
