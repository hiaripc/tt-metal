...
def as_float_in_env(env_key, default):
    ...
    try:
        ...
        raise RuntimeError(
            "Error: expected the env variable: %s to be set to a float value. Found: %s" % (env_key, value)
        )
...
def as_int_in_env(env_key, default):
    ...
    try:
        ...
        raise RuntimeError(
            "Error: expected the env variable: %s to be set to a int value. Found: %s" % (env_key, value)
        )
