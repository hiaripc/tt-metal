...
class FilesFiltering(object):
    ...
    def in_project_roots(self, received_filename):
        ...
        if not project_roots:
            ...
            if DEBUG:
                pydev_log.debug(
                    "Final in project (no project roots): %s (%s)", absolute_normalized_filename, in_project
                )
            ...
            if found_in_project:
                if not found_in_library:
                    ...
                    if DEBUG:
                        pydev_log.debug(
                            "Final in project (found in both): %s (%s)", absolute_normalized_filename, in_project
                        )
