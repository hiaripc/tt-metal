...
class _PyDevCommandProcessor(object):
    ...
    def cmd_remove_break(self, py_db, cmd_id, seq, text):
        ...
        try:
            ...
            pydev_log.critical(
                "Error removing breakpoint. Expected breakpoint_id to be an int. Found: %s", breakpoint_id
            )
    ...
    def cmd_run_custom_operation(self, py_db, cmd_id, seq, text):
        ...
        if text != "":
            ...
            int_cmd = InternalRunCustomOperation(
                seq, thread_id, frame_id, scope, attrs, style, encoded_code_or_file, fnname
            )
            py_db.post_internal_command(int_cmd, thread_id)
