...
class ValidationInfo(object):
    ...
    def verify_breakpoints(self, py_db, canonical_normalized_filename, template_breakpoints_for_file, template):
        ...
        self._canonical_normalized_filename_to_last_template_lines[canonical_normalized_filename] = (
    ...
    def verify_breakpoints_from_template_cached_lines(
        self, py_db, canonical_normalized_filename, template_breakpoints_for_file
    ):
        """
    ...
    def _verify_breakpoints_with_lines_collected(
        ...
        for line, template_bp in list(
            template_breakpoints_for_file.items()
                    ...
                    if new_line >= 0 and new_line not in template_breakpoints_for_file:
                        ...
                        if (
                            ...
                            template_bp.on_changed_breakpoint_state(
                                template_bp.breakpoint_id, template_bp.add_breakpoint_result
                            )
                    else:
