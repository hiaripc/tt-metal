...
def build_extension(
    dir_name, extension_name, target_pydevd_name, force_cython, extended=False, has_pxd=False, template=False
):
...
if IS_PY36_OR_GREATER and not IS_PY311_ONWARDS or FORCE_BUILD_ALL:
    ...
    build_extension(
        "_pydevd_frame_eval", extension_name, target_frame_eval, force_cython, extension_folder, True, template=True
    )
