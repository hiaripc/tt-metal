    ...
    try:
        ...
        if "threading" not in sys.modules:
            try:
                ...
                attach_script.fix_main_thread_id(on_warn=on_warn, on_exception=on_exception, on_critical=on_critical)
        ...
        if setup["mode"] == "listen":
            ...
            debugpy.connect(setup["address"], access_token=setup["adapter_access_token"])
        else:
