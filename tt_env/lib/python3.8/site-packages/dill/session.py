...
__all__ = ["dump_module", "load_module", "load_module_asdict", "dump_session", "load_session"]  # backward compatibility
...
def load_module(
    filename=str(TEMPDIR / "session.pkl"), module: Optional[Union[ModuleType, str]] = None, **kwds
) -> Optional[ModuleType]:
...
def load_module_asdict(filename=str(TEMPDIR / "session.pkl"), update: bool = False, **kwds) -> dict:
    """
