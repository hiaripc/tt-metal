...
class VersionInfo(namedtuple("VersionInfo", "major minor micro releaselevel serial release")):
    def __new__(cls, major=0, minor=0, micro=0, releaselevel="final", serial=0, release=True):
        ...
        if releaselevel == "final":
            if not release:
                raise ValueError(
                    'releaselevel "final" must not be used '
        ...
        return super(VersionInfo, cls).__new__(cls, major, minor, micro, releaselevel, serial, release)
...
class TransformSpec:
    ...
    def get_transforms(self):
        ...
        if self.default_transforms != ():
            ...
            warnings.warn(
                'TransformSpec: the "default_transforms" attribute '
