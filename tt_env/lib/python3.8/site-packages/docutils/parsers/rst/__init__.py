...
class Parser(docutils.parsers.Parser):
    ...
    settings_spec = docutils.parsers.Parser.settings_spec + (
        ...
        (
            ...
            (
                ...
                ["--tab-width"],
                {"metavar": "<width>", "type": "int", "default": 8, "validator": frontend.validate_nonnegative_int},
            ),
            (
            ...
            (
                ...
                ["--syntax-highlight"],
                {"choices": ["long", "short", "none"], "default": "long", "metavar": "<format>"},
            ),
            (
                "Change straight quotation marks to typographic form: "
                'one of "yes", "no", "alt[ernative]" (default "no").',
                ["--smart-quotes"],
                {"default": False, "metavar": "<yes/no/alt>", "validator": frontend.validate_ternary},
            ),
            (
            ...
            (
                ...
                {"action": "store_true", "default": False, "dest": "character_level_inline_markup"},
            ),
        ),
    )
    ...
    def parse(self, inputstring, document):
        ...
        self.statemachine = states.RSTStateMachine(
            state_classes=self.state_classes, initial_state=self.initial_state, debug=document.reporter.debug_flag
        )
        ...
        for i, line in enumerate(inputlines):
            if len(line) > self.document.settings.line_length_limit:
                error = self.document.reporter.error("Line %d exceeds the line-length-limit." % (i + 1))
