...
class StateMachine(object):
            ...
            while True:
                try:
                    try:
                        ...
                        if self.debug:
                            print("\nStateMachine.run: %s.eof transition" % state.__class__.__name__, file=self._stderr)
                    ...
                    if self.debug:
                        print(
                            ...
                            'state "%s", transition %s.' % (state.__class__.__name__, transitions[0]),
                            file=self._stderr,
                        )
                    continue
                    ...
                    if self.debug:
                        print(
                            ...
                            '"%s", transition %s.' % (next_state, transitions[0]),
                            file=self._stderr,
                        )
                else:
                    transitions = None
    ...
    def error(self):
        ...
        print(("module %s, line %s, function %s" % (module, line, function)), file=self._stderr)
