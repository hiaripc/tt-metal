...
class FormulaConfig(object):
    ...
    hybridfunctions = {
        ...
        "\\binom": [
            ...
            "f2{(}f0{f1{$1}f1{$2}}f2{)}",
            'span class="binom"',
            'span class="binomstack"',
            'span class="bigdelimiter size2"',
        ],
        "\\boxed": [
            "{$1}",
            "f0{$1}",
        ...
        "\\cfrac": [
            "[$p!]{$1}{$2}",
            "f0{f3{(}f1{$1}f3{)/(}f2{$2}f3{)}}",
            'span class="fullfraction"',
            'span class="numerator align-$p"',
...
class TextParser(Parser):
    ...
    def parse(self, reader):
        ...
        self.endings = TextParser.stack + [
            ContainerConfig.endings["Layout"],
...
class EquationEnvironment(MultiRowFormula):
    ...
    def parsebit(self, pos):
        ...
        self.output = TaggedOutput().settag('span class="environment %s"' % environment, False)
...
FormulaCommand.types += [OversetFunction, UndersetFunction, CombiningFunction, LimitCommand, BracketCommand]
