# $Id: __init__.py 8722 2021-05-17 20:28:42Z milde $
...
class Writer(html4css1.Writer):
    ...
    settings_spec = html4css1.Writer.settings_spec + (
        ...
        "See HTML Writer Options above." % (default_stylesheet_path, default_template_path),
        (
            (
            ...
            # For testing.
            (frontend.SUPPRESS_HELP, ["--no-random"], {"action": "store_true", "validator": frontend.validate_boolean}),
        ),
    )
