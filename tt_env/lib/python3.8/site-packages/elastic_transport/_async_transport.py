...
class AsyncTransport(Transport):
    ...
    def _should_sniff(self, is_initial_sniff: bool) -> bool:
        ...
        return self._loop.time() - self._last_sniffed_at >= self._min_delay_between_sniffing

    def _create_sniffing_task(self, is_initial_sniff: bool) -> Optional["asyncio.Task[Any]"]:
