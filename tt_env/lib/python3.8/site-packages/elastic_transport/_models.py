...
class HttpHeaders(MutableMapping[str, str]):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return {k: v for k, (_, v) in self._internal.items()} == {k: v for k, (_, v) in other._internal.items()}
    ...
    def _dict_hide_auth(self) -> Dict[str, str]:
        ...
        return {key: hide_auth(val) if key.lower() == "authorization" else val for key, val in self.items()}
...
class NodeConfig:
    ...
    headers: Union[HttpHeaders, Mapping[str, str]] = field(default_factory=_empty_frozen_http_headers)
    ...
    def __post_init__(self) -> None:
        ...
        if self.scheme != "https":
            ...
            if self.ssl_context is not None and any(
                ...
                raise ValueError("The 'ssl_context' option can't be combined with other TLS options")
