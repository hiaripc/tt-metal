...
class BaseNode:
    ...
    def __init__(self, config: NodeConfig):
        ...
        self._path_prefix = ("/" + config.path_prefix.strip("/")) if config.path_prefix else ""
...
_SSL_PROTOCOL_VERSION_DEFAULT = getattr(ssl, "OP_NO_SSLv2", 0) | getattr(ssl, "OP_NO_SSLv3", 0)
...
for i, _protocol_attr in enumerate(_SSL_PROTOCOL_VERSION_ATTRS):
    ...
    _SSL_PROTOCOL_VERSION_TO_OPTIONS[_protocol_value] = _SSL_PROTOCOL_VERSION_DEFAULT | sum(
...
if _HAS_TLS_VERSION:
    try:
        _SSL_PROTOCOL_VERSION_TO_TLS_VERSION[ssl.TLSVersion.TLSv1_3] = ssl.TLSVersion.TLSv1_3
