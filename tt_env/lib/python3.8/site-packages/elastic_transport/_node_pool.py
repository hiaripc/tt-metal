...
class NodePool:
    ...
    def __init__(
        ...
        node_configs = list(node_configs)  # Make a copy so we don't have side-effects outside.
    ...
    def get(self) -> BaseNode:
        ...
        nodes = [node for node_config, node in self._alive_nodes.items() if node_config not in self._removed_nodes]
