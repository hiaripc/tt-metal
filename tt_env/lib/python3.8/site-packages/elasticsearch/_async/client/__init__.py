...
class AsyncElasticsearch(BaseClient):
        ...
        *,
        ...
        if timeout is not DEFAULT:
            if request_timeout is not DEFAULT:
                raise ValueError(
                    "Can't specify both 'timeout' and 'request_timeout', " "instead only specify 'request_timeout'"
                )
            warnings.warn(
        ...
        if cloud_id is not None and any(x is not DEFAULT and x is not None for x in sniffing_options):
            raise ValueError("Sniffing should not be enabled when connecting to Elastic Cloud")
        ...
        if host_info_callback is not None:
            ...
            sniff_callback = create_sniff_callback(host_info_callback=host_info_callback)
        elif sniffed_node_callback is not None:
            sniff_callback = create_sniff_callback(sniffed_node_callback=sniffed_node_callback)
        elif sniff_on_start is True or sniff_before_requests is True or sniff_on_node_failure is True:
        ...
        if _transport is None:
            ...
            if serializers is not DEFAULT:
                ...
                for mime_subtype in ("json", "x-ndjson"):
                    if f"application/{mime_subtype}" in serializers:
                        compat_mimetype = f"application/vnd.elasticsearch+{mime_subtype}"
                        if compat_mimetype not in serializers:
                            transport_serializers[compat_mimetype] = serializers[f"application/{mime_subtype}"]
            ...
            if min_delay_between_sniffing is not DEFAULT:
                transport_kwargs["min_delay_between_sniffing"] = min_delay_between_sniffing
    ...
    async def ping(
        ...
        *,
        ...
        try:
            await self.perform_request("HEAD", __path, params=__query, headers=__headers)
            return True
    ...
    async def bulk(
        ...
        *,
        ...
        pretty: t.Optional[bool] = None,
        refresh: t.Optional[t.Union[bool, str, t.Literal["false", "true", "wait_for"]]] = None,
        ...
        wait_for_active_shards: t.Optional[t.Union[int, t.Union[str, t.Literal["all", "index-setting"]]]] = None,
        ...
        if operations is None and body is None:
            raise ValueError("Empty value passed for parameters 'operations' and 'body', one of them should be set.")
    ...
    async def count(
        ...
        *,
        ...
        expand_wildcards: t.Optional[
            t.Union[
                t.Sequence[t.Union[str, t.Literal["all", "closed", "hidden", "none", "open"]]],
    ...
    async def create(
        ...
        *,
        ...
        version_type: t.Optional[t.Union[str, t.Literal["external", "external_gte", "force", "internal"]]] = None,
        wait_for_active_shards: t.Optional[t.Union[int, t.Union[str, t.Literal["all", "index-setting"]]]] = None,
    ) -> ObjectApiResponse[t.Any]:
        """
        .. raw:: html
        ...
        if document is None and body is None:
            raise ValueError("Empty value passed for parameters 'document' and 'body', one of them should be set.")
    ...
    async def delete_by_query(
        ...
        *,
        ...
        search_type: t.Optional[t.Union[str, t.Literal["dfs_query_then_fetch", "query_then_fetch"]]] = None,
    ...
    async def knn_search(
        ...
        *,
        ...
        error_trace: t.Optional[bool] = None,
        fields: t.Optional[t.Union[str, t.Sequence[str]]] = None,
        filter: t.Optional[t.Union[t.Mapping[str, t.Any], t.Sequence[t.Mapping[str, t.Any]]]] = None,
        filter_path: t.Optional[t.Union[str, t.Sequence[str]]] = None,
        human: t.Optional[bool] = None,
        pretty: t.Optional[bool] = None,
        routing: t.Optional[str] = None,
    ...
    async def msearch(
        ...
        *,
        ...
        if searches is None and body is None:
            raise ValueError("Empty value passed for parameters 'searches' and 'body', one of them should be set.")
    ...
    async def search(
        ...
        *,
        ...
        knn: t.Optional[t.Union[t.Mapping[str, t.Any], t.Sequence[t.Mapping[str, t.Any]]]] = None,
        lenient: t.Optional[bool] = None,
        max_concurrent_shard_requests: t.Optional[int] = None,
        ...
        request_cache: t.Optional[bool] = None,
        rescore: t.Optional[t.Union[t.Mapping[str, t.Any], t.Sequence[t.Mapping[str, t.Any]]]] = None,
        rest_total_hits_as_int: t.Optional[bool] = None,
        ...
        scroll: t.Optional[t.Union[str, t.Literal[-1], t.Literal[0]]] = None,
        search_after: t.Optional[t.Sequence[t.Union[None, bool, float, int, str, t.Any]]] = None,
        search_type: t.Optional[t.Union[str, t.Literal["dfs_query_then_fetch", "query_then_fetch"]]] = None,
        ...
        suggest_mode: t.Optional[t.Union[str, t.Literal["always", "missing", "popular"]]] = None,
    ...
    async def search_mvt(
        ...
        *,
        ...
        grid_type: t.Optional[t.Union[str, t.Literal["centroid", "grid", "point"]]] = None,
        human: t.Optional[bool] = None,
        pretty: t.Optional[bool] = None,
        query: t.Optional[t.Mapping[str, t.Any]] = None,
        runtime_mappings: t.Optional[t.Mapping[str, t.Mapping[str, t.Any]]] = None,
