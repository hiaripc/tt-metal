...
class ConnectorClient(NamespacedClient):
        ...
        *,
        ...
        if not __body:
            if last_access_control_sync_error is not None:
                __body["last_access_control_sync_error"] = last_access_control_sync_error
            if last_access_control_sync_scheduled_at is not None:
                __body["last_access_control_sync_scheduled_at"] = last_access_control_sync_scheduled_at
            if last_access_control_sync_status is not None:
                __body["last_access_control_sync_status"] = last_access_control_sync_status
            ...
            if last_incremental_sync_scheduled_at is not None:
                __body["last_incremental_sync_scheduled_at"] = last_incremental_sync_scheduled_at
    ...
    async def sync_job_cancel(
        ...
        *,
        ...
        __path_parts: t.Dict[str, str] = {"connector_sync_job_id": _quote(connector_sync_job_id)}
        __path = f'/_connector/_sync_job/{__path_parts["connector_sync_job_id"]}/_cancel'
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
            __query["error_trace"] = error_trace
        if filter_path is not None:
    ...
    async def sync_job_check_in(
        ...
        *,
        ...
        if connector_sync_job_id in SKIP_IN_PATH:
            raise ValueError("Empty value passed for parameter 'connector_sync_job_id'")
        __path_parts: t.Dict[str, str] = {"connector_sync_job_id": _quote(connector_sync_job_id)}
        __path = f'/_connector/_sync_job/{__path_parts["connector_sync_job_id"]}/_check_in'
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
            __query["error_trace"] = error_trace
        if filter_path is not None:
    ...
    async def sync_job_list(
        ...
        *,
        ...
        job_type: t.Optional[
            t.Union[
                t.Sequence[t.Union[str, t.Literal["access_control", "full", "incremental"]]],
    ...
    async def sync_job_post(
        ...
        *,
        ...
        filter_path: t.Optional[t.Union[str, t.Sequence[str]]] = None,
        human: t.Optional[bool] = None,
        job_type: t.Optional[t.Union[str, t.Literal["access_control", "full", "incremental"]]] = None,
        pretty: t.Optional[bool] = None,
        trigger_method: t.Optional[t.Union[str, t.Literal["on_demand", "scheduled"]]] = None,
        body: t.Optional[t.Dict[str, t.Any]] = None,
    ) -> ObjectApiResponse[t.Any]:
        """
        .. raw:: html
    ...
    async def sync_job_update_stats(
        ...
        *,
        ...
        if deleted_document_count is None and body is None:
            raise ValueError("Empty value passed for parameter 'deleted_document_count'")
        if indexed_document_count is None and body is None:
            raise ValueError("Empty value passed for parameter 'indexed_document_count'")
        if indexed_document_volume is None and body is None:
            raise ValueError("Empty value passed for parameter 'indexed_document_volume'")
        __path_parts: t.Dict[str, str] = {"connector_sync_job_id": _quote(connector_sync_job_id)}
    ...
    async def update_status(
        ...
        *,
        ...
        status: t.Optional[
            t.Union[
                str,
                t.Literal["configured", "connected", "created", "error", "needs_configuration"],
            ]
        ] = None,
        error_trace: t.Optional[bool] = None,
        filter_path: t.Optional[t.Union[str, t.Sequence[str]]] = None,
