...
class MlClient(NamespacedClient):
    ...
    async def clear_trained_model_deployment_cache(
        ...
        *,
        ...
        __path = f'/_ml/trained_models/{__path_parts["model_id"]}/deployment/cache/_clear'
    ...
    async def get_categories(
        ...
        *,
        ...
        if job_id not in SKIP_IN_PATH and category_id not in SKIP_IN_PATH:
            ...
            __path_parts = {"job_id": _quote(job_id)}
            __path = f'/_ml/anomaly_detectors/{__path_parts["job_id"]}/results/categories'
        else:
            raise ValueError("Couldn't find a path for the given parameters")
        __query: t.Dict[str, t.Any] = {}
        __body: t.Dict[str, t.Any] = body if body is not None else {}
    ...
    async def get_overall_buckets(
        ...
        *,
        ...
        if job_id in SKIP_IN_PATH:
            raise ValueError("Empty value passed for parameter 'job_id'")
        __path_parts: t.Dict[str, str] = {"job_id": _quote(job_id)}
        __path = f'/_ml/anomaly_detectors/{__path_parts["job_id"]}/results/overall_buckets'
        __query: t.Dict[str, t.Any] = {}
        __body: t.Dict[str, t.Any] = body if body is not None else {}
        if error_trace is not None:
            __query["error_trace"] = error_trace
    ...
    async def post_data(
        ...
        *,
        ...
        if data is None and body is None:
            raise ValueError("Empty value passed for parameters 'data' and 'body', one of them should be set.")
    ...
    async def put_job(
        ...
        *,
        ...
        background_persist_interval: t.Optional[t.Union[str, t.Literal[-1], t.Literal[0]]] = None,
        ...
        if not __body:
            ...
            if daily_model_snapshot_retention_after_days is not None:
                __body["daily_model_snapshot_retention_after_days"] = daily_model_snapshot_retention_after_days
            if datafeed_config is not None:
                __body["datafeed_config"] = datafeed_config
            if description is not None:
                __body["description"] = description
    ...
    async def put_trained_model(
        ...
        *,
        ...
        model_type: t.Optional[t.Union[str, t.Literal["lang_ident", "pytorch", "tree_ensemble"]]] = None,
    ...
    async def put_trained_model_definition_part(
        ...
        *,
        ...
        if total_definition_length is None and body is None:
            raise ValueError("Empty value passed for parameter 'total_definition_length'")
    ...
    async def revert_model_snapshot(
        ...
        *,
        ...
        __path = (
            f'/_ml/anomaly_detectors/{__path_parts["job_id"]}/model_snapshots/{__path_parts["snapshot_id"]}/_revert'
        )
        __query: t.Dict[str, t.Any] = {}
        __body: t.Dict[str, t.Any] = body if body is not None else {}
        if error_trace is not None:
    ...
    async def start_trained_model_deployment(
        ...
        *,
        ...
        timeout: t.Optional[t.Union[str, t.Literal[-1], t.Literal[0]]] = None,
        wait_for: t.Optional[t.Union[str, t.Literal["fully_allocated", "started", "starting"]]] = None,
    ) -> ObjectApiResponse[t.Any]:
        """
        .. raw:: html
    ...
    async def update_job(
        ...
        *,
        ...
        human: t.Optional[bool] = None,
        model_plot_config: t.Optional[t.Mapping[str, t.Any]] = None,
        model_prune_window: t.Optional[t.Union[str, t.Literal[-1], t.Literal[0]]] = None,
        model_snapshot_retention_days: t.Optional[int] = None,
    ...
    async def update_model_snapshot(
        ...
        *,
        ...
        __path = (
            f'/_ml/anomaly_detectors/{__path_parts["job_id"]}/model_snapshots/{__path_parts["snapshot_id"]}/_update'
        )
        __query: t.Dict[str, t.Any] = {}
        __body: t.Dict[str, t.Any] = body if body is not None else {}
        if error_trace is not None:
    ...
    async def upgrade_job_snapshot(
        ...
        *,
        ...
        __path = (
            f'/_ml/anomaly_detectors/{__path_parts["job_id"]}/model_snapshots/{__path_parts["snapshot_id"]}/_upgrade'
        )
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
            __query["error_trace"] = error_trace
    ...
    async def validate_detector(
        ...
        *,
        ...
        if detector is None and body is None:
            raise ValueError("Empty value passed for parameters 'detector' and 'body', one of them should be set.")
