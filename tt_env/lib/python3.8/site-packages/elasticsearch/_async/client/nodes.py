...
class NodesClient(NamespacedClient):
    ...
    async def hot_threads(
        ...
        *,
        ...
        sort: t.Optional[t.Union[str, t.Literal["block", "cpu", "gpu", "mem", "wait"]]] = None,
        threads: t.Optional[int] = None,
        timeout: t.Optional[t.Union[str, t.Literal[-1], t.Literal[0]]] = None,
        type: t.Optional[t.Union[str, t.Literal["block", "cpu", "gpu", "mem", "wait"]]] = None,
    ) -> TextApiResponse:
        """
        .. raw:: html
    ...
    async def stats(
        ...
        *,
        ...
        """
        __path_parts: t.Dict[str, str]
        if node_id not in SKIP_IN_PATH and metric not in SKIP_IN_PATH and index_metric not in SKIP_IN_PATH:
            __path_parts = {
                "node_id": _quote(node_id),
            ...
            __path = f'/_nodes/stats/{__path_parts["metric"]}/{__path_parts["index_metric"]}'
        elif node_id not in SKIP_IN_PATH:
            __path_parts = {"node_id": _quote(node_id)}
