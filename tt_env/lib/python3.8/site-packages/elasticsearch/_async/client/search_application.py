    ...
    async def post_behavioral_analytics_event(
        ...
        *,
        ...
        if payload is None and body is None:
            raise ValueError("Empty value passed for parameters 'payload' and 'body', one of them should be set.")
    ...
    async def render_query(
        ...
        *,
        ...
        if name in SKIP_IN_PATH:
            raise ValueError("Empty value passed for parameter 'name'")
        __path_parts: t.Dict[str, str] = {"name": _quote(name)}
        __path = f'/_application/search_application/{__path_parts["name"]}/_render_query'
        __query: t.Dict[str, t.Any] = {}
