...
class SecurityClient(NamespacedClient):
    ...
    async def activate_user_profile(
        self,
        *,
        grant_type: t.Optional[t.Union[str, t.Literal["access_token", "password"]]] = None,
    ...
    async def create_service_token(
        ...
        *,
        ...
        if service in SKIP_IN_PATH:
            raise ValueError("Empty value passed for parameter 'service'")
        __path_parts: t.Dict[str, str]
        if namespace not in SKIP_IN_PATH and service not in SKIP_IN_PATH and name not in SKIP_IN_PATH:
            __path_parts = {
                "namespace": _quote(namespace),
                "service": _quote(service),
                "name": _quote(name),
    ...
    async def delegate_pki(
        ...
        *,
        ...
        if x509_certificate_chain is None and body is None:
            raise ValueError("Empty value passed for parameter 'x509_certificate_chain'")
        __path_parts: t.Dict[str, str] = {}
    ...
    async def put_privileges(
        self,
        *,
        privileges: t.Optional[t.Mapping[str, t.Mapping[str, t.Mapping[str, t.Any]]]] = None,
        ...
        """
        if privileges is None and body is None:
            raise ValueError("Empty value passed for parameters 'privileges' and 'body', one of them should be set.")
