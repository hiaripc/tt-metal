...
class ShutdownClient(NamespacedClient):
    ...
    async def delete_node(
        ...
        *,
        ...
        master_timeout: t.Optional[t.Union[str, t.Literal["d", "h", "m", "micros", "ms", "nanos", "s"]]] = None,
        pretty: t.Optional[bool] = None,
        timeout: t.Optional[t.Union[str, t.Literal["d", "h", "m", "micros", "ms", "nanos", "s"]]] = None,
    ...
    async def put_node(
        ...
        *,
        ...
        type: t.Optional[t.Union[str, t.Literal["remove", "replace", "restart"]]] = None,
