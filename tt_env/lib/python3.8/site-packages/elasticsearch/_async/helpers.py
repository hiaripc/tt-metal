...
async def azip(*iterables: Union[Iterable[T], AsyncIterable[T]]) -> AsyncIterable[Tuple[T, ...]]:
...
async def async_streaming_bulk(
    ...
    **kwargs: Any,
    ...
    bulk_actions: List[bytes]
    async for bulk_data, bulk_actions in _chunk_actions(map_actions(), chunk_size, max_chunk_bytes, serializer):
    ...
    **kwargs: Any,
    ...
    try:
        while scroll_id and resp["hits"]["hits"]:
            ...
            resp = await scroll_client.scroll(scroll_id=scroll_id, scroll=scroll, **scroll_kwargs)
...
async def async_reindex(
    ...
    try:
        ...
        data_streams = await target_client.indices.get_data_stream(name=target_index, expand_wildcards="all")
