...
class IndicesClient(NamespacedClient):
    ...
    def downsample(
        ...
        *,
        ...
        if config is None and body is None:
            raise ValueError("Empty value passed for parameters 'config' and 'body', one of them should be set.")
        ...
        *,
        ...
        if not __body:
            ...
            if ignore_missing_component_templates is not None:
                __body["ignore_missing_component_templates"] = ignore_missing_component_templates
    ...
    def put_mapping(
        ...
        *,
        ...
        dynamic: t.Optional[t.Union[str, t.Literal["false", "runtime", "strict", "true"]]] = None,
        dynamic_date_formats: t.Optional[t.Sequence[str]] = None,
        dynamic_templates: t.Optional[t.Sequence[t.Mapping[str, t.Mapping[str, t.Any]]]] = None,
        error_trace: t.Optional[bool] = None,
        expand_wildcards: t.Optional[
            t.Union[
                t.Sequence[t.Union[str, t.Literal["all", "closed", "hidden", "none", "open"]]],
    ...
    def put_settings(
        ...
        *,
        ...
        if settings is None and body is None:
            raise ValueError("Empty value passed for parameters 'settings' and 'body', one of them should be set.")
    ...
    def stats(
        ...
        *,
        ...
        level: t.Optional[t.Union[str, t.Literal["cluster", "indices", "shards"]]] = None,
        pretty: t.Optional[bool] = None,
    ) -> ObjectApiResponse[t.Any]:
        """
        .. raw:: html
