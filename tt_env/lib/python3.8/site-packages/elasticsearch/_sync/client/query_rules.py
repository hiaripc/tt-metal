...
class QueryRulesClient(NamespacedClient):
    ...
    def put_rule(
        ...
        *,
        ...
        criteria: t.Optional[t.Union[t.Mapping[str, t.Any], t.Sequence[t.Mapping[str, t.Any]]]] = None,
    ...
    def put_ruleset(
        ...
        *,
        ruleset_id: str,
        rules: t.Optional[t.Union[t.Mapping[str, t.Any], t.Sequence[t.Mapping[str, t.Any]]]] = None,
        error_trace: t.Optional[bool] = None,
        filter_path: t.Optional[t.Union[str, t.Sequence[str]]] = None,
        human: t.Optional[bool] = None,
        pretty: t.Optional[bool] = None,
