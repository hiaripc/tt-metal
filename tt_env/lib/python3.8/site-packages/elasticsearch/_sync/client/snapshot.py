    ...
    def create_repository(
        ...
        *,
        ...
        if repository is None and body is None:
            raise ValueError("Empty value passed for parameters 'repository' and 'body', one of them should be set.")
    ...
    def repository_verify_integrity(
        ...
        *,
        ...
        if index_snapshot_verification_concurrency is not None:
            __query["index_snapshot_verification_concurrency"] = index_snapshot_verification_concurrency
        ...
        if snapshot_verification_concurrency is not None:
            __query["snapshot_verification_concurrency"] = snapshot_verification_concurrency
