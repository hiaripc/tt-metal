...
class TextStructureClient(NamespacedClient):
    ...
    def find_field_structure(
        ...
        *,
        ...
        format: t.Optional[t.Union[str, t.Literal["delimited", "ndjson", "semi_structured_text", "xml"]]] = None,
    ...
    def find_structure(
        ...
        *,
        ...
        if text_files is None and body is None:
            raise ValueError("Empty value passed for parameters 'text_files' and 'body', one of them should be set.")
