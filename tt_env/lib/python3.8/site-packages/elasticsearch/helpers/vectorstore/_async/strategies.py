...
class AsyncRetrievalStrategy(ABC):
    ...
    async def before_index_creation(self, *, client: AsyncElasticsearch, text_field: str, vector_field: str) -> None:
        """
    ...
    def es_mappings_settings(
        ...
        *,
        ...
        mappings: Dict[str, Any] = {
            "properties": {vector_field: {"properties": {self._tokens_field: {"type": "rank_features"}}}}
        }
                ...
                processors=[
                    {
                        "inference": {
                            ...
                            "inference_config": {"text_expansion": {"results_field": self._tokens_field}},
                        }
                    }
                ],
            )
...
class AsyncDenseVectorStrategy(AsyncRetrievalStrategy):
    ...
    def __init__(
        ...
        *,
        ...
        if hybrid and not text_field:
            raise ValueError("to enable hybrid you have to specify a text_field (for BM25Strategy matching)")
    ...
    def _hybrid(self, query: str, knn: Dict[str, Any], filter: List[Dict[str, Any]]) -> Dict[str, Any]:
...
class AsyncDenseVectorScriptScoreStrategy(AsyncRetrievalStrategy):
    ...
    def es_query(
        ...
        *,
        ...
        if self.distance is DistanceMetric.COSINE:
            similarity_algo = f"cosineSimilarity(params.query_vector, '{vector_field}') + 1.0"
        elif self.distance is DistanceMetric.EUCLIDEAN_DISTANCE:
