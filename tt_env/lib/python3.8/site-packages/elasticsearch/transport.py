...
warnings.warn(
    "Importing from the 'elasticsearch.transport' module is deprecated. " "Instead import from 'elastic_transport'",
...
def get_host_info(node_info: Dict[str, Any], host: Dict[str, Union[int, str]]) -> Optional[Dict[str, Union[int, str]]]:
    ...
    warnings.warn(
        "The 'get_host_info' function is deprecated. Instead " "use the 'sniff_node_callback' parameter on the client",
        category=DeprecationWarning,
        stacklevel=2,
    )
