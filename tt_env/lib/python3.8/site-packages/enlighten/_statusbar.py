...
from enlighten._util import EnlightenWarning, FORMAT_MAP_SUPPORT, format_time, Justify, raise_from_none, warn_best_level
    ...
    **Instance Attributes**
    ...
    def justify(self, value):
        if value in (Justify.LEFT, Justify.CENTER, Justify.RIGHT):
            ...
            raise ValueError(
                "justify must be one of Justify.LEFT, Justify.CENTER, ", "Justify.RIGHT, not: '%r'" % value
            )
