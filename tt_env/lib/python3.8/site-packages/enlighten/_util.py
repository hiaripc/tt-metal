...
class HTMLConverter(object):
    ...
    set_a_codes = {
        ...
        5: ("enlighten-blink", {"animation": "enlighten-blink-animation 1s steps(5, start) infinite"}),
    ...
    def _parse_style(self, value, cap):  # pylint: disable=too-many-return-statements
        ...
        if 100 <= code <= 107:
            idx = code - 100
            return ("enlighten-bg-bright-%s" % CGA_COLORS[idx], {"background-color": str(RGB_256TABLE[idx + 8])})
