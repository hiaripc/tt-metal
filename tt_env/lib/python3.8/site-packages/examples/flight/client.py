...
def push_data(args, client, connection_args={}):
    ...
    print(df.head())
    writer, _ = client.do_put(pyarrow.flight.FlightDescriptor.for_path(args.file), my_table.schema)
...
def _add_common_arguments(parser):
    ...
    parser.add_argument(
        "--mtls", nargs=2, default=None, metavar=("CERTFILE", "KEYFILE"), help="Enable transport-level security"
    )
...
def main():
    ...
    cmd_list.add_argument("-l", "--list", action="store_true", help="Print more details.")

    cmd_do = subcommands.add_parser("do")
    cmd_do.set_defaults(action="do")
    _add_common_arguments(cmd_do)
    cmd_do.add_argument("action_type", type=str, help="The action type to run.")
    ...
    cmd_get_descriptor.add_argument("-p", "--path", type=str, action="append", help="The path for the descriptor.")
    cmd_get_descriptor.add_argument("-c", "--command", type=str, help="The command for the descriptor.")
