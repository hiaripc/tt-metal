...
class FlightServer(pyarrow.flight.FlightServerBase):
    def __init__(
        ...
        super(FlightServer, self).__init__(location, auth_handler, tls_certificates, verify_client, root_certificates)
        self.flights = {}
        self.host = host
...
def main():
    ...
    parser.add_argument(
        "--tls", nargs=2, default=None, metavar=("CERTFILE", "KEYFILE"), help="Enable transport-level security"
    )
    parser.add_argument(
        "--verify_client", type=bool, default=False, help="enable mutual TLS and verify the client if True"
    )
