...
class SocketServerService(win32serviceutil.ServiceFramework):
    ...
    def __init__(self, args) -> None:
        ...
        #
        win32evtlogutil.AddSourceToRegistry(self._svc_display_name_, servicemanager.__file__, "Application")
        super.__init__(args)
    ...
    def SvcDoRun(self) -> None:
        ...
        thread = threading.Thread(target=socketserver.startserver, args=(serversock,), kwargs={"loop": True})
