...
def _convertToBlendCmds(args):
    ...
    while i < num_args:
        ...
        if not isinstance(arg, list):
            ...
            while (i < num_args) and isinstance(args[i], list) and stack_use + num_sources < maxStackLimit:
...
if __name__ == "__main__":
    ...
    if options.font:
        ...
        for glyphName in charstrings.keys():
            ...
            charstring.program = specializeProgram(charstring.program, getNumRegions, maxstack=maxStackLimit)
