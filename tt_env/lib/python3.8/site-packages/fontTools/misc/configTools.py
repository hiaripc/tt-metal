...
class AbstractConfig(MutableMapping):
    ...
    def register_option(
        ...
        return cls.options.register(name, help=help, default=default, parse=parse, validate=validate)
    ...
    def _resolve_option(self, option_or_name: Union[Option, str]) -> Option:
        if isinstance(option_or_name, Option):
            ...
            raise TypeError("expected Option or str, found " f"{type(option_or_name).__name__}: {option_or_name!r}")
