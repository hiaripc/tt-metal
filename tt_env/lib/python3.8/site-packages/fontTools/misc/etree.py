...
try:
    ...
    def _tounicode(s):
        ...
        try:
            ...
            raise ValueError(
                "Bytes strings can only contain ASCII characters. " "Use unicode strings for non-ASCII characters."
            )
    ...
    def _serialize_xml(write, elem, qnames, namespaces, **kwargs):
        ...
        if tag is Comment:
            ...
            if tag is None:
                ...
                write("<" + tag)
                if namespaces:
                    for uri, prefix in sorted(namespaces.items(), key=lambda x: x[1]):  # sort on prefix
                        if prefix:
                            prefix = ":" + prefix
