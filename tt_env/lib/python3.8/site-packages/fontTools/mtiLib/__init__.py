...
def parseCmap(lines, font):
    ...
    while lines.peek() is not None:
        ...
        platId, encId, fmt, lang = [
            parseCmapId(lines, field) for field in ("platformID", "encodingID", "format", "language")
        ]
...
def main(args=None, font=None):
    ...
    parser.add_argument("inputs", metavar="FILE", type=str, nargs="+", help="Input FontDame .txt files")
