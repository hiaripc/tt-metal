...
class Glyph(object):
    ...
    def compile(self, glyfTable, recalcBBoxes=True, *, boundsDone=None, optimizeSize=None):
    ...
    def getCoordinates(self, glyfTable, *, round=noRound):
        ...
        if self.numberOfContours > 0:
            ...
            for compo in self.components:
                ...
                if round is not noRound and g.numberOfContours > 0 and not compo._hasOnlyIntegerTranslate():
    ...
    for i, glyph in enumerate(interpolatable_glyphs):
        ...
        for attr in staticAttributes.__dict__:
            ...
            if expected is None:
                ...
                raise ValueError(
                    f"Incompatible {attr} for glyph at master index {i}: " f"expected {expected}, found {found}"
                )
