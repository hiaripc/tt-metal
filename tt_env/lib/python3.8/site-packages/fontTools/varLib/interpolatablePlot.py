...
"""
    ...
    def __init__(self, out, glyphsets, names=None, **kwargs):
        ...
        self.panel_height = self.height / 2 - self.pad * 6 - self.font_size * 2 - self.title_font_size
    ...
    def add_summary(self, problems):
        ...
        for problem_type in sorted(glyphs_per_problem, key=lambda x: InterpolatableProblem.severity[x]):
            y += self.font_size
            self.draw_label(
