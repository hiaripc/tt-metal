...
class BlockCache(BaseCache):
    ...
    def __repr__(self):
        return "<BlockCache blocksize={}, size={}, nblocks={}>".format(self.blocksize, self.size, self.nblocks)
    ...
    def _fetch_block(self, block_number):
        ...
        if block_number > self.nblocks:
            raise ValueError(
                "'block_number={}' is greater than the number of blocks ({})".format(block_number, self.nblocks)
            )
...
class KnownPartsOfAFile(BaseCache):
    ...
    def _fetch(self, start, stop):
        ...
        warnings.warn(f"Read is outside the known file parts: {(start, stop)}. " f"IO/caching performance may be poor!")
