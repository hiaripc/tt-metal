...
class CachingFileSystem(AbstractFileSystem):
    ...
    def to_json(self):
        ...
        """
        raise NotImplementedError("CachingFileSystem JSON representation not implemented")
...
class WholeFileCacheFileSystem(CachingFileSystem):
    ...
    def open_many(self, open_files):
        ...
        if "r" in open_files.mode:
            ...
            return [LocalTempFile(self.fs, path, mode=open_files.mode) for path in paths]
    ...
    def _open(self, path, mode="rb", **kwargs):
        ...
        if detail:
            ...
            if blocks is True:
                ...
                raise ValueError("Attempt to open partially cached file %s" "as a wholly cached file" % path)
        else:
