...
class ResponseProxy:
    ...
    def headers(self):
        if self._headers is None:
            self._headers = dict([_.split(": ") for _ in self.request.getAllResponseHeaders().strip().split("\r\n")])
...
class HTTPFile(AbstractBufferedFile):
    ...
    def _fetch_range(self, start, end):
        ...
        response_is_range = (
            r.status_code == 206 or self._parse_content_range(r.headers)[0] == start or int(cl) <= end - start
        )
