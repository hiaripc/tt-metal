...
def _try_fix(fixer_name: str, text: str, config: TextFixerConfig, steps: Optional[list]) -> str:
    """
...
def guess_bytes(bstring):
    ...
    if isinstance(bstring, str):
        raise UnicodeError(
            "This string was already decoded as Unicode. You should pass " "bytes to guess_bytes, not Unicode."
        )
