...
def fix_encoding(text):
    ...
    """
    warnings.warn("`fix_encoding()` has moved to the main module of ftfy.", DeprecationWarning)
...
def apply_plan(text, plan):
    ...
    """
    warnings.warn("`apply_plan()` has moved to the main module of ftfy.", DeprecationWarning)
