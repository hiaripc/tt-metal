...
from gitdb.stream import DecompressMemMapReader, DeltaApplyReader, Sha1Writer, NullStream, FlexibleSha1Writer
...
class PackEntity(LazyMixin):
    ...
    @classmethod
    def write_pack(
        cls, object_iter, pack_write, index_write=None, object_count=None, zlib_compression=zlib.Z_BEST_SPEED
    ):
        """
