...
from gitdb.fun import msb_size, stream_copy, apply_delta_data, connect_deltas, delta_types
...
class DecompressMemMapReader(LazyMixin):
    ...
    **Note:** The chunk-size should be carefully selected as it will involve quite a bit
    ...
    def read(self, size=-1):
        ...
        if (
            getattr(zlib, "ZLIB_RUNTIME_VERSION", zlib.ZLIB_VERSION) in ("1.2.7", "1.2.5")
