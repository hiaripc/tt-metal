...
@typing.overload
def run_check(
    cmd: typing.Sequence[typing.Union[os.PathLike, str]],
    *,
...
def _run_input_lines(cmd, input_lines, *, kwargs):
    ...
    return subprocess.CompletedProcess(popen.args, popen.returncode, stdout=stdout, stderr=stderr)


def _write_stderr(stderr) -> None:
    if isinstance(stderr, bytes):
        stderr_encoding = getattr(sys.stderr, "encoding", None) or sys.getdefaultencoding()
