...
class Render(saving.Save, backend.Render, backend.View):
    ...
    def render(
        ...
        *,
        ...
        args, kwargs = self._get_render_parameters(
            engine=engine,
            format=format,
            renderer=renderer,
            formatter=formatter,
    ...
    def _view(self, filepath: typing.Union[os.PathLike, str], *, format: str, quiet: bool) -> None:
        ...
        for name in methodnames:
            ...
            raise RuntimeError(
                f"{self.__class__!r} has no built-in viewer"
    ...
    def view(
        ...
        """
        return self.render(
            filename=filename, directory=directory, view=True, cleanup=cleanup, quiet=quiet, quiet_view=quiet_view
        )
