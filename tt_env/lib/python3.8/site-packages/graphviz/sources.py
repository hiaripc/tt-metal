...
class Source(
    rendering.Render, saving.Save, jupyter_integration.JupyterIntegration, piping.Pipe, unflattening.Unflatten
):
    ...
    def from_file(
        ...
        filepath = os.path.join(directory, filename) if directory.parts else os.fspath(filename)
    ...
    def _copy_kwargs(self, **kwargs):
        ...
        return super()._copy_kwargs(source=self._source, loaded_from_path=self._loaded_from_path, **kwargs)
    ...
    def save(
        ...
        *,
        ...
        """
        skip = (
            skip_existing is None and self._loaded_from_path and os.path.samefile(self._loaded_from_path, self.filepath)
        )
        if skip:
            log.debug(".save(skip_existing=None) skip writing Source.from_file(%r)", self.filepath)
        return super().save(filename=filename, directory=directory, skip_existing=skip)
