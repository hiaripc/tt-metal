...
class Unflatten(encoding.Encoding, base.Base, backend.Unflatten):
    ...
    def unflatten(
        self, stagger: typing.Optional[int] = None, fanout: bool = False, chain: typing.Optional[int] = None
    ) -> "graphviz.Source":
        ...
        out = self._unflatten(self.source, stagger=stagger, fanout=fanout, chain=chain, encoding=self.encoding)
