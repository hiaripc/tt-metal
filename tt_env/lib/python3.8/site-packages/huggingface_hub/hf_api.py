...
class HfApi:
    ...
    def upload_file(
        ...
        *,
        ...
        commit_message = commit_message if commit_message is not None else f"Upload {path_in_repo} with huggingface_hub"
    ...
    def delete_file(
        ...
        *,
        ...
        """
        commit_message = commit_message if commit_message is not None else f"Delete {path_in_repo} with huggingface_hub"
