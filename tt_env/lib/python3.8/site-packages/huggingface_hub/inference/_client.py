...
class InferenceClient:
        ...
        while True:
            ...
            try:
                ...
                if error.response.status_code == 422 and task is not None:
                    error.args = (f"{error.args[0]}\nMake sure '{task}' task is supported by the model.",) + error.args[
                        1:
                    ]
    ...
    def token_classification(self, text: str, *, model: Optional[str] = None) -> List[TokenClassificationOutputElement]:
        """
