...
class OpenNamespaceTests(FilesTests, util.DiskSetup, unittest.TestCase):
    ...
    def test_non_paths_in_dunder_path(self):
        ...
        namespacedata01.__path__.append("__editable__.sample_namespace-1.0.finder.__path_hook__")
...
class ImplicitContextFilesDiskTests(DirectSpec, util.DiskSetup, ImplicitContextFiles, unittest.TestCase):
    pass


class ImplicitContextFilesZipTests(DirectSpec, util.ZipSetup, ImplicitContextFiles, unittest.TestCase):
    pass
