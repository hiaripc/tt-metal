...
class ResourceLoaderTests(util.DiskSetup, unittest.TestCase):
    def test_resource_contents(self):
        package = util.create_package(file=self.data, path=self.data.__file__, contents=["A", "B", "C"])
...
class ResourceCornerCaseTests(util.DiskSetup, unittest.TestCase):
    def test_package_has_no_reader_fallback(self):
        ...
        """
        module = util.create_package(file=self.data, path=self.data.__file__, contents=["A", "B", "C"])
