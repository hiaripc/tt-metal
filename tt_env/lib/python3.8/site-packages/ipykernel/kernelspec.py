...
def get_kernel_dict(
    ...
    return {
        "argv": make_ipkernel_cmd(extra_arguments=extra_arguments, python_arguments=python_arguments),
...
class InstallIPythonKernelSpecApp(Application):
    ...
    def start(self) -> None:
        ...
        parser.add_argument(
            "--profile",
            type=str,
            help="Specify an IPython profile to load. " "This can be used to create custom versions of the kernel.",
        )
        parser.add_argument(
            "--prefix",
            type=str,
