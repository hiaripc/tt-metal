...
DEFAULT_EMBED_SCRIPT_URL = (
    "https://cdn.jsdelivr.net/npm/@jupyter-widgets/html-manager@%s/dist/embed.js" % __html_manager_version__
)
DEFAULT_EMBED_REQUIREJS_URL = (
    "https://cdn.jsdelivr.net/npm/@jupyter-widgets/html-manager@%s/dist/embed-amd.js" % __html_manager_version__
)
...
def embed_snippet(views, drop_defaults=True, state=None, indent=2, embed_url=None, requirejs=True, cors=True):
    ...
    widget_views = "\n".join(
        widget_view_template.format(view_spec=escape_script(json.dumps(view_spec))) for view_spec in data["view_specs"]
    )
