...
def test_append_display_data():
    ...
    expected = (
        {
            ...
            "data": {"text/plain": "<IPython.core.display.Markdown object>", "text/markdown": "# snakes!"},
            "metadata": {},
        },
    )
    assert widget.outputs == expected, repr(widget.outputs)
    ...
    expected2 = expected + (
        {
            "output_type": "display_data",
            "data": {"image/png": "Zm9vYmFy", "text/plain": "<IPython.core.display.Image object>"},
            "metadata": {"image/png": {"width": 123, "height": 456}},
        },
    )
