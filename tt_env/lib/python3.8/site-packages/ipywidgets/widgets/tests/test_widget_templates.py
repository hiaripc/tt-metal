...
class TestTwoByTwoLayout(TestCase):
    ...
    def test_keep_layout_options(self):  # pylint: disable=no-self-use
        ...
        box = widgets.TwoByTwoLayout(
            top_left=button1, top_right=button2, bottom_left=button3, bottom_right=button4, layout=layout
        )
...
class TestAppLayout(TestCase):
    ...
    def test_create_with_defaults(self):
        ...
        box = widgets.AppLayout(
            footer=footer, header=header, center=center, left_sidebar=left_sidebar, right_sidebar=right_sidebar
        )
    ...
    def test_merge_empty_cells(self):
        ...
        box = widgets.AppLayout(
            header=header, footer=footer, center=None, left_sidebar=left_sidebar, right_sidebar=right_sidebar
        )
        ...
        box = widgets.AppLayout(
            header=header, footer=footer, center=None, left_sidebar=None, right_sidebar=right_sidebar
        )
    ...
    def test_set_pane_widths_heights(self):
        ...
        box = widgets.AppLayout(
            header=header, footer=footer, left_sidebar=left_sidebar, right_sidebar=left_sidebar, center=center
        )
