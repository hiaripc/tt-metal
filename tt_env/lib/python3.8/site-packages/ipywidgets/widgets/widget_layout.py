...
class Layout(Widget):
    ...
    align_self = CaselessStrEnum(
        ["auto", "flex-start", "flex-end", "center", "baseline", "stretch"] + CSS_PROPERTIES,
        allow_none=True,
    ...
    justify_content = CaselessStrEnum(
        ["flex-start", "flex-end", "center", "space-between", "space-around"] + CSS_PROPERTIES,
        allow_none=True,
        help="The justify-content CSS attribute.",
    ).tag(sync=True)
    justify_items = CaselessStrEnum(
        ["flex-start", "flex-end", "center"] + CSS_PROPERTIES, allow_none=True, help="The justify-items CSS attribute."
    ).tag(sync=True)
    ...
    visibility = CaselessStrEnum(
        ["visible", "hidden"] + CSS_PROPERTIES, allow_none=True, help="The visibility CSS attribute."
    ).tag(sync=True)
    width = Unicode(None, allow_none=True, help="The width CSS attribute.").tag(sync=True)

    object_fit = CaselessStrEnum(
        ["contain", "cover", "fill", "scale-down", "none"], allow_none=True, help="The object-fit CSS attribute."
    ).tag(sync=True)
    ...
    grid_template_columns = Unicode(None, allow_none=True, help="The grid-template-columns CSS attribute.").tag(
        sync=True
    )
