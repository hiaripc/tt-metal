...
class Image(_Media):
    ...
    width = CUnicode(help="Width of the image in pixels. Use layout.width " "for styling the widget.").tag(sync=True)
    height = CUnicode(help="Height of the image in pixels. Use layout.height " "for styling the widget.").tag(sync=True)
...
class Video(_Media):
    ...
    controls = Bool(
        True, help="Specifies that video controls should be displayed (such as a play/pause button etc)"
    ).tag(sync=True)
...
class Audio(_Media):
    ...
    controls = Bool(
        True, help="Specifies that audio controls should be displayed (such as a play/pause button etc)"
    ).tag(sync=True)
