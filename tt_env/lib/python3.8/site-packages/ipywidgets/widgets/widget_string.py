...
class Combobox(Text):
    ...
    options = TypedTuple(trait=Unicode(), help="Dropdown options for the combobox").tag(sync=True)

    ensure_option = Bool(False, help="If set, ensure value is in options. Implies continuous_update=False.").tag(
        sync=True
    )
