...
from traitlets import CaselessStrEnum, CInt, CFloat, Bool, Unicode, List, TraitError, validate
    ...
    def _validate_value(self, proposal):
        ...
        for tag_value in proposal["value"]:
            if tag_value not in self.allowed_tags:
                raise TraitError(
                    "Tag value {} is not allowed, allowed tags are {}".format(tag_value, self.allowed_tags)
                )
