...
class Serializer(t.Generic[_TSerialized]):
    ...
    def __init__(
        ...
        fallback_signers: list[dict[str, t.Any] | tuple[type[Signer], dict[str, t.Any]] | type[Signer]] | None = None,
    ):
        ...
