...
class Script:
    ...
    def _get_module(self):
        ...
        if self.path is not None and self.path.suffix == ".pyi":
            ...
            stub_module = load_proper_stub_module(
                self._inference_state, self._inference_state.latest_grammar, file_io, names, self._module_node
            )
    ...
    def get_signatures(self, line=None, column=None):
        ...
        definitions = helpers.cache_signatures(
            self._inference_state, context, call_details.bracket_leaf, self._code_lines, pos
        )
    ...
    def extract_variable(self, line, column, *, new_name, until_line=None, until_column=None):
        ...
        return extract_variable(
            self._inference_state, self.path, self._module_node, new_name, (line, column), until_pos
        )
    ...
    def extract_function(self, line, column, *, new_name, until_line=None, until_column=None):
        ...
        return extract_function(
            self._inference_state, self.path, self._get_module_context(), new_name, (line, column), until_pos
        )
...
class Interpreter(Script):
    ...
    def __init__(self, code, namespaces, *, project=None, **kwds):
        ...
        self._inference_state.allow_unsafe_executions = settings.allow_unsafe_interpreter_executions
