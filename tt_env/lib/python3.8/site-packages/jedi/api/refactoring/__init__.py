...
EXPRESSION_PARTS = (
    "or_test and_test not_test comparison " "expr xor_expr and_expr shift_expr arith_expr term factor power atom_expr"
).split()
...
class Refactoring:
    ...
    def get_changed_files(self) -> Dict[Path, ChangedFile]:
        ...
        return {
            ...
            for path, map_ in sorted(self._file_to_node_changes.items(), key=lambda x: x[0] or Path(""))
        }
