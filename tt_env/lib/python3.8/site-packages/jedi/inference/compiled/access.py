...
SignatureParam = namedtuple(
    "SignatureParam", "name has_default default default_string has_annotation annotation annotation_string kind_name"
)
...
def get_api_type(obj):
    if inspect.isclass(obj):
        ...
        return "module"
    elif inspect.isbuiltin(obj) or inspect.ismethod(obj) or inspect.ismethoddescriptor(obj) or inspect.isfunction(obj):
        return "function"
    # Everything else...
    return "instance"
...
class DirectObjectAccess:
    ...
    def py__name__(self):
        if not _is_class_instance(self._obj) or inspect.ismethoddescriptor(self._obj):  # slots
            cls = self._obj
        else:
            try:
