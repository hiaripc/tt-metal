...
class MatchRule:
    ...
    def __init__(
        ...
        *,
        ...
        self.header_fields = {k: v for (k, v) in fields.items() if (v is not None)}
    ...
    def serialise(self) -> str:
        ...
        return ",".join("{}='{}'".format(k, v.replace("'", r"'\''")) for (k, v) in pairs)
    ...
    def matches(self, msg: Message) -> bool:
        ...
        for argno, (expected, kind) in self.arg_conditions.items():
            ...
            if kind == "string":
                ...
                if not ((arg == expected) or arg.startswith(expected + ".")):
                    return False
