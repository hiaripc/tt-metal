...
class DBusAddress:
    ...
    def __repr__(self):
        return "{}({!r}, bus_name={!r}, interface={!r})".format(
            type(self).__name__, self.object_path, self.bus_name, self.interface
        )
...
class Properties:
    ...
    def __init__(self, obj: Union[DBusAddress, MessageGenerator]):
        self.obj = obj
        self.props_if = DBusAddress(obj.object_path, bus_name=obj.bus_name, interface="org.freedesktop.DBus.Properties")

    def get(self, name):
        """Get the value of the property *name*"""
        return new_method_call(self.props_if, "Get", "ss", (self.obj.interface, name))

    def get_all(self):
        """Get all property values for this interface"""
        return new_method_call(self.props_if, "GetAll", "s", (self.obj.interface,))
