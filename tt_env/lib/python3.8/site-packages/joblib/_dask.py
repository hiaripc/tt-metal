...
class DaskDistributedBackend(AutoBatchingMixin, ParallelBackendBase):
    ...
    def __init__(
        self, scheduler_host=None, scatter=None, client=None, loop=None, wait_for_workers_timeout=10, **submit_kwargs
    ):
        super().__init__()
    ...
    def effective_n_jobs(self, n_jobs):
        ...
        try:
            ...
            ).format(self.wait_for_workers_timeout, max(10, 2 * self.wait_for_workers_timeout))
    ...
    def apply_async(self, func, callback=None):
        ...
        async def f(func, callback):
            ...
            dask_future = self.client.submit(
                _TracebackCapturingWrapper(batch), tasks=tasks, key=key, **self.submit_kwargs
            )
