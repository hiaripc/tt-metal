...
class PoolManagerMixin(object):
    ...
    def apply_async(self, func, callback=None):
        ...
        return self._get_pool().apply_async(
            _TracebackCapturingWrapper(func), (), callback=callback, error_callback=callback
        )
...
class LokyBackend(AutoBatchingMixin, ParallelBackendBase):
    ...
    def configure(
        self, n_jobs=1, parallel=None, prefer=None, require=None, idle_worker_timeout=300, **memmappingexecutor_args
    ):
    ...
    def effective_n_jobs(self, n_jobs):
        ...
        if n_jobs == 0:
            ...
            if n_jobs != 1:
                warnings.warn(
                    "Loky-backed parallel loops cannot be nested below " "threads, setting n_jobs=1", stacklevel=3
                )
            return 1
        elif n_jobs < 0:
            n_jobs = max(cpu_count() + 1 + n_jobs, 1)
