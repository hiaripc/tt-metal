...
class SemLock:
    ...
    def __init__(self, kind, value, maxvalue, name=None):
        ...
        self.name = name
        util.debug(f"created semlock with handle {self._semlock.handle} and name " f'"{self.name}"')
...
class BoundedSemaphore(Semaphore):
    ...
    def __repr__(self):
        try:
            ...
            value = "unknown"
        return f"<{self.__class__.__name__}(value={value}, " f"maxvalue={self._semlock.maxvalue})>"
