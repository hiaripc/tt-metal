...
@parametrize(
    ...
    [
        (ValueError, "ignore_lst must be a list of parameters to ignore", f, ["bar", (None,)]),
        (ValueError, r"Ignore list: argument \'(.*)\' is not defined", g, [["bar"], (None,)]),
...
@parametrize(
    ...
    [(g, [list(range(5))], {}, "g([0, 1, 2, 3, 4])"), (k, [1, 2, (3, 4)], {"y": True}, "k(1, 2, (3, 4), y=True)")],
)
