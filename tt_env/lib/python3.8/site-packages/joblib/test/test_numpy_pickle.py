...
@parametrize(
    ...
    [
        (("zlib", 3, "extra"), "Compress argument tuple should contain exactly 2 elements"),  # wrong compress tuple
        (("wrong", 3), 'Non valid compression method given: "{}"'.format("wrong")),  # wrong compress method
        (("zlib", "wrong"), 'Non valid compress level given: "{}"'.format("wrong")),  # wrong compress level
    ],
)
