...
class LanguageServerSession(LoggingConfigurable):
    ...
    def __repr__(self):  # pragma: no cover
        return ("<LanguageServerSession(" "language_server={language_server}, argv={argv})>").format(
    ...
    def to_json(self):
        return dict(
            ...
            last_server_message_at=(self.last_server_message_at.isoformat() if self.last_server_message_at else None),
    ...
    def initialize(self):
        ...
        self._tasks = [loop.create_task(coro()) for coro in [self._read_lsp, self._write_lsp, self._broadcast_from_lsp]]
    ...
    def init_writer(self):
        ...
        self.writer = stdio.LspStdIoWriter(stream=self.process.stdin, queue=self.to_lsp, parent=self)
