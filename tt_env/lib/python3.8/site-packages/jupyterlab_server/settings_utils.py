...
def _override(schema_name: str, schema: dict[str, Any], overrides: dict[str, Any]) -> dict[str, Any]:
...
def _path(root_dir: str, schema_name: str, make_dirs: bool = False, extension: str = ".json") -> str:
    """
...
def save_settings(
    ...
    schema, _ = _get_schema(schemas_dir, schema_name, overrides, labextensions_path=labextensions_path)
    validator = Validator(schema)
