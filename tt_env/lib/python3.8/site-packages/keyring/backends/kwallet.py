...
class DBusKeyring(KeyringBackend):
    ...
    def priority(cls) -> float:
        ...
        if not (bus.name_has_owner(cls.bus_name) or cls.bus_name in bus.list_activatable_names()):
            raise RuntimeError("The KWallet daemon is neither running nor activatable through D-Bus")
