...
class CommandLineTool:
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--disable", action="store_true", help="Disable keyring and exit")
    ...
    def _get_password(self) -> credentials.Credential | None:
        ...
        return credentials.AnonymousCredential(password) if password is not None else None
