    ...
    *,
    ...
    if isinstance(intervals, str):
        if intervals == "equal":
            ...
            ratios = plimit_intervals(primes=[3], bins_per_octave=bins_per_octave, sort=sort)
        elif intervals == "ji5":
            ratios = plimit_intervals(primes=[3, 5], bins_per_octave=bins_per_octave, sort=sort)
        elif intervals == "ji7":
            ratios = plimit_intervals(primes=[3, 5, 7], bins_per_octave=bins_per_octave, sort=sort)
    else:
...
def plimit_intervals(
    *, primes: ArrayLike, bins_per_octave: int = ..., sort: bool = ..., return_factors: Literal[False] = ...
) -> np.ndarray:
    ...
...
@overload
def plimit_intervals(
    *, primes: ArrayLike, bins_per_octave: int = ..., sort: bool = ..., return_factors: Literal[True]
) -> List[Dict[int, int]]:
    ...
...
@overload
def plimit_intervals(
    *, primes: ArrayLike, bins_per_octave: int = ..., sort: bool = ..., return_factors: bool = ...
) -> Union[np.ndarray, List[Dict[int, int]]]:
    ...
...
@cache(level=10)
def plimit_intervals(
    *, primes: ArrayLike, bins_per_octave: int = 12, sort: bool = True, return_factors: bool = False
) -> Union[np.ndarray, List[Dict[int, int]]]:
