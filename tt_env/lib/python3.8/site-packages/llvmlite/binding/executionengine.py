...
ffi.lib.LLVMPY_AddGlobalMapping.argtypes = [ffi.LLVMExecutionEngineRef, ffi.LLVMValueRef, c_void_p]
...
ffi.lib.LLVMPY_MCJITAddObjectFile.argtypes = [ffi.LLVMExecutionEngineRef, ffi.LLVMObjectFileRef]
...
ffi.lib.LLVMPY_CreateObjectCache.argtypes = [_ObjectCacheNotifyFunc, _ObjectCacheGetBufferFunc, py_object]
...
ffi.lib.LLVMPY_SetObjectCache.argtypes = [ffi.LLVMExecutionEngineRef, ffi.LLVMObjectCacheRef]
