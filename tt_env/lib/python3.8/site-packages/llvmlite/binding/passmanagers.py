from ctypes import c_bool, c_char_p, c_int, c_size_t, c_uint, Structure, byref, POINTER
...
ffi.lib.LLVMPY_RunFunctionPassManager.argtypes = [ffi.LLVMPassManagerRef, ffi.LLVMValueRef]
...
ffi.lib.LLVMPY_AddAggressiveInstructionCombiningPass.argtypes = [ffi.LLVMPassManagerRef]
