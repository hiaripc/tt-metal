...
class IRBuilder(object):
    ...
    def call(self, fn, args, name="", cconv=None, tail=False, fastmath=(), attrs=(), arg_attrs=None):
        """
        Call function *fn* with *args*:
            name = fn(args...)
        """
        inst = instructions.CallInstr(
            self.block, fn, args, name=name, cconv=cconv, tail=tail, fastmath=fastmath, attrs=attrs, arg_attrs=arg_attrs
        )
        self._insert(inst)
        return inst
    ...
    def invoke(self, fn, args, normal_to, unwind_to, name="", cconv=None, fastmath=(), attrs=(), arg_attrs=None):
    ...
    def gep(self, ptr, indices, inbounds=False, name=""):
        ...
        """
        instr = instructions.GEPInstr(self.block, ptr, indices, inbounds=inbounds, name=name)
        self._insert(instr)
        return instr
