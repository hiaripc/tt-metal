...
class Module(object):
    ...
    def add_metadata(self, operands):
        ...
        if not isinstance(operands, (list, tuple)):
            raise TypeError("expected a list or tuple of metadata values, " "got %r" % (operands,))
    ...
    def _get_metadata_lines(self):
        ...
        for k, v in self.namedmetadata.items():
            mdbuf.append(
                "!{name} = !{{ {operands} }}".format(name=k, operands=", ".join(i.get_reference() for i in v.operands))
            )
