...
class Core:
    def __init__(self):
        ...
        self.levels_ansi_codes = {name: Colorizer.ansify(level.color) for name, level in self.levels.items()}
...
class Logger:
    ...
    def stop(self, *args, **kwargs):
        ...
        .. deprecated:: 0.2.2
          ...
          confusing name.
        """
        warnings.warn("The 'stop()' method is deprecated, please use 'remove()' instead", DeprecationWarning)
