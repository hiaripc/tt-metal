...
try:
    ...
    raise ImportError("cssselect does not seem to be installed. " "See https://pypi.org/project/cssselect/")
...
class LxmlTranslator(external_cssselect.GenericTranslator):
    ...
    def xpath_contains_function(self, xpath, function):
        ...
        return xpath.add_condition(
            "contains(__lxml_internal_css:lower-case(string(.)), %s)" % self.xpath_literal(value.lower())
        )
