...
_looks_like_tag_content = re.compile(
    r"</?[a-zA-Z]+|\son[a-zA-Z]+\s*=", *((re.ASCII,) if sys.version_info[0] >= 3 else ())
).search

# All kinds of schemes besides just javascript: that can cause
# execution:
_find_image_dataurls = re.compile(r"data:image/(.+);base64,", re.I).findall
_possibly_malicious_schemes = re.compile(r"(javascript|jscript|livescript|vbscript|data|about|mocha):", re.I).findall
...
_link_regexes = [
    re.compile(
        r"(?P<body>https?://(?P<host>[a-z0-9._-]+)(?:/[/\-_.,a-z0-9%&?;=~]*)?(?:\([/\-_.,a-z0-9%&?;=~]*\))?)", re.I
    ),
