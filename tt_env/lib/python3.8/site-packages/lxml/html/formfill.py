...
_form_name_xpath = XPath(
    "descendant-or-self::form[name=$name]|descendant-or-self::x:form[name=$name]", namespaces={"x": XHTML_NAMESPACE}
)
_input_xpath = XPath(
    "|".join(
        ["descendant-or-self::" + _tag for _tag in ("input", "select", "textarea", "x:input", "x:select", "x:textarea")]
    ),
