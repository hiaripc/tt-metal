...
iso_dsdl_include = _etree.XSLT(
    _etree.parse(os.path.join(_resources_dir, "xsl", "iso-schematron-xslt1", "iso_dsdl_include.xsl"))
)
iso_abstract_expand = _etree.XSLT(
    _etree.parse(os.path.join(_resources_dir, "xsl", "iso-schematron-xslt1", "iso_abstract_expand.xsl"))
)
iso_svrl_for_xslt1 = _etree.XSLT(
    _etree.parse(os.path.join(_resources_dir, "xsl", "iso-schematron-xslt1", "iso_svrl_for_xslt1.xsl"))
)
...
schematron_schema_valid = _etree.RelaxNG(file=os.path.join(_resources_dir, "rng", "iso-schematron.rng"))
