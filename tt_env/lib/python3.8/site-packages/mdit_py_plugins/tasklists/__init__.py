...
def tasklists_plugin(
    ...
    def make_checkbox(token: Token) -> Token:
        ...
        if token.content.startswith("[ ] "):
            checkbox.content = '<input class="task-list-item-checkbox" ' f'{disabled_attr} type="checkbox">'
        elif token.content.startswith("[x] ") or token.content.startswith("[X] "):
            checkbox.content = (
                '<input class="task-list-item-checkbox" checked="checked" ' f'{disabled_attr} type="checkbox">'
            )
        return checkbox
