...
class _matrix(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "force_type" in kwargs:
            warnings.warn(
                "The force_type argument was removed, it did not work"
        ...
        if isinstance(other, self.ctx.matrix):
            ...
            for i in xrange(self.__rows):
                for j in xrange(other.__cols):
                    new[i, j] = self.ctx.fdot(
                        (self_get((i, k), self_zero), other_get((k, j), other_zero)) for k in xrange(other.__rows)
                    )
            return new
        else:
    ...
    def __sub__(self, other):
        if isinstance(other, self.ctx.matrix) and not (self.__rows == other.__rows and self.__cols == other.__cols):
    ...
    def __eq__(self, other):
        return self.__rows == other.__rows and self.__cols == other.__cols and self.__data == other.__data
