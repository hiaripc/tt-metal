...
def test_str_format():
    ...
    assert (
        to_str(from_float(1.23456789000000e-2), 15, strip_zeros=False, min_fixed=0, max_fixed=0)
        == "1.23456789000000e-2"
    )
    assert (
        to_str(from_float(1.23456789000000e2), 15, strip_zeros=False, min_fixed=0, max_fixed=0) == "1.23456789000000e+2"
    )
...
def test_str_prec0():
    ...
    assert to_str(from_float(1e15), 0) == ".0e+15"
    assert to_str(from_float(-1e-15), 0) == "-.0e-15"
    assert to_str(from_float(-1e15), 0) == "-.0e+15"
