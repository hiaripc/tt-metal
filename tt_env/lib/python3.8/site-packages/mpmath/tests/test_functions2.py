...
def test_bessel():
    ...
    for n in range(10, 100, 10):
        mp.dps = n
        assert besseli(91.5, 24.7708).ae(
            "4.00830632138673963619656140653537080438462342928377020695738635559218797348548092636896796324190271316137982810144874264e-41"
        )
...
def test_e1():
    ...
    assert e1(fmul(10**20, j, exact=True)).ae(
        6.4525128526578084421e-21 - 7.6397040444172830039e-21j, abs_eps=0, rel_eps=8 * eps
    )
    assert e1(-10j).ae(0.045456433004455372635 - 0.087551267423977430100j)
    assert e1(-100j).ae(0.0051488251426104921444 + 0.0085708599058403258790j)
    assert e1(fmul(-(10**20), j, exact=True)).ae(
...
def test_expint():
    ...
    assert expint(3, 0).ae(1 / 2.0)
    assert expint(4, 0).ae(1 / 3.0)
    assert expint(-2, 0.5).ae(26 / sqrt(e))
    assert expint(-1, -1) == 0
    assert expint(-2, -1).ae(-e)
    assert expint(5.5, 0).ae(2 / 9.0)
    assert expint(2.00000001, 0).ae(100000000.0 / 100000001)
    ...
    assert expint(1000000, 0).ae(1.0 / 999999)
...
def test_hyper_0f1():
    ...
    assert hyper([], [1 / 3.0], 1.5).ae(v)
    assert hyp0f1(1 / 3.0, 1.5).ae(v)
...
def test_hyper_2f1_hard():
    ...
    assert fsum([hyp2f1((7, 10), (2, 3), (-1, 2), 0.95 * exp(j * k)) for k in range(1, 15)]).ae(
        52.851400204289452922 + 6.244285013912953225j
    )
    assert fsum([hyp2f1((7, 10), (2, 3), (-1, 2), 1.05 * exp(j * k)) for k in range(1, 15)]).ae(
        54.506013786220655330 - 3.000118813413217097j
    )
    assert fsum([hyp2f1((7, 10), (2, 3), (-1, 2), exp(j * k)) for k in range(1, 15)]).ae(
        55.792077935955314887 + 1.731986485778500241j
    )
...
def test_hyper_2f0():
    ...
    for d in [15, 50, 80]:
        mp.dps = d
        assert hyp2f0(1.5, 0.5, 0.009).ae(
            "1.006867007239309717945323585695344927904000945829843527398772456281301440034218290443367270629519483 + 1.238277162240704919639384945859073461954721356062919829456053965502443570466701567100438048602352623e-46j"
        )
...
def test_hyper_1f2():
    ...
    a1, b1, b2 = (1, 10), (2, 3), 1.0 / 16
    assert hyp1f2(a1, b1, b2, 10).ae(298.7482725554557568)
    assert hyp1f2(a1, b1, b2, 100).ae(224128961.48602947604)
    assert hyp1f2(a1, b1, b2, 1000).ae(1.1669528298622675109e27)
    assert hyp1f2(a1, b1, b2, 10000).ae(2.4780514622487212192e86)
    assert hyp1f2(a1, b1, b2, 100000).ae(1.3885391458871523997e274)
    ...
    assert hyp1f2(a1, b1, b2, 10000 * j).ae(-8.9771211184008593089e60 + 4.6550528111731631456e59j)
    assert hyp1f2(a1, b1, b2, 100000 * j).ae(2.6398091437239324225e193 + 4.1658080666870618332e193j)
    ...
    assert hyp1f2(a1, b1, b2, 10**20 * j).ae(
        "-1.1734497974795488504e+6141851462 + 1.1498106965385471542e+6141851462j"
    )
...
def test_hyper_2f3():
    ...
    assert hyp2f3(a1, a2, b1, b2, b3, 10000 * j).ae(-1.1779696326238582496e59 + 1.2297607505213133872e59j)
    assert hyp2f3(a1, a2, b1, b2, b3, 100000 * j).ae(2.9844228969804380301e191 + 7.5587163231490273296e190j)
    ...
    assert hyp2f3(a1, a2, b1, b2, b3, 10**20 * j).ae(
        "-2.0988815677627225449e+6141851451 + 5.7708223542739208681e+6141851452j"
    )
...
def test_orthpoly():
    ...
    assert jacobi(1.5, 5 / 6.0, 4, 0).ae(-1.0851951434075508417)
...
def test_gammainc():
    ...
    assert gammainc(-1000000, 3 + 4j).ae(
        "-1.322575609404222361e-698979 - 4.9274570591854533273e-698978j", abs_eps=0, rel_eps=8 * eps
    )
...
def test_gammainc_expint_n():
    ...
    assert expint(-3, -350).ae(-2.8528796154044839443e149)
    assert expint(-2, -350).ae(-2.8610072121701264351e149)
    assert expint(-1, -350).ae(-2.8691813842677537647e149)
    assert expint(0, -350).ae(-2.8774025343659421709e149)
    u = expint(1, -350)
    assert u.ae(-2.8856710698020863568e149)
    assert u.imag.ae(-3.1415926535897932385)
    u = expint(2, -350)
    assert u.ae(-2.8939874026504650534e149)
    assert u.imag.ae(-1099.5574287564276335)
    u = expint(3, -350)
    assert u.ae(-2.9023519497915044349e149)
    assert u.imag.ae(-192422.55003237483586)
    assert expint(-3, 350000000000000000000000).ae(
        "2.1592908471792544286e-152003068666138139677919", abs_eps=0, rel_eps=8 * eps
    )
    assert expint(-2, 350000000000000000000000).ae(
        "2.1592908471792544286e-152003068666138139677919", abs_eps=0, rel_eps=8 * eps
    )
    assert expint(-1, 350000000000000000000000).ae(
        "2.1592908471792544286e-152003068666138139677919", abs_eps=0, rel_eps=8 * eps
    )
    assert expint(0, 350000000000000000000000).ae(
        "2.1592908471792544286e-152003068666138139677919", abs_eps=0, rel_eps=8 * eps
    )
    assert expint(1, 350000000000000000000000).ae(
        "2.1592908471792544286e-152003068666138139677919", abs_eps=0, rel_eps=8 * eps
    ...
    assert u.imag.ae(-1.0995574287564276335e24)
    assert u.ae("-3.7805306852415755699e+152003068666138139677871")
    u = expint(3, -350000000000000000000000)
    assert u.imag.ae(-1.9242255003237483586e47)
    assert u.ae("-3.7805306852415755699e+152003068666138139677871")
    ...
    u = gammainc(-3, -350)
    assert u.ae(6.7889565783842895085e141)
    assert u.imag.ae(0.52359877559829887308)
    u = gammainc(-2, -350)
    assert u.ae(-2.3692668977889832121e144)
    assert u.imag.ae(-1.5707963267948966192)
    u = gammainc(-1, -350)
    assert u.ae(8.2685354361441858669e146)
    assert u.imag.ae(3.1415926535897932385)
    u = gammainc(0, -350)
    assert u.ae(-2.8856710698020863568e149)
    assert u.imag.ae(-3.1415926535897932385)
    u = gammainc(1, -350)
    assert u.ae(1.0070908870280797598e152)
    assert u.imag == 0
    u = gammainc(2, -350)
    assert u.ae(-3.5147471957279983618e154)
    assert u.imag == 0
    u = gammainc(3, -350)
    assert u.ae(1.2266568422179417091e157)
    assert u.imag == 0
    # Extreme asymptotic case
    assert gammainc(-3, 350000000000000000000000).ae(
        "5.0362468738874738859e-152003068666138139677990", abs_eps=0, rel_eps=8 * eps
    )
    assert gammainc(-2, 350000000000000000000000).ae(
        "1.7626864058606158601e-152003068666138139677966", abs_eps=0, rel_eps=8 * eps
    )
    assert gammainc(-1, 350000000000000000000000).ae(
        "6.1694024205121555102e-152003068666138139677943", abs_eps=0, rel_eps=8 * eps
    )
    assert gammainc(0, 350000000000000000000000).ae(
        "2.1592908471792544286e-152003068666138139677919", abs_eps=0, rel_eps=8 * eps
    )
    assert gammainc(1, 350000000000000000000000).ae(
        "7.5575179651273905e-152003068666138139677896", abs_eps=0, rel_eps=8 * eps
    )
    assert gammainc(2, 350000000000000000000000).ae(
        "2.645131287794586675e-152003068666138139677872", abs_eps=0, rel_eps=8 * eps
    )
    assert gammainc(3, 350000000000000000000000).ae(
        "9.2579595072810533625e-152003068666138139677849", abs_eps=0, rel_eps=8 * eps
    )
...
def test_erf():
    ...
    assert (
        str(erfc(10**50))
        == "3.66744826532555e-4342944819032518276511289189166050822943970058036665661144537831658646492088707747292249493384317534"
    )
    assert erfinv(0) == 0
...
def test_lambertw():
    ...
    assert lambertw(-1.0 / 10000, 0).ae(-0.000100010001500266719)
    ...
    assert lambertw(-1.0 / 10000, 1).ae(-11.82350837248724344 + 6.80546081842002101j)
    assert lambertw(-1.0 / 10000, -1).ae(-11.6671145325663544)
    assert lambertw(-1.0 / 10000, -2).ae(-11.82350837248724344 - 6.80546081842002101j)
    assert lambertw(-1.0 / 100000, 4).ae(-14.9186890769540539 + 26.1856750178782046j)
    assert lambertw(-1.0 / 100000, 5).ae(-15.0931437726379218666 + 32.5525721210262290086j)
    ...
    assert w.imag.ae(6.2831853071795864769e20)
...
def test_lambertw_hard():
    ...
    x = -1 / e + mpf("1e-13")
    ans = (
        "-0.99999926266961377166355784455394913638782494543377383"
...
def test_hyper_param_accuracy():
    ...
    assert legenp(0.5, 100, 0.25).ae(-2.4124576567211311755e144)
    ...
    (hyp1f1(-5000.5, 1500, 100) * 10**185).ae(8.5185229673381935522)
    (hyp1f1(-5000, 1500, 100) * 10**185).ae(9.1501213424563944311)
    assert hyp0f1(fadd(-20, "1e-100", exact=True), 0.25).ae(1.85014429040102783e49)
    assert hyp0f1((-20 * 10**100 + 1, 10**100), 0.25).ae(1.85014429040102783e49)
