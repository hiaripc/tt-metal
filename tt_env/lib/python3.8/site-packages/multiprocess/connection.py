...
def arbitrary_address(family):
    ...
    if family == "AF_INET":
        ...
        return tempfile.mktemp(prefix=r"\\.\pipe\pyc-%d-%d-" % (os.getpid(), next(_mmap_counter)), dir="")
    else:
...
if sys.platform != "win32":
    ...
    def Pipe(duplex=True):
        ...
        h2 = _winapi.CreateFile(
            address, access, 0, _winapi.NULL, _winapi.OPEN_EXISTING, _winapi.FILE_FLAG_OVERLAPPED, _winapi.NULL
        )
    ...
    class PipeListener(object):
        ...
        def __init__(self, address, backlog=None):
            ...
            self.close = util.Finalize(
                self, PipeListener._finalize_pipe_listener, args=(self._handle_queue, self._address), exitpriority=0
            )
