...
class _TestRemoteManager(BaseTestCase):
    ...
    def test_remote(self):
        ...
        manager = QueueManager(address=(test.support.HOST, 0), authkey=authkey, serializer=SERIALIZER)
        manager.start()
...
class OtherTest(unittest.TestCase):
    ...
    def test_deliver_challenge_auth_failure(self):
        ...
        self.assertRaises(
            multiprocessing.AuthenticationError, multiprocessing.connection.deliver_challenge, _FakeConnection(), b"abc"
        )
    ...
    def test_answer_challenge_auth_failure(self):
        ...
        self.assertRaises(
            multiprocessing.AuthenticationError, multiprocessing.connection.answer_challenge, _FakeConnection(), b"abc"
        )
    ...
    def _test_resource_tracker(self):
        ...
        for rtype in resource_tracker._CLEANUP_FUNCS:
            with self.subTest(rtype=rtype):
                ...
                r, w = os.pipe()
                p = subprocess.Popen(
                    [sys.executable, "-E", "-c", cmd.format(w=w, rtype=rtype)], pass_fds=[w], stderr=subprocess.PIPE
                )
                os.close(w)
        ...
        while len(multiprocessing.active_children()) > 1:
            ...
            if dt >= 5.0:
                ...
                support.print_warning(
                    f"multiprocess.Manager still has "
...
class MiscTestCase(unittest.TestCase):
    def test__all__(self):
        ...
        support.check__all__(
            self,
            multiprocessing,
            extra=multiprocessing.__all__,
            blacklist=["SUBDEBUG", "SUBWARNING", "license", "citation"],
        )
