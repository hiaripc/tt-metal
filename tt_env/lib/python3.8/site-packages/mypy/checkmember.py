...
def analyze_descriptor_access(descriptor_type: Type, mx: MemberContext) -> Type:
    ...
    if dunder_get is None:
        mx.msg.fail(
            message_registry.DESCRIPTOR_GET_NOT_CALLABLE.format(descriptor_type.str_with_options(mx.msg.options)),
            mx.context,
        )
        return AnyType(TypeOfAny.from_error)
...
def analyze_class_attribute_access(
    ...
    *,
    ...
    if t:
        ...
        result = add_class_tvars(t, isuper, is_classmethod, is_staticmethod, mx.self_type, original_vars=original_vars)
        if not mx.is_lvalue:
            result = analyze_descriptor_access(result, mx)
