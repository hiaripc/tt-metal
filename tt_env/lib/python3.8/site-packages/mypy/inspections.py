...
class InspectionEngine:
    ...
    def missing_type(self, expression: Expression) -> str:
        ...
        return f'No known type available for "{type(expression).__name__}"' f" (maybe unreachable{alt_suggestion})"

    def missing_node(self, expression: Expression) -> str:
        return f'Cannot find definition for "{type(expression).__name__}"' f" at {expr_span(expression)}"
