...
class TypesSuite(Suite):
    ...
    def test_tuple_type_upper(self) -> None:
        ...
        assert_equal(
            TupleType([self.x, AnyType(TypeOfAny.special_form)], self.fx.std_tuple).str_with_options(options),
            "Tuple[X?, Any]",
        )
    ...
    def test_generic_function_type(self) -> None:
        c = CallableType(
            ...
            self.function,
            name=None,
            variables=[TypeVarType("X", "X", -1, [], self.fx.o, AnyType(TypeOfAny.from_omitted_generics))],
        )
