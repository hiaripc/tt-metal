...
class Mapper:
    ...
    def type_to_rtype(self, typ: Type | None) -> RType:
        ...
        if isinstance(typ, Instance):
            ...
            if typ.partial_fallback.type.fullname == "builtins.tuple" and find_unpack_in_list(typ.items) is None:
    ...
    def fdef_to_sig(self, fdef: FuncDef) -> FuncSignature:
        if isinstance(fdef.type, CallableType):
            arg_types = [self.get_arg_rtype(typ, kind) for typ, kind in zip(fdef.type.arg_types, fdef.type.arg_kinds)]
        ...
        args = [
            ...
            for arg_name, arg_kind, arg_type, arg_pos_only in zip(arg_names, fdef.arg_kinds, arg_types, arg_pos_onlys)
        ]
