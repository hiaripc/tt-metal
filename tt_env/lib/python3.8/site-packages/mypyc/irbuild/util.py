...
def dataclass_decorator_type(d: Expression) -> str | None:
    ...
    elif isinstance(d, CallExpr) and isinstance(d.callee, RefExpr) and d.callee.fullname in DATACLASS_DECORATORS:
...
def get_mypyc_attr_call(d: Expression) -> CallExpr | None:
    ...
    if isinstance(d, CallExpr) and isinstance(d.callee, RefExpr) and d.callee.fullname == "mypy_extensions.mypyc_attr":
        return d
    return None
