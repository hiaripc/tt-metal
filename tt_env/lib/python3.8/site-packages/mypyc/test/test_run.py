...
class TestRun(MypycDataSuite):
    ...
    def run_case(self, testcase: DataDrivenTestCase) -> None:
        ...
        with use_custom_builtins(os.path.join(self.data_prefix, ICODE_GEN_BUILTINS), testcase), chdir_manager("tmp"):
    ...
    def run_case_step(self, testcase: DataDrivenTestCase, incremental_step: int) -> None:
        ...
        with open(setup_file, "w", encoding="utf-8") as f:
            f.write(setup_format.format(module_paths, separate, cfiles, self.multi_file, opt_level, debug_level))
        ...
        if not os.path.isfile(driver_path):
            ...
            default_driver = os.path.join(os.path.dirname(__file__), "..", "test-data", "driver", "driver.py")
