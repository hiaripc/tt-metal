...
def json_clean(obj: Any) -> Any:
    ...
    if isinstance(obj, container_to_list) or (hasattr(obj, "__iter__") and hasattr(obj, "__next__")):
        obj = list(obj)
    ...
    if isinstance(obj, dict):
        ...
        if nkeys != nkeys_collapsed:
            raise ValueError("dict cannot be safely converted to JSON: " "key collision would lead to dropped values")
