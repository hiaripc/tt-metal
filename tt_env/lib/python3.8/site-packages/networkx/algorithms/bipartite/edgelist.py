    ...
    for line in lines:
        ...
        if nodetype is not None:
            try:
                ...
                raise TypeError(f"Failed to convert nodes {u},{v} " f"to type {nodetype}.") from err
        ...
        if len(d) == 0 or data is False:
            ...
            try:  # try to evaluate as dictionary
                ...
                raise TypeError(f"Failed to convert edge data ({d})" f"to dictionary.") from err
        else:
            ...
            for (edge_key, edge_type), edge_value in zip(data, d):
                try:
                    ...
                    raise TypeError(f"Failed to convert {edge_key} data " f"{edge_value} to type {edge_type}.") from err
