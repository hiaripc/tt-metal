    ...
    try:
        ...
        try:
            ...
            if avail is None:
                ...
                assert n_nodes <= k, (
                    "unconstrained cases are only unfeasible if |V| <= k. " f"Got |V|={n_nodes} and k={k}"
                )
            else:
                ...
                assert max_aug_k < k, (
                    "avail should only be unfeasible if using all edges " "does not achieve k-edge-connectivity"
                )
