...
def _extrema_bounding(G, compute="diameter", weight=None):
    ...
    while candidates:
        ...
        if compute == "diameter":
            ...
            ruled_out = {
                i for i in candidates if ecc_upper[i] < maxlower and (maxlower == maxupper or ecc_lower[i] > maxupper)
            }
        elif compute == "center":
            ruled_out = {
                i
        ...
        for i in candidates:
            if (
                ...
                or (ecc_lower[i] == ecc_lower[minlowernode] and degrees[i] > degrees[minlowernode])
            ...
            if (
                ...
                or (ecc_upper[i] == ecc_upper[maxuppernode] and degrees[i] > degrees[maxuppernode])
    ...
    for v, dists in sp:
        if len(dists) < n:
            raise nx.NetworkXNoPath(
                f"Input graph {G} is disconnected, so every induced subgraph " "has infinite barycentricity."
            )
