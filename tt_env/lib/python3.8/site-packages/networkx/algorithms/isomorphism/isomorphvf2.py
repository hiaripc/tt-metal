            ...
            for neighbor in self.G1[G1_node]:
                if neighbor in self.core_1:
                    if self.core_1[neighbor] not in self.G2[G2_node]:
                        return False
                    elif self.G1.number_of_edges(neighbor, G1_node) != self.G2.number_of_edges(
        ...
        for neighbor in self.G2[G2_node]:
            if neighbor in self.core_2:
                if self.core_2[neighbor] not in self.G1[G1_node]:
                    ...
                    if self.G1.number_of_edges(self.core_2[neighbor], G1_node) < self.G2.number_of_edges(
                        neighbor, G2_node
                    ):
                        return False
                else:
            ...
            for predecessor in self.G1.pred[G1_node]:
                if predecessor in self.core_1:
                    if self.core_1[predecessor] not in self.G2.pred[G2_node]:
                        return False
                    elif self.G1.number_of_edges(predecessor, G1_node) != self.G2.number_of_edges(
                        self.core_1[predecessor], G2_node
                    ):
                        return False
        ...
        for predecessor in self.G2.pred[G2_node]:
            if predecessor in self.core_2:
                if self.core_2[predecessor] not in self.G1.pred[G1_node]:
                    ...
                    if self.G1.number_of_edges(self.core_2[predecessor], G1_node) < self.G2.number_of_edges(
                        predecessor, G2_node
                    ):
                        return False
                else:
            ...
            for successor in self.G1[G1_node]:
                if successor in self.core_1:
                    if self.core_1[successor] not in self.G2[G2_node]:
                        return False
                    elif self.G1.number_of_edges(G1_node, successor) != self.G2.number_of_edges(
                        G2_node, self.core_1[successor]
                    ):
                        return False
        ...
        for successor in self.G2[G2_node]:
            if successor in self.core_2:
                if self.core_2[successor] not in self.G1[G1_node]:
                    ...
                    if self.G1.number_of_edges(G1_node, self.core_2[successor]) < self.G2.number_of_edges(
                        G2_node, successor
                    ):
                        return False
                else:
