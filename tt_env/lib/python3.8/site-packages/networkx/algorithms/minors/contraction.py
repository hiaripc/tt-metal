...
def quotient_graph(
    ...
    *`Strongly connected component`_*.
    ...
    if callable(partition):
        ...
        return _quotient_graph(G, partition, edge_relation, node_data, edge_data, relabel, create_using)
...
def _quotient_graph(
    ...
    if H.is_multigraph():
        edges = chaini(
            ((b, c, G.get_edge_data(u, v, default={})) for u, v in product(b, c) if v in G[u])
