...
"""
    ...
    def test_preserve_multi_edge_data(self):
        ...
        Gadj = {
            str(node): {
                str(nbr): {str(ekey): dd for ekey, dd in key_dict.items()} for nbr, key_dict in nbr_dict.items()
            }
...
class TestWriteGraphML(BaseGraphML):
    ...
    def test_write_generate_edge_id_from_attribute(self):
        ...
        edge_ids = [
            edge.attrib["id"] for edge in tree.getroot().findall(".//{http://graphml.graphdrawing.org/xmlns}edge")
        ]
