...
def generate_network_text(graph, with_labels=True, sources=None, max_depth=None, ascii_only=False):
    ...
    if max_depth == 0:
        ...
        stack = [(None, node, [], (idx == last_idx)) for idx, node in enumerate(sources)][::-1]
