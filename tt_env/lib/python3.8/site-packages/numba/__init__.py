...
def _ensure_critical_deps():
    ...
    if PYVERSION < (3, 8):
        msg = "Numba needs Python 3.8 or greater. Got Python " f"{PYVERSION[0]}.{PYVERSION[1]}."
    ...
    if numpy_version < (1, 22):
        msg = f"Numba needs NumPy 1.22 or greater. Got NumPy " f"{numpy_version[0]}.{numpy_version[1]}."
        raise ImportError(msg)
    ...
    try:
        ...
        if sp_version < (1, 0):
            msg = "Numba requires SciPy version 1.0 or greater. Got SciPy " f"{scipy.__version__}."
            raise ImportError(msg)
...
from numba.core.decorators import cfunc, generated_jit, jit, njit, stencil, jit_module
