...
# base.
from numba.core.cpu_options import ParallelOptions, FastMathOptions, InlineOptions  # noqa F401  # noqa F401
...
class CPUContext(BaseContext):
    ...
    def load_additional_registries(self):
        ...
        from numba.np.random import (
            generator_core,  # noqa F401
            generator_methods,
        )  # noqa F401
    ...
    def get_generator_state(self, builder, genptr, return_type):
        ...
        return cgutils.pointer_add(
            builder, genptr, _dynfunc._impl_info["offsetof_generator_state"], return_type=return_type
        )
    ...
    def create_cpython_wrapper(self, library, fndesc, env, call_helper, release_gil=False):
        ...
        builder = PyCallWrapper(
            self, wrapper_module, wrapper_callee, fndesc, env, call_helper=call_helper, release_gil=release_gil
        )
        builder.build()
    ...
    def create_cfunc_wrapper(self, library, fndesc, env, call_helper):
        ...
        status, out = self.call_conv.call_function(
            builder, wrapper_callee, fndesc.restype, fndesc.argtypes, wrapfn.args, attrs=("noinline",)
        )
