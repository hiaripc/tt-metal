...
from numba.core.utils import chain_exception, use_old_style_errors, use_new_style_errors
...
def deprecated(arg):
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            if subst:
                msg += '\n Use "{}" instead.'
            warnings.warn(msg.format(func.__name__, subst), category=DeprecationWarning, stacklevel=2)
...
def new_error_context(fmt_, *args, **kwargs):
    ...
    try:
        ...
        if use_old_style_errors():
            ...
            msg = "Unknown CAPTURED_ERRORS style: " f"'{numba.core.config.CAPTURED_ERRORS}'."
            assert 0, msg
