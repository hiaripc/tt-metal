...
class PythonAPI(object):
    ...
    def set_next_entry(self, set, posptr, keyptr, hashptr):
        fnty = ir.FunctionType(
            ir.IntType(32),
            [self.pyobj, self.py_ssize_t.as_pointer(), self.pyobj.as_pointer(), self.py_hash_t.as_pointer()],
        )
    ...
    def nrt_adapt_ndarray_to_python(self, aryty, ary, dtypeptr):
        ...
        return self.builder.call(
            fn, [self.builder.bitcast(aryptr, self.voidptr), serial_aryty_pytype, ndim, writable, dtypeptr]
        )
    ...
    def from_native_generator(self, val, typ, env=None):
        ...
        *env* is an optional _dynfunc.Environment instance to be wrapped
        ...
        fnty = ir.FunctionType(
            self.pyobj,
            [self.py_ssize_t, self.voidptr, ir.PointerType(genfnty), ir.PointerType(finalizerty), self.voidptr],
        )
