...
class UnicodeIteratorModel(StructModel):
    def __init__(self, dmm, fe_type):
        members = [("index", types.EphemeralPointer(types.uintp)), ("data", fe_type.data)]
...
_unicode_is_upper = register_jitable(_is_upper(_PyUnicode_IsLowercase, _PyUnicode_IsUppercase, _PyUnicode_IsTitlecase))
