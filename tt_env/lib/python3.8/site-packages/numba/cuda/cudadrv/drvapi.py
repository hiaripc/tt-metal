...
API_PROTOTYPES = {
    ...
    #                               CUdevice dev);
    "cuDeviceGetAttribute": (c_int, POINTER(c_int), cu_device_attribute, cu_device),
    # CUresult cuDeviceComputeCapability(int *major, int *minor,
    #                                    CUdevice dev);
    "cuDeviceComputeCapability": (c_int, POINTER(c_int), POINTER(c_int), cu_device),
    # CUresult cuDevicePrimaryCtxGetState(
    #              CUdevice dev,
    #              unsigned int* flags,
    #              int* active)
    "cuDevicePrimaryCtxGetState": (c_int, cu_device, POINTER(c_uint), POINTER(c_int)),
    ...
    #                             void **optionValues);
    "cuModuleLoadDataEx": (c_int, cu_module, c_void_p, c_uint, POINTER(cu_jit_option), POINTER(c_void_p)),
    ...
    "cuModuleGetGlobal": (c_int, POINTER(cu_device_ptr), POINTER(c_size_t), cu_module, c_char_p),
    ...
    #                            size_t ByteCount, CUstream hStream);
    "cuMemcpyDtoDAsync": (c_int, cu_device_ptr, cu_device_ptr, c_size_t, cu_stream),
    ...
    #                                    void *        p,
    #                                    unsigned int  Flags)
    "cuMemHostGetDevicePointer": (c_int, POINTER(cu_device_ptr), c_void_p, c_uint),
    ...
    #                                        CUdeviceptr 	dptr
    #                                        )
    "cuMemGetAddressRange": (c_int, POINTER(cu_device_ptr), POINTER(c_size_t), cu_device_ptr),
    ...
    "cuLinkCreate": (c_int, c_uint, POINTER(cu_jit_option), POINTER(c_void_p), POINTER(cu_link_state)),
    #    CUresult
    ...
    "cuLinkComplete": (c_int, cu_link_state, POINTER(c_void_p), POINTER(c_size_t)),
    #    CUresult CUDAAPI
    ...
    #                              CUfunction hfunc )
    "cuFuncGetAttribute": (c_int, POINTER(c_int), cu_function_attribute, cu_function),
    ...
    #                      size_t dynamicSMemSize,
    #                      unsigned int flags);
    "cuOccupancyMaxActiveBlocksPerMultiprocessorWithFlags": (c_int, POINTER(c_int), cu_function, c_size_t, c_uint),
    ...
    #              unsigned int Flags)
    "cuIpcOpenMemHandle": (c_int, POINTER(cu_device_ptr), cu_ipc_mem_handle, c_uint),
