...
def llvm_replace(llvmir):
    replacements = [
        ...
        (
            ...
            ir_numba_atomic_minmax(T="float", Ti="i32", NAN="", OP="nnan olt", PTR_OR_VAL="ptr", FUNC="max"),
        ),
        (
            'declare double @"___numba_atomic_double_max"(double* %".1", double %".2")',  # noqa: E501
            ir_numba_atomic_minmax(T="double", Ti="i64", NAN="", OP="nnan olt", PTR_OR_VAL="ptr", FUNC="max"),
        ),
        (
            'declare float @"___numba_atomic_float_min"(float* %".1", float %".2")',  # noqa: E501
            ir_numba_atomic_minmax(T="float", Ti="i32", NAN="", OP="nnan ogt", PTR_OR_VAL="ptr", FUNC="min"),
        ),
        (
            'declare double @"___numba_atomic_double_min"(double* %".1", double %".2")',  # noqa: E501
            ir_numba_atomic_minmax(T="double", Ti="i64", NAN="", OP="nnan ogt", PTR_OR_VAL="ptr", FUNC="min"),
        ),
        (
            'declare float @"___numba_atomic_float_nanmax"(float* %".1", float %".2")',  # noqa: E501
            ir_numba_atomic_minmax(T="float", Ti="i32", NAN="nan", OP="ult", PTR_OR_VAL="", FUNC="max"),
        ),
        (
            'declare double @"___numba_atomic_double_nanmax"(double* %".1", double %".2")',  # noqa: E501
            ir_numba_atomic_minmax(T="double", Ti="i64", NAN="nan", OP="ult", PTR_OR_VAL="", FUNC="max"),
        ),
        (
            'declare float @"___numba_atomic_float_nanmin"(float* %".1", float %".2")',  # noqa: E501
            ir_numba_atomic_minmax(T="float", Ti="i32", NAN="nan", OP="ugt", PTR_OR_VAL="", FUNC="min"),
        ),
        (
            'declare double @"___numba_atomic_double_nanmin"(double* %".1", double %".2")',  # noqa: E501
            ir_numba_atomic_minmax(T="double", Ti="i64", NAN="nan", OP="ugt", PTR_OR_VAL="", FUNC="min"),
        ),
        ("immarg", ""),
    ]
