...
class _Kernel(serialize.ReduceMixin):
    ...
    def __init__(
        ...
        lib, kernel = tgt_ctx.prepare_cuda_kernel(
            cres.library, cres.fndesc, debug, lineinfo, nvvm_options, filename, linenum, max_registers
        )
    ...
    def launch(self, args, griddim, blockdim, stream=0, sharedmem=0):
        ...
        driver.launch_kernel(
            cufunc.handle, *griddim, *blockdim, sharedmem, stream_handle, kernelargs, cooperative=self.cooperative
        )
