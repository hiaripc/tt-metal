...
class SimulatedVectorType:
    ...
    def __init__(self, *args):
        ...
        if not self.num_elements == len(args_flattened):
            raise TypeError(f"{self.name} expects {self.num_elements}" f" elements, got {len(args_flattened)}")
...
def _initialize():
    ...
    for stub in _vector_type_stubs:
        ...
        _simulated_vector_types[stub.__name__] = make_simulated_vector_type(num_elements, stub.__name__)
