    ...
    def test_incompatible_highdim(self):
        ...
        self.assertIn(
            ...
            container=[
                ...
                "could not broadcast input array from shape (2,3) " "into shape (35,)",  # simulator, NP >= 1.20
            ],
        )
    ...
    def test_incompatible_shape(self):
        ...
        self.assertIn(
            ...
            container=[
                ...
                "could not broadcast input array from shape (2,) into " "shape (5,)",  # simulator, NP >= 1.20
            ],
        )
