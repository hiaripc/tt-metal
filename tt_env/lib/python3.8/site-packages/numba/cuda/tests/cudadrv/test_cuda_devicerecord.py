import numpy as np
import ctypes
from numba.cuda.cudadrv.devicearray import DeviceRecord, from_record_like, auto_device
...
recordtype = np.dtype([("a", np.float64), ("b", np.int32), ("c", np.complex64), ("d", (np.str_, N_CHARS))], align=True)
