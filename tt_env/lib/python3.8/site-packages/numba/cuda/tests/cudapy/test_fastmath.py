...
class TestFastMathOption(CUDATestCase):
    ...
    def test_cosf(self):
        self._test_fast_math_unary(
            cos, FastMathCriterion(fast_expected=["cos.approx.ftz.f32 "], prec_unexpected=["cos.approx.ftz.f32 "])
        )

    def test_sinf(self):
        self._test_fast_math_unary(
            sin, FastMathCriterion(fast_expected=["sin.approx.ftz.f32 "], prec_unexpected=["sin.approx.ftz.f32 "])
        )
    ...
    def test_tanf(self):
        self._test_fast_math_unary(
            tan,
            FastMathCriterion(
                fast_expected=["sin.approx.ftz.f32 ", "cos.approx.ftz.f32 ", "div.approx.ftz.f32 "],
    ...
    def test_tanhf(self):
        self._test_fast_math_unary(
            tanh, FastMathCriterion(fast_expected=["tanh.approx.f32 "], prec_unexpected=["tanh.approx.f32 "])
        )
    ...
    def test_tanhf_compile_ptx(self):
        ...
        tanh_common_test(
            cc=(7, 5),
            criterion=FastMathCriterion(fast_expected=["tanh.approx.f32 "], prec_unexpected=["tanh.approx.f32 "]),
        )

        tanh_common_test(
            cc=(7, 0),
            criterion=FastMathCriterion(
                fast_expected=["ex2.approx.ftz.f32 ", "rcp.approx.ftz.f32 "], prec_unexpected=["tanh.approx.f32 "]
            ),
        )

    def test_expf(self):
        self._test_fast_math_unary(
            exp, FastMathCriterion(fast_unexpected=["fma.rn.f32 "], prec_expected=["fma.rn.f32 "])
        )
    ...
    def test_log10f(self):
        ...
        self._test_fast_math_unary(
            log10,
            FastMathCriterion(
                fast_expected=["lg2.approx.ftz.f32 ", "0f3E9A209B"], prec_unexpected=["lg2.approx.ftz.f32 "]
            ),
        )

    def test_log2f(self):
        self._test_fast_math_unary(
            log2, FastMathCriterion(fast_expected=["lg2.approx.ftz.f32 "], prec_unexpected=["lg2.approx.ftz.f32 "])
        )
