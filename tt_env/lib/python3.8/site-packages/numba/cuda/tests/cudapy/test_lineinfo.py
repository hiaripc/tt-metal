...
class TestCudaLineInfo(CUDATestCase):
    ...
    def test_lineinfo_in_device_function(self):
        ...
        if not found:
            self.fail(f"No .loc directive with inlined_at info found" f"in:\n\n{ptx}")
        ...
        self.assertEqual(
            subprograms, expected_subprograms, f'"Expected {expected_subprograms} DISubprograms; ' f"got {subprograms}"
        )
