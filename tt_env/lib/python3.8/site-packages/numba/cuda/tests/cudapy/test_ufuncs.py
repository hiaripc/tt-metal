    ...
    def setUp(self):
        ...
        self.inputs.extend(
            [
                ...
                (np.complex128(0.5 + 0.5j), types.complex128),
                (np.array([-0.5 - 0.5j, 0.0, 0.5 + 0.5j], dtype="c8"), types.Array(types.complex64, 1, "C")),
                (np.array([-0.5 - 0.5j, 0.0, 0.5 + 0.5j], dtype="c16"), types.Array(types.complex128, 1, "C")),
            ]
        )
        ...
        self.inputs.extend(
            [
                ...
                (np.linspace(0, 1).reshape((5, -1)), types.Array(types.float64, 2, "C")),
                (np.linspace(0, 1).reshape((2, 5, -1)), types.Array(types.float64, 3, "C")),
                # Complex data (i.e. interleaved)
                (np.linspace(0, 1 + 1j).reshape(5, -1), types.Array(types.complex128, 2, "C")),
                # F-ordered
                (np.asfortranarray(np.linspace(0, 1).reshape((5, -1))), types.Array(types.float64, 2, "F")),
            ]
        )
        ...
        self.inputs.extend(
            [
                ...
                (np.array([0, 1], dtype=np.ulonglong), types.Array(types.ulonglong, 1, "C")),
                (np.array([0, 1], dtype=np.longlong), types.Array(types.longlong, 1, "C")),
            ]
        )
