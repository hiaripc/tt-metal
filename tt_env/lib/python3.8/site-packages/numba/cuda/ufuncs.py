...
from numba.cuda.mathimpl import get_unary_impl_for_fn_and_ty, get_binary_impl_for_fn_and_ty
...
def ufunc_db():
    ...
    if numpy_version >= (1, 25):
        db[np.greater].update(
            {"qQ->?": numbers.int_signed_unsigned_cmp(">"), "Qq->?": numbers.int_unsigned_signed_cmp(">")}
        )
