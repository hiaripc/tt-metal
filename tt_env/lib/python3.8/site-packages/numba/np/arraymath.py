    ...
    def codegen(cgctx, builder, signature, args):
        ...
        for i in range(nd):
            ...
            data = cgctx.compile_internal(
                builder, array_indexer, types.intp(shape_list, types.intp), [in_shape, dataidx]
            )
...
def ov_np_angle(z, deg=False):
    ...
    if isinstance(z, types.Number):
        ...
        raise NumbaTypeError('Argument "z" must be a complex ' f"or Array[complex]. Got {z}")
...
def _gen_np_machar():
    ...
    with warnings.catch_warnings(record=True) as w:
        ...
        warnings.filterwarnings("always", message=msg, category=DeprecationWarning, module=r".*numba.*arraymath")
        np_MachAr = np.MachAr
