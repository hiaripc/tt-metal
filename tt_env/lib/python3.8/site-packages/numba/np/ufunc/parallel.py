...
def build_gufunc_kernel(library, ctx, info, sig, inner_ndim):
    ...
    fnty = ir.FunctionType(
        ir.VoidType(), [ir.PointerType(byte_ptr_t), ir.PointerType(intp_t), ir.PointerType(intp_t), byte_ptr_t]
    )
    ...
    get_num_threads = cgutils.get_or_insert_function(
        builder.module, ir.FunctionType(ir.IntType(types.intp.bitwidth), []), "get_num_threads"
    )
