...
_options_mixin = include_default_options(
    "nopython", "forceobj", "boundscheck", "fastmath", "target_backend", "writable_args"
)
...
def _get_transform_arg(py_func):
    ...
    def transform_arg(arg):
        ...
        try:
            ...
            msg = f"Specified writable arg {arg} not found in arg list " f"{args} for function {py_func.__qualname__}"
