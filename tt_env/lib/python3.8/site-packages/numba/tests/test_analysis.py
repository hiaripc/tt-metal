...
from numba.tests.support import TestCase, MemoryLeakMixin, SerialMixin, IRPreservingTestPipeline
from numba.core.analysis import dead_branch_prune, rewrite_semantic_constants
from numba.core.untyped_passes import ReconstructSSA, TranslateByteCode, IRProcessing, DeadBranchPrune, PreserveIR
...
class TestBranchPrune(TestBranchPruneBase, SerialMixin):
    ...
    def test_redefinition_analysis_different_block_cannot_exec(self):
        ...
        self.assert_prune(
            impl,
            (types.Array(types.float64, 2, "C"), types.NoneType("none"), types.NoneType("none")),
            [True, None],
            np.zeros((2, 3)),
            None,
            None,
...
class TestBranchPrunePostSemanticConstRewrites(TestBranchPruneBase):
    ...
    def test_tuple_len(self):
        ...
        self.assert_prune(impl, (types.UniTuple(types.int64, 3),), [False, None], tuple([1, 2, 3]))
        self.assert_prune(impl, (types.UniTuple(types.int64, 2),), [True, "both"], tuple([1, 2]))
    ...
    def test_ndim_not_on_array(self):
        ...
        self.assert_prune(impl, (FakeArrayType,), [None], fa, flags=enable_pyobj_flags)
