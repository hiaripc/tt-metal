...
from numba.tests.support import TestCase, tag, skip_parfors_unsupported, skip_unless_scipy
...
from numba.core.typed_passes import NopythonTypeInference, AnnotateTypes, NopythonRewrites, IRLegalization
...
class ArrayAnalysisTester(Compiler):
    @classmethod
    def mk_pipeline(
        cls, args, return_type=None, flags=None, locals={}, library=None, typing_context=None, target_context=None
    ):
        if not flags:
            flags = Flags()
        flags.nrt = True
...
class TestArrayAnalysis(TestCase):
    ...
    def test_base_cases(self):
        ...
        self._compile_and_test(
            test_0, (), equivs=[self.with_equiv("a", (0,)), self.with_equiv("b", (1,)), self.with_equiv("c", (0, 1))]
        )
        ...
        self._compile_and_test(
            test_6, (types.intp, types.intp), asserts=[self.with_assert("a", "b"), self.without_assert("d", "e")]
        )
        ...
        self._compile_and_test(
            test_7, (types.intp, types.intp), asserts=[self.with_assert("a", "b"), self.without_assert("d", "a")]
        )
        ...
        self._compile_and_test(
            test_8, (types.intp, types.intp), asserts=[self.with_assert("b", "a"), self.with_assert("b", "d")]
        )
        ...
        self._compile_and_test(
            ...
            asserts=[self.with_assert("A", "B"), self.without_assert("C", "D")],
        )
    ...
    def test_stencilcall(self):
        ...
        self._compile_and_test(
            test_1, (types.intp,), equivs=[self.with_equiv("a", "b")], asserts=[self.without_assert("a", "b")]
        )
        ...
        self._compile_and_test(
            test_3,
            (types.intp,),
            equivs=[self.with_equiv("a", "b", "v"), self.without_equiv("a", "u")],
    ...
    def test_slice(self):
        ...
        self._compile_and_test(
            test_2,
            (types.intp,),
            asserts=[self.without_assert("B", "C"), self.without_assert("D", "E")],
            idempotent=False,
        )
        ...
        self._compile_and_test(
            ...
            asserts=[self.without_assert("B", "A"), self.with_assert("C", "D"), self.with_assert("B", "C")],
            idempotent=False,
        )
    ...
    def test_numpy_calls(self):
        ...
        self._compile_and_test(
            test_zeros,
            (types.intp,),
            equivs=[self.with_equiv("a", "n"), self.with_equiv("b", ("n", "n")), self.with_equiv("b", "c")],
        )
        ...
        self._compile_and_test(
            test_0d_array, (types.intp,), equivs=[self.without_equiv("a", "b")], asserts=[self.without_shapecall("a")]
        )
        ...
        self._compile_and_test(
            test_diag,
            (types.intp,),
            equivs=[self.with_equiv("b", ("n",)), self.with_equiv("c", ("n", "n"))],
            asserts=[self.with_shapecall("d"), self.without_shapecall("c")],
        )
        ...
        self._compile_and_test(
            ...
            asserts=[self.with_shapecall("a"), self.without_shapecall("b")],
        )
        ...
        self._compile_and_test(
            ...
            equivs=[self.with_equiv("a", (50,)), self.with_equiv("b", (10,))],
        )
        ...
        self._compile_and_test(
            ...
            (types.intp, types.intp, types.intp),
            equivs=[
                self.without_equiv("a", (1,)),  # not array
                self.with_equiv("b", (3,)),
                self.with_equiv("e", (1,)),
        ...
        self._compile_and_test(
            test_broadcast, (types.intp, types.intp), equivs=[self.with_equiv("a", "c", "e")], asserts=None
        )
