...
class TestArrayExpressions(MemoryLeakMixin, TestCase):
    ...
    def test_trivial_expr(self):
        ...
        self._assert_total_rewrite(
            ns.control_pipeline.state.func_ir.blocks, ns.test_pipeline.state.func_ir.blocks, trivial=True
        )
    ...
    def test_ufunc_and_dufunc_calls(self):
        ...
        control_pipeline = RewritesTester.mk_no_rw_pipeline(
            arg_tys, typing_context=vaxy_descr.typing_context, target_context=vaxy_descr.target_context
        )
