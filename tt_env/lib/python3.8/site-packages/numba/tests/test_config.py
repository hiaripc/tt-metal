...
from numba.tests.support import TestCase, temp_directory, override_env_config, run_in_subprocess
...
class TestConfig(TestCase):
    ...
    def test_illegal_error_style_handling(self):
        ...
        expected = (
            "Environment variable 'NUMBA_CAPTURED_ERRORS' is defined "
            "but its associated value 'not_a_known_style' could not "
            "be parsed."
        )
        err_msg = err.decode("utf-8")
        self.assertIn(expected, err_msg)
        ex_expected = "The parse failed with exception: Invalid style in " "NUMBA_CAPTURED_ERRORS: not_a_known_style"
