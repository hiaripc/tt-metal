...
class TestConversion(TestCase):
    ...
    def test_complex_identity(self):
        pyfunc = identity
        cres = compile_isolated(pyfunc, [types.complex64], return_type=types.complex64)
        ...
        cres = compile_isolated(pyfunc, [types.complex128], return_type=types.complex128)
    ...
    def test_complex_addition(self):
        pyfunc = addition
        cres = compile_isolated(pyfunc, [types.complex64, types.complex64], return_type=types.complex64)
        ...
        cres = compile_isolated(pyfunc, [types.complex128, types.complex128], return_type=types.complex128)
    ...
    def test_multiple_args_negative_to_unsigned(self):
        pyfunc = foobar
        cres = compile_isolated(pyfunc, [types.uint64, types.uint64, types.uint64], return_type=types.uint64)
        cfunc = cres.entry_point
    ...
    def test_multiple_args_records(self):
        ...
        cres = compile_isolated(pyfunc, [mystruct[:], types.uint64, types.uint64], return_type=mystruct[:])
        cfunc = cres.entry_point
