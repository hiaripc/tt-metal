...
class TestParforsDebug(TestCase):
    ...
    def test_warns(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            cres = compile_isolated(unsupported_parfor, (arr_ty, arr_ty), flags=force_parallel_flags)
    ...
    def test_array_debug_opt_stats(self):
        ...
        # indices.
        cres = compile_isolated(supported_parfor, (types.int64,), flags=force_parallel_flags)
        ...
        with override_env_config("NUMBA_DEBUG_ARRAY_OPT_STATS", "1"):
            ...
            parfor_state = int(re.compile(r"#([0-9]+)").search(parallel_loop_output[0]).group(1))
