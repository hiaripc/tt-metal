...
class TestDebugInfoEmission(TestCase):
    ...
    def test_arrays(self):
        ...
        ptr_re = r"!DIDerivedType\(tag: DW_TAG_pointer_type, " rf"baseType: ![0-9]+, size: {ptr_size}\)"
        int_re = rf'!DIBasicType\(name: "int{ptr_size}", size: {ptr_size}, ' r"encoding: DW_ATE_signed\)"
        utuple_re = (
