...
class TestDeprecation(TestCase):
    ...
    def test_jitfallback(self):
        ...
        with _catch_numba_deprecation_warnings() as w:
            ...
            warnings.filterwarnings(
                "ignore",
                message=(r".*The 'nopython' keyword " r"argument was not supplied.*"),
            ...
            msg = "Fall-back from the nopython compilation path to the object " "mode compilation path"
    ...
    def test_generated_jit(self):
        with _catch_numba_deprecation_warnings() as w:
            ...
            self.check_warning(w, "numba.generated_jit is deprecated", NumbaDeprecationWarning)
