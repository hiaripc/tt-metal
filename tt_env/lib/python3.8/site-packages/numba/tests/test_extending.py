...
@overload_method(MyDummyType, "method_jit_option_check_no_nrt", jit_options={"_nrt": False})
...
@overload_attribute(MyDummyType, "attr_jit_option_check_nrt", jit_options={"_nrt": True})
...
@overload_attribute(MyDummyType, "attr_jit_option_check_no_nrt", jit_options={"_nrt": False})
