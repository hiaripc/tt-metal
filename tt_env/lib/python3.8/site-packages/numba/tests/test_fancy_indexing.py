...
class TestFancyIndexingMultiDim(MemoryLeakMixin, TestCase):
    ...
    def test_unsupported_condition_exceptions(self):
        err_idx_cases = [
            ...
            ("Multi-dimensional indices are not supported.", (0, 3, np.array([[1, 2], [2, 3]]))),
            # Cases with more than one indexing array
            ("Using more than one non-scalar array index is unsupported.", (0, 3, np.array([1, 2]), np.array([1, 2]))),
