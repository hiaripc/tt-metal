...
class TestCFGraph(TestCase):
    ...
    def test_topo_order(self):
        ...
        self.assertIn(
            g.topo_order(),
            ([0, 6, 10, 13, 19, 26], [0, 6, 10, 13, 26, 19], [0, 10, 13, 19, 26, 6], [0, 10, 13, 26, 19, 6]),
        )
    ...
    def test_dominator_tree(self):
        ...
        check(
            self.multiple_exits(),
            {0: {7}, 7: {10, 36, 37}, 36: set(), 10: {19, 23}, 23: {29}, 29: set(), 37: set(), 19: set()},
        )
    ...
    def test_dominance_frontier(self):
        ...
        check(
            self.multiple_exits(),
            {0: set(), 7: {7}, 10: {37, 7}, 19: set(), 23: {37, 7}, 29: {37}, 36: {37}, 37: set()},
        )
