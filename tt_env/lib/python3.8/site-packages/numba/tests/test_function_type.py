        ...
        class LibM(types.WrapperAddressProtocol):
            def __init__(self, fname):
                ...
                if fname == "cos":
                    ...
                    raise NotImplementedError(f"wrapper address of `{fname}`" f" with signature `{signature}`")
...
class TestMiscIssues(TestCase):
    ...
    def test_issue_5540(self):
        ...
        self.assertRegex(str(cm.exception), r".*first-class function call cannot use keyword arguments")
