...
from numba.tests.support import TestCase, MemoryLeakMixin, skip_parfors_unsupported, captured_stdout
from numba import njit, typed, literal_unroll, prange
from numba.core import types, errors, ir
from numba.testing import unittest
from numba.core.extending import overload
from numba.core.compiler_machinery import PassManager, register_pass, FunctionPass, AnalysisPass
...
class TestMore(TestCase):
    ...
    def test_non_constant_list(self):
        ...
        with self.assertRaises(errors.UnsupportedError) as raises:
            foo(10)
        self.assertIn(
            ("Found non-constant value at position 1 in a list argument to " "literal_unroll"), str(raises.exception)
        )
