...
class TestTimedeltaArithmeticNoPython(TestTimedeltaArithmetic):
    ...
    def test_int_cast(self):
        ...
        with self.assertRaises(
            TypingError, msg=("Only datetime64[ns] can be " + "converted, but got " + "datetime64[y]")
        ):
            f(DT("2014"))
    ...
    def silence_numpy_warnings(self):
        ...
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore", message="Implicitly casting between incompatible kinds", category=DeprecationWarning
            )
            yield
