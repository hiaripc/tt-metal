...
from numba.tests.support import TestCase, tag, needs_lapack, EnableNRTStatsMixin, MemoryLeakMixin
    ...
    def test_roots(self):
        ...
        def check(a, **kwargs):
            ...
            np.testing.assert_allclose(
                expected, got, rtol=10 * resolution, atol=100 * resolution  # zeros tend to be fuzzy
            )
