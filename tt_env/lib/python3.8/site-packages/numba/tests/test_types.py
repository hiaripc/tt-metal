...
from numba.core.extending import overload, register_model, models, unbox, NativeValue, typeof_impl
...
class TestTypes(TestCase):
    def test_equality(self):
        ...
        a = types.ExternalFunctionPointer(sig=sig_a, get_pointer=get_pointer)
        b = types.ExternalFunctionPointer(sig=sig_a, get_pointer=get_pointer, cconv="stdcall")
        self.assertNotEqual(a, b)
...
"""
    ...
    def test_mixin_against_real_example(self):
        ...
        with create_temp_module(self.source_lines) as test_module:
            ...
            self.assertEqual(("RAN CUSTOM EQ OVERLOAD", "RAN CUSTOM NE OVERLOAD"), f(Foo()))
...
class TestIssues(TestCase):
    ...
    def test_issue_list_type_key(self):
        ...
        for ty1 in (no_unique_name_type_1, no_unique_name_type_2):
            for ty2 in (no_unique_name_type_1, no_unique_name_type_2):
                self.assertIs(types.ListType(ty1) == types.ListType(ty2), ty1 == ty2)  # noqa: E721
