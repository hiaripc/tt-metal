...
class TestUsecases(TestCase):
    ...
    def test_sum1d_pyobj(self):
        pyfunc = usecases.sum1d
        cr = compile_isolated(pyfunc, (types.int32, types.int32), flags=force_pyobj_flags)
        cfunc = cr.entry_point
        ...
        print(utils.benchmark(bm_python, maxsec=0.1))
        print(utils.benchmark(bm_numba, maxsec=0.1))
    ...
    def test_string_concat(self):
        ...
        cr = compile_isolated(pyfunc, (types.int32, types.int32), flags=enable_pyobj_flags)
        cfunc = cr.entry_point
    ...
    def test_string_len(self):
        ...
        cr = compile_isolated(pyfunc, (types.pyobject,), flags=enable_pyobj_flags)
        cfunc = cr.entry_point
    ...
    def test_string_slicing(self):
        ...
        cr = compile_isolated(pyfunc, (types.pyobject,) * 3, flags=enable_pyobj_flags)
        cfunc = cr.entry_point
    ...
    def test_string_conversion(self):
        ...
        cr = compile_isolated(pyfunc, (types.int32,), flags=enable_pyobj_flags)
        cfunc = cr.entry_point
        self.assertEqual(pyfunc(1), cfunc(1))

        cr = compile_isolated(pyfunc, (types.float32,), flags=enable_pyobj_flags)
        cfunc = cr.entry_point
    ...
    def test_string_comparisons(self):
        ...
        cr = compile_isolated(pyfunc, (types.pyobject, types.pyobject, types.pyobject), flags=enable_pyobj_flags)
        cfunc = cr.entry_point
