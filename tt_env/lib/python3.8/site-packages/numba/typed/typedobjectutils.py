...
def _get_incref_decref(context, module, datamodel, container_element_type):
    ...
    incref_fn = cgutils.get_or_insert_function(
        module,
        refct_fnty,
        ".numba_{}.{}_incref".format(context.fndesc.mangled_name, container_element_type),
    )
    ...
    decref_fn = cgutils.get_or_insert_function(
        module,
        refct_fnty,
        name=".numba_{}.{}_decref".format(context.fndesc.mangled_name, container_element_type),
    )
...
def _get_equal(context, module, datamodel, container_element_type):
    ...
    wrapfn = cgutils.get_or_insert_function(
        module, wrapfnty, name=".numba_{}.{}_equal.wrap".format(context.fndesc.mangled_name, container_element_type)
    )
    ...
    equal_fn = cgutils.get_or_insert_function(
        module,
        equal_fnty,
        name=".numba_{}.{}_equal".format(context.fndesc.mangled_name, container_element_type),
    )
