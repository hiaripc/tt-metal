...
def verify_matching_signatures(implementation, dispatcher):
    ...
    if (
        ...
        raise RuntimeError(
            "implementation and dispatcher for %s have " "different function signatures" % implementation
        )
...
def array_function_from_dispatcher(implementation, module=None, verify=True, docs_from_dispatcher=True):
    ...
    def decorator(dispatcher):
        return array_function_dispatch(dispatcher, module, verify=verify, docs_from_dispatcher=docs_from_dispatcher)(
            implementation
        )
