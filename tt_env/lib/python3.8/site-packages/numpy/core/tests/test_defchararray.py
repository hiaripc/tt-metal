...
from numpy.testing import assert_, assert_equal, assert_array_equal, assert_raises, assert_raises_regex
...
class TestComparisonsMixed1(TestComparisons):
    ...
    def setup_method(self):
        ...
        self.B = np.array([["efg", "123  "], ["051", "tuv"]], np.unicode_).view(np.chararray)
...
class TestComparisonsMixed2(TestComparisons):
    ...
    def setup_method(self):
        TestComparisons.setup_method(self)
        self.A = np.array([["abc", "123"], ["789", "xyz"]], np.unicode_).view(np.chararray)


class TestInformation:
    def setup_method(self):
        self.A = np.array([[" abc ", ""], ["12345", "MixedCase"], ["123 \t 345 \0 ", "UPPER"]]).view(np.chararray)
...
class TestMethods:
    def setup_method(self):
        self.A = np.array([[" abc ", ""], ["12345", "MixedCase"], ["123 \t 345 \0 ", "UPPER"]], dtype="S").view(
            np.chararray
        )
        self.B = np.array([[" \u03a3 ", ""], ["12345", "MixedCase"], ["123 \t 345 \0 ", "UPPER"]]).view(np.chararray)
    ...
    def test_join(self):
        ...
        assert_(issubclass(A.dtype.type, np.unicode_))
        tgt = np.array(
            [[" ,a,b,c, ", ""], ["1,2,3,4,5", "M#i#x#e#d#C#a#s#e"], ["1,2,3, ,\t, ,3,4,5, ,\x00, ", "U#P#P#E#R"]]
        )
...
class TestOperations:
    ...
    def test_mul(self):
        ...
        for r in (2, 3, 5, 7, 197):
            Ar = np.array([[A[0, 0] * r, A[0, 1] * r], [A[1, 0] * r, A[1, 1] * r]]).view(np.chararray)
    ...
    def test_slice(self):
        ...
        arr = np.array([["abc ", "def "], ["geh ", "ijk "]], dtype="S4").view(np.chararray)
        sl1 = arr[:]
