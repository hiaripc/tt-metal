...
class TestHalf:
    def setup_method(self):
        ...
        self.nonan_f16 = np.concatenate(
            (np.arange(0xFC00, 0x7FFF, -1, dtype=uint16), np.arange(0x0000, 0x7C01, 1, dtype=uint16))
        )
    ...
    def test_half_conversions(self):
        ...
        assert_equal(self.all_f16.view(dtype=uint16), b.view(dtype=uint16))
    ...
    def test_half_correctness(self):
        ...
        if len(a32_fail) != 0:
            ...
            assert_equal(
                ...
                % (self.finite_f16[bad_index], self.finite_f32[bad_index], a_manual[bad_index]),
            )
        ...
        if len(a64_fail) != 0:
            ...
            assert_equal(
                ...
                a_manual,
                "First non-equal is half value %x -> %g != %g"
                % (self.finite_f16[bad_index], self.finite_f64[bad_index], a_manual[bad_index]),
            )
