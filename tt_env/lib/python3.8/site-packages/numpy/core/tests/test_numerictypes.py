...
class ReadValuesNested:
    ...
    def test_nested2_acessors(self):
        ...
        if not self.multiple_rows:
            ...
            assert_equal(
                h["Info"]["Info2"]["value"], np.array([self._buffer[0][1][2][1], self._buffer[1][1][2][1]], dtype="c16")
            )
            assert_equal(
                h["Info"]["Info2"]["z3"], np.array([self._buffer[0][1][2][3], self._buffer[1][1][2][3]], dtype="u4")
            )
