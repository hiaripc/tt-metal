...
class TestNDArrayArrayFunction:
    ...
    def test_method(self):
        ...
        result = array.__array_function__(
            func=dispatched_two_arg, types=(np.ndarray, Other), args=(array, other), kwargs={}
        )
        assert_(result is NotImplemented)

        result = array.__array_function__(
            func=dispatched_two_arg, types=(np.ndarray, NoOverrideSub), args=(array, no_override_sub), kwargs={}
        )
        assert_equal(result, "original")

        result = array.__array_function__(
            func=dispatched_two_arg, types=(np.ndarray, OverrideSub), args=(array, override_sub), kwargs={}
        )
        assert_equal(result, "original")
...
class TestArrayLike:
    ...
    _array_tests = [
        ...
        ("genfromtxt", *func_args(lambda: StringIO("1,2.1"), dtype=[("int", "i8"), ("float", "f8")], delimiter=",")),
    ]
