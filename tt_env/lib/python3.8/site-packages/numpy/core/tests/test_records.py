...
class TestFromrecords:
    ...
    def test_method_array2(self):
        r = np.rec.array(
            [(1, 11, "a"), (2, 22, "b"), (3, 33, "c"), (4, 44, "d"), (5, 55, "ex"), (6, 66, "f"), (7, 77, "g")],
            formats="u1,f4,a1",
        )
    ...
    def test_recarray_from_names(self):
        ra = np.rec.array(
            [(1, "abc", 3.7000002861022949, 0), (2, "xy", 6.6999998092651367, 1), (0, " ", 0.40000000596046448, 0)],
            names="c1, c2, c3, c4",
        )
    ...
    def test_recarray_returntypes(self):
        ...
        a = np.rec.array(
            [("abc ", (1, 1), 1, ("abcde", "fgehi")), ("abc", (2, 3), 1, ("abcde", "jklmn"))],
            dtype=[("foo", "S4"), ("bar", [("A", int), ("B", int)]), ("baz", int), ("qux", qux_fields)],
        )
...
class TestRecord:
    def setup_method(self):
        self.data = np.rec.fromrecords(
            [(1, 2, 3), (4, 5, 6)], dtype=[("col1", "<i4"), ("col2", "<i4"), ("col3", "<i4")]
        )
