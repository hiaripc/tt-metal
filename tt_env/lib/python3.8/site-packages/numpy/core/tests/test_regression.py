...
class TestRegression:
    ...
    def test_mem_dtype_align(self):
        # Ticket #93
        assert_raises(TypeError, np.dtype, {"names": ["a"], "formats": ["foo"]}, align=1)
    ...
    @pytest.mark.parametrize(
        "index", [np.ones(10, dtype=bool), np.arange(10)], ids=["boolean-arr-index", "integer-arr-index"]
    )
    ...
    def test_compress_small_type(self):
        ...
        try:
            ...
            raise AssertionError(
                "compress with an out which cannot be " "safely casted should not return " "successfully"
            )
        except TypeError:
            pass
    ...
    def test_pickle_empty_string(self):
        ...
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
            ...
            assert_equal(pickle.loads(pickle.dumps(test_string, protocol=proto)), test_string)
