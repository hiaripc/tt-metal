...
from numpy.core.shape_base import _block_dispatcher, _block_setup, _block_concatenate, _block_slicing
...
def test_stack():
    ...
    assert_raises_regex(ValueError, "must have the same shape", stack, [np.arange(3), 1])
    assert_raises_regex(ValueError, "must have the same shape", stack, [np.arange(3), 1], axis=1)
    assert_raises_regex(ValueError, "must have the same shape", stack, [np.zeros((3, 3)), np.zeros(3)], axis=1)
    assert_raises_regex(ValueError, "must have the same shape", stack, [np.arange(2), np.arange(3)])
...
class TestBlock:
    ...
    def test_3d(self, block):
        ...
        expected = array(
            [
                [[1, 1, 4, 4, 4], [1, 1, 4, 4, 4], [3, 3, 5, 5, 5], [3, 3, 5, 5, 5], [3, 3, 5, 5, 5]],
                [[1, 1, 4, 4, 4], [1, 1, 4, 4, 4], [3, 3, 5, 5, 5], [3, 3, 5, 5, 5], [3, 3, 5, 5, 5]],
                [[2, 2, 6, 6, 6], [2, 2, 6, 6, 6], [7, 7, 8, 8, 8], [7, 7, 8, 8, 8], [7, 7, 8, 8, 8]],
                [[2, 2, 6, 6, 6], [2, 2, 6, 6, 6], [7, 7, 8, 8, 8], [7, 7, 8, 8, 8], [7, 7, 8, 8, 8]],
                [[2, 2, 6, 6, 6], [2, 2, 6, 6, 6], [7, 7, 8, 8, 8], [7, 7, 8, 8, 8], [7, 7, 8, 8, 8]],
            ]
        )
    ...
    def test_invalid_nesting(self, block):
        ...
        assert_raises_regex(ValueError, msg, block, [[[1], [2]], [[3, 4]], [5]])  # missing brackets
