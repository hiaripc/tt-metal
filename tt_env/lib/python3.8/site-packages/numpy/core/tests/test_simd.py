...
class _SIMD_FP(_Test_Utility):
    ...
    @pytest.mark.parametrize(
        "intrin, func", [("ceil", math.ceil), ("trunc", math.trunc), ("floor", math.floor), ("rint", round)]
    )
    def test_rounding(self, intrin, func):
        ...
        # test large numbers
        for i in (1.1529215045988576e18, 4.6116860183954304e18, 5.902958103546122e20, 2.3611832414184488e21):
            x = self.setall(i)
            y = intrin(x)
