...
class build(old_build):
    ...
    user_options = old_build.user_options + [
        ...
        ("simd-test=", None, "specify a list of CPU optimizations to be tested against NumPy SIMD interface"),
    ]
    ...
    def initialize_options(self):
        ...
        """
        self.simd_test = (
            "BASELINE SSE2 SSE42 XOP FMA4 (FMA3 AVX2) AVX512F " "AVX512_SKX VSX VSX2 VSX3 VSX4 NEON ASIMD VX VXE VXE2"
        )
