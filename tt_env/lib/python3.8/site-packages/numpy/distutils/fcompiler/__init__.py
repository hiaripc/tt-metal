...
_default_compilers = (
    ...
    ("win32", ("gnu", "intelv", "absoft", "compaqv", "intelev", "gnu95", "g95", "intelvem", "intelem", "flang")),
...
def get_default_fcompiler(osname=None, platform=None, requiref90=False, c_compiler=None):
    ...
    compiler_type = _find_existing_fcompiler(
        matching_compiler_types, osname=osname, platform=platform, requiref90=requiref90, c_compiler=c_compiler
    )
    return compiler_type
