...
#endif
""",
        "need": ["#ctype#_from_pyobj", {debugcapi: "CFUNCSMESS"}, "string.h", "GETSCALARFROMPYTUPLE", "#ctype#"],
...
cb_arg_rules = [
    ...
    {  # Scalars
        ...
        "error": {
            l_and(isintent_c, isintent_out, throw_error("intent(c,out) is forbidden for callback scalar arguments")): ""
        },
        "frompyobj": [
        ...
        "need": [{isintent_out: ["#ctype#_from_pyobj", "GETSCALARFROMPYTUPLE"]}, {debugcapi: "CFUNCSMESS"}],
        "_check": isscalar,
    },
    {
        "pyobjfrom": [
    ...
    if (cb->nofargs>capi_i) {
        ...
        "need": [{isintent_in: "pyobj_from_#ctype#1size"}, {isintent_inout: "pyarr_from_p_#ctype#1"}],
