...
rout_rules = [
    ...
    {  # Subroutine
        ...
        "routine_def": {
            l_not(l_or(ismoduleroutine, isintent_c, isdummyroutine)): '    {"#name#",-1,{{-1}},0,0,(char *)'
    ...
    {  # Wrapped function
        ...
        "routine_def": {
            ...
            "  (f2py_init_func)#apiname#,doc_#apiname#},",
            isdummyroutine: '    {"#name#",-1,{{-1}},0,0,NULL,' "  (f2py_init_func)#apiname#,doc_#apiname#},",
        },
        "initf2pywraphook": {
            l_not(
                l_or(ismoduleroutine, isdummyroutine)
    ...
    {  # Function
        ...
        "latexdocstrout": ["\\item[]{{}\\verb@#pydocsignout#@{}}", {hasresultnote: "--- #resultnote#"}],
        "callfortranroutine": [
            {
                l_and(
...
arg_rules = [
    ...
    # Doc signatures
    {
        ...
        "latexdocstropt": {
            l_and(isoptional, isintent_nothide): ["\\item[]{{}\\verb@#pydocsign#@{}}", {hasnote: "--- #note#"}]
        },
        "latexdocstrreq": {
            l_and(isrequired, isintent_nothide): ["\\item[]{{}\\verb@#pydocsign#@{}}", {hasnote: "--- #note#"}]
        },
        "latexdocstrout": {
            isintent_out: [
    ...
    {"kwlist": '"#varname#",', "docsign": "#varname#,", "_check": l_and(isintent_nothide, l_not(isoptional))},
    {
        "kwlistopt": '"#varname#",',
...
""",
    ...
    if (f2py_success) {"""
        ...
        "closepyobjfrom": {isintent_inout: "    } /*if (f2py_success) of #varname# pyobjfrom*/"},
        "need": {isintent_inout: "try_pyarr_from_#ctype#", l_and(isintent_inout, l_not(isintent_c)): "STRINGPADN"},
    ...
    {"need": [{hasinitvalue: "forcomb"}, {hasinitvalue: "CFUNCSMESS"}], "_check": isarray, "_depend": ""},
    {  # Not hidden
        "decl": "    PyObject *#varname#_capi = Py_None;",
        "argformat": {isrequired: "O"},
        "keyformat": {isoptional: "O"},
...
def buildapi(rout):
    ...
    rd["docsignature"] = stripcomma(
        replace(
            ...
            {"docsign": rd["docsign"], "docsignopt": rd["docsignopt"], "docsignxa": rd["docsignxa"]},
        )
    )
    optargs = stripcomma(
        replace("#docsignopt##docsignxa#", {"docsignxa": rd["docsignxashort"], "docsignopt": rd["docsignoptshort"]})
    )
    if optargs == "":
    ...
    for k in ["docstrreq", "docstropt", "docstrout", "docstrcbs"]:
        ...
        if k in rd and isinstance(rd[k], list):
            rd["latexdocstrsigns"] = (
                rd["latexdocstrsigns"] + rd[k][0:1] + ["\\begin{description}"] + rd[k][1:] + ["\\end{description}"]
            )
