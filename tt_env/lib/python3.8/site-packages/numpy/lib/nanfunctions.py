...
def nanpercentile(
    ...
    *,
    ...
    if interpolation is not None:
        method = function_base._check_interpolation_as_method(method, interpolation, "nanpercentile")
...
def nanquantile(
    ...
    *,
    ...
    """
    if interpolation is not None:
        method = function_base._check_interpolation_as_method(method, interpolation, "nanquantile")
...
def nanvar(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue, *, where=np._NoValue):
    ...
    arr, mask = _replace_nan(a, 0)
    if mask is None:
        return np.var(arr, axis=axis, dtype=dtype, out=out, ddof=ddof, keepdims=keepdims, where=where)
...
def nanstd(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue, *, where=np._NoValue):
    ...
    """
    var = nanvar(a, axis=axis, dtype=dtype, out=out, ddof=ddof, keepdims=keepdims, where=where)
