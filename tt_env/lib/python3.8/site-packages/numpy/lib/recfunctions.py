...
def merge_arrays(seqarrays, fill_value=-1, flatten=False, usemask=False, asrecarray=False):
    ...
    * XXX: I just obtained these values empirically
    ...
    if usemask:
        ...
        output = ma.array(
            np.fromiter(data, dtype=newdtype, count=maxlength), mask=list(_izip_records(seqmask, flatten=flatten))
        )
        if asrecarray:
            output = output.view(MaskedRecords)
    else:
...
def _join_by_dispatcher(
    key, r1, r2, jointype=None, r1postfix=None, r2postfix=None, defaults=None, usemask=None, asrecarray=None
):
    return (r1, r2)
...
def join_by(key, r1, r2, jointype="inner", r1postfix="1", r2postfix="2", defaults=None, usemask=True, asrecarray=False):
    ...
    * A temporary array is formed by dropping the fields not in the key for
    ...
    if jointype not in ("inner", "outer", "leftouter"):
        raise ValueError(
            "The 'jointype' argument should be in 'inner', " "'outer' or 'leftouter' (got '%s' instead)" % jointype
        )
...
def rec_join(key, r1, r2, jointype="inner", r1postfix="1", r2postfix="2", defaults=None):
    ...
    """
    kwargs = dict(
        jointype=jointype, r1postfix=r1postfix, r2postfix=r2postfix, defaults=defaults, usemask=False, asrecarray=True
    )
