...
class TestSetOps:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (np.array([1, 2, 3], dtype=np.int64), np.array([5, 7, 2], dtype=np.float32), None, "to_begin"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (np.array([1, 2, 3], dtype=np.int32), 0, 0, np.array([0, 1, 1, 0], dtype=np.int32)),
            (np.array([1, 2, 3], dtype=np.int64), 3, -9, np.array([3, 1, 1, -9], dtype=np.int64)),
        ],
    )
    ...
    def test_in1d_mixed_dtype(self, dtype1, dtype2, kind):
        ...
        expect_failure = kind == "table" and any(
            (dtype1 == np.int8 and dtype2 == np.int16, dtype1 == np.int16 and dtype2 == np.int8)
        )
