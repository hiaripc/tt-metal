...
Ndescr = [
    ...
    (
        ...
        [
            ("value", "c16"),
            ("y2", "f8"),
            ("Info2", [("name", "S2"), ("value", "c16", (2,)), ("y3", "f8", (2,)), ("z3", "u4", (2,))]),
            ("name", "S2"),
            ("z2", "b1"),
        ],
    ),
...
# titles
dt5 = np.dtype({"names": ["a", "b"], "formats": ["i4", "i4"], "offsets": [1, 6], "titles": ["aa", "bb"]})
# empty
                    ...
                    np.dtype(
                        (
                            np.dtype(
                                (
                                    np.dtype(
                                        {"names": ["a", "b"], "formats": ["i1", "i1"], "offsets": [0, 4], "itemsize": 8}
                                    ),
                                    (3,),
                                )
                            ),
...
def test_bad_header():
    ...
    # d = {"shape": (1, 2),
    #      "descr": "x"}
    s = BytesIO(b"\x93NUMPY\x01\x006\x00{'descr': 'x', 'shape': (1, 2), }" + b"                    \n")
    assert_raises(ValueError, format.read_array_header_1_0, s)
...
def test_unicode_field_names(tmpdir):
    ...
    arr = np.array(
        [(1, 3), (1, 2), (1, 3), (1, 2)],
        dtype=[("int", int), ("\N{CJK UNIFIED IDEOGRAPH-6574}\N{CJK UNIFIED IDEOGRAPH-5F62}", int)],
    )
    ...
    [
        ...
        (
            np.dtype(
                {
                    "names": ["a", "b"],
                    "formats": [float, np.dtype({"names": ["c"], "formats": [np.dtype(int, metadata={})]})],
                }
            ),
            False,
        ),
