...
class ABCPolyBase(abc.ABC):
    ...
    def __repr__(self):
        ...
        return f"{name}({coef}, domain={domain}, window={window}, " f"symbol='{self.symbol}')"
    ...
    def _str_term_unicode(cls, i, arg_str):
        ...
        if cls.basis_name is None:
            raise NotImplementedError(
                "Subclasses must define either a basis_name, or override " "_str_term_unicode(cls, i, arg_str)"
            )
    ...
    def _str_term_ascii(cls, i, arg_str):
        ...
        if cls.basis_name is None:
            raise NotImplementedError(
                "Subclasses must define either a basis_name, or override " "_str_term_ascii(cls, i, arg_str)"
            )
    ...
    def _repr_latex_term(cls, i, arg_str, needs_parens):
        if cls.basis_name is None:
            raise NotImplementedError(
                "Subclasses must define either a basis name, or override " "_repr_latex_term(i, arg_str, needs_parens)"
            )
    ...
    def _repr_latex_(self):
        ...
        if off == 0 and scale == 1:
            ...
            term = f"{self._repr_latex_scalar(off)} + " f"{self._repr_latex_scalar(scale)}{self.symbol}"
            needs_parens = True
    ...
    def __truediv__(self, other):
        ...
        if not isinstance(other, numbers.Number) or isinstance(other, bool):
            raise TypeError(f"unsupported types for true division: " f"'{type(self)}', '{type(other)}'")
