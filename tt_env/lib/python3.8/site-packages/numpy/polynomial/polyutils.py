...
__all__ = ["RankWarning", "as_series", "trimseq", "trimcoef", "getdomain", "mapdomain", "mapparms", "format_float"]
...
def format_float(x, parens=False):
    ...
    if exp_format:
        ...
        s = dragon4_positional(
            x, precision=opts["precision"], fractional=True, unique=unique, trim=trim, sign=opts["sign"] == "+"
        )
    return s
