...
class TestLinebreaking:
    ...
    def test_first_linebreak_multiline_one_less_than_linewidth(self):
        ...
        assert_equal(
            str(p), ("12345678.0 + 12345678.0 x + 12345678.0 x**2 + " "12345678.0 x**3 + 1.0 x**4 +\n12345678.0 x**5")
        )
    ...
    def test_first_linebreak_multiline_on_linewidth(self):
        ...
        assert_equal(
            str(p), ("12345678.0 + 12345678.0 x + 12345678.0 x**2 + " "12345678.12 x**3 +\n1.0 x**4 + 12345678.0 x**5")
        )
...
class TestLatexRepr:
    ...
    def test_simple_polynomial(self):
        ...
        assert_equal(self.as_latex(p), r"$x \mapsto 1.0 + 2.0\,\left(1.0 + x\right) + 3.0\,\left(1.0 + x\right)^{2}$")

        # scaled input
        p = poly.Polynomial([1, 2, 3], domain=[-0.5, 0.5])
        assert_equal(self.as_latex(p), r"$x \mapsto 1.0 + 2.0\,\left(2.0x\right) + 3.0\,\left(2.0x\right)^{2}$")

        # affine input
        p = poly.Polynomial([1, 2, 3], domain=[-1, 0])
        assert_equal(
            self.as_latex(p), r"$x \mapsto 1.0 + 2.0\,\left(1.0 + 2.0x\right) + 3.0\,\left(1.0 + 2.0x\right)^{2}$"
        )

    def test_basis_func(self):
        p = poly.Chebyshev([1, 2, 3])
        assert_equal(self.as_latex(p), r"$x \mapsto 1.0\,{T}_{0}(x) + 2.0\,{T}_{1}(x) + 3.0\,{T}_{2}(x)$")
    ...
    def test_multichar_basis_func(self):
        ...
        assert_equal(self.as_latex(p), r"$x \mapsto 1.0\,{He}_{0}(x) + 2.0\,{He}_{1}(x) + 3.0\,{He}_{2}(x)$")
    ...
    def test_symbol_basic(self):
        ...
        assert_equal(
            self.as_latex(p),
            (r"$z \mapsto 1.0 + 2.0\,\left(1.0 + 2.0z\right) + 3.0\," r"\left(1.0 + 2.0z\right)^{2}$"),
        )
