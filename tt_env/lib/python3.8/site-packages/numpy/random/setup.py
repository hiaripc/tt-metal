...
def configuration(parent_package="", top_path=None):
    ...
    if sys.platform[:3] == "aix":
        ...
        defs = [("_FILE_OFFSET_BITS", "64"), ("_LARGEFILE_SOURCE", "1"), ("_LARGEFILE64_SOURCE", "1")]
    ...
    for gen in ["mt19937"]:
        ...
        config.add_extension(
            f"_{gen}",
            sources=[f"_{gen}.c", f"src/{gen}/{gen}.c", f"src/{gen}/{gen}-jump.c"],
    ...
    for gen in ["philox", "pcg64", "sfc64"]:
        ...
        config.add_extension(
            f"_{gen}",
            sources=[f"_{gen}.c", f"src/{gen}/{gen}.c"],
            include_dirs=[".", "src", join("src", gen)],
            libraries=EXTRA_LIBRARIES,
            extra_compile_args=EXTRA_COMPILE_ARGS,
            extra_link_args=EXTRA_LINK_ARGS,
            depends=depends + [f"_{gen}.pyx", "bit_generator.pyx", "bit_generator.pxd"],
            define_macros=_defs,
        )
