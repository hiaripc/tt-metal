...
class TestRandomDist:
    ...
    def test_random_integers_deprecated(self):
        with warnings.catch_warnings():
            ...
            # DeprecationWarning raised with high != None
            assert_raises(DeprecationWarning, np.random.random_integers, np.iinfo("l").max, np.iinfo("l").max)
...
class TestThread:
    ...
    def check_function(self, function, sz):
        ...
        # threaded generation
        t = [Thread(target=function, args=(np.random.RandomState(s), o)) for s, o in zip(self.seeds, out1)]
        [x.start() for x in t]
        [x.join() for x in t]
