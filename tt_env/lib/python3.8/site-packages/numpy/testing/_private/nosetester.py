...
class NoseTester:
    ...
    def test(
        self, label="fast", verbose=1, extra_argv=None, doctests=False, coverage=False, raise_warnings=None, timer=False
    ):
        """
        Run tests for module using nose.
        ...
        with suppress_warnings("location") as sup:
            ...
            #       be implemented).
            warnings.filterwarnings("ignore", message=".*getargspec.*", category=DeprecationWarning, module=r"nose\.")
