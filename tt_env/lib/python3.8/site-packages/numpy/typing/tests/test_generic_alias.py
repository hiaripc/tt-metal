...
class TestGenericAlias:
    ...
    def test_copy(self, name: str, func: FuncType) -> None:
        ...
        # xref bpo-45167
        GE_398 = sys.version_info[:2] == (3, 9) and sys.version_info >= (3, 9, 8)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # >= beta3
            ("__typing_unpacked_tuple_args__", lambda n: n.__typing_unpacked_tuple_args__, ("beta", 3)),
            # >= beta4
