...
if not pa_version_under7p0:
    ...
    ALL_INT_PYARROW_DTYPES_STR_REPR = [str(ArrowDtype(typ)) for typ in ALL_INT_PYARROW_DTYPES]
    ...
    FLOAT_PYARROW_DTYPES_STR_REPR = [str(ArrowDtype(typ)) for typ in FLOAT_PYARROW_DTYPES]
...
def makeCategoricalIndex(k: int = 10, n: int = 3, name=None, **kwargs) -> CategoricalIndex:
...
def makeTimedeltaIndex(k: int = 10, freq: Frequency = "D", name=None, **kwargs) -> TimedeltaIndex:
