...
class ExtensionArray:
    ...
    * _from_sequence_of_strings
    ...
    def repeat(self: ExtensionArrayT, repeats: int | Sequence[int], axis: AxisInt | None = None) -> ExtensionArrayT:
    ...
    def _reduce(self, name: str, *, skipna: bool = True, **kwargs):
        ...
        **kwargs
        ...
        if meth is None:
            raise TypeError(f"'{type(self).__name__}' with dtype {self.dtype} " f"does not support reduction '{name}'")
    ...
    def _quantile(self: ExtensionArrayT, qs: npt.NDArray[np.float64], interpolation: str) -> ExtensionArrayT:
        """
