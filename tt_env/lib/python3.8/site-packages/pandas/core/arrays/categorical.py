...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    @classmethod
    def _from_sequence(cls, scalars, *, dtype: Dtype | None = None, copy: bool = False) -> Categorical:
    ...
    @classmethod
    def from_codes(cls, codes, categories=None, ordered=None, dtype: Dtype | None = None) -> Categorical:
        """
    ...
    def _validate_scalar(self, fill_value):
        ...
        if is_valid_na_for_dtype(fill_value, self.categories.dtype):
            ...
            raise TypeError(
                "Cannot setitem on a Categorical with a new " f"category ({fill_value}), set the categories first"
            ) from None
        return fill_value
    ...
    def __array_ufunc__(self, ufunc: np.ufunc, method: str, *inputs, **kwargs):
        ...
        raise TypeError(f"Object with dtype {self.dtype} cannot perform " f"the numpy op {ufunc.__name__}")
    ...
    def value_counts(self, dropna: bool = True) -> Series:
        ...
        return Series(count, index=CategoricalIndex(ix), dtype="int64", name="count", copy=False)
    ...
    def _get_repr(self, length: bool = True, na_rep: str = "NaN", footer: bool = True) -> str:
        from pandas.io.formats import format as fmt
    ...
    def isin(self, values) -> npt.NDArray[np.bool_]:
        ...
        if not is_list_like(values):
            ...
            raise TypeError(
                "only list-like objects are allowed to be passed " f"to isin(), you passed a [{values_type}]"
            )
    ...
    def _replace(self, *, to_replace, value, inplace: bool = False):
        ...
        new_codes = recode_for_categories(cat._codes, all_values, new_categories, copy=False)
