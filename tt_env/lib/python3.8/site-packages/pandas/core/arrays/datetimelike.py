...
class DatetimeLikeArrayMixin(OpsMixin, NDArrayBackedExtensionArray):
    ...
    def __getitem__(self: DatetimeLikeArrayT, key: PositionalIndexer2D) -> DatetimeLikeArrayT | DTScalarOrNaT:
        """
    ...
    def _validation_error_message(self, value, allow_listlike: bool = False) -> str:
        ...
        if allow_listlike:
            ...
            msg = (
                f"value should be a '{self._scalar_type.__name__}' or 'NaT'. " f"Got '{type(value).__name__}' instead."
            )
        return msg
    ...
    def _addsub_object_array(self, other: npt.NDArray[np.object_], op):
        ...
        warnings.warn(
            "Adding/subtracting object-dtype array to " f"{type(self).__name__} not vectorized.",
            PerformanceWarning,
    ...
    def _accumulate(self, name: str, *, skipna: bool = True, **kwargs):
        ...
        return type(self)._simple_new(result, freq=None, dtype=self.dtype)  # type: ignore[call-arg]
    ...
    def __rsub__(self, other):
        ...
        if is_datetime64_any_dtype(other_dtype) and is_timedelta64_dtype(self.dtype):
            ...
            is_datetime64_any_dtype(self.dtype) and hasattr(other, "dtype") and not is_datetime64_any_dtype(other.dtype)
        ):
...
class TimelikeOps(DatetimeLikeArrayMixin):
    ...
    def __init__(self, values, dtype=None, freq=lib.no_default, copy: bool = False) -> None:
        ...
        if freq == "infer":
            raise ValueError(
                f"Frequency inference not allowed in {type(self).__name__}.__init__. " "Use 'pd.array()' instead."
            )
    ...
    def as_unit(self: TimelikeOpsT, unit: str) -> TimelikeOpsT:
        ...
        return type(self)._simple_new(new_values, dtype=new_dtype, freq=self.freq)  # type: ignore[call-arg]
...
def ensure_arraylike_for_datetimelike(data, copy: bool, cls_name: str):
    ...
    if isinstance(data, IntegerArray) or (isinstance(data, ArrowExtensionArray) and data.dtype.kind in "iu"):
        ...
        copy = False
    elif not isinstance(data, (np.ndarray, ExtensionArray)) or isinstance(data, ArrowExtensionArray):
