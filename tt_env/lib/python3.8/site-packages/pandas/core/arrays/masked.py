...
class BaseMaskedArray(OpsMixin, ExtensionArray):
    ...
    @classmethod
    def _from_sequence(cls: type[BaseMaskedArrayT], scalars, *, dtype=None, copy: bool = False) -> BaseMaskedArrayT:
    ...
    def isin(self, values) -> BooleanArray:  # type: ignore[override]
        ...
        if self._hasna:
            values_have_NA = is_object_dtype(values_arr.dtype) and any(val is self.dtype.na_value for val in values_arr)
    ...
    def value_counts(self, dropna: bool = True) -> Series:
        ...
        keys, value_counts = algos.value_counts_arraylike(self._data, dropna=True, mask=self._mask)
    ...
    def mean(self, *, skipna: bool = True, axis: AxisInt | None = 0, **kwargs):
        ...
        return self._wrap_reduction_result("mean", result, skipna=skipna, axis=axis, **kwargs)
    ...
    def var(self, *, skipna: bool = True, axis: AxisInt | None = 0, ddof: int = 1, **kwargs):
        ...
        return self._wrap_reduction_result("var", result, skipna=skipna, axis=axis, **kwargs)
    ...
    def std(self, *, skipna: bool = True, axis: AxisInt | None = 0, ddof: int = 1, **kwargs):
        ...
        return self._wrap_reduction_result("std", result, skipna=skipna, axis=axis, **kwargs)
