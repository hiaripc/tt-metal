...
class PandasArray(
    ...
    @classmethod
    def _from_sequence(cls, scalars, *, dtype: Dtype | None = None, copy: bool = False) -> PandasArray:
    ...
    def _wrap_ndarray_result(self, result: np.ndarray):
        ...
        #  of a PandasArray
        if result.dtype.kind == "m" and is_supported_unit(get_unit_from_dtype(result.dtype)):
