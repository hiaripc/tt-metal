...
class PeriodArray(dtl.DatelikeOps, libperiod.PeriodMixin):
    ...
    @classmethod
    def _from_sequence_of_strings(cls, strings, *, dtype: Dtype | None = None, copy: bool = False) -> PeriodArray:
    ...
    def _addsub_int_array_or_scalar(self, other: np.ndarray | int, op: Callable[[Any, Any], Any]) -> PeriodArray:
        """
    ...
    def _add_timedelta_arraylike(self, other: TimedeltaArray | npt.NDArray[np.timedelta64]) -> PeriodArray:
        """
        Parameters
        ----------
        ...
        res_values = algos.checked_add_with_arr(self.asi8, delta.view("i8"), arr_mask=self._isnan, b_mask=b_mask)
...
def validate_dtype_freq(dtype, freq: BaseOffsetT | timedelta | str | None) -> BaseOffsetT:
    """
