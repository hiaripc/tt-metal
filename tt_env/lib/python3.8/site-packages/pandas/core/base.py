...
class IndexOpsMixin(OpsMixin):
    ...
    _hidden_attrs: frozenset[str] = frozenset(["tolist"])  # tolist is not deprecated, just suppressed in the __dir__
    ...
    def to_numpy(
        ...
        **kwargs
        ...
        if (copy and na_value is lib.no_default) or (not copy and using_copy_on_write()):
    ...
    def searchsorted(
        ...
        if isinstance(value, ABCDataFrame):
            msg = "Value must be 1-D array-like or scalar, " f"{type(value).__name__} is not supported"
            raise ValueError(msg)
