...
_special_case_arith_ops_dict = dict(zip(SPECIAL_CASE_ARITH_OPS_SYMS, _special_case_arith_ops_funcs))
...
class UnaryOp(Op):
    ...
    def __init__(self, op: Literal["+", "-", "~", "not"], operand) -> None:
        ...
        try:
            ...
            raise ValueError(f"Invalid unary operator {repr(op)}, " f"valid operators are {UNARY_OPS_SYMS}") from err
