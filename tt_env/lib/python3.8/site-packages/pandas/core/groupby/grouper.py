...
class Grouper:
    ...
    @final
    def _set_grouper(self, obj: NDFrame, sort: bool = False, *, gpr_index: Index | None = None):
        """
...
class Grouping:
    ...
    def group_index(self) -> Index:
        ...
        if not self._dropna and self._passed_categorical:
            ...
            if self._sort and (codes == len(uniques)).any():
                ...
                uniques = Categorical.from_codes(np.append(uniques.codes, [-1]), uniques.categories)
            elif len(codes) > 0:
                ...
                if cat.codes[na_idx] < 0:
                    ...
                    uniques = Categorical.from_codes(np.insert(uniques.codes, na_unique_idx, -1), uniques.categories)
    ...
    def _codes_and_uniques(self) -> tuple[npt.NDArray[np.signedinteger], ArrayLike]:
        ...
        if self._passed_categorical:
            ...
            uniques = Categorical.from_codes(codes=ucodes, categories=categories, ordered=cat.ordered)
