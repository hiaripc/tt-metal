...
class WrappedCythonOp:
        ...
        if is_numeric:
            ...
            if how in ["median", "cumprod"]:
                ...
                raise NotImplementedError(
                    f"function is not implemented for this dtype: " f"[how->{how},dtype->{dtype_str}]"
                )
    ...
    # TODO: general case implementation overridable by EAs.
    def _reconstruct_ea_result(self, values: ExtensionArray, res_values: np.ndarray) -> ExtensionArray:
        """
...
def _get_splitter(data: NDFrame, labels: np.ndarray, ngroups: int, axis: AxisInt = 0) -> DataSplitter:
