...
class Index(IndexOpsMixin, PandasObject):
    ...
    @final
    def _left_indexer(self: _IndexT, other: _IndexT) -> tuple[ArrayLike, npt.NDArray[np.intp], npt.NDArray[np.intp]]:
        # Caller is responsible for ensuring other.dtype == self.dtype
        sv = self._get_join_target()
        ov = other._get_join_target()
        # can_use_libjoin assures sv and ov are ndarrays
    ...
    @final
    def _inner_indexer(self: _IndexT, other: _IndexT) -> tuple[ArrayLike, npt.NDArray[np.intp], npt.NDArray[np.intp]]:
        # Caller is responsible for ensuring other.dtype == self.dtype
        sv = self._get_join_target()
        ov = other._get_join_target()
        # can_use_libjoin assures sv and ov are ndarrays
    ...
    @final
    def _outer_indexer(self: _IndexT, other: _IndexT) -> tuple[ArrayLike, npt.NDArray[np.intp], npt.NDArray[np.intp]]:
        # Caller is responsible for ensuring other.dtype == self.dtype
        sv = self._get_join_target()
        ov = other._get_join_target()
        # can_use_libjoin assures sv and ov are ndarrays
    ...
    @classmethod
    def _simple_new(cls: type[_IndexT], values: ArrayLike, name: Hashable = None, refs=None) -> _IndexT:
        """
    ...
    def view(self, cls=None):
        ...
        if cls is not None and not hasattr(cls, "_typ"):
            ...
            if isinstance(dtype, (np.dtype, ExtensionDtype)) and needs_i8_conversion(dtype):
    ...
    @overload
    def set_names(self: _IndexT, names, *, level=..., inplace: Literal[False] = ...) -> _IndexT:
        ...
    ...
    @overload
    def set_names(self: _IndexT, names, *, level=..., inplace: bool = ...) -> _IndexT | None:
        ...

    def set_names(self: _IndexT, names, *, level=None, inplace: bool = False) -> _IndexT | None:
        """
    ...
    def _validate_index_level(self, level) -> None:
        ...
        if isinstance(level, int):
            if level < 0 and level != -1:
                raise IndexError("Too many levels: Index has only 1 level, " f"{level} is not a valid level number")
            if level > 0:
    ...
    def sortlevel(self, level=None, ascending: bool | list[bool] = True, sort_remaining=None):
        """
        ...
        if not isinstance(ascending, (list, bool)):
            raise TypeError("ascending must be a single bool value or" "a list of bool values of length 1")
    ...
    def is_boolean(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.is_boolean is deprecated. " "Use pandas.api.types.is_bool_type instead.",
            FutureWarning,
    ...
    def is_integer(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.is_integer is deprecated. " "Use pandas.api.types.is_integer_dtype instead.",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def is_floating(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.is_floating is deprecated. " "Use pandas.api.types.is_float_dtype instead.",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def is_object(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.is_object is deprecated." "Use pandas.api.types.is_object_dtype instead",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def is_categorical(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.is_categorical is deprecated." "Use pandas.api.types.is_categorical_dtype instead",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def is_interval(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.is_interval is deprecated." "Use pandas.api.types.is_interval_dtype instead",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def holds_integer(self) -> bool:
        ...
        """
        warnings.warn(
            f"{type(self).__name__}.holds_integer is deprecated. " "Use pandas.api.types.infer_dtype instead.",
            FutureWarning,
            stacklevel=find_stack_level(),
        )
    ...
    def fillna(self, value=None, downcast=None):
        ...
        if self.hasnans:
            ...
            raise NotImplementedError(
                f"{type(self).__name__}.fillna does not support 'downcast' " "argument values other than 'None'."
            )
        return self._view()
    ...
    def _validate_sort_keyword(self, sort):
        if sort not in [None, False, True]:
            raise ValueError("The 'sort' keyword only takes the values of " f"None, True, or False; {sort} was passed.")
    ...
    def get_indexer(
        ...
        if not is_dtype_equal(self.dtype, target.dtype) and not self._should_partial_index(target):
    ...
    def _get_fill_indexer_searchsorted(
        ...
        if limit is not None:
            raise ValueError(
                f"limit argument for {repr(method)} method only well-defined " "if index and target are monotonic"
            )
    ...
    def _get_nearest_indexer(self, target: Index, limit: int | None, tolerance) -> npt.NDArray[np.intp]:
        ...
        indexer = np.where(
            ...
            op(left_distances, right_distances) | (right_indexer == -1),  # type: ignore[arg-type]
            left_indexer,
            right_indexer,
        )
        if tolerance is not None:
    ...
    def _convert_slice_indexer(self, key: slice, kind: str_t):
        ...
        ints_are_positional = self._should_fallback_to_positional or is_interval_dtype(self.dtype)
    ...
    def join(
        ...
        *,
        ...
        if self._join_precedence < other._join_precedence:
            ...
            join_index, lidx, ridx = other.join(self, how=how, level=level, return_indexers=True)
            lidx, ridx = ridx, lidx
            return join_index, lidx, ridx
    ...
    def _join_non_unique(
        ...
        left_idx, right_idx = get_join_indexers([self._values], [other._values], how=how, sort=True)
        mask = left_idx == -1
    ...
    def _raise_scalar_data_error(cls, data):
        ...
        raise TypeError(
            f"{cls.__name__}(...) must be called with a collection of some " f"kind, {repr(data)} was passed"
        )
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, slice):
            ...
            return type(self)._simple_new(result, name=self._name, refs=self._references)
    ...
    def _can_hold_identifiers_and_holds_name(self, name) -> bool:
        ...
        """
        if is_object_dtype(self.dtype) or is_string_dtype(self.dtype) or is_categorical_dtype(self.dtype):
            return name in self
        return False
    ...
    def identical(self, other) -> bool:
        ...
        return (
            self.equals(other)
            and all(getattr(self, c, None) == getattr(other, c, None) for c in self._comparables)
    ...
    def asof_locs(self, where: Index, mask: npt.NDArray[np.bool_]) -> npt.NDArray[np.intp]:
        ...
        locs = self._values[mask].searchsorted(where._values, side="right")  # type: ignore[call-overload]
    ...
    def _get_indexer_strict(self, key, axis_name: str_t) -> tuple[Index, np.ndarray]:
        ...
        if (isinstance(keyarr.dtype, np.dtype) and keyarr.dtype.kind in ["m", "M"]) or isinstance(
    ...
    def _raise_if_missing(self, key, indexer, axis_name: str_t) -> None:
        ...
        if nmissing:
            ...
            use_interval_msg = is_interval_dtype(self.dtype) or (
                ...
                and is_interval_dtype(self.categories.dtype)  # type: ignore[attr-defined]
            )
    ...
    def _transform_index(self, func, *, level=None) -> Index:
        ...
        if isinstance(self, ABCMultiIndex):
            values = [
                self.get_level_values(i).map(func) if i == level or level is None else self.get_level_values(i)
    ...
    def get_slice_bound(self, label, side: Literal["left", "right"]) -> int:
        ...
        if side not in ("left", "right"):
            raise ValueError("Invalid value for side kwarg, must be either " f"'left' or 'right': {side}")
        ...
        if isinstance(slc, np.ndarray):
            ...
            if isinstance(slc, np.ndarray):
                raise KeyError(f"Cannot get {side} slice bound for non-unique " f"label: {repr(original_label)}")
    ...
    def infer_objects(self, copy: bool = True) -> Index:
        ...
        if self._is_multi:
            raise NotImplementedError(
                "infer_objects is not implemented for MultiIndex. " "Use index.to_frame().infer_objects() instead."
            )
