...
class DatetimeIndexOpsMixin(NDArrayBackedExtensionIndex, ABC):
    ...
    def _format_with_header(self, header: list[str], na_rep: str = "NaT", date_format: str | None = None) -> list[str]:
...
class DatetimeTimedeltaMixin(DatetimeIndexOpsMixin, ABC):
    ...
    def shift(self: _TDT, periods: int = 1, freq=None) -> _TDT:
        ...
        result = self._data._generate_range(start=start, end=end, periods=None, freq=self.freq)
