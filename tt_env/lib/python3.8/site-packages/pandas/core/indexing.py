...
class _LocationIndexer(NDFrameIndexerBase):
    ...
    @final
    def __call__(self: _LocationIndexerT, axis: Axis | None = None) -> _LocationIndexerT:
    ...
    def _validate_tuple_indexer(self, key: tuple) -> tuple:
        ...
        for i, k in enumerate(key):
            try:
                ...
                raise ValueError("Location based indexing can only have " f"[{self._valid_types}] types") from err
        return key
...
class _iLocIndexer(_LocationIndexer):
    ...
    def _setitem_with_indexer_split_path(self, indexer, value, name: str):
        ...
        if is_list_like_indexer(value) and getattr(value, "ndim", 1) > 0:
            ...
            elif self._is_scalar_access(indexer) and is_object_dtype(self.obj.dtypes[ilocs[0]]):
