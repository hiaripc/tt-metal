...
def to_dict(
    ...
    if orient == "dict":
        ...
        return into_c(
            (
                k,
                list(map(maybe_box_native, v.tolist())) if i in object_dtype_indices_as_set else v.tolist(),
            )
        ...
        return into_c(
            ...
            + (
                ...
                (
                    "data",
                    [list(map(maybe_box_native, t)) for t in df.itertuples(index=False, name=None)],
                ),
            )
        ...
        if are_all_object_dtype_cols:
            ...
            return into_c(
                (
                    t[0],
                    {
                        columns[i]: maybe_box_native(v) if is_object_dtype_by_index[i] else v
