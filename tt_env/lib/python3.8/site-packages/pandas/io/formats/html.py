...
class HTMLFormatter:
    ...
    def __init__(
        ...
        self.col_space = {
            column: f"{value}px" if isinstance(value, int) else value for column, value in self.fmt.col_space.items()
        }
    ...
    def _write_table(self, indent: int = 0) -> None:
        ...
        if self.classes is not None:
            ...
            if not isinstance(self.classes, (list, tuple)):
                raise TypeError("classes must be a string, list, " f"or tuple, not {type(self.classes)}")
