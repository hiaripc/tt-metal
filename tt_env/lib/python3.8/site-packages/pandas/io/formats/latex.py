...
class RowStringConverter:
    ...
    def _format_multicolumn(self, row: list[str]) -> list[str]:
        ...
        def append_col() -> None:
            ...
            if ncol > 1:
                row2.append(f"\\multicolumn{{{ncol:d}}}{{{self.multicolumn_format}}}" f"{{{coltext.strip()}}}")
...
class LongTableBuilder(GenericTableBuilder):
    ...
    def middle_separator(self) -> str:
        ...
        elements = [
            ...
            "\\endhead",
            "\\midrule",
            f"\\multicolumn{{{len(iterator.strcols)}}}{{r}}" "{{Continued on next page}} \\\\",
            "\\midrule",
            "\\endfoot\n",
            "\\bottomrule",
            "\\endlastfoot",
...
class LatexFormatter:
    ...
    def column_format(self, input_column_format: str | None) -> None:
        ...
        if input_column_format is None:
            ...
            raise ValueError(f"column_format must be str or unicode, " f"not {type(input_column_format)}")
        else:
