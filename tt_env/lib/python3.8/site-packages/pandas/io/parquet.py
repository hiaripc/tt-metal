...
class PyArrowImpl(BaseImpl):
    ...
    def read(
        ...
        **kwargs,
        ...
        try:
            pa_table = self.api.parquet.read_table(path_or_handle, columns=columns, **kwargs)
...
class FastParquetImpl(BaseImpl):
    ...
    def read(self, path, columns=None, storage_options: StorageOptions = None, **kwargs) -> DataFrame:
        ...
        if is_fsspec_url(path):
            ...
            if Version(self.api.__version__) > Version("0.6.1"):
                ...
                parquet_kwargs["open_with"] = lambda path, _: fsspec.open(path, "rb", **(storage_options or {})).open()
