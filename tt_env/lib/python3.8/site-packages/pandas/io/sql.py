...
def _convert_arrays_to_dataframe(
    ...
    if dtype_backend == "pyarrow":
        ...
        arrays = [ArrowExtensionArray(pa.array(arr, from_pandas=True)) for arr in arrays]
    if arrays:
...
def execute(sql, con, params=None):
    ...
    """
    warnings.warn(
        "`pandas.io.sql.execute` is deprecated and " "will be removed in the future version.",
        FutureWarning,
        ...
        if index is True:
            ...
            if index_label is not None:
                ...
                if len(index_label) != nlevels:
                    raise ValueError("Length of 'index_label' should match number of " f"levels, which is {nlevels}")
                return index_label
