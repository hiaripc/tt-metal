...
class PlotAccessor(PandasObject):
    ...
    **kwargs
    ...
    @Appender(_bar_or_line_doc)
    def bar(self, x=None, y=None, **kwargs) -> PlotAccessor:  # pylint: disable=disallowed-name
        """
        Vertical bar plot.
    ...
    def hexbin(self, x, y, C=None, reduce_C_function=None, gridsize=None, **kwargs) -> PlotAccessor:
        """
