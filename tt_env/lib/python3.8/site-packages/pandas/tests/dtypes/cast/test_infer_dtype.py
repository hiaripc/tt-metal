...
@pytest.mark.parametrize("data,exp_dtype", [(12, np.int64), (np.float_(12), np.float64)])
...
@pytest.mark.parametrize("data", [np.datetime64(1, "ns"), Timestamp(1), datetime(2000, 1, 1, 0, 0)])
...
@pytest.mark.parametrize("data", [date(2000, 1, 1), "foo", Timestamp(1, tz="US/Eastern")])
