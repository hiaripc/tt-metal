...
@pytest.mark.parametrize("ll", [r"a", "x", r"asdf", re.compile("adsf"), r"\u2233\s*", re.compile(r"")])
...
class TestInference:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                True,
                BooleanArray(np.array([True, False], dtype="bool"), np.array([False, True])),
            ),
    ...
    def test_maybe_convert_objects_datetime(self):
        ...
        exp = arr.copy()
        out = lib.maybe_convert_objects(arr, convert_datetime=True, convert_timedelta=True)
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                True,
                FloatingArray(np.array([2.0, 0.0], dtype="float64"), np.array([False, True])),
            ),
