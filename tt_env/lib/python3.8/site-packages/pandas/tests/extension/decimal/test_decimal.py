...
@pytest.mark.xfail(
    reason=(
        "DecimalArray constructor raises bc _from_sequence wants Decimals, not ints." "Easy to fix, just need to do it."
    ),
    raises=TypeError,
)
def test_series_constructor_coerce_data_to_extension_dtype_raises():
    xpr = "Cannot cast data to extension dtype 'decimal'. Pass the " "extension array directly."
