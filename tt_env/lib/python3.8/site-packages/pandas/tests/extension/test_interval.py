...
class TestMethods(BaseInterval, base.BaseMethodsTests):
    ...
    @pytest.mark.xfail(
        reason="Raises with incorrect message bc it disallows *all* listlikes " "instead of just wrong-length listlikes"
    )
...
class TestMissing(BaseInterval, base.BaseMissingTests):
    ...
    unsupported_fill = pytest.mark.xfail(reason="Unsupported fillna option for Interval.")
