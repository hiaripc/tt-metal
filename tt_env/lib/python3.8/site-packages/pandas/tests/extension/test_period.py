...
class TestArithmeticOps(BasePeriodTests, base.BaseArithmeticOpsTests):
    ...
    def test_add_series_with_extension_array(self, data):
        ...
        s = pd.Series(data)
        msg = r"unsupported operand type\(s\) for \+: " r"\'PeriodArray\' and \'PeriodArray\'"
        with pytest.raises(TypeError, match=msg):
            s + data

    def test_direct_arith_with_ndframe_returns_not_implemented(self, data, frame_or_series):
