...
class TestXSWithMultiIndex:
    ...
    def test_xs_setting_with_copy_error(self, multiindex_dataframe_random_data, using_copy_on_write):
    ...
    def test_xs_setting_with_copy_error_multiple(self, four_level_index_dataframe, using_copy_on_write):
        # this is a copy in 0.14
