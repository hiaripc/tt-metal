...
class TestAstype:
    ...
    def test_astype_dict_like(self, dtype_class):
        ...
        msg_frame = (
            "Only a column name can be used for the key in a dtype mappings argument. " "'{}' not found in columns."
        )
    ...
    def test_astype_to_incorrect_datetimelike(self, unit):
        ...
        msg = "|".join(
            [
                ...
                # ArrayManager path
                "cannot astype a datetimelike from " rf"\[datetime64\[ns\]\] to \[timedelta64\[{unit}\]\]",
            ]
        )
        with pytest.raises(TypeError, match=msg):
            df.astype(other)
        ...
        msg = "|".join(
            [
                ...
                # ArrayManager path
                "cannot astype a timedelta from " rf"\[timedelta64\[ns\]\] to \[datetime64\[{unit}\]\]",
            ]
        )
