...
class TestFillNA:
    ...
    def test_ffill(self, datetime_frame):
        ...
        tm.assert_frame_equal(datetime_frame.ffill(), datetime_frame.fillna(method="ffill"))

    def test_bfill(self, datetime_frame):
        datetime_frame.loc[datetime_frame.index[:5], "A"] = np.nan
        datetime_frame.loc[datetime_frame.index[-5:], "A"] = np.nan

        tm.assert_frame_equal(datetime_frame.bfill(), datetime_frame.fillna(method="bfill"))
