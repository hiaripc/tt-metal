...
class TestNLargestNSmallest:
    ...
    def test_nlargest_n(self, df_strings, nselect_method, n, order):
        ...
        df = df_strings
        if "b" in order:
            error_msg = f"Column 'b' has dtype object, " f"cannot use method '{nselect_method}' with this dtype"
    ...
    def test_nlargest_error(self, df_main_dtypes, nselect_method, columns):
        ...
        col = columns[1]
        error_msg = (
            f"Column '{col}' has dtype {df[col].dtype}, " f"cannot use method '{nselect_method}' with this dtype"
        )
