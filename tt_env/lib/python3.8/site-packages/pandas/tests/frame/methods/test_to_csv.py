...
class TestDataFrameToCSV:
    ...
    def test_to_csv_idx_types(self, nrows, r_idx_type, c_idx_type, ncols):
        df = tm.makeCustomDataframe(nrows, ncols, r_idx_type=r_idx_type, c_idx_type=c_idx_type)
        ...
        with tm.ensure_clean("__tmp_to_csv_multiindex__") as path:
            ...
            def _make_frame(names=None):
                ...
                return DataFrame(
                    ...
                    columns=MultiIndex.from_tuples([("bah", "foo"), ("bah", "bar"), ("ban", "baz")], names=names),
                    dtype="int64",
                )
    ...
    def test_to_csv_lineterminators(self):
        ...
        with tm.ensure_clean() as path:
            ...
            expected = (
                b",A,B" + os_linesep + b"one,1,4" + os_linesep + b"two,2,5" + os_linesep + b"three,3,6" + os_linesep
            )
