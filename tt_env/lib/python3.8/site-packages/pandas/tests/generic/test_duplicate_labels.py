...
class TestPreserves:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [
                    pd.Series(1, index=["a", "b"]).set_flags(allows_duplicate_labels=False),
                    pd.Series(2, index=["c", "d"]).set_flags(allows_duplicate_labels=False),
                ],
                {},
            ),
            (
                [
                    pd.Series(1, index=["a", "b"]).set_flags(allows_duplicate_labels=False),
                    pd.Series(2, index=["a", "b"]).set_flags(allows_duplicate_labels=False),
                ],
                {"ignore_index": True},
            ),
            (
            ...
            (
                [
                    pd.DataFrame({"A": [1, 2]}, index=["a", "b"]).set_flags(allows_duplicate_labels=False),
                    pd.DataFrame({"A": [1, 2]}, index=["c", "d"]).set_flags(allows_duplicate_labels=False),
                ],
                {},
            ),
            (
            ...
            (
                [
                    pd.DataFrame({"A": [1, 2]}, index=["a", "b"]).set_flags(allows_duplicate_labels=False),
                    pd.DataFrame({"B": [1, 2]}, index=["a", "b"]).set_flags(allows_duplicate_labels=False),
                ],
                {"axis": 1},
            ),
            # Series / Frame
    ...
    @pytest.mark.parametrize(
        ...
        [
            # false false false
            pytest.param(
                pd.DataFrame({"A": [0, 1]}, index=["a", "b"]).set_flags(allows_duplicate_labels=False),
                pd.DataFrame({"B": [0, 1]}, index=["a", "d"]).set_flags(allows_duplicate_labels=False),
...
class TestRaises:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                [
                    pd.Series(1, index=[0, 1], name="a").set_flags(allows_duplicate_labels=False),
                    pd.Series(2, index=[0, 1], name="a").set_flags(allows_duplicate_labels=False),
                ],
                {"axis": 1},
            )
        ],
