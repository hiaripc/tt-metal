...
class TestDatetimeIndex:
    ...
    @pytest.mark.parametrize("dt_cls", [DatetimeIndex, DatetimeArray._from_sequence_not_strict])
    ...
    def test_constructor_dtype_tz_mismatch_raises(self):
        ...
        msg = "cannot supply both a tz and a timezone-naive dtype " r"\(i\.e\. datetime64\[ns\]\)"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_constructor_with_nonexistent_keyword_arg(self, warsaw):
        ...
        end = Timestamp("2015-03-29 02:30:00").tz_localize(timezone, nonexistent="shift_forward")
