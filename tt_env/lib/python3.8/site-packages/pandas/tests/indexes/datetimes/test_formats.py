...
class TestDatetimeIndexRendering:
    ...
    def test_dti_representation(self, method):
        ...
        idxs.append(DatetimeIndex(["2011-01-01 09:00", "2011-01-01 10:00", pd.NaT], tz="US/Eastern"))
        idxs.append(DatetimeIndex(["2011-01-01 09:00", "2011-01-01 10:00", pd.NaT], tz="UTC"))
    ...
    def test_dti_representation_to_series(self):
        ...
        idx6 = DatetimeIndex(["2011-01-01 09:00", "2011-01-01 10:00", pd.NaT], tz="US/Eastern")
