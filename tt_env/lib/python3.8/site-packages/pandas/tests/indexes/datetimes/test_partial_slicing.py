...
class TestSlicing:
    ...
    def test_partial_slicing_with_multiindex_series(self):
        ...
        ser = DataFrame(np.random.rand(1000, 1000), index=date_range("2000-1-1", periods=1000)).stack()
    ...
    def test_slice_reduce_to_series(self):
        ...
        expected = Series(range(12), index=date_range("2000", periods=12, freq="M"), name="A")
