...
class TestDatetimeIndexTimezones:
    ...
    def test_dti_tz_localize(self, prefix):
        ...
        dti_utc = date_range(start="1/1/2005 05:00", end="1/1/2005 5:00:30.256", freq="L", tz="utc")
    ...
    def test_dti_tz_localize_nonexistent_shift(self, start_ts, tz, end_ts, shift, tz_type):
        # GH 8917
        tz = tz_type + tz
