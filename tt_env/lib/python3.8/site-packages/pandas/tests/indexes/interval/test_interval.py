...
class TestIntervalIndex:
    ...
    def test_maybe_convert_i8_errors(self, breaks1, breaks2, make_key):
        ...
        msg = f"Cannot index an IntervalIndex of subtype {breaks1.dtype} with " f"values of dtype {breaks2.dtype}"
        msg = re.escape(msg)
        with pytest.raises(ValueError, match=msg):
    ...
    def test_missing_values(self, closed):
        idx = Index([np.nan, Interval(0, 1, closed=closed), Interval(1, 2, closed=closed)])
    ...
    def test_is_all_dates(self):
        # GH 23576
        year_2017 = Interval(Timestamp("2017-01-01 00:00:00"), Timestamp("2018-01-01 00:00:00"))
