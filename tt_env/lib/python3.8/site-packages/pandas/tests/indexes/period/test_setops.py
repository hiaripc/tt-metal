...
class TestPeriodIndex:
    def test_union(self, sort):
        ...
        rng5 = PeriodIndex(["2000-01-01 09:01", "2000-01-01 09:03", "2000-01-01 09:05"], freq="T")
        other5 = PeriodIndex(["2000-01-01 09:01", "2000-01-01 09:05", "2000-01-01 09:08"], freq="T")
    ...
    def test_difference(self, sort):
        ...
        rng5 = PeriodIndex(["2000-01-01 09:03", "2000-01-01 09:01", "2000-01-01 09:05"], freq="T")
