...
class TestCommon:
    ...
    def test_unique_level(self, index_flat):
        ...
        msg = rf"Requested level \(wrong\) does not match index name " rf"\({re.escape(index.name.__repr__())}\)"
...
def test_sort_values_with_missing(index_with_missing, na_position, request):
    ...
    if isinstance(index_with_missing, CategoricalIndex):
        request.node.add_marker(pytest.mark.xfail(reason="missing value sorting order not well-defined", strict=False))
