...
class TestGetItem:
    ...
    def test_getitem(self):
        ...
        for idx in [idx1]:
            ...
            result = idx[4::-1]
            expected = TimedeltaIndex(["5 day", "4 day", "3 day", "2 day", "1 day"], freq="-1D", name="idx")
            tm.assert_index_equal(result, expected)
            assert result.freq == expected.freq
...
class TestMaybeCastSliceBound:
    ...
    def test_maybe_cast_slice_bound_invalid_str(self, tdi):
        ...
        msg = "cannot do slice indexing on TimedeltaIndex with these " r"indexers \[foo\] of type str"
        with pytest.raises(TypeError, match=msg):
