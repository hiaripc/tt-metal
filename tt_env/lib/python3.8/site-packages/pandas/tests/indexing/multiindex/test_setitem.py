...
class TestMultiIndexSetItem:
    ...
    def test_frame_setitem_multi_column(self):
        df = DataFrame(np.random.randn(10, 4), columns=[["a", "a", "b", "b"], [0, 1, 0, 1]])
    ...
    def test_loc_getitem_setitem_slice_integers(self, frame_or_series):
        ...
        obj = DataFrame(np.random.randn(len(index), 4), index=index, columns=["a", "b", "c", "d"])
    ...
    def test_set_column_scalar_with_loc(self, multiindex_dataframe_random_data, using_copy_on_write):
        frame = multiindex_dataframe_random_data
...
def test_frame_setitem_copy_no_write(multiindex_dataframe_random_data, using_copy_on_write):
