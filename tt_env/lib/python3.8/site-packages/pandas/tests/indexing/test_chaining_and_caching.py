...
class TestChaining:
    ...
    @pytest.mark.arm_slow
    def test_detect_chained_assignment_raises(self, using_array_manager, using_copy_on_write):
    ...
    @pytest.mark.arm_slow
    def test_detect_chained_assignment_object_dtype(self, using_array_manager, using_copy_on_write):
    ...
    @pytest.mark.arm_slow
    def test_detect_chained_assignment_changing_dtype(self, using_array_manager, using_copy_on_write):
    ...
    def test_detect_chained_assignment_warning_stacklevel(self, rhs, using_copy_on_write):
        # GH#42570
