...
class BaseParser:
    ...
    def read_csv_check_warnings(self, warn_type: type[Warning], warn_msg: str, *args, **kwargs):
    ...
    def read_table_check_warnings(self, warn_type: type[Warning], warn_msg: str, *args, **kwargs):
        # We need to check the stacklevel here instead of in the tests
