...
@pytest.mark.network
@tm.network(
    url=("https://github.com/pandas-dev/pandas/raw/main/" "pandas/tests/io/parser/data/salaries.csv"),
...
def test_compressed_urls(salaries_table, mode, engine, compression_only):
    ...
    base_url = "https://github.com/pandas-dev/pandas/raw/main/" "pandas/tests/io/parser/data/salaries.csv"
...
@pytest.mark.network
@tm.network(
    url=("https://raw.githubusercontent.com/pandas-dev/pandas/main/" "pandas/tests/io/parser/data/unicode_series.csv"),
    check_before_test=True,
)
def test_url_encoding_csv():
    ...
    """
    path = (
        "https://raw.githubusercontent.com/pandas-dev/pandas/main/" + "pandas/tests/io/parser/data/unicode_series.csv"
    )
...
class TestS3:
    ...
    def test_read_feather_s3_file_path(self, feather_file, s3so):
        ...
        res = read_feather("s3://pandas-test/simple_dataset.feather", storage_options=s3so)
