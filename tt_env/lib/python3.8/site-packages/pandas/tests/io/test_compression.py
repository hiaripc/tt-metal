...
_compression_to_extension = {value: key for key, value in icom.extension_to_compression.items()}
...
def test_dataframe_compression_defaults_to_infer(write_method, write_kwargs, read_method, compression_only):
    # GH22004
...
def test_series_compression_defaults_to_infer(write_method, write_kwargs, read_method, read_kwargs, compression_only):
    # GH22004
