...
class Base:
    ...
    @pytest.mark.network
    @tm.network(
        url=("https://raw.githubusercontent.com/pandas-dev/pandas/" "main/pandas/tests/io/data/parquet/simple.parquet"),
...
class TestParquetPyArrow(Base):
    ...
    def test_s3_roundtrip_for_dir(self, df_compat, s3_resource, pa, partition_col, s3so):
        # GH #26388
    ...
    def test_timezone_aware_index(self, request, pa, timezone_aware_date_list):
        if not pa_version_under7p0 and timezone_aware_date_list.tzinfo != datetime.timezone.utc:
    ...
    def test_filter_row_groups(self, pa):
        ...
        with tm.ensure_clean() as path:
            ...
            result = read_parquet(path, pa, filters=[("a", "==", 0)], use_legacy_dataset=False)
        assert len(result) == 1
