...
class TestPlotBase:
    ...
    def _check_patches_all_filled(self, axes: Axes | Sequence[Axes], filled: bool = True) -> None:
        """
    ...
    def _check_ticks_props(self, axes, xlabelsize=None, xrot=None, ylabelsize=None, yrot=None):
        """
    ...
    def _check_box_return_type(self, returned, return_type, expected_keys=None, check_ax_title=True):
        """
