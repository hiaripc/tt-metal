...
class TestTimezoneConcat:
    ...
    def test_concat_multiindex_with_tz(self):
        ...
        exp_idx1 = DatetimeIndex(["2014-01-01", "2014-01-02", "2014-01-03"] * 2, tz="US/Pacific", name="dt")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                pd.NaT,
                marks=pytest.mark.xfail(reason="GH23037 incorrect dtype when concatenating"),
            ),
        ],
    )
