...
def test_api_per_method(
    ...
    allowed_types = (
        ["string", "unicode", "empty"] + ["bytes"] * bytes_allowed + ["mixed", "mixed-integer"] * mixed_allowed
    )
    ...
    if inferred_dtype in allowed_types:
        ...
        # GH 23011, GH 23163
        msg = f"Cannot use .str.{method_name} with values of " f"inferred dtype {repr(inferred_dtype)}."
