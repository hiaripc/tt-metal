...
def test_random_state():
    ...
    assert com.random_state(state_arr_like).uniform() == npr.RandomState(state_arr_like).uniform()

    # Check BitGenerators
    # GH32503
    assert com.random_state(npr.MT19937(3)).uniform() == npr.RandomState(npr.MT19937(3)).uniform()
    assert com.random_state(npr.PCG64(11)).uniform() == npr.RandomState(npr.PCG64(11)).uniform()
