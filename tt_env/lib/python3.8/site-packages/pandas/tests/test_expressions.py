...
@pytest.fixture
def _integer():
    return DataFrame(np.random.randint(1, 100, size=(10001, 4)), columns=list("ABCD"), dtype="int64")
...
@pytest.fixture
def _integer2():
    return DataFrame(np.random.randint(1, 100, size=(101, 4)), columns=list("ABCD"), dtype="int64")
