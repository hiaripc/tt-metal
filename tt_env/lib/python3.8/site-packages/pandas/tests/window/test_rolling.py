...
def test_freq_window_not_implemented(window):
    ...
    with pytest.raises(NotImplementedError, match="step is not supported with frequency windows"):
...
def test_rank(window, method, pct, ascending, test_data):
    ...
    if test_data == "default":
        ...
        ser = Series(data=np.random.choice([1.0, 0.25, 0.75, np.nan, np.inf, -np.inf], length))
