...
def configure(
    ...
    read_only = read and auto is False and path is None and version is None and pandoc_types_version is None
...
def read(source=None, file=None, format=None, options=None):
    ...
    if format == "json":
        ...
        options = ["-t", "json", "-o", output_path] + list(options) + ["-f", format, input_path]
        pandoc(options)
...
def write(doc, file=None, format=None, options=None):
    ...
    if format == "json":
        ...
        options = ["-t", format, "-o", output_path] + list(options) + ["-f", "json", input_path]
        pandoc(options)
...
def main():
    ...
    read_parser.add_argument("file", nargs="?", metavar="FILE", default=None, help="input file")
    read_parser.add_argument("-f", "--format", nargs="?", default=None, help="input format")
    read_parser.add_argument("-o", "--output", nargs="?", default=None, help="output file")
    write_parser = subparsers.add_parser("write")
    write_parser.set_defaults(command="write")
    write_parser.add_argument("file", nargs="?", metavar="FILE", default=None, help="input file")
    write_parser.add_argument("-f", "--format", nargs="?", default=None, help="output format")
    write_parser.add_argument("-o", "--output", nargs="?", default=None, help="output file")
