    ...
    **Examples**
    ...
    while True:
        try:
            ...
            if isinstance(responses[index], child.allowed_string_types):
            ...
            elif isinstance(responses[index], types.FunctionType) or isinstance(responses[index], types.MethodType):
                ...
                raise TypeError(
                    ...
                    "a string, method, or function: {value!r}".format(index=index, value=responses[index])
                )
