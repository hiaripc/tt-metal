...
def compact(paths: Iterable[str]) -> Set[str]:
    ...
    for path in sorted(paths, key=len):
        should_skip = any(
            path.startswith(shortpath.rstrip("*")) and path[len(shortpath.rstrip("*").rstrip(sep))] == sep
        ...
        if (
            ...
            # of pip
                ...
                for top_level_pkg in [
                    p for p in dist.get_metadata("top_level.txt").splitlines() if p and p not in namespaces
                ]:
