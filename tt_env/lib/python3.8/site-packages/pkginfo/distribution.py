...
HEADER_ATTRS_2_2 = HEADER_ATTRS_2_1 + (("Dynamic", "dynamic", True),)  # PEP 643
...
METADATA_VERSIONS = [_version_tuple(key) for key in HEADER_ATTRS]

MAX_METADATA_VERSION = max(METADATA_VERSIONS)
# See: https://bugs.launchpad.net/bugs/2066340
MAX_METADATA_VERSION_STR = ".".join(str(element) for element in MAX_METADATA_VERSION)
