    ...
    def _transform_data(to_data, from_data, should_remove=True, relayout_path=()):
        ...
        if isinstance(to_data, dict):
            ...
            if not isinstance(from_data, dict):
                raise ValueError(
                    "Mismatched data types: {to_dict} {from_data}".format(to_dict=to_data, from_data=from_data)
                )
        ...
        # -----------
            ...
            if not isinstance(from_data, list):
                raise ValueError(
                    "Mismatched data types: to_data: {to_data} {from_data}".format(to_data=to_data, from_data=from_data)
                )
