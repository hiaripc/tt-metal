...
def create_table(
    ...
    **kwargs,
    ...
    colorscale = colorscale if colorscale is not None else [[0, "#00083e"], [0.5, "#ededee"], [1, "#ffffff"]]
    font_colors = font_colors if font_colors is not None else ["#ffffff", "#000000", "#000000"]
