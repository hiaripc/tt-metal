...
class PlotlyRenderer(Renderer):
    ...
    def open_axes(self, ax, props):
        ...
        xaxis = go.layout.XAxis(anchor="y{0}".format(self.axis_ct), zeroline=False, ticks="inside")
        yaxis = go.layout.YAxis(anchor="x{0}".format(self.axis_ct), zeroline=False, ticks="inside")
    ...
    def draw_marked_line(self, **props):
        ...
        if props["coordinates"] == "data":
            marked_line = go.Scatter(
                mode=mode,
                name=(str(props["label"]) if isinstance(props["label"], str) else props["label"]),
    ...
    def draw_text(self, **props):
        ...
        if props["text_type"] == "xlabel":
            ...
            annotation = go.layout.Annotation(
                text=(str(props["text"]) if isinstance(props["text"], str) else props["text"]),
                ...
                font=go.layout.annotation.Font(color=props["style"]["color"], size=props["style"]["fontsize"]),
            )
