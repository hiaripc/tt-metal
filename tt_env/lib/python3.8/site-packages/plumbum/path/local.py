...
class LocalPath(Path):
    ...
    def __new__(cls, *parts):
        ...
        return super().__new__(cls, os.path.normpath(os.path.join(*(str(p) for p in parts))))
    ...
    def glob(self, pattern):
        return self._glob(
            pattern,
            lambda pat: [LocalPath(m) for m in glob.glob(os.path.join(glob.escape(str(self)), pat))],
        )
