...
def calculate_avail_vmem(mems):
    ...
    * https://github.com/famzah/linux-memavailable-procfs/issues/2
    ...
    try:
        ...
        debug(
            f"{err.args[0]} is missing from /proc/meminfo; using an" " approximation for calculating available memory"
        )
        return fallback
    try:
...
def swap_memory():
    ...
    try:
        ...
        msg = "'sin' and 'sout' swap memory stats couldn't " f"be determined and were set to 0 ({err})"
        warnings.warn(msg, RuntimeWarning, stacklevel=2)
        sin = sout = 0
    else:
        with f:
    ...
    if os.path.exists(f"/proc/{os.getpid()}/io"):
        ...
        def io_counters(self):
            ...
            try:
                ...
                msg = f"{err.args[0]!r} field was not found in {fname}; found" f" fields are {fields!r}"
                ...
                if isinstance(err, ValueError) or err.errno == errno.EINVAL:
                    ...
                    for cpu in cpus:
                        ...
                        if cpu not in eligible_cpus:
                            msg = f"CPU number {cpu} is not eligible; choose" f" between {eligible_cpus}"
