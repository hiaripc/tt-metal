...
class TestSpecialMethods(PsutilTestCase):
    ...
    def test_no_such_process__repr__(self):
        assert repr(psutil.NoSuchProcess(321)) == "psutil.NoSuchProcess(pid=321, msg='process no longer exists')"
        assert (
    ...
    def test_no_such_process__str__(self):
        ...
        assert str(psutil.NoSuchProcess(321, name="name", msg="msg")) == "msg (pid=321, name='name')"
    ...
    def test_zombie_process__str__(self):
        ...
        assert (
            str(psutil.ZombieProcess(321, name="name", ppid=320, msg="foo")) == "foo (pid=321, ppid=320, name='name')"
        )
    ...
    def test_timeout_expired__repr__(self):
        assert repr(psutil.TimeoutExpired(5)) == "psutil.TimeoutExpired(seconds=5, msg='timeout after 5" " seconds')"
        assert (
    ...
    def test_timeout_expired__str__(self):
        ...
        assert str(psutil.TimeoutExpired(5, pid=321, name="name")) == "timeout after 5 seconds (pid=321, name='name')"
...
class TestMisc(PsutilTestCase):
    ...
    def test_serialization(self):
        ...
        b = pickle.loads(pickle.dumps(psutil.ZombieProcess(pid=4567, name="name", ppid=42, msg="msg")))
    ...
    def test_ad_on_process_creation(self):
        ...
        with mock.patch.object(psutil.Process, "_get_ident", side_effect=psutil.AccessDenied) as meth:
            psutil.Process()
            assert meth.called

        with mock.patch.object(psutil.Process, "_get_ident", side_effect=psutil.ZombieProcess(1)) as meth:
            psutil.Process()
            assert meth.called
        ...
        with mock.patch.object(psutil.Process, "_get_ident", side_effect=psutil.NoSuchProcess(1)) as meth:
