    ...
    def test_virtual_memory(self):
        ...
        for name in mem._fields:
            ...
            if name != "total":
                ...
                if value > mem.total:
                    raise self.fail(f"{name!r} > total (total={mem.total}, {name}={value})")
...
class TestCpuAPIs(PsutilTestCase):
    ...
    def _test_cpu_percent(self, percent, last_ret, new_ret):
        try:
            ...
            raise AssertionError("\n{}\nlast={}\nnew={}".format(err, pprint.pformat(last_ret), pprint.pformat(new_ret)))
    ...
    @pytest.mark.skipif(MACOS and platform.machine() == "arm64", reason="skipped due to #1892")
...
class TestDiskAPIs(PsutilTestCase):
    ...
    @pytest.mark.skipif(CI_TESTING and not psutil.disk_io_counters(), reason="unreliable on CI")  # no visible disks
    ...
    def test_net_if_addrs(self):
        ...
        for nic, addrs in nics.items():
            ...
            for addr in addrs:
                ...
                if addr.broadcast and addr.netmask and addr.family in {socket.AF_INET, socket.AF_INET6}:
