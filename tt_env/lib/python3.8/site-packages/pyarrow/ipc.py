...
def new_stream(sink, schema, *, use_legacy_format=None, options=None):
    return RecordBatchStreamWriter(sink, schema, use_legacy_format=use_legacy_format, options=options)
...
def new_file(sink, schema, *, use_legacy_format=None, options=None):
    return RecordBatchFileWriter(sink, schema, use_legacy_format=use_legacy_format, options=options)
...
def open_file(source, footer_offset=None, *, options=None, memory_pool=None):
    ...
    reader : RecordBatchFileReader
        A reader for the given source
    """
    return RecordBatchFileReader(source, footer_offset=footer_offset, options=options, memory_pool=memory_pool)
