...
def pytest_configure(config):
    ...
    for mark in groups:
        ...
        is_enabled = config.getoption(enable_flag) and not config.getoption(disable_flag)
    ...
    try:
        ...
        yield {
            ...
            "connection": (
                ...
                port,
                "devstoreaccount1",
                "Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2" "UVErCz4I6tq/K1SZFPTOtr/KBHBeksoGMGw==",
            ),
            "process": proc,
            "tempdir": tmpdir,
        }
