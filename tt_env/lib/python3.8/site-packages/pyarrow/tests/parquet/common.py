...
def _check_roundtrip(table, expected=None, read_table_kwargs=None, **write_table_kwargs):
    if expected is None:
        expected = table
    ...
    result = _roundtrip_table(table, read_table_kwargs=read_table_kwargs, write_table_kwargs=write_table_kwargs)
    assert result.equals(expected)
    result = _roundtrip_table(result, read_table_kwargs=read_table_kwargs, write_table_kwargs=write_table_kwargs)
    assert result.equals(expected)
