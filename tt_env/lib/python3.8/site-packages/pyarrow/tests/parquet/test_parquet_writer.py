...
try:
    ...
    from pyarrow.tests.parquet.common import _read_table, _test_dataframe, _range_integers
except ImportError:
    pq = None
...
def test_validate_schema_write_table(tempdir):
    ...
    with pq.ParquetWriter(path, simple_schema, version="2.6", compression="snappy", flavor="spark") as w:
