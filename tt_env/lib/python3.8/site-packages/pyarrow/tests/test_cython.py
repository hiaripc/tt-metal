...
def check_cython_example_module(mod):
    ...
    with pytest.raises(NotImplementedError, match="Unsupported cast from int64 to list using function " "cast_list"):
...
def test_cython_api(tmpdir):
    ...
    with tmpdir.as_cwd():
        ...
        subprocess.check_call([sys.executable, "-c", code], stdout=subprocess.PIPE, env=subprocess_env)
