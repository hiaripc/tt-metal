...
def test_table():
    ...
    table = pa.Table.from_arrays([pa.array([1.0, 2.0]), pa.array([3.0, 4.0])], ["a", "b"])
...
def test_boolean():
    ...
    table = pa.Table.from_arrays(
        [pa.array([1.0, 31.0, 46.0, 3.0, 57.0, 44.0, 22.0]), pa.array([5.0, 45.0, 36.0, 73.0, 83.0, 23.0, 76.0])],
        ["a", "b"],
    )
...
def test_to_string():
    ...
    assert str(builder.make_literal(2.0, pa.float64())).startswith("(const double) 2 raw(")
