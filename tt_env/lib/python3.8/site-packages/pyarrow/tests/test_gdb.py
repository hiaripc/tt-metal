...
gdb_script = os.environ.get("ARROW_GDB_SCRIPT") or os.path.join(here, "../../../cpp/gdb_arrow.py")
...
class GdbSession:
    ...
    def __init__(self, *args, **env):
        ...
        self.proc = subprocess.Popen(
            gdb_command + list(args), env=gdb_env, bufsize=0, stdin=subprocess.PIPE, stdout=subprocess.PIPE
        )
        self.last_stdout = []
...
def test_status(gdb_arrow):
    ...
    check_stack_repr(gdb_arrow, "error_status", 'arrow::Status::IOError("This is an error")')
    check_stack_repr(
        gdb_arrow,
        "error_detail_status",
        'arrow::Status::IOError("This is an error", ' 'detail=[custom-detail-id] "This is a detail")',
    )

    check_stack_repr(gdb_arrow, "ok_result", "arrow::Result<int>(42)")
    check_stack_repr(gdb_arrow, "error_result", 'arrow::Result<int>(arrow::Status::IOError("This is an error"))')
    check_stack_repr(
        gdb_arrow,
        "error_detail_result",
...
def test_buffer_stack(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow, "buffer_special_chars", r'arrow::Buffer of size 12, read-only, "foo\"bar\000\r\n\t\037"'
    )
...
def test_decimals(gdb_arrow):
    ...
    check_stack_repr(gdb_arrow, "basic_decimal128_pos", f"arrow::BasicDecimal128({v128})")
    check_stack_repr(gdb_arrow, "basic_decimal128_neg", f"arrow::BasicDecimal128(-{v128})")

    v256 = "9876543210987654321098765432109876543210" "987654321098765432109876543210987654"
    ...
    check_stack_repr(gdb_arrow, "basic_decimal256_pos", f"arrow::BasicDecimal256({v256})")
    check_stack_repr(gdb_arrow, "basic_decimal256_neg", f"arrow::BasicDecimal256(-{v256})")


def test_metadata(gdb_arrow):
    check_heap_repr(gdb_arrow, "empty_metadata.get()", "arrow::KeyValueMetadata of size 0")
    check_heap_repr(
        gdb_arrow,
        "metadata.get()",
        ("arrow::KeyValueMetadata of size 2 = {" '["key_text"] = "some value", ["key_binary"] = "z\\000\\037\\377"}'),
    )
...
def test_types_stack(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow, "timestamp_type_ms_timezone", 'arrow::timestamp(arrow::TimeUnit::MILLI, "Europe/Paris")'
    )
    ...
    check_stack_repr(
        gdb_arrow, "dict_type_unordered", "arrow::dictionary(arrow::int16(), arrow::utf8(), ordered=false)"
    )
    ...
    check_stack_repr(
        gdb_arrow,
        "uuid_type",
        ('arrow::ExtensionType "extension<uuid>" ' "with storage type arrow::fixed_size_binary(16)"),
    )
...
def test_types_heap(gdb_arrow):
    ...
    check_heap_repr(
        gdb_arrow, "heap_timestamp_type_ns_timezone", 'arrow::timestamp(arrow::TimeUnit::NANO, "Europe/Paris")'
    )
...
def test_scalars_stack(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow, "timestamp_scalar_ns_tz", 'arrow::TimestampScalar of value -12345678ns ["Europe/Paris"]'
    )
    ...
    check_stack_repr(
        gdb_arrow, "month_day_nano_interval_scalar", "arrow::MonthDayNanoIntervalScalar of value 1M23d-456ns"
    )
    check_stack_repr(
        gdb_arrow, "month_day_nano_interval_scalar_null", "arrow::MonthDayNanoIntervalScalar of null value"
    )
    ...
    check_stack_repr(
        gdb_arrow, "decimal128_scalar_null", "arrow::Decimal128Scalar of null value [precision=10, scale=4]"
    )
    check_stack_repr(
        gdb_arrow,
    ...
    check_stack_repr(
        gdb_arrow, "decimal256_scalar_null", "arrow::Decimal256Scalar of null value [precision=50, scale=4]"
    )
    check_stack_repr(
        gdb_arrow,
    ...
    check_stack_repr(gdb_arrow, "binary_scalar_bytes", r'arrow::BinaryScalar of size 3, value "\000\037\377"')
    ...
    check_stack_repr(
        gdb_arrow, "string_scalar_invalid_chars", r'arrow::StringScalar of size 11, value "abc\x00def\\xffghi"'
    )
    ...
    check_stack_repr(
        gdb_arrow, "fixed_size_binary_scalar_null", 'arrow::FixedSizeBinaryScalar of size 3, null with value "   "'
    )
    ...
    check_stack_repr(
        ...
        "dict_scalar",
        re.compile(
            (r"^arrow::DictionaryScalar of index " r"arrow::Int8Scalar of value 42, " r"dictionary arrow::StringArray ")
        ),
    )
    check_stack_repr(
        gdb_arrow,
    ...
    check_stack_repr(
        ...
        ("arrow::LargeListScalar of type arrow::large_list(arrow::int32()), " "null value"),
    )
    check_stack_repr(
        gdb_arrow,
    ...
    check_stack_repr(
        ...
        ("arrow::FixedSizeListScalar of type " "arrow::fixed_size_list(arrow::int32(), 3), null value"),
    )
    ...
    check_stack_repr(
        gdb_arrow,
        "sparse_union_scalar",
        ("arrow::SparseUnionScalar of type code 7, " "value arrow::Int32Scalar of value 43"),
    )
    check_stack_repr(
        gdb_arrow,
        "sparse_union_scalar_null",
        re.compile(r"^arrow::SparseUnionScalar of type arrow::sparse_union\(.*\), " r"type code 7, null value$"),
    )
    check_stack_repr(
        gdb_arrow,
        "dense_union_scalar",
        ("arrow::DenseUnionScalar of type code 7, " "value arrow::Int32Scalar of value 43"),
    )
    check_stack_repr(
        gdb_arrow,
        "dense_union_scalar_null",
        re.compile(r"^arrow::DenseUnionScalar of type arrow::dense_union\(.*\), " r"type code 7, null value$"),
    )
...
def test_scalars_heap(gdb_arrow):
    ...
    check_heap_repr(
        gdb_arrow, "heap_decimal128_scalar", "arrow::Decimal128Scalar of value 123.4567 [precision=10, scale=4]"
    )
    check_heap_repr(
        gdb_arrow,
    ...
    check_heap_repr(
        ...
        ("arrow::MapScalar of type arrow::map(arrow::utf8(), arrow::int32(), " "keys_sorted=false), null value"),
    )
...
def test_arrays_stack(gdb_arrow):
    check_stack_repr(
        gdb_arrow,
        "int32_array",
        ("arrow::Int32Array of length 4, offset 0, null count 1 = " "{[0] = -5, [1] = 6, [2] = null, [3] = 42}"),
    )
    check_stack_repr(
        gdb_arrow,
        "list_array",
        ("arrow::ListArray of type arrow::list(arrow::int64()), " "length 3, offset 0, null count 1"),
    )
...
def test_arrays_heap(gdb_arrow):
    ...
    check_heap_repr(
        ...
        ("arrow::Int32Array of length 4, offset 0, null count 0 = {" "[0] = -5, [1] = 6, [2] = 3, [3] = 42}"),
    )
    check_heap_repr(
        gdb_arrow,
    ...
    check_heap_repr(
        ...
        ("arrow::Int32Array of length 4, offset 8, unknown null count = {" "[0] = 8, [1] = null, [2] = -9, [3] = -10}"),
    )
    check_heap_repr(
        gdb_arrow, "heap_int32_array_sliced_empty", "arrow::Int32Array of length 0, offset 6, unknown null count"
    )

    check_heap_repr(
        gdb_arrow,
        "heap_double_array",
        ("arrow::DoubleArray of length 2, offset 0, null count 1 = {" "[0] = -1.5, [1] = null}"),
    )
    check_heap_repr(
        gdb_arrow,
        "heap_float16_array",
        ("arrow::HalfFloatArray of length 2, offset 0, null count 0 = {" "[0] = 0.0, [1] = -1.5}"),
    )
    ...
    check_heap_repr(
        gdb_arrow, "heap_bool_array_sliced_empty", "arrow::BooleanArray of length 0, offset 6, unknown null count"
    )
    ...
    check_heap_repr(
        ...
        ("arrow::MonthIntervalArray of length 3, offset 0, null count 1 = {" "[0] = 123M, [1] = -456M, [2] = null}"),
    )
    check_heap_repr(
        gdb_arrow,
        "heap_day_time_interval_array",
        ("arrow::DayTimeIntervalArray of length 2, offset 0, null count 1 = {" "[0] = 1d-600ms, [1] = null}"),
    )
    check_heap_repr(
        gdb_arrow,
        "heap_month_day_nano_interval_array",
        ("arrow::MonthDayNanoIntervalArray of length 2, offset 0, " "null count 1 = {[0] = 1M-600d5000ns, [1] = null}"),
    )
    check_heap_repr(
        gdb_arrow,
    ...
    check_heap_repr(
        ...
        (r"arrow::BinaryArray of length 1, offset 1, unknown null count = " r'{[0] = "abcd"}'),
    )
...
def test_schema(gdb_arrow):
    ...
    check_heap_repr(
        gdb_arrow,
        "schema_non_empty",
        ('arrow::Schema with 2 fields = {["ints"] = arrow::int8(), ' '["strs"] = arrow::utf8()}'),
    )
    check_heap_repr(
        gdb_arrow,
        "schema_with_metadata",
        ("arrow::Schema with 2 fields and 2 metadata items = " '{["ints"] = arrow::int8(), ["strs"] = arrow::utf8()}'),
    )
...
def test_datum(gdb_arrow):
    ...
    check_stack_repr(gdb_arrow, "array_datum", re.compile(r"^arrow::Datum of value arrow::ArrayData of type "))
    check_stack_repr(
        gdb_arrow, "chunked_array_datum", re.compile(r"^arrow::Datum of value arrow::ChunkedArray of type ")
    )
    check_stack_repr(
        gdb_arrow, "batch_datum", re.compile(r"^arrow::Datum of value arrow::RecordBatch " r"with 2 columns, 3 rows ")
    )
    check_stack_repr(
        gdb_arrow, "table_datum", re.compile(r"^arrow::Datum of value arrow::Table " r"with 2 columns, 5 rows ")
    )
