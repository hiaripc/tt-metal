...
def test_build_info():
    ...
    assert pa.cpp_build_info.build_type in ("debug", "release", "minsizerel", "relwithdebinfo")
...
@pytest.mark.skipif(
    sys.platform == "win32", reason="Path to timezone database is not configurable " "on non-Windows platforms"
)
