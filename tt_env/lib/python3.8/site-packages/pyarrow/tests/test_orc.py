...
def test_orcfile_empty(datadir):
    ...
    expected_schema = pa.schema(
        [
            ...
            ("bytes1", pa.binary()),
            ("string1", pa.string()),
            ("middle", pa.struct([("list", pa.list_(pa.struct([("int1", pa.int32()), ("string1", pa.string())])))])),
            ("list", pa.list_(pa.struct([("int1", pa.int32()), ("string1", pa.string())]))),
            ("map", pa.map_(pa.string(), pa.struct([("int1", pa.int32()), ("string1", pa.string())]))),
        ]
    )
...
def test_filesystem_uri(tmpdir):
    ...
    # filesystem URI
    result = orc.read_table("data_dir/data.orc", filesystem=util._filesystem_uri(tmpdir))
    assert result.equals(table)
...
def test_column_selection(tempdir):
    ...
    fields = [
        ...
        pa.field(
            "list-struct",
            pa.list_(pa.field("item", pa.struct([pa.field("inner1", pa.int64()), pa.field("inner2", pa.int64())]))),
        ),
