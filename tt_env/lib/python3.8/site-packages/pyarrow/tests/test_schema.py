...
bar: string
  ...
  key3: 'value3'"""
    ...
    assert (
        my_schema.to_string(truncate_metadata=False, show_field_metadata=False, show_schema_metadata=False)
        == """\
foo: int32 not null
bar: string"""
    )
...
def test_type_schema_pickling(pickle_module):
    cases = [
        ...
        pa.union([pa.field("a", pa.int8()), pa.field("b", pa.int16())], pa.lib.UnionMode_SPARSE),
        pa.union([pa.field("a", pa.int8()), pa.field("b", pa.int16())], pa.lib.UnionMode_DENSE),
        pa.time32("s"),
        pa.time64("us"),
        pa.date32(),
        pa.date64(),
        ...
        pa.map_(pa.field("key", pa.string(), nullable=False), pa.field("value", pa.int8())),
    ]
...
def test_empty_table():
    ...
    schema2 = pa.schema([pa.field("a", pa.int64(), nullable=False), pa.field("b", pa.int64())])
