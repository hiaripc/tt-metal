...
from pyarrow.util import doc, _break_traceback_cycle_from_frame, download_tzdata_on_windows
...
@pytest.mark.skipif(sys.platform != "win32", reason="Timezone database is already provided.")
