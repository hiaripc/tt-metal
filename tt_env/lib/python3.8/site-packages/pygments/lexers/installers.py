...
class DebianSourcesLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"^([a-zA-Z\-0-9\.]*?)(:)(\s*)(.*?)$", bygroups(Keyword, Punctuation, Whitespace, String)),
        ],
        "signed-by": [
...
class DebianControlLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"^(Maintainer|Uploaders|Changed-By)(:)(\s*)", bygroups(Keyword, Punctuation, Whitespace), "maintainer"),
            (
            ...
            (r"^((?:Python-)?Version)(:)(\s*)(\S+)$", bygroups(Keyword, Punctuation, Whitespace, Number)),
            (r"^((?:Installed-)?Size)(:)(\s*)(\S+)$", bygroups(Keyword, Punctuation, Whitespace, Number)),
            (r"^(MD5Sum|SHA1|SHA256)(:)(\s*)(\S+)$", bygroups(Keyword, Punctuation, Whitespace, Number)),
            (r"^([a-zA-Z\-0-9\.]*?)(:)(\s*)(.*?)$", bygroups(Keyword, Punctuation, Whitespace, String)),
        ],
        "maintainer": [
        ...
        "package_list": [
            (
                r"(\$)(\{)(\w+)(\s*)(:)(\s*)(\w+)(\})",
                bygroups(Operator, Punctuation, Name.Entity, Whitespace, Punctuation, Whitespace, Text, Punctuation),
            ),
