...
class SwiftLexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            ...
            (r"(func)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword.Declaration, Whitespace, Name.Function)),
            (r"(var|let)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword.Declaration, Whitespace, Name.Variable)),
            (
                words(
                    (
                        "actor",
        ...
        "module": [(r"\n", Whitespace, "#pop"), (r"[a-zA-Z_]\w*", Name.Class), include("root")],
        "preproc": [
            (r"\n", Whitespace, "#pop"),
            include("keywords"),
