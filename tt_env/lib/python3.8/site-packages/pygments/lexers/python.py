...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(from)((?:\s|\\\s)+)", bygroups(Keyword.Namespace, Whitespace), "fromimport"),
            (r"(import)((?:\s|\\\s)+)", bygroups(Keyword.Namespace, Whitespace), "import"),
            include("expr"),
        ],
        "expr": [
            # raw f-strings
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(from)(\d+)(<=)(\s+)(<)(\d+)(:)",
                bygroups(Keyword, Number.Integer, Operator, Whitespace, Operator, Name, Punctuation),
            ),
            include("keywords"),
