...
class ResolutionError(RFC3986Exception):
    ...
    def __init__(self, uri):
        ...
        super().__init__("{} does not meet the requirements for resolution.".format(uri.unsplit()))
...
class PasswordForbidden(ValidationError):
    ...
    def __init__(self, uri):
        ...
        super().__init__('"{}" contained a password when validation forbade it'.format(unsplit()))
        self.uri = uri
