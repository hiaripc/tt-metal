...
_msg = "scipy.{0} is deprecated and will be removed in SciPy 2.0.0, " "use numpy.{0} instead"
...
_msg = "scipy.{0} is deprecated and will be removed in SciPy 2.0.0, " "use numpy.random.{0} instead"
...
ifft = _deprecated("scipy.ifft is deprecated and will be removed in SciPy " "2.0.0, use scipy.fft.ifft instead")(ifft)

from numpy.lib import scimath  # noqa: E402

_msg = "scipy.{0} is deprecated and will be removed in SciPy 2.0.0, " "use numpy.lib.scimath.{0} instead"
...
if __SCIPY_SETUP__:
    ...
    __all__ = submodules + ["LowLevelCallable", "test", "show_config", "__version__", "__numpy_version__"]
