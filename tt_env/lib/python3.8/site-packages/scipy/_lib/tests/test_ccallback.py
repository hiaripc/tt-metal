...
FUNCS = {
    ...
    "cffi": lambda: _get_cffi_func(_test_ccallback_cython.plus1_ctypes, "double (*)(double, int *, void *)"),
    ...
    "cffi_b": lambda: _get_cffi_func(_test_ccallback_cython.plus1b_ctypes, "double (*)(double, double, int *, void *)"),
}
