...
# Global data
X = np.array([[3.0, 3], [4, 3], [4, 2], [9, 2], [5, 1], [6, 2], [9, 4], [5, 2], [5, 4], [7, 4], [6, 5]])
...
class TestWhiten:
    ...
    def test_whiten_zero_std(self):
        desired = np.array([[0.0, 1.0, 2.86666544], [0.0, 1.0, 1.32460034], [0.0, 1.0, 3.74382172]])
        for tp in np.array, matrix:
            obs = tp([[0.0, 1.0, 0.74109533], [0.0, 1.0, 0.34243798], [0.0, 1.0, 0.96785929]])
