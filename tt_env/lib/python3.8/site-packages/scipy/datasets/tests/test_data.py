...
def test_clear_cache(tmp_path):
    ...
    _clear_cache(datasets=[data1, data2], cache_dir=dummy_basepath, method_map=dummy_method_map)
    ...
    _clear_cache(datasets=[data4], cache_dir=dummy_basepath, method_map=dummy_method_map)
    ...
    with pytest.raises(ValueError):
        _clear_cache(datasets=[data5], cache_dir=dummy_basepath, method_map=dummy_method_map)
