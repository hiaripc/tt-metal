...
class TestFFT1D:
    def test_identity(self):
        ...
        for i in range(1, maxlen):
            assert_array_almost_equal(fft.ifft(fft.fft(x[0:i])), x[0:i], decimal=12)
            assert_array_almost_equal(fft.irfft(fft.rfft(xr[0:i]), i), xr[0:i], decimal=12)
    ...
    def test_fft(self):
        ...
        assert_array_almost_equal(expect / np.sqrt(30), fft.fft(x, norm="ortho"))
    ...
    def test_ifft(self):
        ...
        for norm in ["backward", "ortho", "forward"]:
            assert_array_almost_equal(x, fft.ifft(fft.fft(x, norm=norm), norm=norm))
    ...
    def test_fft2(self):
        ...
        assert_array_almost_equal(expect / np.sqrt(30 * 20), fft.fft2(x, norm="ortho"))
        assert_array_almost_equal(expect / (30 * 20), fft.fft2(x, norm="forward"))
    ...
    def test_ifft2(self):
        ...
        assert_array_almost_equal(expect * np.sqrt(30 * 20), fft.ifft2(x, norm="ortho"))
        assert_array_almost_equal(expect * (30 * 20), fft.ifft2(x, norm="forward"))
    ...
    def test_fftn(self):
        ...
        assert_array_almost_equal(expect / np.sqrt(30 * 20 * 10), fft.fftn(x, norm="ortho"))
        assert_array_almost_equal(expect / (30 * 20 * 10), fft.fftn(x, norm="forward"))
    ...
    def test_ifftn(self):
        ...
        assert_array_almost_equal(fft.ifftn(x) * np.sqrt(30 * 20 * 10), fft.ifftn(x, norm="ortho"))
        assert_array_almost_equal(expect * (30 * 20 * 10), fft.ifftn(x, norm="forward"))

    def test_rfft(self):
        x = random(29)
        for n in [x.size, 2 * x.size]:
            for norm in [None, "backward", "ortho", "forward"]:
                assert_array_almost_equal(fft.fft(x, n=n, norm=norm)[: (n // 2 + 1)], fft.rfft(x, n=n, norm=norm))
            assert_array_almost_equal(fft.rfft(x, n=n) / np.sqrt(n), fft.rfft(x, n=n, norm="ortho"))

    def test_irfft(self):
        x = random(30)
        assert_array_almost_equal(x, fft.irfft(fft.rfft(x)))
        for norm in ["backward", "ortho", "forward"]:
            assert_array_almost_equal(x, fft.irfft(fft.rfft(x, norm=norm), norm=norm))
    ...
    def test_rfft2(self):
        ...
        assert_array_almost_equal(expect / np.sqrt(30 * 20), fft.rfft2(x, norm="ortho"))
        assert_array_almost_equal(expect / (30 * 20), fft.rfft2(x, norm="forward"))

    def test_irfft2(self):
        x = random((30, 20))
        assert_array_almost_equal(x, fft.irfft2(fft.rfft2(x)))
        for norm in ["backward", "ortho", "forward"]:
            assert_array_almost_equal(x, fft.irfft2(fft.rfft2(x, norm=norm), norm=norm))
    ...
    def test_rfftn(self):
        ...
        assert_array_almost_equal(expect / np.sqrt(30 * 20 * 10), fft.rfftn(x, norm="ortho"))
        assert_array_almost_equal(expect / (30 * 20 * 10), fft.rfftn(x, norm="forward"))

    def test_irfftn(self):
        x = random((30, 20, 10))
        assert_array_almost_equal(x, fft.irfftn(fft.rfftn(x)))
        for norm in ["backward", "ortho", "forward"]:
            assert_array_almost_equal(x, fft.irfftn(fft.rfftn(x, norm=norm), norm=norm))
    ...
    def test_hfft(self):
        ...
        assert_array_almost_equal(expect / np.sqrt(30), fft.hfft(x_herm, norm="ortho"))
        assert_array_almost_equal(expect / 30, fft.hfft(x_herm, norm="forward"))
    ...
    def test_ihfft(self):
        ...
        for norm in ["backward", "ortho", "forward"]:
            assert_array_almost_equal(x_herm, fft.ihfft(fft.hfft(x_herm, norm=norm), norm=norm))

    def test_hfft2(self):
        x = random((30, 20))
        assert_array_almost_equal(x, fft.hfft2(fft.ihfft2(x)))
        for norm in ["backward", "ortho", "forward"]:
            assert_array_almost_equal(x, fft.hfft2(fft.ihfft2(x, norm=norm), norm=norm))
    ...
    def test_ihfft2(self):
        ...
        assert_array_almost_equal(expect * np.sqrt(30 * 20), fft.ihfft2(x, norm="ortho"))
        assert_array_almost_equal(expect * (30 * 20), fft.ihfft2(x, norm="forward"))

    def test_hfftn(self):
        x = random((30, 20, 10))
        assert_array_almost_equal(x, fft.hfftn(fft.ihfftn(x)))
        for norm in ["backward", "ortho", "forward"]:
            assert_array_almost_equal(x, fft.hfftn(fft.ihfftn(x, norm=norm), norm=norm))
    ...
    def test_ihfftn(self):
        ...
        assert_array_almost_equal(expect * np.sqrt(30 * 20 * 10), fft.ihfftn(x, norm="ortho"))
        assert_array_almost_equal(expect * (30 * 20 * 10), fft.ihfftn(x, norm="forward"))

    @pytest.mark.parametrize("op", [fft.fftn, fft.ifftn, fft.rfftn, fft.irfftn, fft.hfftn, fft.ihfftn])
...
@pytest.mark.parametrize("dtype", [np.float32, np.float64, np.longfloat, np.complex64, np.complex128, np.longcomplex])
...
class TestFFTThreadSafe:
    ...
    def _test_mtsame(self, func, *args):
        ...
        for i in range(self.threads):
            assert_array_equal(q.get(timeout=5), expected, "Function returned wrong value in multithreaded context")
