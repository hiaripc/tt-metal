...
METHODS = {"RK23": RK23, "RK45": RK45, "DOP853": DOP853, "Radau": Radau, "BDF": BDF, "LSODA": LSODA}
    ...
    **options
    ...
    if args is not None:
        ...
        try:
            ...
            suggestion_tuple = (
                "Supplied 'args' cannot be unpacked. Please supply `args`" f" as a tuple (e.g. `args=({args},)`)"
            )
