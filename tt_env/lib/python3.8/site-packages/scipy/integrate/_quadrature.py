...
def quadrature(func, a, b, args=(), tol=1.49e-8, rtol=1.49e-8, maxiter=50, vec_func=True, miniter=1):
    """
...
def _basic_simpson(y, start, stop, x, dx, axis):
    ...
    if x is None:  # Even-spaced Simpson's rule.
        ...
        tmp = (
            ...
            / 6.0
            * (
                y[slice0] * (2.0 - np.true_divide(1.0, h0divh1, out=np.zeros_like(h0divh1), where=h0divh1 != 0))
                + y[slice1] * (hsum * np.true_divide(hsum, hprod, out=np.zeros_like(hsum), where=hprod != 0))
...
def _qmc_quad(func, a, b, *, n_points=1024, n_estimates=8, qrng=None, log=False, args=None):
    """
