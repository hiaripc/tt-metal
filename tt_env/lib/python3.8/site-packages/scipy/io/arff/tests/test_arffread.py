...
class TestDateAttribute:
    ...
    def test_date_attribute(self):
        expected = np.array(
            ["1999-01-31", "2004-12-01", "1817-04-28", "2100-09-10", "2013-11-30", "1631-10-15"], dtype="datetime64[D]"
        )
    ...
    def test_datetime_missing(self):
        expected = np.array(
            ["nat", "2004-12-01T23:59", "nat", "nat", "2013-11-30T04:55", "1631-10-15T20:04"], dtype="datetime64[m]"
        )
...
class TestRelationalAttribute:
    ...
    def test_data(self):
        ...
        expected = [
            ...
            np.array([("2100-09-10", 4), ("1957-04-17", 40), ("1721-01-14", 400)], dtype=dtype_instance),
