...
def _has_struct(elem):
    ...
    return isinstance(elem, np.ndarray) and (elem.size > 0) and isinstance(elem[0], mat_struct)
...
class VarWriter5:
    ...
    def write_char(self, arr, codec="ascii"):
        ...
        if arr.dtype.kind == "U" and arr.size:
            ...
            st_arr = np.ndarray(shape=(), dtype=arr_dtype_number(arr, n_chars), buffer=arr.T.copy())  # Fortran order
