...
from scipy.io.matlab._streams import make_stream, GenericStream, ZlibInputStream, _read_into, _read_string, BLOCK_SIZE
...
class TestZlibInputStream:
    ...
    def test_read(self):
        SIZES = [0, 1, 10, BLOCK_SIZE // 2, BLOCK_SIZE - 1, BLOCK_SIZE, BLOCK_SIZE + 1, 2 * BLOCK_SIZE - 1]
