            ...
            for j in range(3):
                for k in range(2):
                    ...
                    assert_array_identical(
                        s.arrays_rep.c[i, j, k], np.array([np.complex64(1 + 2j), np.complex64(7 + 8j)])
                    )
                    assert_array_identical(
                        s.arrays_rep.d[i, j, k], np.array([b"cheese", b"bacon", b"spam"], dtype=object)
                    )
...
class TestPointers:
    ...
    def test_pointers(self):
        ...
        assert_identical(s.c64_pointer1, np.complex128(1.1987253647623157e112 - 5.1987258887729157e307j))
        assert_identical(s.c64_pointer2, np.complex128(1.1987253647623157e112 - 5.1987258887729157e307j))
