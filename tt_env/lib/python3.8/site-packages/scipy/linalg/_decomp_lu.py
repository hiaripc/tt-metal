...
def lu_factor(a, overwrite_a=False, check_finite=True):
    ...
    if info < 0:
        raise ValueError("illegal value in %dth argument of " "internal getrf (lu_factor)" % -info)
    if info > 0:
...
def lu_solve(lu_and_piv, b, trans=0, overwrite_b=False, check_finite=True):
    ...
    if lu.shape[0] != b1.shape[0]:
        raise ValueError("Shapes of lu {} and b {} are incompatible".format(lu.shape, b1.shape))
