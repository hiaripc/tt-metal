...
@_deprecated(
    msg="scipy.misc.central_diff_weights is deprecated in "
...
@_deprecated(
    msg="scipy.misc.derivative is deprecated in "
    "SciPy v1.10.0; and will be completely removed in "
    "SciPy v1.12.0. You may consider using "
    "findiff: https://github.com/maroba/findiff or "
    "numdifftools: https://github.com/pbrod/numdifftools"
...
@_deprecated(
    msg="scipy.misc.ascent has been deprecated in SciPy v1.10.0;"
...
@_deprecated(
    msg="scipy.misc.face has been deprecated in SciPy v1.10.0; "
    "and will be completely removed in SciPy v1.12.0. "
    "Dataset methods have moved into the scipy.datasets "
...
@_deprecated(
    msg="scipy.misc.electrocardiogram has been "
