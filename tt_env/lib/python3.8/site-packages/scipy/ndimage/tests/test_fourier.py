...
class TestNdimageFourier:
    ...
    @pytest.mark.parametrize("dtype, dec", [(numpy.float32, 6), (numpy.float64, 14)])
    ...
    @pytest.mark.parametrize("shape", [(32, 16), (31, 15), (1, 10)])
    @pytest.mark.parametrize("dtype, dec", [(numpy.float32, 5), (numpy.float64, 14)])
    ...
    def test_fourier_ellipsoid_1d_complex(self):
        ...
        for shape in [(32,), (31,)]:
            for type_, dec in zip([numpy.complex64, numpy.complex128], [5, 14]):
    ...
    @pytest.mark.parametrize(
        "test_func", [ndimage.fourier_ellipsoid, ndimage.fourier_gaussian, ndimage.fourier_uniform]
    )
