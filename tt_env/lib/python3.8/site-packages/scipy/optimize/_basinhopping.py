    ...
    def _monte_carlo_step(self):
        ...
        if hasattr(self.step_taking, "report"):
            self.step_taking.report(
                accept, f_new=energy_after_quench, x_new=x_after_quench, f_old=self.energy, x_old=self.x
            )
    ...
    def _adjust_step_size(self):
        ...
        if self.verbose:
            print(
                ...
                % (accept_rate, self.target_accept_rate, self.takestep.stepsize, old_stepsize)
            )
    ...
    if take_step is not None:
        ...
        if hasattr(take_step, "stepsize"):
            take_step_wrapped = AdaptiveStepsize(
                take_step, interval=interval, accept_rate=target_accept_rate, factor=stepwise_factor, verbose=disp
            )
        else:
        ...
        take_step_wrapped = AdaptiveStepsize(
            displace, interval=interval, accept_rate=target_accept_rate, factor=stepwise_factor, verbose=disp
        )
