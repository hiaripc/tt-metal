    ...
    def __init__(
        ...
        *,
        ...
        if vectorized and workers != 1:
            warnings.warn(
                "differential_evolution: the 'workers' keyword" " overrides the 'vectorized' keyword", stacklevel=2
            )
    ...
    def solve(self):
        ...
        if self._wrapped_constraints:
            ...
            if DE_result.maxcv > 0:
                ...
                DE_result.message = "The solution does not satisfy the " f"constraints, MAXCV = {DE_result.maxcv}"
    ...
    def __next__(self):
        ...
        if self._updating == "immediate":
            ...
            loc = [
                ...
                for val in zip(
                    trial_energies, feasible, cv, self.population_energies, self.feasible, self.constraint_violation
                )
            ]
            loc = np.array(loc)
