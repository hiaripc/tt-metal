...
from typing import Any, Callable, Iterable, Optional, Tuple, TYPE_CHECKING, Union
...
def direct(
    ...
    *,
    ...
    return OptimizeResult(
        x=np.asarray(x), fun=fun, status=ret_code, success=ret_code > 2, message=message, nfev=nfev, nit=nit
    )
