...
def _highs_to_scipy_status_message(highs_status, highs_message):
    ...
    scipy_statuses_messages = {
        ...
        MODEL_STATUS_UNBOUNDED_OR_INFEASIBLE: (4, "The problem is unbounded " "or infeasible. "),
    }
    ...
    scipy_message = f"{scipy_message}" f"(HiGHS Status {highs_status}: {highs_message})"
...
def _linprog_highs(
    ...
    **unknown_options,
    ...
    simplex_dual_edge_weight_strategy_enum = _convert_to_highs_enum(
        ...
        "simplex_dual_edge_weight_strategy",
        choices={
            "dantzig": HIGHS_SIMPLEX_EDGE_WEIGHT_STRATEGY_DANTZIG,
            "devex": HIGHS_SIMPLEX_EDGE_WEIGHT_STRATEGY_DEVEX,
            "steepest-devex": HIGHS_SIMPLEX_EDGE_WEIGHT_STRATEGY_CHOOSE,
            "steepest": HIGHS_SIMPLEX_EDGE_WEIGHT_STRATEGY_STEEPEST_EDGE,
            None: None,
        },
    )
    ...
    sol = {
        ...
        "upper": OptimizeResult({"residual": None if x is None else ub - x, "marginals": marg_upper}),
        "fun": res.get("fun"),
        "status": status,
