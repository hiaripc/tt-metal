...
def _clean_inputs(lp):
    ...
    try:
        ...
        raise ValueError(
            "Invalid input for linprog: unable to interpret bounds, " "check values and dimensions: " + e.args[0]
        ) from e
    ...
    if len(bsh) > 2:
        ...
        raise ValueError(
            "Invalid input for linprog: provide a 2-D array for bounds, " "not a {:d}-D array.".format(len(bsh))
        )
        ...
        raise ValueError(
            "Invalid input for linprog: provide a {:d} x 2 array for bounds, " "not a 2 x {:d} array.".format(n_x, n_x)
        )
    else:
        raise ValueError(
            "Invalid input for linprog: unable to interpret bounds with this " "dimension tuple: {0}.".format(bsh)
        )
