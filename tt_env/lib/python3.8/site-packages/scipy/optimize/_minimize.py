...
def minimize(
    ...
    **Custom minimizers**
    ...
    if x0.ndim != 1:
        message = (
            "Use of `minimize` with `x0.ndim != 1` is deprecated. "
    ...
    # - hess
    if (
        meth not in ("newton-cg", "dogleg", "trust-ncg", "trust-constr", "trust-krylov", "trust-exact", "_custom")
    ...
    if (
        meth not in ("nelder-mead", "powell", "l-bfgs-b", "tnc", "slsqp", "trust-constr", "_custom")
    ...
    if meth == "nelder-mead":
        ...
        res = _minimize_cobyla(fun, x0, args, constraints, callback=callback, **options)
    elif meth == "slsqp":
