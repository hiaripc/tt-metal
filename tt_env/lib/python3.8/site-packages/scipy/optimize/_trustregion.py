...
import numpy as np
import scipy.linalg
from ._optimize import _check_unknown_options, _status_message, OptimizeResult, _prepare_scalar_function
...
def _minimize_trust_region(
    ...
    **unknown_options,
    ...
    if hess is None and hessp is None:
        raise ValueError(
            "Either the Hessian or the Hessian-vector product " "is currently required for trust-region methods"
        )
