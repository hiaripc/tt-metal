...
from .._constraints import NonlinearConstraint, LinearConstraint, PreparedConstraint, strict_bounds
...
def _minimize_trustregion_constr(
    ...
    if method == "equality_constrained_sqp":
        ...
        def stop_criteria(
            state, x, last_iteration_failed, optimality, constr_violation, tr_radius, constr_penalty, cg_info
        ):
            state = update_state_sqp(
                state,
                x,
        ...
        def stop_criteria(
            state, x, last_iteration_failed, tr_radius, constr_penalty, cg_info, barrier_parameter, barrier_tolerance
        ):
