...
class TestDifferentialEvolutionSolver:
    ...
    def test_population_initiation(self):
        ...
        solver = DifferentialEvolutionSolver(
            rosen, self.bounds, init=population, strategy="best2bin", atol=0.01, seed=1, popsize=5
        )
    ...
    def test_constraint_population_feasibilities(self):
        ...
        for vectorize in [False, True]:
            solver = DifferentialEvolutionSolver(
                rosen, [(0, 2), (0, 2)], constraints=(nlc, nlc2), vectorized=vectorize, updating="deferred"
            )
    ...
    def test_accept_trial(self):
        ...
        assert fn(1.0, False, np.array([0.5, 0.5]), 1.0, False, np.array([1.0, 0.4])) == False
    ...
    def test_L6(self):
        ...
        bounds = [(13, 100), (0, 100)]
        constraints = N
        res = differential_evolution(f, bounds, strategy="rand1bin", seed=1234, constraints=constraints, tol=1e-7)
    ...
    def test_L8(self):
        ...
        with suppress_warnings() as sup:
            ...
            res = differential_evolution(
                f, bounds, strategy="best1bin", seed=1234, constraints=constraints, maxiter=5000
            )
    ...
    def test_vectorized_constraints(self):
        ...
        res1 = differential_evolution(
            rosen, bounds, updating="deferred", seed=1, constraints=[nlc1, nlc2], polish=False
        )
        res2 = differential_evolution(
            rosen_vec, bounds, vectorized=True, updating="deferred", seed=1, constraints=[nlc1, nlc2], polish=False
        )
        # the two minimisation runs should be functionally equivalent
        assert_allclose(res1.x, res2.x)
    ...
    def test_constraint_violation_error_message(self):
        ...
        result = differential_evolution(
            func, bounds=[(-1, 2), (-1, 1)], constraints=[c0, c1], maxiter=10, polish=False, seed=864197532
        )
