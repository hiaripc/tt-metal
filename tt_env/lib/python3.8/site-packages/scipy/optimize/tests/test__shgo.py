...
class StructTest5(StructTestFunction):
    def f(self, x):
        return -(x[1] + 47.0) * numpy.sin(numpy.sqrt(abs(x[0] / 2.0 + (x[1] + 47.0)))) - x[0] * numpy.sin(
            numpy.sqrt(abs(x[0] - (x[1] + 47.0)))
        )
...
test5_1 = StructTest5(
    bounds=[(-512, 512), (-512, 512)], expected_fun=[-959.64066272085051], expected_x=[512.0, 404.23180542]
)
...
testLJ = StructTestLJ(
    bounds=boundsLJ,
    expected_fun=[-1.0],
    expected_x=[-2.71247337e-08, -2.71247337e-08, -2.50000222e00, -2.71247337e-08, -2.71247337e-08, -1.50000222e00],
)
...
class TestShgoSimplicialTestFunctions:
    ...
    def test_f2_1_simplicial(self):
        ...
        run_test(test2_1, iters=7, options=options, sampling_method="simplicial")
    ...
    def test_lj_symmetry(self):
        ...
        run_test(testLJ, args=args, n=None, options=options, iters=4, sampling_method="simplicial")
...
class TestShgoArguments:
    ...
    def test_1_2_simpl_iter(self):
        ...
        options = {"minimize_every_iter": False}
        run_test(test2_1, n=None, iters=7, options=options, sampling_method="simplicial")
    ...
    def test_4_3_known_f_min(self):
        ...
        run_test(test4_1, n=1024, test_atol=1e-5, options=options, sampling_method="sobol")
    ...
    def test_7_1_minkwargs(self):
        ...
        for solver in ["COBYLA", "SLSQP"]:
            ...
            print("=" * 100)
            run_test(test3_1, n=128, test_atol=1e-3, minimizer_kwargs=minimizer_kwargs, sampling_method="sobol")
    ...
    def test_7_3_minkwargs(self):
        ...
        for solver in [
            ...
            logging.info("=" * 100)
            run_test(test1_1, n=128, test_atol=1e-3, minimizer_kwargs=minimizer_kwargs, sampling_method="sobol")
    ...
    def test_10_finite_time(self):
        ...
        shgo(test1_1.f, test1_1.bounds, n=1, iters=None, options=options, sampling_method="sobol")

    def test_11_f_min_time(self):
        """Test to cover the case where f_lowest == 0"""
        options = {"maxtime": 1e-15, "f_min": 0.0}
        shgo(test1_2.f, test1_2.bounds, n=1, iters=None, options=options, sampling_method="sobol")
...
class TestShgoFailures:
    def test_1_maxiter(self):
        ...
        options = {"maxiter": 2}
        res = shgo(test4_1.f, test4_1.bounds, n=4, iters=None, options=options, sampling_method="sobol")
    ...
    def test_3_1_no_min_pool_sobol(self):
        ...
        res = shgo(test_table.f, test_table.bounds, n=4, options=options, sampling_method="sobol")
        numpy.testing.assert_equal(False, res.success)
    ...
    def test_5_1_2_infeasible_sobol(self):
        ...
        options = {"maxev": 64, "disp": True, "infty_constraints": False}
