...
def test_performance():
    ...
    for xscale, yscale, line_search in itertools.product([1.0, 1e-10, 1e10], [1.0, 1e-10, 1e10], ["cruz", "cheng"]):
...
def F_4(x, n):
    ...
    g[1::3] = (
        0.48 * x[::3] - 0.72 * x[1::3] ** 3 + 3.24 * x[1::3] ** 2 - 4.32 * x[1::3] - x[2::3] + 0.2 * x[2::3] ** 3 + 2.16
    )
