...
class TestCobyla:
    def setup_method(self):
        ...
        self.opts = {"disp": False, "rhobeg": 1, "tol": 1e-5, "maxiter": 100}
    ...
    def test_simple(self):
        ...
        x = fmin_cobyla(self.fun, self.x0, [self.con1, self.con2], rhobeg=1, rhoend=1e-5, maxfun=100, disp=True)
    ...
    def test_minimize_simple(self):
        ...
        assert_array_equal(
            sol.x, callback.last_x, "Last design vector sent to the callback is not equal to returned value."
        )
    ...
    def test_minimize_constraint_violation(self):
        ...
        with pytest.warns(DeprecationWarning, match=message):
            sol = minimize(f, w0, method="cobyla", constraints=cons, options={"catol": 1e-6})
