...
class TestNonlin:
        ...
        if method == "krylov":
            for jac_method in ["gmres", "bicgstab", "cgs", "minres", "tfqmr"]:
                ...
                res = root(
                    ...
                    f.xin,
                    method=method,
                    options={"ftol": f_tol, "maxiter": 200, "disp": 0, "jac_options": {"method": jac_method}},
                )
    ...
    def test_tol_norm_called(self, method):
        ...
        nonlin.newton_krylov(F, F.xin, method=method, f_tol=1e-2, maxiter=200, verbose=0, tol_norm=local_norm_func)
