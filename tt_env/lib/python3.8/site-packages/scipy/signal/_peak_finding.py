...
from ._peak_finding_utils import _local_maxima_1d, _select_by_peak_distance, _peak_prominences, _peak_widths
...
def find_peaks_cwt(
    ...
    filtered = _filter_ridge_lines(
        cwt_dat, ridge_lines, min_length=min_length, window_size=window_size, min_snr=min_snr, noise_perc=noise_perc
    )
