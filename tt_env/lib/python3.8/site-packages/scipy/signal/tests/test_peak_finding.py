    ...
    def test_warnings(self):
        ...
        with warns(PeakPropertyWarning, match=msg):
            ...
            peak_widths(
                [0, 1, 1, 1, 0],
                [2],
                prominence_data=(np.array([0.0], np.float64), np.array([2], np.intp), np.array([2], np.intp)),
            )
...
class TestFindPeaks:
    ...
    def test_constant(self):
        ...
        peaks, props = find_peaks(
            np.ones(10), height=open_interval, threshold=open_interval, prominence=open_interval, width=open_interval
        )
    ...
    def test_properties(self):
        ...
        peaks, props = find_peaks(
            x, height=open_interval, threshold=open_interval, prominence=open_interval, width=open_interval
        )
