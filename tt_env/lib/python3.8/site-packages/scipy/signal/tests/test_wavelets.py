...
class TestWavelets:
    ...
    def test_morlet(self):
        ...
        # miscellaneous tests:
        x = np.array(
            [1.73752399e-09 + 9.84327394e-25j, 6.49471756e-01 + 0.00000000e00j, 1.73752399e-09 - 9.84327394e-25j]
        )
        y = wavelets.morlet(3, w=2, complete=True)
        assert_array_almost_equal(x, y)

        x = np.array(
            [2.00947715e-09 + 9.84327394e-25j, 7.51125544e-01 + 0.00000000e00j, 2.00947715e-09 - 9.84327394e-25j]
        )
    ...
    def test_morlet2(self):
        ...
        x = np.array(
            [5.03701224e-09 + 2.46742437e-24j, 1.88279253e00 + 0.00000000e00j, 5.03701224e-09 - 2.46742437e-24j]
        )
