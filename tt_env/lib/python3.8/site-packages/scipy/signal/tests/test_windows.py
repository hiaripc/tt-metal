...
class TestBartHann:
    def test_basic(self):
        assert_allclose(
            ...
            [0, 0.35857354213752, 0.8794264578624801, 0.8794264578624801, 0.3585735421375199, 0],
        )
...
class TestBlackmanHarris:
    def test_basic(self):
        assert_allclose(windows.blackmanharris(6, False), [6.0e-05, 0.055645, 0.520575, 1.0, 0.520575, 0.055645])
        assert_allclose(
        ...
        assert_allclose(
            ...
            [6.0e-05, 0.1030114893456638, 0.7938335106543362, 0.7938335106543364, 0.1030114893456638, 6.0e-05],
        )
        assert_allclose(
            windows.blackmanharris(7, sym=True), [6.0e-05, 0.055645, 0.520575, 1.0, 0.520575, 0.055645, 6.0e-05]
        )
...
class TestTaylor:
    def test_normalized(self):
        ...
        assert_allclose(
            windows.taylor(6, 2, 15), np.array([0.7504082, 0.86624416, 0.98208011, 0.98208011, 0.86624416, 0.7504082])
        )
    ...
    def test_non_normalized(self):
        ...
        """
        assert_allclose(
            windows.taylor(5, 2, 15, norm=False), np.array([0.87508054, 1.04771499, 1.15440894, 1.04771499, 0.87508054])
        )
        assert_allclose(
            windows.taylor(6, 2, 15, norm=False), np.array([0.86627793, 1.0, 1.13372207, 1.13372207, 1.0, 0.86627793])
        )
...
class TestBohman:
    def test_basic(self):
        assert_allclose(
            windows.bohman(6), [0, 0.1791238937062839, 0.8343114522576858, 0.8343114522576858, 0.1791238937062838, 0]
        )
        assert_allclose(
            windows.bohman(7, sym=True),
            [0, 0.1089977810442293, 0.6089977810442293, 1.0, 0.6089977810442295, 0.1089977810442293, 0],
        )
        assert_allclose(
            windows.bohman(6, False),
            [0, 0.1089977810442293, 0.6089977810442293, 1.0, 0.6089977810442295, 0.1089977810442293],
        )
...
class TestChebWin:
    def test_basic(self):
        with suppress_warnings() as sup:
            ...
            assert_allclose(
                ...
                [0.1046401879356917, 0.5075781475823447, 1.0, 1.0, 0.5075781475823447, 0.1046401879356917],
            )
            assert_allclose(
            ...
            assert_allclose(
                ...
                [1.0, 0.6071201674458373, 0.6808391469897297, 0.6808391469897297, 0.6071201674458373, 1.0],
            )
            assert_allclose(
    ...
    def test_cheb_odd_low_attenuation(self):
        cheb_odd_low_at_true = array([1.000000, 0.519052, 0.586405, 0.610151, 0.586405, 0.519052, 1.000000])
        with suppress_warnings() as sup:
            sup.filter(UserWarning, "This window is not suitable")
    ...
    def test_cheb_even_low_attenuation(self):
        cheb_even_low_at_true = array([1.000000, 0.451924, 0.51027, 0.541338, 0.541338, 0.51027, 0.451924, 1.000000])
        with suppress_warnings() as sup:
            sup.filter(UserWarning, "This window is not suitable")
...
exponential_data = {
    (4, None, 0.2, False): array(
        [4.53999297624848542e-05, 6.73794699908546700e-03, 1.00000000000000000e00, 6.73794699908546700e-03]
    ),
    (4, None, 0.2, True): array([0.00055308437014783, 0.0820849986238988, 0.0820849986238988, 0.00055308437014783]),
    (4, None, 1.0, False): array([0.1353352832366127, 0.36787944117144233, 1.0, 0.36787944117144233]),
    (4, None, 1.0, True): array([0.22313016014842982, 0.60653065971263342, 0.60653065971263342, 0.22313016014842982]),
    (4, 2, 0.2, False): array(
        [4.53999297624848542e-05, 6.73794699908546700e-03, 1.00000000000000000e00, 6.73794699908546700e-03]
    ),
    (4, 2, 0.2, True): None,
    (4, 2, 1.0, False): array([0.1353352832366127, 0.36787944117144233, 1.0, 0.36787944117144233]),
    (4, 2, 1.0, True): None,
...
class TestFlatTop:
    def test_basic(self):
        assert_allclose(
            windows.flattop(6, sym=False), [-0.000421051, -0.051263156, 0.19821053, 1.0, 0.19821053, -0.051263156]
        )
        assert_allclose(
        ...
        assert_allclose(
            ...
            [-0.000421051, -0.051263156, 0.19821053, 1.0, 0.19821053, -0.051263156, -0.000421051],
        )
...
class TestGaussian:
    def test_basic(self):
        ...
        assert_allclose(
            ...
            [0.6065306597126334, 0.8007374029168081, 0.9459594689067654, 1.0, 0.9459594689067654, 0.8007374029168081],
        )
...
class TestGeneralHamming:
    def test_basic(self):
        ...
        assert_allclose(
            windows.general_hamming(5, 0.75, sym=False), [0.5, 0.6727457514, 0.9522542486, 0.9522542486, 0.6727457514]
        )
        assert_allclose(
...
class TestKaiser:
    def test_basic(self):
        ...
        assert_allclose(
            ...
            [0.2603047507678832, 0.5985765418119844, 0.8868495172060835, 1.0, 0.8868495172060835, 0.5985765418119844],
        )
...
class TestKaiserBesselDerived:
    def test_basic(self):
        ...
        assert_allclose(windows.kaiser_bessel_derived(4, beta=np.pi / 2)[:2], [0.518562710536, 0.855039598640])

        assert_allclose(
            windows.kaiser_bessel_derived(6, beta=np.pi / 2)[:3], [0.436168993154, 0.707106781187, 0.899864772847]
        )
...
class TestNuttall:
    def test_basic(self):
        ...
        assert_allclose(
            windows.nuttall(6),
            [0.0003628, 0.1105152530498718, 0.7982580969501282, 0.7982580969501283, 0.1105152530498719, 0.0003628],
        )
        assert_allclose(
            windows.nuttall(7, True), [0.0003628, 0.0613345, 0.5292298, 1.0, 0.5292298, 0.0613345, 0.0003628]
        )
...
class TestParzen:
    def test_basic(self):
        assert_allclose(
            windows.parzen(6),
            [0.009259259259259254, 0.25, 0.8611111111111112, 0.8611111111111112, 0.25, 0.009259259259259254],
        )
        assert_allclose(
        ...
        assert_allclose(
            ...
            [0.00583090379008747, 0.1574344023323616, 0.6501457725947521, 1.0, 0.6501457725947521, 0.1574344023323616],
        )


class TestTriang:
    def test_basic(self):
        assert_allclose(windows.triang(6, True), [1 / 6, 1 / 2, 5 / 6, 5 / 6, 1 / 2, 1 / 6])
        assert_allclose(windows.triang(7), [1 / 4, 1 / 2, 3 / 4, 1, 3 / 4, 1 / 2, 1 / 4])
        assert_allclose(windows.triang(6, sym=False), [1 / 4, 1 / 2, 3 / 4, 1, 3 / 4, 1 / 2])
...
tukey_data = {
    ...
    (7, 0.75): [0, 0.4131759111665348, 0.9698463103929542, 1.0, 0.9698463103929542, 0.4131759111665347, 0],
    (6, 1): [0, 0.3454915028125263, 0.9045084971874737, 0.9045084971874737, 0.3454915028125263, 0],
...
dpss_data = {
    ...
    (4, 0.1, 2): (
        [[0.497943898, 0.502047681, 0.502047681, 0.497943898], [0.670487993, 0.224601537, -0.224601537, -0.670487993]],
    ...
    def test_unity(self):
        ...
        for M in range(1, 21):
            ...
            if M > 2:
                ...
                assert_equal(np.isclose(win_sub, 1.0).sum(), expected, err_msg="%s" % (win_sub,))
            ...
            assert_equal(np.isclose(win_2, 1.0).sum(), expected, err_msg="%s" % (win_2,))
...
class TestLanczos:
    def test_basic(self):
        ...
        assert_allclose(
            windows.lanczos(6, sym=False), [0.0, 0.413496672, 0.826993343, 1.0, 0.826993343, 0.413496672], atol=1e-9
        )
        assert_allclose(windows.lanczos(6), [0.0, 0.504551152, 0.935489284, 0.935489284, 0.504551152, 0.0], atol=1e-9)
        assert_allclose(
            windows.lanczos(7, sym=True), [0.0, 0.413496672, 0.826993343, 1.0, 0.826993343, 0.413496672, 0.0], atol=1e-9
        )
...
class TestGetWindow:
    ...
    def test_lanczos(self):
        assert_allclose(
            get_window("lanczos", 6), [0.0, 0.413496672, 0.826993343, 1.0, 0.826993343, 0.413496672], atol=1e-9
        )
        assert_allclose(
