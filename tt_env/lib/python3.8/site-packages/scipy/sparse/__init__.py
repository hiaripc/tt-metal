...
from ._arrays import csr_array, csc_array, lil_array, dok_array, coo_array, dia_array, bsr_array

# For backward compatibility with v0.19.
from . import csgraph

# Deprecated namespaces, to be removed in v2.0.0
from . import base, bsr, compressed, construct, coo, csc, csr, data, dia, dok, extract, lil, sparsetools, sputils
