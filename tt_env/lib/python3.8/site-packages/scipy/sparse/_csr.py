...
class csr_matrix(_cs_matrix):
    ...
    def tocsc(self, copy=False):
        idx_dtype = get_index_dtype((self.indptr, self.indices), maxval=max(self.nnz, self.shape[0]))
    ...
    def tobsr(self, blocksize=None, copy=True):
        if blocksize is None:
            ...
            idx_dtype = get_index_dtype((self.indptr, self.indices), maxval=max(N // C, blks))
