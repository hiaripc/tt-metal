...
class dok_matrix(spmatrix, IndexMixin, dict):
    ...
    def update(self, val):
        ...
        raise NotImplementedError("Direct modification to dok_matrix element " "is not allowed.")
    ...
    def getnnz(self, axis=None):
        if axis is not None:
            raise NotImplementedError("getnnz over an axis is not implemented " "for DOK format.")
