...
from ._sputils import getdtype, isshape, isscalarlike, upcast_scalar, get_index_dtype, check_shape, check_reshape_kwargs
...
class lil_matrix(spmatrix, IndexMixin):
    ...
    def _get_row_ranges(self, rows, col_slice):
        ...
        _csparsetools.lil_get_row_ranges(
            self.shape[0], self.shape[1], self.rows, self.data, new.rows, new.data, rows, j_start, j_stop, j_stride, nj
        )
