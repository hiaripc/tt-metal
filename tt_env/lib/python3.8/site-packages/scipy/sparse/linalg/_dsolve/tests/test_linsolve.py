...
def setup_bug_8278():
    ...
    A = (
        scipy.sparse.kron(eyeN, scipy.sparse.kron(eyeN, Ah1D))
...
class TestLinsolve:
    ...
    def test_shape_compatibility(self):
        ...
        bs = [
            ...
            csc_matrix([[1.0, 2.0, 3.0], [6.0, 8.0, 10.0]]),
            csr_matrix([[1.0, 2.0, 3.0], [6.0, 8.0, 10.0]]),
            dok_matrix([[1.0, 2.0, 3.0], [6.0, 8.0, 10.0]]),
            bsr_matrix([[1.0, 2.0, 3.0], [6.0, 8.0, 10.0]]),
        ]
...
class TestSplu:
    ...
    def test_spilu_drop_rule(self):
        ...
        rules = [b"basic,area".decode("ascii"), b"basic,area", [b"basic", b"area".decode("ascii")]]  # unicode  # ascii
        for rule in rules:
            ...
            for n in (10, 10**2, 10**3):
                ...
                for m in (1, 10):
                    for b in (
                        ...
                        np.random.randint(-9, 9, (n, m)) + np.random.randint(-9, 9, (n, m)) * 1j,
                    ):
