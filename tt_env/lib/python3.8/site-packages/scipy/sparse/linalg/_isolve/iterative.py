...
def gmres(
    ...
    if restrt is None:
        ...
        raise ValueError("Cannot specify both restart and restrt keywords. " "Preferably use 'restart' only.")
    else:
        msg = (
            "'gmres' keyword argument 'restrt' is deprecated infavour of "
            "'restart' and will be removed in SciPy 1.12.0."
...
@non_reentrant()
def qmr(A, b, x0=None, tol=1e-5, maxiter=None, M1=None, M2=None, callback=None, atol=None):
