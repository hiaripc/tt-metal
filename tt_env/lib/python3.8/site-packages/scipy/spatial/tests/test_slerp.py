...
class TestGeometricSlerp:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (np.array([0.00000000e00, -6.10865200e-04, 9.99999813e-01]), np.array([0, 0, -1.0]), "warning"),
            ...
            (np.array([0.00000000e00, -9.59930941e-04, 9.99999539e-01]), np.array([0, 0, -1.0]), "success"),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                np.array([1, 0, 0]),
                np.array([0, 1, 0]),
                np.array([[1, 0, 0], [np.sqrt(3) / 2, 0.5, 0], [0.5, np.sqrt(3) / 2, 0], [0, 1, 0]]),
            ),
            ...
            (
                ...
                np.array([0, 1, 0, 0, 0]),
                np.array(
                    [[1, 0, 0, 0, 0], [np.sqrt(3) / 2, 0.5, 0, 0, 0], [0.5, np.sqrt(3) / 2, 0, 0, 0], [0, 1, 0, 0, 0]]
                ),
            ),
        ],
    )
    ...
    def test_accept_arraylike(self):
        ...
        expected = np.array(
            [[1, 0], [np.sqrt(3) / 2, 0.5], [np.sqrt(2) / 2, np.sqrt(2) / 2], [0.5, np.sqrt(3) / 2], [0, 1]],
            dtype=np.float64,
        )
