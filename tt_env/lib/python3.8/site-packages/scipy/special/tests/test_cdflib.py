...
class TestCDFlib:
    ...
    def test_bdtrik(self):
        _assert_inverts(sp.bdtrik, _binomial_cdf, 0, [ProbArg(), IntArg(1, 1000), ProbArg()], rtol=1e-4)
    ...
    def test_btdtria(self):
        _assert_inverts(
            ...
            0,
            [ProbArg(), Arg(0, 1e2, inclusive_a=False), Arg(0, 1, inclusive_a=False, inclusive_b=False)],
            rtol=1e-6,
        )
    ...
    def test_btdtrib(self):
        ...
        _assert_inverts(
            ...
            lambda a, b, x: mpmath.betainc(a, b, x2=x, regularized=True),
            1,
            [Arg(0, 1e2, inclusive_a=False), ProbArg(), Arg(0, 1, inclusive_a=False, inclusive_b=False)],
            rtol=1e-7,
    ...
    def test_fdtridfd(self):
        _assert_inverts(sp.fdtridfd, _f_cdf, 1, [IntArg(1, 100), ProbArg(), Arg(0, 100, inclusive_a=False)], rtol=1e-7)
    ...
    def test_stdtr(self):
        ...
        assert_mpmath_equal(sp.stdtr, _student_t_cdf, [IntArg(1, 100), Arg(1e-10, np.inf)], rtol=1e-7)
    ...
    def test_stdtrit(self):
        _assert_inverts(sp.stdtrit, _student_t_cdf, 1, [IntArg(1, 100), ProbArg()], rtol=1e-7, endpt_atol=[None, 1e-10])
    ...
    def test_tklmbda_zero_shape(self):
        ...
        one = mpmath.mpf(1)
        assert_mpmath_equal(lambda x: sp.tklmbda(x, 0), lambda x: one / (mpmath.exp(-x) + one), [Arg()], rtol=1e-7)
