...
PARAMS: List[Tuple[Callable, Callable, Tuple[str, ...], Optional[str]]] = [
    ...
    (special.eval_chebys, cython_special.eval_chebys, ("dd", "dD", "ld"), "d and l differ for negative int"),
    (special.eval_chebyt, cython_special.eval_chebyt, ("dd", "dD", "ld"), "d and l differ for negative int"),
    (special.eval_chebyu, cython_special.eval_chebyu, ("dd", "dD", "ld"), "d and l differ for negative int"),
    (special.eval_gegenbauer, cython_special.eval_gegenbauer, ("ddd", "ddD", "ldd"), "d and l differ for negative int"),
    (
    ...
    (special.eval_jacobi, cython_special.eval_jacobi, ("dddd", "dddD", "lddd"), "d and l differ for negative int"),
    (special.eval_laguerre, cython_special.eval_laguerre, ("dd", "dD", "ld"), "d and l differ for negative int"),
    ...
    (special.eval_sh_chebyu, cython_special.eval_sh_chebyu, ("dd", "dD", "ld"), "d and l differ for negative int"),
    (
