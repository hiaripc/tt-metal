...
DATASETS_BOOST = np.load(os.path.join(os.path.dirname(__file__), "data", "boost.npz"))

DATASETS_GSL = np.load(os.path.join(os.path.dirname(__file__), "data", "gsl.npz"))

DATASETS_LOCAL = np.load(os.path.join(os.path.dirname(__file__), "data", "local.npz"))
...
BOOST_TESTS = [
    ...
    data(
        gdtrix_comp, "gamma_inv_small_data_ipp-gamma_inv_small_data", (0, 1), 2, knownfailure="gdtrix bad some points"
    ),
