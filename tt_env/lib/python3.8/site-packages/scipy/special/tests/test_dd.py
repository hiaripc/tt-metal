...
#
test_data = [
    (_dd_exp, -0.3333333333333333, -1.850371707708594e-17, 0.7165313105737893, -2.0286948382455594e-17),
...
def test_dd(dd_func, xhi, xlo, expected_yhi, expected_ylo):
    ...
    assert yhi == expected_yhi, f"high double ({yhi}) does not equal the " f"expected value {expected_yhi}"
