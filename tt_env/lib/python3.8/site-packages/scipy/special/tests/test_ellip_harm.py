...
def test_ellip_norm():
    ...
    def G32(h2, k2):
        res = (
            ...
            - 36 * h2 * k2 * (h2**2 + k2**2)
            + 46 * h2**2 * k2**2
            + sqrt(4 * (h2**2 + k2**2) - 7 * h2 * k2) * (-8 * (h2**3 + k2**3) + 11 * h2 * k2 * (h2 + k2))
        )
    ...
    def G33(h2, k2):
        res = (
            ...
            - 28 * h2 * k2**3
            + 34 * h2**2 * k2**2
            + sqrt(h2**2 + 4 * k2**2 - h2 * k2) * (6 * h2**3 + 8 * k2**3 - 9 * h2**2 * k2 - 13 * h2 * k2**2)
        )
        return 16 * pi / 13125 * h2 * (k2 - h2) * res
    ...
    def G35(h2, k2):
        res = (
            ...
            - 12 * h2 * k2**3
            + 34 * h2**2 * k2**2
            + sqrt(4 * h2**2 + k2**2 - h2 * k2) * (8 * h2**3 + 6 * k2**3 - 13 * h2**2 * k2 - 9 * h2 * k2**2)
        )
        return 16 * pi / 13125 * k2 * (k2 - h2) * res
...
def test_ellip_harm():
    ...
    def E33(h2, k2, s):
        return sqrt(abs(s * s - h2)) * (
            s * s - 1 / 5 * ((h2 + 2 * k2) + sqrt(abs((h2 + 2 * k2) * (h2 + 2 * k2) - 5 * h2 * k2)))
        )
    ...
    def E35(h2, k2, s):
        return sqrt(abs(s * s - k2)) * (
            s * s - 1 / 5 * ((2 * h2 + k2) + sqrt(abs((2 * h2 + k2) * (2 * h2 + k2) - 5 * h2 * k2)))
        )
