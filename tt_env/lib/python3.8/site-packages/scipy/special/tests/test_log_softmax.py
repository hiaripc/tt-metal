...
@pytest.mark.parametrize(
    ...
    [
        ...
        # converted to float.
        (np.arange(4), np.array([-3.4401896985611953, -2.4401896985611953, -1.4401896985611953, -0.44018969856119533])),
    ],
)
...
@pytest.mark.parametrize(
    "axis_2d, expected_2d", [(0, np.log(0.5) * np.ones((2, 2))), (1, np.array([[0, -999], [0, -999]]))]
)
...
def log_softmax_2d_expected():
    ...
    expected = np.array(
        [
            [-3.4401896985611953, -2.4401896985611953, -1.4401896985611953, -0.44018969856119533],
            [-3.4401896985611953, -2.4401896985611953, -1.4401896985611953, -0.44018969856119533],
        ]
    )
    return expected
