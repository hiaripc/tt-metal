...
def test_hyp2f1_real_some():
    ...
    with np.errstate(invalid="ignore"):
        FuncData(sc.hyp2f1, dataset, (0, 1, 2, 3), 4, rtol=1e-9, ignore_inf_sign=True).check()
...
def test_beta():
    ...
    try:
        ...
        assert_func_equal(
            sc.beta, lambda a, b: float(mpmath.beta(a, b)), ab, vectorized=False, rtol=1e-10, ignore_inf_sign=True
        )

        assert_func_equal(
            sc.betaln, lambda a, b: float(mpmath.log(abs(mpmath.beta(a, b)))), ab, vectorized=False, rtol=1e-10
        )
    finally:
        mpmath.mp.dps, mpmath.mp.prec = old_dps, old_prec
...
class TestSystematic:
    def test_airyai(self):
        ...
        assert_mpmath_equal(lambda z: sc.airy(z)[0], mpmath.airyai, [Arg(-1e8, 1e8)], rtol=1e-5)
    ...
    def test_airyai_prime(self):
        # oscillating function, limit range
        assert_mpmath_equal(
            lambda z: sc.airy(z)[1], lambda z: mpmath.airyai(z, derivative=1), [Arg(-1e8, 1e8)], rtol=1e-5
        )
        assert_mpmath_equal(lambda z: sc.airy(z)[1], lambda z: mpmath.airyai(z, derivative=1), [Arg(-1e3, 1e3)])
    ...
    def test_airybi(self):
        # oscillating function, limit range
        assert_mpmath_equal(lambda z: sc.airy(z)[2], lambda z: mpmath.airybi(z), [Arg(-1e8, 1e8)], rtol=1e-5)
        assert_mpmath_equal(lambda z: sc.airy(z)[2], lambda z: mpmath.airybi(z), [Arg(-1e3, 1e3)])
    ...
    def test_airybi_prime(self):
        # oscillating function, limit range
        assert_mpmath_equal(
            lambda z: sc.airy(z)[3], lambda z: mpmath.airybi(z, derivative=1), [Arg(-1e8, 1e8)], rtol=1e-5
        )
        assert_mpmath_equal(lambda z: sc.airy(z)[3], lambda z: mpmath.airybi(z, derivative=1), [Arg(-1e3, 1e3)])
    ...
    def test_bei(self):
        assert_mpmath_equal(sc.bei, exception_to_nan(lambda z: mpmath.bei(0, z, **HYPERKW)), [Arg(-1e3, 1e3)])

    def test_ber(self):
        assert_mpmath_equal(sc.ber, exception_to_nan(lambda z: mpmath.ber(0, z, **HYPERKW)), [Arg(-1e3, 1e3)])
    ...
    def test_bessely(self):
        ...
        assert_mpmath_equal(sc.yv, exception_to_nan(mpbessely), [Arg(-1e100, 1e100), Arg(-1e8, 1e8)], n=5000)
    ...
    def test_bessely_int(self):
        ...
        assert_mpmath_equal(
            lambda v, z: sc.yn(int(v), z), exception_to_nan(mpbessely), [IntArg(-1000, 1000), Arg(-1e8, 1e8)]
        )
    ...
    def test_beta(self):
        ...
        assert_mpmath_equal(
            sc.beta, lambda a, b: beta(a, b, nonzero=True), [Arg(), Arg()], dps=400, ignore_inf_sign=True
        )
    ...
    def test_chi_complex(self):
        ...
        assert_mpmath_equal(chi, mpmath.chi, [ComplexArg(complex(-np.inf, -1e8), complex(np.inf, 1e8))], rtol=1e-12)
    ...
    def test_ci_complex(self):
        ...
        assert_mpmath_equal(ci, mpmath.ci, [ComplexArg(complex(-1e8, -np.inf), complex(1e8, np.inf))], rtol=1e-8)
    ...
    def test_digamma_complex(self):
        ...
        assert_mpmath_equal(
            sc.digamma, exception_to_nan(mpmath.digamma), [ComplexArg()], rtol=1e-13, dps=40, param_filter=param_filter
        )
    ...
    def test_e1_complex(self):
        ...
        assert_mpmath_equal(sc.exp1, mpmath.e1, [ComplexArg(complex(-np.inf, -1e8), complex(np.inf, 1e8))], rtol=1e-11)
        ...
        assert_mpmath_equal(
            ...
            mpmath.e1,
            (
                np.linspace(-50, 50, 171)[:, None] + np.r_[0, np.logspace(-3, 2, 61), -np.logspace(-3, 2, 11)] * 1j
            ).ravel(),
            rtol=1e-11,
        )
    ...
    def test_expm1_complex(self):
        ...
        assert_mpmath_equal(sc.expm1, mpmath.expm1, [ComplexArg(complex(-np.inf, -1e7), complex(np.inf, 1e7))])
    ...
    def test_ei_complex(self):
        ...
        assert_mpmath_equal(sc.expi, mpmath.ei, [ComplexArg(complex(-np.inf, -1e8), complex(np.inf, 1e8))], rtol=1e-9)
    ...
    def test_ellipkinc(self):
        ...
        assert_mpmath_equal(sc.ellipkinc, ellipkinc, [Arg(-1e3, 1e3), Arg(b=1.0)], ignore_inf_sign=True)
    ...
    def test_ellipfun_sn(self):
        ...
        assert_mpmath_equal(lambda u, m: sc.ellipj(u, m)[0], sn, [Arg(-1e6, 1e6), Arg(a=0, b=1)], rtol=1e-8)
    ...
    def test_log_ndtr(self):
        assert_mpmath_equal(
            sc.log_ndtr, exception_to_nan(lambda z: mpmath.log(mpmath.ncdf(z))), [Arg()], n=600, dps=300, rtol=1e-13
        )

    def test_log_ndtr_complex(self):
        assert_mpmath_equal(
            sc.log_ndtr,
            exception_to_nan(lambda z: mpmath.log(mpmath.erfc(-z / np.sqrt(2.0)) / 2.0)),
    ...
    def test_gegenbauer(self):
        assert_mpmath_equal(sc.eval_gegenbauer, exception_to_nan(mpmath.gegenbauer), [Arg(-1e3, 1e3), Arg(), Arg()])
    ...
    def test_hankel1(self):
        assert_mpmath_equal(
            sc.hankel1, exception_to_nan(lambda v, x: mpmath.hankel1(v, x, **HYPERKW)), [Arg(-1e20, 1e20), Arg()]
        )

    def test_hankel2(self):
        assert_mpmath_equal(
            sc.hankel2, exception_to_nan(lambda v, x: mpmath.hankel2(v, x, **HYPERKW)), [Arg(-1e20, 1e20), Arg()]
        )

    @pytest.mark.xfail(run=False, reason="issues at intermediately large orders")
    def test_hermite(self):
        assert_mpmath_equal(
            lambda n, x: sc.eval_hermite(int(n), x), exception_to_nan(mpmath.hermite), [IntArg(0, 10000), Arg()]
        )
    ...
    def test_hyp0f1(self):
        ...
        assert_mpmath_equal(sc.hyp0f1, lambda a, x: mpmath.hyp0f1(a, x, **KW), [Arg(-1e7, 1e7), Arg(0, 1e5)], n=5000)
    ...
    def test_hyp1f1(self):
        ...
        assert_mpmath_equal(
            sc.hyp1f1, mpmath_hyp1f1, [Arg(-50, 50), Arg(1, 50, inclusive_a=False), Arg(-50, 50)], n=500, nan_ok=False
        )
    ...
    def test_hyperu(self):
        assert_mpmath_equal(
            sc.hyperu, exception_to_nan(lambda a, b, x: mpmath.hyperu(a, b, x, **HYPERKW)), [Arg(), Arg(), Arg()]
        )
    ...
    def test_igam_fac(self):
        ...
        assert_mpmath_equal(_igam_fac, mp_igam_fac, [Arg(0, 1e14, inclusive_a=False), Arg(0, 1e14)], rtol=1e-10)
    ...
    def test_ker(self):
        assert_mpmath_equal(sc.ker, exception_to_nan(lambda x: mpmath.ker(0, x, **HYPERKW)), [Arg(-1e30, 1e30)], n=1000)
    ...
    def test_loggamma(self):
        ...
        assert_mpmath_equal(
            sc.loggamma, mpmath_loggamma, [ComplexArg()], nan_ok=False, distinguish_nan_and_inf=False, rtol=5e-14
        )
    ...
    def test_pcfv(self):
        ...
        assert_mpmath_equal(
            pcfv, lambda v, x: time_limited()(exception_to_nan(mpmath.pcfv))(v, x, **HYPERKW), [Arg(), Arg()], n=1000
        )
    ...
    def test_pcfw(self):
        ...
        assert_mpmath_equal(pcfw, mpmath.pcfw, [Arg(-5, 5), Arg(-5, 5)], rtol=2e-8, n=100)

        assert_mpmath_equal(dpcfw, mpmath_dpcfw, [Arg(-5, 5), Arg(-5, 5)], rtol=2e-9, n=100)
    ...
    def test_shi_complex(self):
        ...
        assert_mpmath_equal(shi, mpmath.shi, [ComplexArg(complex(-np.inf, -1e8), complex(np.inf, 1e8))], rtol=1e-12)
    ...
    def test_si_complex(self):
        ...
        assert_mpmath_equal(si, mpmath.si, [ComplexArg(complex(-1e8, -np.inf), complex(1e8, np.inf))], rtol=1e-12)
    ...
    def test_struveh(self):
        assert_mpmath_equal(sc.struve, exception_to_nan(mpmath.struveh), [Arg(-1e4, 1e4), Arg(0, 1e4)], rtol=5e-10)
    ...
    def test_struvel(self):
        ...
        assert_mpmath_equal(
            sc.modstruve, exception_to_nan(mp_struvel), [Arg(-1e4, 1e4), Arg(0, 1e4)], rtol=5e-10, ignore_inf_sign=True
        )
    ...
    def test_wrightomega(self):
        assert_mpmath_equal(
            sc.wrightomega, lambda z: _mpmath_wrightomega(z, 25), [ComplexArg()], rtol=1e-14, nan_ok=False
        )

    def test_hurwitz_zeta(self):
        assert_mpmath_equal(
            sc.zeta, exception_to_nan(mpmath.zeta), [Arg(a=1, b=1e10, inclusive_a=False), Arg(a=0, inclusive_a=False)]
        )
    ...
    def test_boxcox(self):
        ...
        assert_mpmath_equal(
            sc.boxcox, exception_to_nan(mp_boxcox), [Arg(a=0, inclusive_a=False), Arg()], n=200, dps=60, rtol=1e-13
        )
    ...
    def test_boxcox1p(self):
        ...
        assert_mpmath_equal(
            sc.boxcox1p, exception_to_nan(mp_boxcox1p), [Arg(a=-1, inclusive_a=False), Arg()], n=200, dps=60, rtol=1e-13
        )
    ...
    def test_spherical_kn(self):
        ...
        assert_mpmath_equal(
            lambda n, z: sc.spherical_kn(int(n), z), exception_to_nan(mp_spherical_kn), [IntArg(0, 150), Arg()], dps=100
        )
