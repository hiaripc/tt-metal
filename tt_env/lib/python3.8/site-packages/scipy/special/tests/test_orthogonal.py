...
from numpy.testing import assert_array_almost_equal, assert_equal, assert_almost_equal, assert_allclose
...
class TestGegenbauer:
    def test_gegenbauer(self):
        ...
        assert_array_almost_equal(
            Ca4.c, array([4 * sc.poch(a, 4), 0, -12 * sc.poch(a, 3), 0, 3 * a * (a + 1)]) / 6.0, 11
        )
        assert_array_almost_equal(
            Ca5.c, array([4 * sc.poch(a, 5), 0, -20 * sc.poch(a, 4), 0, 15 * sc.poch(a, 3), 0]) / 15.0, 11
        )
...
def test_roots_sh_chebyt():
    ...
    verify_gauss_quad(sc.roots_sh_chebyt, sc.eval_sh_chebyt, weightf, 0.0, 1.0, 100, atol=1e-13)
...
def test_roots_sh_chebyu():
    ...
    verify_gauss_quad(sc.roots_sh_chebyu, sc.eval_sh_chebyu, weightf, 0.0, 1.0, 100, atol=1e-13)
...
def test_roots_legendre():
    ...
    verify_gauss_quad(sc.roots_legendre, sc.eval_legendre, weightf, -1.0, 1.0, 25, atol=1e-13)
    verify_gauss_quad(sc.roots_legendre, sc.eval_legendre, weightf, -1.0, 1.0, 100, atol=1e-12)
