...
class gaussian_kde:
    ...
    def integrate_box(self, low_bounds, high_bounds, maxpts=None):
        ...
        value, inform = _mvn.mvnun_weighted(
            low_bounds, high_bounds, self.dataset, self.weights, self.covariance, **extra_kwds
        )
        if inform:
    ...
    def marginal(self, dimensions):
        ...
        if np.any(i_invalid):
            msg = f"Dimensions {original_dims[i_invalid]} are invalid " f"for a distribution in {n} dimensions."
            raise ValueError(msg)
