...
def _monte_carlo_test_iv(sample, rvs, statistic, vectorized, n_resamples, batch, alternative, axis):
    ...
    return (sample, rvs, statistic_vectorized, vectorized, n_resamples_int, batch_iv, alternative, axis_int)
...
def monte_carlo_test(
    sample, rvs, statistic, *, vectorized=None, n_resamples=9999, batch=None, alternative="two-sided", axis=0
):
    r"""
    ...
    """
    args = _monte_carlo_test_iv(sample, rvs, statistic, vectorized, n_resamples, batch, alternative, axis)
    (sample, rvs, statistic, vectorized, n_resamples, batch, alternative, axis) = args
...
def _permutation_test_iv(
    data, statistic, permutation_type, vectorized, n_resamples, batch, alternative, axis, random_state
):
