...
LinregressResult = _make_tuple_bunch(
    "LinregressResult", ["slope", "intercept", "rvalue", "pvalue", "stderr"], extra_field_names=["intercept_stderr"]
)
...
def linregress(x, y=None, alternative="two-sided"):
    ...
    return LinregressResult(
        slope=slope, intercept=intercept, rvalue=r, pvalue=prob, stderr=slope_stderr, intercept_stderr=intercept_stderr
    )
