...
Chi2ContingencyResult = _make_tuple_bunch("Chi2ContingencyResult", ["statistic", "pvalue", "dof", "expected_freq"], [])
...
def chi2_contingency(observed, correction=True, lambda_=None):
    ...
    if np.any(expected == 0):
        ...
        raise ValueError(
            "The internally computed table of expected " "frequencies has a zero element at %s." % (zeropos,)
        )
