...
axis_nan_policy_cases = [
    ...
    (stats.wilcoxon, ("pratt",), {"mode": "auto"}, 2, 2, True, lambda res: (res.statistic, res.pvalue)),
    (stats.wilcoxon, tuple(), dict(), 1, 2, True, lambda res: (res.statistic, res.pvalue)),
    (stats.wilcoxon, tuple(), {"mode": "approx"}, 1, 3, True, lambda res: (res.statistic, res.pvalue, res.zstatistic)),
...
def nan_policy_1d(
    hypotest, data1d, unpacker, *args, n_outputs=2, nan_policy="raise", paired=False, _no_deco=True, **kwds
):
...
@pytest.mark.parametrize(
    ("hypotest", "args", "kwds", "n_samples", "n_outputs", "paired", "unpacker"), axis_nan_policy_cases
)
@pytest.mark.parametrize(("nan_policy"), ("propagate", "omit", "raise"))
@pytest.mark.parametrize(("axis"), (1,))
@pytest.mark.parametrize(("data_generator"), ("mixed",))
def test_axis_nan_policy_fast(
    hypotest, args, kwds, n_samples, n_outputs, paired, unpacker, nan_policy, axis, data_generator
):
...
def _axis_nan_policy_test(
    ...
    if nan_policy == "raise" and not data_generator == "all_finite":
        ...
        with suppress_warnings() as sup, np.errstate(divide="ignore", invalid="ignore"):
            ...
            res = unpacker(hypotest(*data, axis=axis, nan_policy=nan_policy, *args, **kwds))
...
def test_axis_nan_policy_axis_is_None(
    hypotest, args, kwds, n_samples, n_outputs, paired, unpacker, nan_policy, data_generator
):
...
@pytest.mark.parametrize(
    ...
    (((2, 3, 3, 4), (None, 0, -1, (0, 2), (1, -1), (3, 1, 2, 0))), ((10,), (0, -1)), ((20, 0), (0, 1))),
)
