...
@pytest.mark.parametrize(
    "k, M, n, N, expected, rtol",
    [(25, 10000, 3000, 215, 0.9999999999052958, 1e-15), (125, 10000, 3000, 215, 1.4416781705752128e-18, 5e-11)],
)
...
class TestZipfian:
    ...
    def test_zipfian_continuity(self):
        ...
        assert_allclose(zipfian.stats(alt1, N, moments="msvk"), zipfian.stats(agt1, N, moments="msvk"), rtol=5e-7)
...
class TestNCH:
    ...
    def test_nchypergeom_wallenius_naive(self):
        ...
        with suppress_warnings() as sup:
            ...
            assert_allclose(nchypergeom_wallenius.mean(N, m1, n, w), mean(N, m1, n, w), rtol=2e-2)
        ...
        with suppress_warnings() as sup:
            sup.filter(RuntimeWarning, message="invalid value encountered in mean")
            assert_allclose(nchypergeom_wallenius.stats(N, m1, n, w, moments="v"), variance(N, m1, n, w), rtol=5e-2)
