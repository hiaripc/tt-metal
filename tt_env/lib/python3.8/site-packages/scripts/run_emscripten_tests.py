...
class BrowserDriver:
    ...
    def wait_for_done(self):
        while True:
            ...
            lines = self.driver.execute_script("let temp = window.python_logs;window.python_logs=[];return temp;")
            if len(lines) > 0:
...
parser.add_argument("-t", "--test-submodule", help="Submodule that tests live in", default="test")
parser.add_argument(
    "-r",
    "--runtime",
    type=str,
