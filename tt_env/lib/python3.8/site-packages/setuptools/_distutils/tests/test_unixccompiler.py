...
class TestUnixCCompiler(support.TempdirManager):
    ...
    def test_cc_overrides_ldshared_for_cxx_correctly(self):
        ...
        sysconfig.get_config_var = gcv
        sysconfig.get_config_vars = gcvs
        with mock.patch.object(self.cc, "spawn", return_value=None) as mock_spawn, mock.patch.object(
            self.cc, "_need_link", return_value=True
        ), mock.patch.object(self.cc, "mkpath", return_value=None), EnvironmentVarGuard() as env:
            env["CC"] = "ccache my_cc"
            env["CXX"] = "my_cxx"
            del env["LDSHARED"]
            sysconfig.customize_compiler(self.cc)
