...
def instrument(f: T_CallableOrType) -> FunctionType | str:
    ...
    new_code = find_target_function(module_code, target_path, instrumentor.target_lineno)
    if not new_code:
...
def typechecked(
    ...
    *,
    ...
    wrapper_class: (type[classmethod[Any, Any, Any]] | type[staticmethod[Any, Any]] | None) = None
