...
def read_configuration(filepath: StrPath, find_others: bool = False, ignore_option_errors: bool = False) -> dict:
    ...
    def _exclude_files_parser(cls, key):
        ...
        def parser(value):
            ...
            if value.startswith(exclude_directive):
                raise ValueError(f"Only strings are accepted for the {key} field, " "files are not accepted")
            return value
