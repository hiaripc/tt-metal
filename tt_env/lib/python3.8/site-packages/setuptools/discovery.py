...
class _Finder:
    ...
    @classmethod
    def _find_iter(cls, where: StrPath, exclude: _Filter, include: _Filter) -> Iterator[str]:
...
class ConfigDiscovery:
    ...
    def __call__(self, force: bool = False, name: bool = True, ignore_ext_modules: bool = False):
