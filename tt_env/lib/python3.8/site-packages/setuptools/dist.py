...
def assert_string_list(dist, attr: str, value: _Sequence) -> None:
    ...
    try:
        ...
        raise DistutilsSetupError(f"{attr!r} must be of type <{_sequence_type_repr}> (got {value!r})") from e
...
class Distribution(_Distribution):
    ...
    def _exclude_misc(self, name: str, value: _Sequence) -> None:
        ...
        if not isinstance(value, _sequence):
            raise DistutilsSetupError(f"{name}: setting must be of type <{_sequence_type_repr}> (got {value!r})")
        try:
    ...
    def _exclude_packages(self, packages: _Sequence) -> None:
        if not isinstance(packages, _sequence):
            raise DistutilsSetupError(f"packages: setting must be of type <{_sequence_type_repr}> (got {packages!r})")
