...
CHECK_PACKAGE_DATA_TESTS = (
    ...
    (
        ...
        ("\"values of 'package_data' dict\" must be of type <tuple[str, ...] | list[str]>" " (got '*.msg')"),
    ),
    ...
    (
        ...
        ("\"values of 'package_data' dict\" must be of type <tuple[str, ...] | list[str]>" " (got <generator object"),
    ),
)
