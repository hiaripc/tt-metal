...
class TestDistInfo:
    ...
    def test_distinfo(self, metadata):
        dists = dict((d.project_name, d) for d in pkg_resources.find_distributions(metadata))
...
class TestWheelCompatibility:
    ...
    def test_dist_info_is_the_same_as_in_wheel(self, name, version, tmp_path, suffix, cfg):
