...
match_params = itertools.chain.from_iterable(
    zip(itertools.repeat(pattern), matches) for pattern, matches, mismatches in translate_specs
)
...
mismatch_params = itertools.chain.from_iterable(
    zip(itertools.repeat(pattern), mismatches) for pattern, matches, mismatches in translate_specs
)
