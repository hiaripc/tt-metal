...
class TamilStemmer(BaseStemmer):
    ...
    a_8 = [Among("\u0BAF", -1, -1), Among("\u0BB5", -1, -1), Among("\u0BB5\u0BCD", -1, -1)]
    ...
    a_11 = [Among("\u0B85", -1, -1), Among("\u0B87", -1, -1), Among("\u0B89", -1, -1)]
    ...
    a_22 = [Among("\u0BAA\u0B9F\u0BC1", -1, -1), Among("\u0B95\u0BCA\u0BA3\u0BCD\u0B9F\u0BBF\u0BB0\u0BCD", -1, -1)]
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        if not self.eq_s_b("\u0B9F\u0BCD\u0BAA\u0BCD"):
                            raise lab5()
                        raise lab4()
                    except lab5:
                        pass
                    self.cursor = self.limit - v_3
                    if not self.eq_s_b("\u0B9F\u0BCD\u0B95\u0BCD"):
                        raise lab3()
                except lab4:
                    pass
                self.bra = self.cursor
            ...
            try:
                ...
                try:
                    ...
                    try:
                        if not self.eq_s_b("\u0BC1\u0B95\u0BCD"):
                            raise lab13()
                        raise lab12()
                    except lab13:
                        pass
                    self.cursor = self.limit - v_6
                    if not self.eq_s_b("\u0BC1\u0B95\u0BCD\u0B95\u0BCD"):
                        raise lab11()
                except lab12:
                    pass
                self.bra = self.cursor
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    self.cursor = self.limit - v_16
                    try:
                        if not self.eq_s_b("\u0BAA\u0BBF\u0BA9\u0BCD"):
                            raise lab32()
                        raise lab26()
                    except lab32:
                        pass
                    self.cursor = self.limit - v_16
                    if not self.eq_s_b("\u0BA4\u0BC1"):
                        raise lab25()
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        self.cursor = self.limit - v_11
                        try:
                            if not self.eq_s_b("\u0BC0\u0BB0\u0BCD"):
                                raise lab54()
                            raise lab36()
                        except lab54:
                            pass
                        self.cursor = self.limit - v_11
                        if not self.eq_s_b("\u0BC0\u0BAF\u0BB0\u0BCD"):
                            raise lab35()
                    except lab36:
                        pass
                    self.bra = self.cursor
