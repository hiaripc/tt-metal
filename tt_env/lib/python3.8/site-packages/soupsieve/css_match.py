...
class _DocumentNav:
    ...
    def get_children(
        self, el: bs4.Tag, start: int | None = None, reverse: bool = False, tags: bool = True, no_iframe: bool = False
...
class CSSMatch(_DocumentNav):
    ...
    def __init__(
        self, selectors: ct.SelectorList, scope: bs4.Tag, namespaces: ct.Namespaces | None, flags: int
    ) -> None:
        """Initialize."""
    ...
    def match_lang(self, el: bs4.Tag, langs: tuple[ct.SelectorLang, ...]) -> bool:
        ...
        while not found_lang:
            ...
            for k, v in self.iter_attributes(parent):
                ...
                if ((not has_ns or has_html_ns) and (util.lower(k) if not self.is_xml else k) == "lang") or (
                    has_ns
                    and not has_html_ns
                    and attr_ns == NS_XML
