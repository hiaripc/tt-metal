...
class HTMLHelpBuilder(StandaloneHTMLBuilder):
    ...
    name = "htmlhelp"
    epilog = __("You can now run HTML Help Workshop with the .htp file in " "%(outdir)s.")
    ...
    def build_hhx(self, outdir: str, outname: str) -> None:
        ...
        with open(filename, "w", encoding=self.encoding, errors="xmlcharrefreplace") as f:
            ...
            def write_index(
                title: str, refs: List[Tuple[str, str]], subitems: List[Tuple[str, List[Tuple[str, str]]]]
            ) -> None:  # NOQA
