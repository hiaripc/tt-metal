...
class AsyncRetrying(BaseRetrying):
    ...
    async def _run_retry(self, retry_state: "RetryCallState") -> None:  # type: ignore[override]
        self.iter_state.retry_run_result = await _utils.wrap_to_async_func(self.retry)(retry_state)
    ...
    async def _run_stop(self, retry_state: "RetryCallState") -> None:  # type: ignore[override]
        ...
        self.iter_state.stop_run_result = await _utils.wrap_to_async_func(self.stop)(retry_state)
