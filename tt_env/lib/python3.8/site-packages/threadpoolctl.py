    ...
    def _check_params(self, limits, user_api):
        ...
        if limits is None or isinstance(limits, int):
            if user_api is None:
                ...
                raise ValueError(f"user_api must be either in {_ALL_USER_APIS} or None. Got " f"{user_api} instead.")
            ...
            if isinstance(limits, list):
                ...
                limits = {
                    lib_controller.prefix: lib_controller.num_threads for lib_controller in limits.lib_controllers
                }
