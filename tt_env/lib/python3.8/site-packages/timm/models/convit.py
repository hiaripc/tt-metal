...
default_cfgs = {
    # ConViT
    "convit_tiny": _cfg(url="https://dl.fbaipublicfiles.com/convit/convit_tiny.pth"),
    "convit_small": _cfg(url="https://dl.fbaipublicfiles.com/convit/convit_small.pth"),
    "convit_base": _cfg(url="https://dl.fbaipublicfiles.com/convit/convit_base.pth"),
}
...
class Block(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        if self.use_gpsa:
            self.attn = GPSA(dim, num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, proj_drop=drop, **kwargs)
        else:
