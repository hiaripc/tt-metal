    ...
    def __init__(
        ...
        if in_chs != out_chs or stride > 1 or dilation[0] != dilation[1]:
            ...
            self.downsample = nn.Sequential(
                norm_layer(in_chs),
                create_conv2d(
                    in_chs, out_chs, kernel_size=ds_ks, stride=stride, dilation=dilation[0], padding=pad, bias=conv_bias
                ),
            )
            in_chs = out_chs
        else:
...
def convnext_atto(pretrained=False, **kwargs):
    ...
    model_args = dict(depths=(2, 2, 6, 2), dims=(40, 80, 160, 320), conv_mlp=True, **kwargs)
...
def convnext_atto_ols(pretrained=False, **kwargs):
    ...
    model_args = dict(depths=(2, 2, 6, 2), dims=(40, 80, 160, 320), conv_mlp=True, stem_type="overlap_tiered", **kwargs)
...
def convnext_femto(pretrained=False, **kwargs):
    # timm femto variant
    model_args = dict(depths=(2, 2, 6, 2), dims=(48, 96, 192, 384), conv_mlp=True, **kwargs)
...
def convnext_femto_ols(pretrained=False, **kwargs):
    # timm femto variant
    model_args = dict(depths=(2, 2, 6, 2), dims=(48, 96, 192, 384), conv_mlp=True, stem_type="overlap_tiered", **kwargs)
...
def convnext_pico(pretrained=False, **kwargs):
    # timm pico variant
    model_args = dict(depths=(2, 2, 6, 2), dims=(64, 128, 256, 512), conv_mlp=True, **kwargs)
...
def convnext_nano(pretrained=False, **kwargs):
    ...
    model_args = dict(depths=(2, 2, 8, 2), dims=(80, 160, 320, 640), conv_mlp=True, **kwargs)
...
def convnext_nano_ols(pretrained=False, **kwargs):
    ...
    model_args = dict(depths=(2, 2, 8, 2), dims=(80, 160, 320, 640), conv_mlp=True, stem_type="overlap", **kwargs)
