...
default_cfgs = {
    ...
    "deit_tiny_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_tiny_patch16_224-a1311bcf.pth"),
    "deit_small_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_small_patch16_224-cd65a155.pth"),
    "deit_base_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_base_patch16_224-b5f2ef4d.pth"),
    ...
    "deit3_small_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_3_small_224_1k.pth"),
    "deit3_small_patch16_384": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_small_384_1k.pth", input_size=(3, 384, 384), crop_pct=1.0
    ),
    "deit3_medium_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_3_medium_224_1k.pth"),
    "deit3_base_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_3_base_224_1k.pth"),
    "deit3_base_patch16_384": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_base_384_1k.pth", input_size=(3, 384, 384), crop_pct=1.0
    ),
    "deit3_large_patch16_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_3_large_224_1k.pth"),
    "deit3_large_patch16_384": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_large_384_1k.pth", input_size=(3, 384, 384), crop_pct=1.0
    ),
    "deit3_huge_patch14_224": _cfg(url="https://dl.fbaipublicfiles.com/deit/deit_3_huge_224_1k.pth"),
    "deit3_small_patch16_224_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_small_224_21k.pth", crop_pct=1.0
    ),
    "deit3_small_patch16_384_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_small_384_21k.pth", input_size=(3, 384, 384), crop_pct=1.0
    ),
    "deit3_medium_patch16_224_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_medium_224_21k.pth", crop_pct=1.0
    ),
    "deit3_base_patch16_224_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_base_224_21k.pth", crop_pct=1.0
    ),
    "deit3_base_patch16_384_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_base_384_21k.pth", input_size=(3, 384, 384), crop_pct=1.0
    ),
    "deit3_large_patch16_224_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_large_224_21k.pth", crop_pct=1.0
    ),
    "deit3_large_patch16_384_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_large_384_21k.pth", input_size=(3, 384, 384), crop_pct=1.0
    ),
    "deit3_huge_patch14_224_in21ft1k": _cfg(
        url="https://dl.fbaipublicfiles.com/deit/deit_3_huge_224_21k_v1.pth", crop_pct=1.0
    ),
}
...
def deit_tiny_distilled_patch16_224(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, **kwargs)
    model = _create_deit("deit_tiny_distilled_patch16_224", pretrained=pretrained, distilled=True, **model_kwargs)
    return model
...
def deit_small_distilled_patch16_224(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
    model = _create_deit("deit_small_distilled_patch16_224", pretrained=pretrained, distilled=True, **model_kwargs)
    return model
...
def deit_base_distilled_patch16_224(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_deit("deit_base_distilled_patch16_224", pretrained=pretrained, distilled=True, **model_kwargs)
    return model
...
def deit_base_distilled_patch16_384(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_deit("deit_base_distilled_patch16_384", pretrained=pretrained, distilled=True, **model_kwargs)
    return model
