...
default_cfgs = {
    ...
    "efficientnet_b5": _cfg(url="", input_size=(3, 456, 456), pool_size=(15, 15), crop_pct=0.934),
    "efficientnet_b6": _cfg(url="", input_size=(3, 528, 528), pool_size=(17, 17), crop_pct=0.942),
    "efficientnet_b7": _cfg(url="", input_size=(3, 600, 600), pool_size=(19, 19), crop_pct=0.949),
    "efficientnet_b8": _cfg(url="", input_size=(3, 672, 672), pool_size=(21, 21), crop_pct=0.954),
    "efficientnet_l2": _cfg(url="", input_size=(3, 800, 800), pool_size=(25, 25), crop_pct=0.961),
    # FIXME experimental
    "efficientnet_b0_gn": _cfg(url=""),
    "efficientnet_b0_g8_gn": _cfg(url=""),
    "efficientnet_b0_g16_evos": _cfg(url=""),
    "efficientnet_b3_gn": _cfg(
        url="", input_size=(3, 288, 288), pool_size=(9, 9), test_input_size=(3, 320, 320), crop_pct=1.0
    ),
    ...
    "efficientnet_lite1": _cfg(url="", input_size=(3, 240, 240), pool_size=(8, 8), crop_pct=0.882),
    "efficientnet_lite2": _cfg(url="", input_size=(3, 260, 260), pool_size=(9, 9), crop_pct=0.890),
    "efficientnet_lite3": _cfg(url="", input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
    "efficientnet_lite4": _cfg(url="", input_size=(3, 380, 380), pool_size=(12, 12), crop_pct=0.922),
    ...
    "efficientnetv2_s": _cfg(
        url="", input_size=(3, 288, 288), test_input_size=(3, 384, 384), pool_size=(9, 9), crop_pct=1.0
    ),
    "efficientnetv2_m": _cfg(
        url="", input_size=(3, 320, 320), test_input_size=(3, 416, 416), pool_size=(10, 10), crop_pct=1.0
    ),
    "efficientnetv2_l": _cfg(
        url="", input_size=(3, 384, 384), test_input_size=(3, 480, 480), pool_size=(12, 12), crop_pct=1.0
    ),
    "efficientnetv2_xl": _cfg(
        url="", input_size=(3, 384, 384), test_input_size=(3, 512, 512), pool_size=(12, 12), crop_pct=1.0
    ),
...
def _create_effnet(variant, pretrained=False, **kwargs):
    ...
    model = build_model_with_cfg(
        model_cls, variant, pretrained, pretrained_strict=not features_only, kwargs_filter=kwargs_filter, **kwargs
    )
    if features_only:
