...
cfg_cls = dict(
    hrnet_w18_small=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(2, 2), NUM_CHANNELS=(16, 32), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=1,
            NUM_BRANCHES=3,
    ...
    hrnet_w18_small_v2=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(2, 2), NUM_CHANNELS=(18, 36), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=3,
            NUM_BRANCHES=3,
    ...
    hrnet_w18=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(4, 4), NUM_CHANNELS=(18, 36), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=4,
            NUM_BRANCHES=3,
    ...
    hrnet_w30=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(4, 4), NUM_CHANNELS=(30, 60), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=4,
            NUM_BRANCHES=3,
    ...
    hrnet_w32=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(4, 4), NUM_CHANNELS=(32, 64), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=4,
            NUM_BRANCHES=3,
    ...
    hrnet_w40=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(4, 4), NUM_CHANNELS=(40, 80), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=4,
            NUM_BRANCHES=3,
    ...
    hrnet_w44=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(4, 4), NUM_CHANNELS=(44, 88), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=4,
            NUM_BRANCHES=3,
    ...
    hrnet_w64=dict(
        ...
        STAGE2=dict(
            NUM_MODULES=1, NUM_BRANCHES=2, BLOCK="BASIC", NUM_BLOCKS=(4, 4), NUM_CHANNELS=(64, 128), FUSE_METHOD="SUM"
        ),
        STAGE3=dict(
            NUM_MODULES=4,
            NUM_BRANCHES=3,
...
class HighResolutionModule(nn.Module):
    def __init__(
        self, num_branches, blocks, num_blocks, num_in_chs, num_channels, fuse_method, multi_scale_output=True
    ):
