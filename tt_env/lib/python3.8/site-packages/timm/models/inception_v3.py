...
default_cfgs = {
    ...
    "inception_v3": _cfg(
        url="https://download.pytorch.org/models/inception_v3_google-1a9a5a14.pth", has_aux=True
    ),  # checkpoint has aux logit layer weights
...
def _create_inception_v3(variant, pretrained=False, **kwargs):
    ...
    return build_model_with_cfg(
        model_cls, variant, pretrained, pretrained_cfg=pretrained_cfg, pretrained_strict=load_strict, **kwargs
    )
