...
class InceptionA(nn.Module):
    def __init__(self):
        ...
        self.branch3 = nn.Sequential(
            nn.AvgPool2d(3, stride=1, padding=1, count_include_pad=False), BasicConv2d(384, 96, kernel_size=1, stride=1)
        )
...
def _create_inception_v4(variant, pretrained=False, **kwargs):
    return build_model_with_cfg(InceptionV4, variant, pretrained, feature_cfg=dict(flatten_sequential=True), **kwargs)
