...
default_cfgs = {
    ...
    "maxvit_rmlp_small_rw_256": _cfg(url="", input_size=(3, 256, 256), pool_size=(8, 8)),
...
class PartitionAttentionCl(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = Mlp(
            in_features=dim, hidden_features=int(dim * cfg.expand_ratio), act_layer=act_layer, drop=cfg.proj_drop
        )
