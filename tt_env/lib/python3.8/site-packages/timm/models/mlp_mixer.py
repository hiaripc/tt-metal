...
class MlpMixer(nn.Module):
    ...
    def group_matcher(self, coarse=False):
        return dict(stem=r"^stem", blocks=[(r"^blocks\.(\d+)", None), (r"^norm", (99999,))])  # stem and embed
...
def _create_mixer(variant, pretrained=False, **kwargs):
    ...
    model = build_model_with_cfg(MlpMixer, variant, pretrained, pretrained_filter_fn=checkpoint_filter_fn, **kwargs)
    return model
