...
default_cfgs = dict(
    ...
    mvitv2_base_in21k=_cfg(
        url="https://dl.fbaipublicfiles.com/mvit/mvitv2_models/MViTv2_B_in21k.pyth", num_classes=19168
    ),
    mvitv2_large_in21k=_cfg(
        url="https://dl.fbaipublicfiles.com/mvit/mvitv2_models/MViTv2_L_in21k.pyth", num_classes=19168
    ),
    mvitv2_huge_in21k=_cfg(
        url="https://dl.fbaipublicfiles.com/mvit/mvitv2_models/MViTv2_H_in21k.pyth", num_classes=19168
    ),
...
class MultiScaleVit(nn.Module):
    ...
    def group_matcher(self, coarse=False):
        matcher = dict(stem=r"^patch_embed", blocks=[(r"^stages\.(\d+)", None), (r"^norm", (99999,))])  # stem and embed
        return matcher
