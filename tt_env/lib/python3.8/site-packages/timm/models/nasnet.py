...
class BranchSeparables(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, pad_type="", stem_cell=False):
        ...
        self.act_1 = nn.ReLU()
        self.separable_1 = SeparableConv2d(in_channels, middle_channels, kernel_size, stride=stride, padding=pad_type)
        self.bn_sep_1 = nn.BatchNorm2d(middle_channels, eps=0.001, momentum=0.1)
        self.act_2 = nn.ReLU(inplace=True)
        self.separable_2 = SeparableConv2d(middle_channels, out_channels, kernel_size, stride=1, padding=pad_type)
