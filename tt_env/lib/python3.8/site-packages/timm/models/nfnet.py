...
default_cfgs = dict(
    ...
    eca_nfnet_l3=_dcfg(
        url="", pool_size=(11, 11), input_size=(3, 352, 352), test_input_size=(3, 448, 448), crop_pct=1.0
    ),
    nf_regnet_b0=_dcfg(
...
class DownsampleAvg(nn.Module):
    def __init__(self, in_chs, out_chs, stride=1, dilation=1, first_dilation=None, conv_layer=ScaledStdConv2d):
...
def _create_normfreenet(variant, pretrained=False, **kwargs):
    ...
    return build_model_with_cfg(
        NormFreeNet, variant, pretrained, model_cfg=model_cfg, feature_cfg=feature_cfg, **kwargs
    )
