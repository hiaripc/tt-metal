...
default_cfgs = dict(
    poolformer_s12=_cfg(
        url="https://github.com/sail-sg/poolformer/releases/download/v1.0/poolformer_s12.pth.tar", crop_pct=0.9
    ),
    poolformer_s24=_cfg(
        url="https://github.com/sail-sg/poolformer/releases/download/v1.0/poolformer_s24.pth.tar", crop_pct=0.9
    ),
    poolformer_s36=_cfg(
        url="https://github.com/sail-sg/poolformer/releases/download/v1.0/poolformer_s36.pth.tar", crop_pct=0.9
    ),
    poolformer_m36=_cfg(
        url="https://github.com/sail-sg/poolformer/releases/download/v1.0/poolformer_m36.pth.tar", crop_pct=0.95
    ),
    poolformer_m48=_cfg(
        url="https://github.com/sail-sg/poolformer/releases/download/v1.0/poolformer_m48.pth.tar", crop_pct=0.95
    ),
)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.patch_embed = PatchEmbed(
            patch_size=in_patch_size, stride=in_stride, padding=in_pad, in_chs=in_chans, embed_dim=embed_dims[0]
        )
