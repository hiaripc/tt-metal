...
default_cfgs = {
    ...
    "ecaresnet200d": _cfg(
        url="", interpolation="bicubic", first_conv="conv1.0", input_size=(3, 256, 256), crop_pct=0.94, pool_size=(8, 8)
    ),
    "ecaresnet269d": _cfg(
    ...
    "resnetblur50d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    "resnetblur101d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    "resnetaa50": _cfg(
    ...
    "resnetaa50d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    "resnetaa101d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
    "seresnetaa50d": _cfg(url="", interpolation="bicubic", first_conv="conv1.0"),
...
def resnet200d(pretrained=False, **kwargs):
    ...
    model_args = dict(block=Bottleneck, layers=[3, 24, 36, 3], stem_width=32, stem_type="deep", avg_down=True, **kwargs)
...
def seresnext50_32x4d(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 6, 3], cardinality=32, base_width=4, block_args=dict(attn_layer="se"), **kwargs
    )
...
def seresnext101_32x4d(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 23, 3], cardinality=32, base_width=4, block_args=dict(attn_layer="se"), **kwargs
    )
...
def seresnext101_32x8d(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 23, 3], cardinality=32, base_width=8, block_args=dict(attn_layer="se"), **kwargs
    )
