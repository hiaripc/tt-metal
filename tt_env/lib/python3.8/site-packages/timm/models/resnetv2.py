...
default_cfgs = {
    ...
    "resnetv2_50x1_bitm_in21k": _cfg(
        url="https://storage.googleapis.com/bit_models/BiT-M-R50x1.npz", num_classes=21843
    ),
    "resnetv2_50x3_bitm_in21k": _cfg(
        url="https://storage.googleapis.com/bit_models/BiT-M-R50x3.npz", num_classes=21843
    ),
    "resnetv2_101x1_bitm_in21k": _cfg(
        url="https://storage.googleapis.com/bit_models/BiT-M-R101x1.npz", num_classes=21843
    ),
    "resnetv2_101x3_bitm_in21k": _cfg(
        url="https://storage.googleapis.com/bit_models/BiT-M-R101x3.npz", num_classes=21843
    ),
    "resnetv2_152x2_bitm_in21k": _cfg(
        url="https://storage.googleapis.com/bit_models/BiT-M-R152x2.npz", num_classes=21843
    ),
    "resnetv2_152x4_bitm_in21k": _cfg(
        url="https://storage.googleapis.com/bit_models/BiT-M-R152x4.npz", num_classes=21843
    ),
    "resnetv2_50x1_bit_distilled": _cfg(
        url="https://storage.googleapis.com/bit_models/distill/R50x1_224.npz", interpolation="bicubic"
    ),
    "resnetv2_152x2_bit_teacher": _cfg(
        url="https://storage.googleapis.com/bit_models/distill/R152x2_T_224.npz", interpolation="bicubic"
    ),
    ...
    "resnetv2_50d": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
    "resnetv2_50t": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
    "resnetv2_101": _cfg(
        url="https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-rsb-weights/resnetv2_101_a1h-5d01f016.pth",
        interpolation="bicubic",
        crop_pct=0.95,
    ),
    "resnetv2_101d": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
    "resnetv2_152": _cfg(interpolation="bicubic"),
    "resnetv2_152d": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
    ...
    "resnetv2_50d_evob": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
    ...
    "resnetv2_50d_frn": _cfg(interpolation="bicubic", first_conv="stem.conv1"),
}
...
class DownsampleConv(nn.Module):
    def __init__(
        self, in_chs, out_chs, stride=1, dilation=1, first_dilation=None, preact=True, conv_layer=None, norm_layer=None
    ):
...
def create_resnetv2_stem(
    in_chs, out_chs=64, stem_type="", preact=True, conv_layer=StdConv2d, norm_layer=partial(GroupNormAct, num_groups=32)
):
    stem = OrderedDict()
...
def _create_resnetv2(variant, pretrained=False, **kwargs):
    ...
    return build_model_with_cfg(
        ResNetV2, variant, pretrained, feature_cfg=feature_cfg, pretrained_custom_load="_bit" in variant, **kwargs
    )
