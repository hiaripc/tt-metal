...
def _build_blocks(
    block_cfg, prev_chs, width_mult, ch_div=1, act_layer="swish", dw_act_layer="relu6", drop_path_rate=0.0
):
    feat_chs = [prev_chs]
    feature_info = []
    curr_stride = 2
...
def _create_rexnet(variant, pretrained, **kwargs):
    ...
    return build_model_with_cfg(ReXNetV1, variant, pretrained, feature_cfg=feature_cfg, **kwargs)
