...
def _create_swin_transformer(variant, pretrained=False, **kwargs):
    model = build_model_with_cfg(
        SwinTransformer, variant, pretrained, pretrained_filter_fn=checkpoint_filter_fn, **kwargs
    )
...
def swin_s3_tiny_224(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        patch_size=4, window_size=(7, 7, 14, 7), embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), **kwargs
    )
...
def swin_s3_base_224(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        patch_size=4, window_size=(7, 7, 14, 7), embed_dim=96, depths=(2, 2, 30, 2), num_heads=(3, 6, 12, 24), **kwargs
    )
