...
default_cfgs = {
    "swinv2_cr_tiny_384": _cfg(url="", input_size=(3, 384, 384), crop_pct=1.0, pool_size=(12, 12)),
    "swinv2_cr_tiny_224": _cfg(url="", input_size=(3, 224, 224), crop_pct=0.9),
    ...
    "swinv2_cr_small_384": _cfg(url="", input_size=(3, 384, 384), crop_pct=1.0, pool_size=(12, 12)),
    ...
    "swinv2_cr_base_384": _cfg(url="", input_size=(3, 384, 384), crop_pct=1.0, pool_size=(12, 12)),
    "swinv2_cr_base_224": _cfg(url="", input_size=(3, 224, 224), crop_pct=0.9),
    "swinv2_cr_base_ns_224": _cfg(url="", input_size=(3, 224, 224), crop_pct=0.9),
    "swinv2_cr_large_384": _cfg(url="", input_size=(3, 384, 384), crop_pct=1.0, pool_size=(12, 12)),
    "swinv2_cr_large_224": _cfg(url="", input_size=(3, 224, 224), crop_pct=0.9),
    "swinv2_cr_huge_384": _cfg(url="", input_size=(3, 384, 384), crop_pct=1.0, pool_size=(12, 12)),
    "swinv2_cr_huge_224": _cfg(url="", input_size=(3, 224, 224), crop_pct=0.9),
    "swinv2_cr_giant_384": _cfg(url="", input_size=(3, 384, 384), crop_pct=1.0, pool_size=(12, 12)),
    "swinv2_cr_giant_224": _cfg(url="", input_size=(3, 224, 224), crop_pct=0.9),
}
...
class WindowMultiHeadAttention(nn.Module):
    ...
    def _make_pair_wise_relative_positions(self) -> None:
        ...
        coordinates = torch.stack(
            torch.meshgrid(
                [torch.arange(self.window_size[0], device=device), torch.arange(self.window_size[1], device=device)]
            ),
            dim=0,
        ).flatten(1)
...
def _create_swin_transformer_v2_cr(variant, pretrained=False, **kwargs):
    ...
    model = build_model_with_cfg(
        SwinTransformerV2Cr, variant, pretrained, pretrained_filter_fn=checkpoint_filter_fn, **kwargs
    )
    return model
...
def swinv2_cr_tiny_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), **kwargs)
...
def swinv2_cr_tiny_ns_224(pretrained=False, **kwargs):
    ...
    ** Experimental, may make default if results are improved. **
    """
    model_kwargs = dict(embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), extra_norm_stage=True, **kwargs)
...
def swinv2_cr_small_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24), **kwargs)
...
def swinv2_cr_small_ns_224(pretrained=False, **kwargs):
    """Swin-S V2 CR @ 224x224, trained ImageNet-1k"""
    model_kwargs = dict(embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24), extra_norm_stage=True, **kwargs)
...
def swinv2_cr_base_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
...
def swinv2_cr_base_ns_224(pretrained=False, **kwargs):
    """Swin-B V2 CR @ 224x224, trained ImageNet-1k"""
    model_kwargs = dict(embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), extra_norm_stage=True, **kwargs)
...
def swinv2_cr_large_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(embed_dim=192, depths=(2, 2, 18, 2), num_heads=(6, 12, 24, 48), **kwargs)
...
def swinv2_cr_giant_384(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(embed_dim=512, depths=(2, 2, 42, 2), num_heads=(16, 32, 64, 128), extra_norm_period=6, **kwargs)
