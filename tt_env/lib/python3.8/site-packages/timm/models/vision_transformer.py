...
default_cfgs = {
    ...
    "vit_base_patch32_224_sam": _cfg(url="https://storage.googleapis.com/vit_models/sam/ViT-B_32.npz"),
    "vit_base_patch16_224_sam": _cfg(url="https://storage.googleapis.com/vit_models/sam/ViT-B_16.npz"),
...
def _load_weights(model: VisionTransformer, checkpoint_path: str, prefix: str = ""):
    ...
    if pos_embed_w.shape != model.pos_embed.shape:
        pos_embed_w = resize_pos_embed(  # resize pos embedding when different size from pretrained weights
            pos_embed_w, model.pos_embed, getattr(model, "num_prefix_tokens", 1), model.patch_embed.grid_size
        )
