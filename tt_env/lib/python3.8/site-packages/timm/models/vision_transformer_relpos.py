...
default_cfgs = {
    ...
    "vit_relpos_base_patch16_cls_224": _cfg(url=""),
...
class RelPosMlp(nn.Module):
    def __init__(
        self, window_size, num_heads=8, hidden_dim=128, prefix_tokens=0, mode="cr", pretrained_window_size=(0, 0)
    ):
        super().__init__()
        ...
        self.register_buffer(
            "rel_coords_log", gen_relative_log_coords(window_size, pretrained_window_size, mode=mode), persistent=False
        )
...
class VisionTransformerRelPos(nn.Module):
    ...
    def group_matcher(self, coarse=False):
        return dict(
            stem=r"^cls_token|patch_embed", blocks=[(r"^blocks\.(\d+)", None), (r"^norm", (99999,))]  # stem and embed
        )
...
def vit_relpos_base_patch32_plus_rpn_256(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=32, embed_dim=896, depth=12, num_heads=14, block_fn=ResPostRelPosBlock, **kwargs)
...
def vit_relpos_small_patch16_224(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/16) w/ relative log-coord position, no class token"""
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, qkv_bias=False, fc_norm=True, **kwargs)
...
def vit_relpos_medium_patch16_224(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/16) w/ relative log-coord position, no class token"""
    model_kwargs = dict(patch_size=16, embed_dim=512, depth=12, num_heads=8, qkv_bias=False, fc_norm=True, **kwargs)
...
def vit_relpos_base_patch16_224(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/16) w/ relative log-coord position, no class token"""
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, qkv_bias=False, fc_norm=True, **kwargs)
...
def vit_srelpos_medium_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos("vit_srelpos_medium_patch16_224", pretrained=pretrained, **model_kwargs)
    return model
...
def vit_relpos_base_patch16_clsgap_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos(
        "vit_relpos_base_patch16_clsgap_224", pretrained=pretrained, **model_kwargs
    )
    return model
...
def vit_relpos_small_patch16_rpn_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer_relpos("vit_relpos_small_patch16_rpn_224", pretrained=pretrained, **model_kwargs)
    return model
