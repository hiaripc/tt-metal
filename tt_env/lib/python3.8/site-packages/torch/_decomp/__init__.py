...
global_decomposition_table: Dict[str, Dict[torch._ops.OperatorBase, Callable]] = defaultdict(dict)
...
def register_decomposition(aten_op, registry=None, *, type="post_autograd", unsafe=False):
    """
