...
aot_eager_decomp_partition = aot_autograd(
    ...
    decompositions=lambda: import_module("torch._inductor.compile_fx").select_decomp_table(),
    partition_fn=functools.partial(min_cut_rematerialization_partition, compiler="inductor"),
)
...
class ExplainOutput:
    ...
    break_reasons: List[Any]  # Type is GraphCompileReason but doesn't matter for this purpose
    op_count: int
