...
if DEBUG_DIR_VAR_NAME in os.environ:
    debug_dir_root = os.path.join(os.environ[DEBUG_DIR_VAR_NAME], "torch_compile_debug")  # [@compile_ignored: debug]
elif is_fbcode():
    debug_dir_root = os.path.join(tempfile.gettempdir(), "torch_compile_debug")  # [@compile_ignored: debug]
else:
    debug_dir_root = os.path.join(os.getcwd(), "torch_compile_debug")  # [@compile_ignored: debug]
