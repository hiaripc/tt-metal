...
ACCURACY_FAILS: Dict[str, Callable[[nn.Module, Any], bool]] = {
    ...
    # divergence
    "accuracy": functools.partial(inductor_accuracy_fails, require_fp64=True, ignore_non_fp=True),
...
def repro_minify(options, mod, load_args):
    ...
    minifier(
        ...
        dump_state=functools.partial(dump_compiler_graph_state, compiler_name=compiler_name),
        save_dir=options.save_dir,
