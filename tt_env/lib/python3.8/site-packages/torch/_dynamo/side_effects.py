...
class SideEffects:
    ...
    def apply(self, fn, cache=None, skip_fn=lambda _: False):
        ...
        self.store_attr_mutations = {
            k: VariableTracker.apply(fn, v, cache, skip_fn) for k, v in self.store_attr_mutations.items()
        }
            ...
            if isinstance(var, variables.ListVariable):
                ...
                for name, value in self.store_attr_mutations.get(var.mutable_local, {}).items():
                    if isinstance(var, variables.NewGlobalVariable):
                        ...
                        if isinstance(var.mutable_local, AttributeMutationExisting) and hasattr(
