...
class ConstantVariable(VariableTracker):
    ...
    def call_method(
        ...
        if any(isinstance(x, SymNodeVariable) for x in args):
            ...
            return variables.SymNodeVariable(self.as_proxy(), self.value).call_method(tx, name, args, kwargs)
        ...
        if isinstance(self.value, str) and name in str.__dict__.keys():
            ...
            if isinstance(add_target, (torch.SymInt, torch.SymFloat)):
                ...
                # )
                proxy = tx.output.create_proxy("call_function", op, (self.value, add_target), {})
