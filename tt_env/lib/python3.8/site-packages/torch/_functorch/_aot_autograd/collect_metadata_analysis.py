    ...
    def inner(*flat_args):
        ...
        for i, (arg, f_arg) in enumerate(zip(flat_args, flat_f_args)):
            ...
            mutations_under_no_grad_or_inference_mode = (
                mutates_data and are_all_mutations_under_no_grad_or_inference_mode(f_arg)
            )
...
from a multi-output view call"
        ...
        f_mutated_inputs = [
            inp for inp, info in zip(flat_f_args, input_info) if info.mutates_data or info.mutates_metadata
        ]
