...
class ViewAndMutationMeta:
    ...
    def __post_init__(self):
        ...
        if not self.requires_subclass_dispatch:
            mutated_inp_runtime_indices = [
                i for i, m in enumerate(self.input_info) if (m.mutation_type == MutationType.MUTATED_OUT_GRAPH)
            ]
        else:
            mutated_inp_runtime_indices = [
                i
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and all(
                x.shape == y.shape and x.dtype == y.dtype for x, y, in zip(self.traced_tangents, other.traced_tangents)
            )
        )
