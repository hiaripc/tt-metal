...
def fn_prepped_for_autograd(
    ...
    def inner_fn(*args):
        ...
        mutated_inputs_to_return = [
            x for (i, x) in enumerate(args_maybe_cloned) if i in meta.mutated_inp_runtime_indices
        ]
        ...
        output_grad_mask = [
            ...
            and issubclass(meta.output_info[i].raw_type, Tensor) and meta.output_info[i].requires_grad
