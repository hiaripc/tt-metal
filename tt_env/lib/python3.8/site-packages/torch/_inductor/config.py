...
coordinate_descent_check_all_directions = os.environ.get("TORCHINDUCTOR_COORDINATE_DESCENT_CHECK_ALL_DIRECTIONS") == "1"
coordinate_descent_search_radius = int(os.environ.get("TORCHINDUCTOR_COORDINATE_DESCENT_RADIUS", "1"))
...
if is_fbcode():
    ...
    try:
        if __package__:
            global_cache_dir = parutil.get_dir_path(os.path.join(__package__.replace(".", os.sep), "fb/cache"))
        else:
...
class cuda:
    ...
    cutlass_dir = os.environ.get(
        ...
        os.path.abspath(os.path.join(os.path.dirname(torch.__file__), "../third_party/cutlass/")),
    )
