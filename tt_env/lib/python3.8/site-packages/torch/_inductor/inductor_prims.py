...
masked_scatter_with_index = make_prim(
    ...
    lambda input_tensor, mask, index, source: torch.masked_scatter(input_tensor, mask, source),
...
_unsafe_index_put_ = make_prim(
    ...
    lambda self, indices, values, accumulate=False: torch.ops.aten.index_put_(self, indices, values, accumulate),
