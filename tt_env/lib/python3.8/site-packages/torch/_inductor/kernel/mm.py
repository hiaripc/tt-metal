...
def tuned_addmm(inp, mat1, mat2, *, alpha=1, beta=1, layout=None):
    ...
    if (
        ...
        choices.insert(
            0,
            aten_bias_addmm.bind((inp_expanded, mat1, mat2), layout, alpha=alpha, beta=beta),
        )
...
def tuned_mixed_mm(mat1, mat2, mat2_dtype):
    ...
    if (mat1.layout.dtype != torch.float32 and not mat2.layout.is_contiguous()) or _is_sm7x_or_older_gpu(
        layout.device.index
    ):
