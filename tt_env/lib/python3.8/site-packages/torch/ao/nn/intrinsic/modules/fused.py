...
class ConvReLU1d(_FusedModule):
    ...
    def __init__(self, conv, relu):
        assert (
            type_before_parametrizations(conv) == Conv1d and type_before_parametrizations(relu) == ReLU
...
class ConvReLU2d(_FusedModule):
    ...
    def __init__(self, conv, relu):
        assert (
            type_before_parametrizations(conv) == Conv2d and type_before_parametrizations(relu) == ReLU
        ), f"Incorrect types for input modules{type_before_parametrizations(conv)}{type_before_parametrizations(relu)}"
        super().__init__(conv, relu)
...
class ConvReLU3d(_FusedModule):
    ...
    def __init__(self, conv, relu):
        assert (
            type_before_parametrizations(conv) == Conv3d and type_before_parametrizations(relu) == ReLU
        ), f"Incorrect types for input modules{type_before_parametrizations(conv)}{type_before_parametrizations(relu)}"
        super().__init__(conv, relu)
...
class LinearReLU(_FusedModule):
    ...
    def __init__(self, linear, relu):
        assert (
            type_before_parametrizations(linear) == Linear and type_before_parametrizations(relu) == ReLU
...
class ConvBn1d(_FusedModule):
    ...
    def __init__(self, conv, bn):
        assert (
            type_before_parametrizations(conv) == Conv1d and type_before_parametrizations(bn) == BatchNorm1d
...
class ConvBn2d(_FusedModule):
    ...
    def __init__(self, conv, bn):
        assert (
            type_before_parametrizations(conv) == Conv2d and type_before_parametrizations(bn) == BatchNorm2d
        ), f"Incorrect types for input modules{type_before_parametrizations(conv)}{type_before_parametrizations(bn)}"
        super().__init__(conv, bn)
...
class ConvBnReLU1d(_FusedModule):
    ...
    def __init__(self, conv, bn, relu):
        assert (
            ...
            type_before_parametrizations(conv), type_before_parametrizations(bn), type_before_parametrizations(relu)
        )
...
class ConvBn3d(_FusedModule):
    ...
    def __init__(self, conv, bn):
        assert (
            type_before_parametrizations(conv) == Conv3d and type_before_parametrizations(bn) == BatchNorm3d
        ), f"Incorrect types for input modules{type_before_parametrizations(conv)}{type_before_parametrizations(bn)}"
        super().__init__(conv, bn)
...
class BNReLU2d(_FusedModule):
    ...
    def __init__(self, batch_norm, relu):
        assert (
            type_before_parametrizations(batch_norm) == BatchNorm2d and type_before_parametrizations(relu) == ReLU
        ), "Incorrect types for input modules{}{}".format(
...
class BNReLU3d(_FusedModule):
    ...
    def __init__(self, batch_norm, relu):
        assert (
            type_before_parametrizations(batch_norm) == BatchNorm3d and type_before_parametrizations(relu) == ReLU
        ), "Incorrect types for input modules{}{}".format(
            type_before_parametrizations(batch_norm), type_before_parametrizations(relu)
        )
        super().__init__(batch_norm, relu)
...
class LinearBn1d(_FusedModule):
    ...
    def __init__(self, linear, bn):
        assert (
            type_before_parametrizations(linear) == Linear and type_before_parametrizations(bn) == BatchNorm1d
