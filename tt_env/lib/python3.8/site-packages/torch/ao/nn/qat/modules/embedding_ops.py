...
class Embedding(nn.Embedding):
    ...
    def __init__(
        ...
        assert (
            qconfig.weight().qscheme == torch.per_channel_affine_float_qparams
        ), "Embedding weights requires a qscheme of torch.per_channel_affine_float_qparams Got " + str(
    ...
    def from_float(cls, mod):
        ...
        assert (
            weight_qscheme == torch.per_channel_affine_float_qparams
        ), "Embedding weights requires a qscheme of torch.per_channel_affine_float_qparams Got " + str(weight_qscheme)
...
class EmbeddingBag(nn.EmbeddingBag):
    ...
    def __init__(
        ...
        assert (
            qconfig.weight().qscheme == torch.per_channel_affine_float_qparams
        ), "Embedding Bag weights requires a qscheme of torch.per_channel_affine_float_qparams Got " + str(
            qconfig.weight().qscheme
        )
        self.qconfig = qconfig
        self.weight_fake_quant = qconfig.weight(factory_kwargs=factory_kwargs)
