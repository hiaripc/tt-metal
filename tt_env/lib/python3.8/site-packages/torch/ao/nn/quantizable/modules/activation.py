...
class MultiheadAttention(nn.MultiheadAttention):
    ...
    def __init__(
        ...
        super().__init__(
            embed_dim, num_heads, dropout, bias, add_bias_kv, add_zero_attn, kdim, vdim, batch_first, **factory_kwargs
        )
    ...
    def from_observed(cls, other):
        ...
        raise NotImplementedError(
            "It looks like you are trying to prepare an " "MHA module. Please, see " "the examples on quantizable MHAs."
        )
