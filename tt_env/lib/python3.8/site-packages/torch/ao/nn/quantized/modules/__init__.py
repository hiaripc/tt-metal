...
from .normalization import LayerNorm, GroupNorm, InstanceNorm1d, InstanceNorm2d, InstanceNorm3d
...
class Quantize(torch.nn.Module):
    ...
    def __init__(self, scale, zero_point, dtype, factory_kwargs=None):
        ...
        self.register_buffer(
            "zero_point",
            torch.tensor([zero_point], dtype=torch.long, **{k: v for k, v in factory_kwargs.items() if k != "dtype"}),
        )
        self.dtype = dtype
