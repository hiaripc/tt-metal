...
class Linear(torch.nn.Module):
    ...
    def _load_from_state_dict(
        ...
        assert op_type == "sparse", f"Cannot load from op_type [{op_type}], expecting [{self._op_type}]"
        ...
        state_dict.update({prefix + "_packed_params.weight": weight, prefix + "_packed_params.bias": bias})
    ...
    def set_weight_bias(
        self, w: torch.Tensor, b: Optional[torch.Tensor], row_block_size: Optional[int], col_block_size: Optional[int]
    ) -> None:
