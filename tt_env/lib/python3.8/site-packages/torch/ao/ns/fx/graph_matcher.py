...
class _NSGraphMatchableSubgraphsIterator:
    ...
    def _is_matchable(self, node: Node) -> bool:
        if node.op == "call_function":
            ...
            return not any(isinstance(target_mod, t) for t in self.non_matchable_modules)  # type: ignore[arg-type]
...
def _get_subgraph_relationship_type(
    ...
    if node_a.op in ("call_function", "call_method"):
        ...
        assert (
            subgraph_a.base_op_node == subgraph_a.start_node and subgraph_b.base_op_node == subgraph_b.start_node
