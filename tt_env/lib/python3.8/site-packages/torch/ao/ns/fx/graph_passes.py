...
def _insert_dtype_cast_after_node(
    ...
    if (
        (node_input_type_a == NodeInputOrOutputType.FP32 and node_input_type_c == NodeInputOrOutputType.INT8)
        or (node_input_type_a == NodeInputOrOutputType.FP32 and node_input_type_c == NodeInputOrOutputType.FP16)
        or
        ...
        (node_input_type_a == NodeInputOrOutputType.FP32 and node_input_type_c == NodeInputOrOutputType.FP32_OR_INT8)
    ):
    ...
    if isinstance(prev_node_c, Node):
        ...
        if dtype_cast_op:
            ...
            return graph_c.create_node(
                "call_method", dtype_cast_method, (prev_node_c, dtype_cast_method_dtype), {}, new_dtype_cast_name
            )
        else:
        ...
        for prev_node_c_inner in prev_node_c:
            ...
            if dtype_cast_op:
                ...
                new_dtype_cast_node = graph_c.create_node(
                    "call_function", dtype_cast_op, (prev_node_c_inner,), {}, new_dtype_cast_name
                )
                ...
                setattr(gm_b, new_dtype_cast_name, dtype_cast_mod)
                new_dtype_cast_node = graph_c.create_node(
                    "call_module", new_dtype_cast_name, (prev_node_c_inner,), {}, new_dtype_cast_name
                )
                results.append(new_dtype_cast_node)
        return results
    else:
    ...
    if node_a.op == "get_attr":
        ...
        if node_a.target == "dequantize":
            ...
            node_a_copy = graph_c.create_node(
                node_a.op, node_a.target, (arg_copy, get_normalized_nth_input(node_a, gm_a, 1)), {}, node_a_copy_name
            )
            return node_a_copy
    ...
    for node_b in gm_b.graph.nodes:
        ...
        if node_b_is_start_node or node_b_is_end_node:
            if node_b_is_start_node:
                ...
                subgraph_a, ref_name, ref_node_type_a, ref_node_type_b = end_node_b_to_matched_subgraph_a_and_name[
                    node_b
                ]
            ...
            node_input_type_a, node_output_type_a = get_node_first_input_and_output_type(
                subgraph_a.start_node, gm_a, logger_cls, node_type_to_io_type_map
            )
            node_input_type_b, node_output_type_b = get_node_first_input_and_output_type(
            ...
            if node_b_is_start_node:
                ...
                node_a_shadows_c = _insert_copy_of_subgraph_a_after_input_node_c(
                    dtype_cast_node, node_c_second_non_param_arg, subgraph_a, gm_a, gm_b, node_c.name + "_shadow_copy_"
                )
