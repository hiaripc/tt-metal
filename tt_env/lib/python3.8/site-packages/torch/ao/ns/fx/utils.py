...
def get_node_first_input_and_output_type(
    ...
    if node.op == "call_function":
        ...
        if node.target in FUNS_IO_TYPE_FP16:
            ...
            ) = get_node_first_input_and_output_type(first_arg, gm, logger_cls, node_type_to_io_type_map)
        ...
        if node.target == "dequantize":
            ...
            (
                _prev_node_input_type,
                prev_node_output_type,
            ) = get_node_first_input_and_output_type(prev_node, gm, logger_cls, node_type_to_io_type_map)
