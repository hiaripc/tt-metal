...
class BackendConfig:
    ...
    def set_backend_pattern_config(self, config: BackendPatternConfig) -> BackendConfig:
        ...
        pattern_complex_format = (
            torch.ao.quantization.backend_config.utils._get_pattern_in_reversed_nested_tuple_format(config)
...
class BackendPatternConfig:
    ...
    def __repr__(self):
        dict_nonempty = {
            ...
            if ((not isinstance(v, (list, dict)) and v is not None) or (isinstance(v, (list, dict)) and len(v) > 0))
        }
