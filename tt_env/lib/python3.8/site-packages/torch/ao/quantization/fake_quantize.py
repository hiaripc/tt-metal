...
class FakeQuantize(FakeQuantizeBase):
    ...
    * :attr:`dtype` specifies the quantized dtype that is being emulated with fake-quantization,
    ...
    def __init__(
        self, observer=MovingAverageMinMaxObserver, quant_min=None, quant_max=None, is_dynamic=False, **observer_kwargs
    ):
        super().__init__()
...
class FusedMovingAvgObsFakeQuantize(FakeQuantize):
    ...
    def __init__(
        ...
        **observer_kwargs: Any,
        ...
        assert isinstance(
            self.activation_post_process, (MovingAverageMinMaxObserver, MovingAveragePerChannelMinMaxObserver)
...
fused_per_channel_wt_fake_quant_range_neg_127_to_127 = FusedMovingAvgObsFakeQuantize.with_args(
    observer=MovingAveragePerChannelMinMaxObserver,
    quant_min=-127,
    quant_max=127,
    dtype=torch.qint8,
...
def _is_fake_quant_script_module(mod):
    ...
    if isinstance(mod, torch.jit.RecursiveScriptModule):
        ...
        return (
            ...
            or name == "torch.ao.quantization.fake_quantize.FusedMovingAvgObsFakeQuantize"
        )
    return False
