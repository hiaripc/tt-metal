...
class ModelReportVisualizer:
    ...
    * :attr:`generated_reports` The reports generated by the ModelReport class in the structure below
    ...
    def _generate_tensor_table(
        self, filtered_data: OrderedDict[str, Dict[str, Any]], tensor_features: List[str]
    ) -> Tuple[List, List]:
        r"""
    ...
    def _generate_channels_table(
        self, filtered_data: OrderedDict[str, Any], channel_features: List[str], num_channels: int
    ) -> Tuple[List, List]:
        r"""
