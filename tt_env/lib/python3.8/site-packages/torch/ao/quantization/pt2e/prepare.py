...
def _has_same_is_dynamic(qspec_a: QuantizationSpecBase, qspec_b: QuantizationSpecBase):
    return (
        hasattr(qspec_a, "is_dynamic") and hasattr(qspec_b, "is_dynamic") and qspec_a.is_dynamic == qspec_b.is_dynamic
    )
            ...
            if n.meta["quantization_annotation"].allow_implicit_sharing:
                ...
                for user in arg.users:
                    ...
                    _union_input_edge_with(
                        input_edge, input_edge_root_qspec, arg_to_user_edge, edge_or_node_to_qspec, shared_with_map
                    )
...
def _maybe_insert_input_and_output_observers_for_node(
    ...
    this_node_quantization_annotation = (
        node.meta["quantization_annotation"] if "quantization_annotation" in node.meta else None
    )
