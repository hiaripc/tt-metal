...
def _reference_quantized_linear(
    ...
    acc_i32 = out_dtype(
        torch.ops.aten.linear.default, torch.int32, x_i16 - x_zero_point, weight_i16 - weight_zero_point, None
    )
    ...
    acc_i32 = (
        out_dtype(torch.ops.aten.mul.Tensor, torch.int32, acc_i32, x_scale * weight_scale / out_scale) + out_zero_point
    )
...
_REWRITE_INFO_LIST = [
    ...
    _RewriteInfo(_QUANTIZED_ADD_OR_ADD_RELU_EXAMPLE_INPUTS, _qdq_quantized_add_relu, _reference_quantized_add_relu),
    _RewriteInfo(_QUANTIZED_ADD_OR_ADD_RELU_EXAMPLE_INPUTS, _qdq_quantized_add, _reference_quantized_add),
    _RewriteInfo(
        _QUANTIZED_MAX_POOL2D_EXAMPLE_INPUTS,
