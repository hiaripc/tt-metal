...
def _compile(
    ...
    **kwargs: Any,
    ...
    def stateless_func(func, params, buffers, named_states, args, kwargs):
        with stateless._reparametrize_module(mod, {**params, **buffers}), _rematerialize_optimizer(
    ...
    def inner(func: Callable):
        ...
        def wrapper(*args, **kwargs):
            ...
            if compiled_obj is None:
                first_iter = True
                global dtensor_expand_mode
                mode: ParallelMode = dtensor_expand_mode if parallel_mode is None else parallel_mode

                compiled_obj = _compile(func, module_override, mode, *args, **kwargs)
                wrapper.__dict__[COMPILED_OBJECT_KEY] = compiled_obj

            flat_inps = compiled_obj.flat_state + pytree.arg_tree_leaves(*args, **kwargs)
