...
class DTensor(torch.Tensor):  # pyre-ignore[13]: pyre is bad at __new__
    ...
    def to_local(self, *, grad_placements: Optional[Sequence[Placement]] = None) -> torch.Tensor:
        ...
        return _ToTorchTensor.apply(self, grad_placements, True)  # pyre-ignore[16]: autograd func
...
def distribute_module(
    ...
    if output_fn is not None:
        module.register_forward_hook(lambda mod, inputs, outputs: output_fn(outputs, device_mesh))  # type: ignore[misc]
