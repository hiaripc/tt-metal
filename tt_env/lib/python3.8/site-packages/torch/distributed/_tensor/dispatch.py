...
class OpDispatcher:
    ...
    def dispatch(
        ...
        if mesh.get_coordinate() is None:
            ...
            if output_sharding.needs_redistribute:
                ...
                self.redistribute_local_args(op_info, output_sharding.schema_suggestions[0])
            ...
            if op_call in self._random_ops and is_rng_supported_mesh(mesh):
                ...
                with random._rng_tracker._distribute_region(cast(dtensor.DTensor, args[0])._spec):
    ...
    def unwrap_to_op_info(
        ...
        op_info = OpInfo(
            ...
            OpSchema(
                op_call,
                pytree.tree_unflatten(args_schema, args_spec) if args_spec else tuple(args_schema),
                kwargs_schema,
