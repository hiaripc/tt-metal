...
if not is_available():
    ...
    sys.modules["torch.distributed.device_mesh"].init_device_mesh = _init_device_mesh_stub  # type: ignore[attr-defined]
    ...
    class DeviceMesh:
        ...
        def get_group(self, mesh_dim: Optional[Union[int, str]] = None) -> Union[ProcessGroup, List[ProcessGroup]]:
            """
            ...
            if mesh_dim is not None:
                ...
                for ith_dim in range(self.mesh.ndim):
                    dim_groups.append(_find_pg_by_ranks_and_tag(*self._dim_group_infos[ith_dim]))
                return dim_groups
