    ...
    def _setup_local_watchdog(self, envs: Dict[int, Dict[str, str]]) -> None:
        ...
        if watchdog_enabled is not None and str(watchdog_enabled) == "1":
            ...
            self._worker_watchdog = timer.FileTimerServer(
                file_path=watchdog_file_path, max_interval=0.1, daemon=True, log_event=self._log_watchdog_event
            )
    ...
    def _start_workers(self, worker_group: WorkerGroup) -> Dict[int, Any]:
        ...
        for worker in worker_group.workers:
            ...
            worker_env = {
                ...
                "TORCH_NCCL_ASYNC_ERROR_HANDLING": os.getenv("TORCH_NCCL_ASYNC_ERROR_HANDLING", str(1)),
            }
