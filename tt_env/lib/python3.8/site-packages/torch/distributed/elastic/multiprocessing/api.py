...
def _validate_full_rank(d: Dict[int, Any], nprocs: int, what: str):
    ...
    if actual_keys != expected_keys:
        raise RuntimeError(f"{what}, local rank mapping mismatch," f" expected: {expected_keys}, actual: {actual_keys}")
...
class MultiprocessContext(PContext):
    ...
    def __init__(
        ...
        self._ret_vals = {
            local_rank: mp.get_context(self.start_method).SimpleQueue() for local_rank in range(self.nprocs)
        }
