...
def parallelize_module(  # type: ignore[return]
    ...
    if is_rng_supported_mesh(device_mesh) and not isinstance(random._rng_tracker, TensorParallelRNGTracker):
    ...
    if device_mesh.ndim > 1:
        _deprecate_warnings(
            "tp_mesh_dim", 'If you have a 2-D or N-D device_mesh, consider passing in device_mesh["tp"]'
        )
