...
translation_validation = os.environ.get("TORCHDYNAMO_TRANSLATION_VALIDATION", "0") == "1"
# Timeout (in milliseconds) for z3 finding a solution.
# [@compile_ignored: debug]
translation_validation_timeout = int(os.environ.get("TORCHDYNAMO_TRANSLATION_VALIDATION_TIMEOUT", "600000"))
...
# [@compile_ignored: debug]
translation_validation_no_bisect = os.environ.get("TORCHDYNAMO_TRANSLATION_NO_BISECT", "0") == "1"
