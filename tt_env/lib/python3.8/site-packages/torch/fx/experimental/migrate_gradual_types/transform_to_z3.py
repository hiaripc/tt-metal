...
try:
                    ...
                    return (
                        z3.Or(
                            [
                                ...
                                z3.And([lhs.arg(0) != 0, rhs.arg(0) == 0]),
                                z3.And([lhs.arg(0) != 0, rhs.arg(0) != 0, lhs.arg(1) != rhs.arg(1)]),
                            ]
                        ),
                        counter,
                    )
    ...
    def evaluate_conditional_with_constraints(tracer_root, graph, node, counter=0, user_constraints=None):
        ...
        transformed_positive, transformed_negative = transform_all_constraints_trace_time(
            tracer_root, graph, node, counter
        )
