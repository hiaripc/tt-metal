...
if HAS_PYDOT:
    ...
    class FxGraphDrawer:
        ...
        def __init__(
            ...
            self._name = name
            self.dot_graph_shape = dot_graph_shape if dot_graph_shape is not None else "record"
        ...
        def _to_dot(
            ...
            for node in graph_module.graph.nodes:
                ...
                dot_node = pydot.Node(
                    node.name,
                    label=self._get_node_label(graph_module, node, skip_node_names_in_args, parse_stack_trace),
                    **style,
                )
