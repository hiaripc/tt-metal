...
def _check_repo_is_trusted(repo_owner, repo_name, owner_name_branch, trust_repo, calling_fn="load"):
    ...
    is_trusted = (
        owner_name in trusted_repos or owner_name_branch in trusted_repos_legacy or repo_owner in _TRUSTED_REPO_OWNERS
    )
...
def list(github, force_reload=False, skip_validation=False, trust_repo=None):
    ...
    repo_dir = _get_cache_or_reload(
        github, force_reload, trust_repo, "list", verbose=True, skip_validation=skip_validation
    )
...
def help(github, model, force_reload=False, skip_validation=False, trust_repo=None):
    ...
    """
    repo_dir = _get_cache_or_reload(
        github, force_reload, trust_repo, "help", verbose=True, skip_validation=skip_validation
    )
    ...
    **kwargs,
    ...
    if source == "github":
        repo_or_dir = _get_cache_or_reload(
            repo_or_dir, force_reload, trust_repo, "load", verbose=verbose, skip_validation=skip_validation
        )
