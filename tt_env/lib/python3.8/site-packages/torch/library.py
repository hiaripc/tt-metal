    ...
    def impl(self, op_name, fn, dispatch_key=""):
        ...
        if key in _impls:
            ...
            raise RuntimeError(
                ...
                "'s behavior for {} dispatch key and {} namespace.".format(name.split("::")[-1], dispatch_key, self.ns)
            )
...
def define(qualname, schema, *, lib=None, tags=()):
    ...
    if not isinstance(qualname, str):
        raise ValueError(f"define(qualname, schema): expected qualname " f"to be instance of str, got {type(qualname)}")
