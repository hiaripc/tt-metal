...
class Module:
    ...
    def register_buffer(self, name: str, tensor: Optional[Tensor], persistent: bool = True) -> None:
        ...
        if "_buffers" not in self.__dict__:
            ...
            raise TypeError(
                f"cannot assign '{torch.typename(tensor)}' object to buffer '{name}' " "(torch Tensor or None required)"
            )
        else:
    ...
    @overload
    def to(
        self, device: Optional[DeviceLikeType] = ..., dtype: Optional[Union[dtype, str]] = ..., non_blocking: bool = ...
    ) -> Self:
        ...
    ...
    def to(self, *args, **kwargs):
        ...
        if dtype is not None:
            if not (dtype.is_floating_point or dtype.is_complex):
                raise TypeError(
                    "nn.Module.to only accepts floating point or complex " f"dtypes, but got desired dtype={dtype}"
                )
            if dtype.is_complex:
                warnings.warn(
        ...
        *,
        ...
        Returns:
            :class:`torch.utils.hooks.RemovableHandle`:
                ...
                ``handle.remove()``
        """
        handle = hooks.RemovableHandle(self._forward_pre_hooks, extra_dict=self._forward_pre_hooks_with_kwargs)
    ...
    def named_parameters(
        ...
        gen = self._named_members(
            lambda module: module._parameters.items(), prefix=prefix, recurse=recurse, remove_duplicate=remove_duplicate
        )
        yield from gen
