...
class RNNBase(Module):
    ...
    def check_hidden_size(
        self, hx: Tensor, expected_hidden_size: Tuple[int, int, int], msg: str = "Expected hidden size {}, got {}"
    ) -> None:
...
class RNNCell(RNNCellBase):
    ...
    def __init__(
        self, input_size: int, hidden_size: int, bias: bool = True, nonlinearity: str = "tanh", device=None, dtype=None
    ) -> None:
        factory_kwargs = {"device": device, "dtype": dtype}
