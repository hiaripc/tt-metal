...
class Parameter(torch.Tensor, metaclass=_ParameterMeta):
    ...
    def __reduce_ex__(self, proto):
        ...
        hooks = OrderedDict()
        if not state:
            return (torch._utils._rebuild_parameter, (self.data, self.requires_grad, hooks))

        return (torch._utils._rebuild_parameter_with_state, (self.data, self.requires_grad, hooks, state))
