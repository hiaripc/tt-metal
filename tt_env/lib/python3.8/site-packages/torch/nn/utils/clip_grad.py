...
def clip_grad_norm_(
    ...
    grouped_grads: Dict[Tuple[torch.device, torch.dtype], List[List[Tensor]]] = _group_tensors_by_device_and_dtype(
...
def clip_grad_norm(
    ...
    """
    warnings.warn(
        "torch.nn.utils.clip_grad_norm is now deprecated in favor " "of torch.nn.utils.clip_grad_norm_.", stacklevel=2
    )
