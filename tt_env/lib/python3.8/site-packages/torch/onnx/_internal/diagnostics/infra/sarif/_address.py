...
class Address(object):
    ...
    absolute_address: int = dataclasses.field(default=-1, metadata={"schema_property_name": "absoluteAddress"})
    ...
    kind: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "kind"})
    length: Optional[int] = dataclasses.field(default=None, metadata={"schema_property_name": "length"})
    ...
    parent_index: int = dataclasses.field(default=-1, metadata={"schema_property_name": "parentIndex"})
