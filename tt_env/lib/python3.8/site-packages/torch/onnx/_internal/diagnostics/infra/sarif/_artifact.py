...
class Artifact(object):
    ...
    encoding: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "encoding"})
    ...
    mime_type: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "mimeType"})
    offset: Optional[int] = dataclasses.field(default=None, metadata={"schema_property_name": "offset"})
