...
class ArtifactLocation(object):
    ...
    uri: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "uri"})
    uri_base_id: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "uriBaseId"})
