...
class ExternalProperties(object):
    ...
    run_guid: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "runGuid"})
    schema: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "schema"})
    ...
    version: Optional[Literal["2.1.0"]] = dataclasses.field(default=None, metadata={"schema_property_name": "version"})
