...
class GraphTraversal(object):
    ...
    result_graph_index: int = dataclasses.field(default=-1, metadata={"schema_property_name": "resultGraphIndex"})
    run_graph_index: int = dataclasses.field(default=-1, metadata={"schema_property_name": "runGraphIndex"})
