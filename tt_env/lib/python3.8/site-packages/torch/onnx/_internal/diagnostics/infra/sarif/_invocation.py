...
class Invocation(object):
    ...
    execution_successful: bool = dataclasses.field(metadata={"schema_property_name": "executionSuccessful"})
    account: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "account"})
    arguments: Optional[List[str]] = dataclasses.field(default=None, metadata={"schema_property_name": "arguments"})
    command_line: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "commandLine"})
    end_time_utc: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "endTimeUtc"})
    ...
    exit_code: Optional[int] = dataclasses.field(default=None, metadata={"schema_property_name": "exitCode"})
    ...
    machine: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "machine"})
    ...
    process_id: Optional[int] = dataclasses.field(default=None, metadata={"schema_property_name": "processId"})
    ...
    rule_configuration_overrides: Optional[List[_configuration_override.ConfigurationOverride]] = dataclasses.field(
        default=None, metadata={"schema_property_name": "ruleConfigurationOverrides"}
    )
    start_time_utc: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "startTimeUtc"})
    ...
    tool_configuration_notifications: Optional[List[_notification.Notification]] = dataclasses.field(
        default=None,
        metadata={"schema_property_name": "toolConfigurationNotifications"},
    )
    tool_execution_notifications: Optional[List[_notification.Notification]] = dataclasses.field(
