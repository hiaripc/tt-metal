...
class Notification(object):
    ...
    associated_rule: Optional[_reporting_descriptor_reference.ReportingDescriptorReference] = dataclasses.field(
        default=None, metadata={"schema_property_name": "associatedRule"}
    )
    descriptor: Optional[_reporting_descriptor_reference.ReportingDescriptorReference] = dataclasses.field(
    ...
    thread_id: Optional[int] = dataclasses.field(default=None, metadata={"schema_property_name": "threadId"})
    time_utc: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "timeUtc"})
