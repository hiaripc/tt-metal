...
class PhysicalLocation(object):
    ...
    address: Optional[_address.Address] = dataclasses.field(default=None, metadata={"schema_property_name": "address"})
    ...
    region: Optional[_region.Region] = dataclasses.field(default=None, metadata={"schema_property_name": "region"})
