...
class ReportingDescriptor(object):
    ...
    default_configuration: Optional[_reporting_configuration.ReportingConfiguration] = dataclasses.field(
    ...
    help_uri: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "helpUri"})
    message_strings: Any = dataclasses.field(default=None, metadata={"schema_property_name": "messageStrings"})
    name: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "name"})
