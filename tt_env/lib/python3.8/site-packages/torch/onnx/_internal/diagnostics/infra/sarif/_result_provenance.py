...
class ResultProvenance(object):
    ...
    conversion_sources: Optional[List[_physical_location.PhysicalLocation]] = dataclasses.field(
    ...
    invocation_index: int = dataclasses.field(default=-1, metadata={"schema_property_name": "invocationIndex"})
