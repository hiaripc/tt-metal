...
class Run(object):
    ...
    automation_details: Optional[_run_automation_details.RunAutomationDetails] = dataclasses.field(
        default=None, metadata={"schema_property_name": "automationDetails"}
    )
    baseline_guid: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "baselineGuid"})
    ...
    run_aggregates: Optional[List[_run_automation_details.RunAutomationDetails]] = dataclasses.field(
    ...
    thread_flow_locations: Optional[List[_thread_flow_location.ThreadFlowLocation]] = dataclasses.field(
    ...
    version_control_provenance: Optional[List[_version_control_details.VersionControlDetails]] = dataclasses.field(
