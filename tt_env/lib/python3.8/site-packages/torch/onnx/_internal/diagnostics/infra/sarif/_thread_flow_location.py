...
class ThreadFlowLocation(object):
    ...
    execution_order: int = dataclasses.field(default=-1, metadata={"schema_property_name": "executionOrder"})
    ...
    kinds: Optional[List[str]] = dataclasses.field(default=None, metadata={"schema_property_name": "kinds"})
    location: Optional[_location.Location] = dataclasses.field(
        default=None, metadata={"schema_property_name": "location"}
    )
    module: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "module"})
    nesting_level: Optional[int] = dataclasses.field(default=None, metadata={"schema_property_name": "nestingLevel"})
    properties: Optional[_property_bag.PropertyBag] = dataclasses.field(
        default=None, metadata={"schema_property_name": "properties"}
    )
    stack: Optional[_stack.Stack] = dataclasses.field(default=None, metadata={"schema_property_name": "stack"})
