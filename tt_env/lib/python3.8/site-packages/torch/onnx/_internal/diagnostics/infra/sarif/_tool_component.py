...
class ToolComponent(object):
    ...
    associated_component: Optional[_tool_component_reference.ToolComponentReference] = dataclasses.field(
    ...
    full_description: Optional[_multiformat_message_string.MultiformatMessageString] = dataclasses.field(
    ...
    language: str = dataclasses.field(default="en-US", metadata={"schema_property_name": "language"})
    ...
    notifications: Optional[List[_reporting_descriptor.ReportingDescriptor]] = dataclasses.field(
        default=None, metadata={"schema_property_name": "notifications"}
    )
    organization: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "organization"})
    product: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "product"})
    product_suite: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "productSuite"})
    ...
    short_description: Optional[_multiformat_message_string.MultiformatMessageString] = dataclasses.field(
        default=None, metadata={"schema_property_name": "shortDescription"}
    )
    supported_taxonomies: Optional[List[_tool_component_reference.ToolComponentReference]] = dataclasses.field(
    ...
    translation_metadata: Optional[_translation_metadata.TranslationMetadata] = dataclasses.field(
        default=None, metadata={"schema_property_name": "translationMetadata"}
    )
    version: Optional[str] = dataclasses.field(default=None, metadata={"schema_property_name": "version"})
