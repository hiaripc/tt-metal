...
def validate_op_between_ort_torch(
    ...
    with evaluator.default_as(evaluator.ort_evaluator):
        ...
        try:
            ...
            function_eager_attributes = fx_onnx_interpreter.filter_incompatible_and_dtype_convert_kwargs(
                function_eager_attributes
            )
        ...
        for torch_output, function_output in zip(flattened_torch_outputs, flattened_function_outputs):
            ...
            try:
                ...
                torch.testing.assert_close(
                    ...
                    torch_output.cpu() if isinstance(torch_output, torch.Tensor) else torch.tensor(torch_output).cpu(),
                    rtol=1e-4,
                    atol=1e-3,
                )
