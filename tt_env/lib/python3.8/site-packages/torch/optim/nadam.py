    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            has_complex = self._init_group(
                group, params_with_grad, grads, exp_avgs, exp_avg_sqs, mu_products, state_steps
            )
...
def _multi_tensor_nadam(
    ...
    *,
    ...
    if not torch._utils.is_compiling() and capturable:
        assert all(
            p.is_cuda and mp.is_cuda and step.is_cuda for p, mp, step in zip(params, mu_products, state_steps)
