...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.quantized_max_pool1d: (
            lambda input, kernel_size, stride=tuple(), padding=(0,), dilation=(1,), ceil_mode=False: -1
        ),
        torch.quantized_max_pool2d: (
            lambda input, kernel_size, stride=tuple(), padding=(0, 0), dilation=(1, 1), ceil_mode=False: -1
        ),
        torch.quantized_max_pool3d: (
            lambda input, kernel_size, stride=tuple(), padding=(0, 0, 0), dilation=(1, 1, 1), ceil_mode=False: -1
        ),
    ...
    for k, v in ret.items():
        ...
        if k.__name__.startswith("bitwise_"):
            ...
            names.extend(["__" + subname + "__", "__i" + subname + "__", "__r" + subname + "__"])
