            ...
            try:
                ...
                if isinstance(
                    ...
                    if not isinstance(
                        ...
                        msg = (_ERR_MSG + "; {!r} is a c extension package which does not contain {!r}.").format(
                            name, parent, name
                        )
                        raise ModuleNotFoundError(msg, name=name) from None
                else:
...
class _PackageResourceReader:
    ...
    def resource_path(self, resource):
        ...
        if isinstance(self.importer.zip_reader, DirectoryReader) and self.importer.zip_reader.has_record(
