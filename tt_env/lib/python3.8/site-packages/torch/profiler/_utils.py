...
class BasicEvaluation:
    def __init__(self, prof: profile):
        ...
        self.event_keys = sorted((e for e in self.metrics.keys()), key=lambda x: x.event.start_time_ns)
    ...
    def compute_queue_depth(self):
        ...
        for cuda_launch_event in cuda_launch_events:
            index = index_of_first_match(
                cuda_kernel_events,
                lambda x: x.linked_correlation_id() == cuda_launch_event.linked_correlation_id(),
        ...
        for event in all_events:
            ...
            while (
                ...
                and (cuda_kernel_events[current_kernel_index].start_us()) * 1000 <= start_time
            ):
