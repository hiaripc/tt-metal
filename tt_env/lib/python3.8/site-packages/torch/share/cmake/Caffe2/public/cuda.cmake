...
if(CUDA_FOUND)
    ...
    if(NOT CMAKE_CROSSCOMPILING)
        try_run(
            run_result
            compile_result
            ${PROJECT_RANDOM_BINARY_DIR}
            ${file}
            CMAKE_FLAGS
                "-DINCLUDE_DIRECTORIES=${CUDA_INCLUDE_DIRS}"
            LINK_LIBRARIES
                ${CUDA_LIBRARIES}
        ...
        message(
            STATUS
            "Caffe2: Header version is: "
            ${cuda_version_from_header}
        )
...
if(CAFFE2_USE_TENSORRT)
    ...
    if(TENSORRT_FOUND)
        ...
        message(WARNING "Caffe2: Cannot find TensorRT library. Turning the option off.")
        set(CAFFE2_USE_TENSORRT OFF)
    endif()
endif()
...
if(CAFFE2_USE_CUDNN)
    ...
    if(CUDNN_STATIC AND NOT WIN32)
        target_link_options(torch::cudnn INTERFACE "-Wl,--exclude-libs,libcudnn_static.a")
    else()
...
elseif(CUDA_DEVICE_DEBUG)
    list(
        ...
        "-g"
        "-G"
    ) # -G enables device code debugging symbols
endif()
