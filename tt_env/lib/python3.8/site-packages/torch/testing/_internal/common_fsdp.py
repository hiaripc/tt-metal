        ...
        for _ in range(num_steps):
            ...
            with torch.cuda.amp.autocast(enabled=autocast):
                ...
                if (
                    ...
                    and model.sharding_strategy not in NO_RESHARD_AFTER_FORWARD_STRATEGIES
                ):
        ...
        **fsdp_kwargs,
        ...
        context = (
            self.assertRaisesRegex(
                RuntimeError,
                "An FSDP-managed module with parameter CPU offloading enabled " "has parameters on cuda",
            )
