...
def poissonnllloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.poisson_nll_loss(i, t.type_as(i), reduction="none")),
...
def bceloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.binary_cross_entropy(i, t.type_as(i), reduction="none")),
...
def bceloss_weights_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(
            lambda i: F.binary_cross_entropy(i, t.type_as(i), weight=weights.type_as(i), reduction="none")
        ),
        cpp_function_call="F::binary_cross_entropy("
        "i, t.to(i.options()), "
...
def bce_with_logistic_legacy_enum_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.binary_cross_entropy_with_logits(i, t.type_as(i), reduce=False)),
...
def bce_with_logistic_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.binary_cross_entropy_with_logits(i, t.type_as(i), reduction="none")),
        cpp_function_call="""F::binary_cross_entropy_with_logits(
            i, t.to(i.options()), F::BinaryCrossEntropyWithLogitsFuncOptions().reduction(torch::kNone))""",
        input_fn=lambda: torch.rand(15, 10).clamp_(2.8e-2, 1 - 2.8e-2),
        cpp_var_map={"i": "_get_input()", "t": t},
...
def kldivloss_with_target_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.kl_div(i, t.type_as(i), reduction="none")),
        cpp_function_call="F::kl_div(i, t.to(i.options()), F::KLDivFuncOptions().reduction(torch::kNone))",
        input_fn=lambda: torch.rand(10, 10).log(),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["KLDivLoss"](i, t.type_as(i), reduction="none"),
...
def kldivloss_with_log_target_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.kl_div(i, t.type_as(i), reduction="none", log_target=True)),
        cpp_function_call="F::kl_div(i, t.to(i.options()), F::KLDivFuncOptions().reduction(torch::kNone).log_target(true))",
        input_fn=lambda: torch.rand(10, 10).log(),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["KLDivLoss_log_target"](i, t.type_as(i), reduction="none"),
        supports_forward_ad=True,
        pickle=False,
        default_dtype=torch.double,
    )
...
def l1loss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.l1_loss(i, t.type_as(i), reduction="none")),
...
def mseloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.mse_loss(i, target.type_as(i), reduction="none")),
...
def nllloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.nll_loss(i, t.type_as(i).long(), reduction=kwargs["reduction"])),
        cpp_function_call="""F::nll_loss(
            i, t.to(i.options()).to(torch::kLong), F::NLLLossFuncOptions().reduction(torch::kNone))""",
        input_fn=lambda: torch.rand(15, 10).log(),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["NLLLoss"](i, t.type_as(i).long(), **kwargs),
        pickle=False,
        default_dtype=torch.double,
    )
...
def nllloss_no_reduce_ignore_index_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(
            lambda i: F.nll_loss(
                i, t.type_as(i).long(), ignore_index=int(kwargs["ignore_index"]), reduction=str(kwargs["reduction"])
            )
        ),
        cpp_function_call="""F::nll_loss(
...
def nllloss_no_reduce_weights_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.nll_loss(i, t.type_as(i).long(), **kwargs(i))),
        cpp_function_call="""F::nll_loss(
        ...
        reference_fn=lambda i, *_: loss_reference_fns["NLLLoss"](i, t.type_as(i).long(), **kwargs(i)),
        pickle=False,
        default_dtype=torch.double,
    )
...
def nllloss_no_reduce_weights_ignore_index_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.nll_loss(i, t.type_as(i).long(), **kwargs(i.data))),
        cpp_function_call="""F::nll_loss(
            i, t.to(i.options()).to(torch::kLong),
...
def nllloss2d_no_reduce_test():
    ...
    return dict(
        ...
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["NLLLossNd"](i, t.type_as(i).long(), **kwargs),
        pickle=False,
        default_dtype=torch.double,
    )
...
def nllloss2d_no_reduce_weights_test():
    ...
    return dict(
        ...
        input_fn=lambda: torch.rand(2, 3, 5, 5).log(),
        cpp_var_map={"i": "_get_input()", "t": t, "weight": weight},
        reference_fn=lambda i, *_: loss_reference_fns["NLLLossNd"](i, t.type_as(i).long(), **kwargs(i)),
        pickle=False,
        default_dtype=torch.double,
    )
...
def smoothl1loss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.smooth_l1_loss(i, t.type_as(i), reduction="none")),
        cpp_function_call="""F::smooth_l1_loss(
            i, t.to(i.options()), F::SmoothL1LossFuncOptions().reduction(torch::kNone))""",
        input_fn=lambda: torch.randn(2, 3, 4),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["SmoothL1Loss"](i, t.type_as(i), reduction="none"),
        supports_forward_ad=True,
        pickle=False,
        default_dtype=torch.double,
    )
...
def smoothl1loss_beta_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.smooth_l1_loss(i, t.type_as(i), reduction="none", beta=0.5)),
        cpp_function_call="""F::smooth_l1_loss(
            i, t.to(i.options()), F::SmoothL1LossFuncOptions().reduction(torch::kNone), 0.5)""",
        input_fn=lambda: torch.randn(2, 3, 4),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["SmoothL1Loss"](i, t.type_as(i), reduction="none", beta=0.5),
        supports_forward_ad=True,
        pickle=False,
        default_dtype=torch.double,
    )
...
def smoothl1loss_zero_beta_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.smooth_l1_loss(i, t.type_as(i), reduction="none", beta=0)),
        cpp_function_call="""F::smooth_l1_loss(
            i, t.to(i.options()), F::SmoothL1LossFuncOptions().reduction(torch::kNone), 0)""",
        input_fn=lambda: torch.randn(2, 3, 4),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["SmoothL1Loss"](i, t.type_as(i), reduction="none", beta=0),
        supports_forward_ad=True,
        pickle=False,
        default_dtype=torch.double,
    )
...
def huberloss_delta_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.huber_loss(i, t.type_as(i), reduction="none", delta=0.5)),
        cpp_function_call="""F::huber_loss(
            i, t.to(i.options()), F::HuberLossFuncOptions().reduction(torch::kNone).delta(0.5))""",
        input_fn=lambda: torch.randn(2, 3, 4),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["HuberLoss"](i, t.type_as(i), reduction="none", delta=0.5),
        supports_forward_ad=True,
        pickle=False,
        default_dtype=torch.double,
    )
...
def multilabelmarginloss_0d_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.multilabel_margin_loss(i, t.type_as(i).long(), reduction="none")),
...
def hingeembeddingloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.hinge_embedding_loss(i, t.type_as(i), reduction="none")),
        cpp_function_call="""F::hinge_embedding_loss(
            i, t.to(i.options()), F::HingeEmbeddingLossFuncOptions().reduction(torch::kNone))""",
        input_fn=lambda: torch.randn(10),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["HingeEmbeddingLoss"](i, t.type_as(i), reduction="none"),
        check_sum_reduction=True,
        pickle=False,
        default_dtype=torch.double,
    )
...
def hingeembeddingloss_margin_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.hinge_embedding_loss(i, t.type_as(i), margin=0.5, reduction="none")),
        cpp_function_call="""F::hinge_embedding_loss(
...
def softmarginloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.soft_margin_loss(i, t.type_as(i), reduction="none")),
        ...
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["SoftMarginLoss"](i, t.type_as(i), reduction="none"),
        supports_forward_ad=True,
        pickle=False,
        default_dtype=torch.double,
    )
...
def multilabelsoftmarginloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.multilabel_soft_margin_loss(i, t.type_as(i), reduction="none")),
        ...
        input_fn=lambda: torch.randn(5, 10),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: (-(t * i.sigmoid().log() + (1 - t) * (-i).sigmoid().log())).sum(dim=1) / i.size(1),
        check_gradgrad=False,
        pickle=False,
        default_dtype=torch.double,
    )
...
def multilabelsoftmarginloss_weights_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(
            lambda i: F.multilabel_soft_margin_loss(i, t.type_as(i), weight=weights.type_as(i), reduction="none")
        ),
        cpp_function_call="""F::multilabel_soft_margin_loss(
            i, t.to(i.options()),
        ...
        input_fn=lambda: torch.randn(5, 10),
        cpp_var_map={"i": "_get_input()", "t": t, "weights": weights},
        reference_fn=lambda i, *_: (-(t * i.sigmoid().log() + (1 - t) * (-i).sigmoid().log()) * weights).sum(dim=1)
        / i.size(1),
        check_sum_reduction=True,
        check_gradgrad=False,
        pickle=False,
...
def multimarginloss_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.multi_margin_loss(i, t.type_as(i).long(), reduction="none")),
        cpp_function_call="""F::multi_margin_loss(
            i, t.to(i.options()).to(torch::kLong), F::MultiMarginLossFuncOptions().reduction(torch::kNone))""",
        input_fn=lambda: torch.randn(5, 10),
        cpp_var_map={"i": "_get_input()", "t": t},
        reference_fn=lambda i, *_: loss_reference_fns["MultiMarginLoss"](i, t.data.type_as(i).long(), reduction="none"),
        check_sum_reduction=True,
        check_gradgrad=False,
        pickle=False,
        default_dtype=torch.double,
...
def multimarginloss_p_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(lambda i: F.multi_margin_loss(i, t.type_as(i).long(), p=2, reduction="none")),
        cpp_function_call="""F::multi_margin_loss(
...
def multimarginloss_weights_no_reduce_test():
    ...
    return dict(
        ...
        constructor=wrap_functional(
            lambda i: F.multi_margin_loss(i, t.type_as(i).long(), weight=weights.type_as(i), reduction="none")
        ),
        cpp_function_call="""F::multi_margin_loss(
            i, t.to(i.options()).to(torch::kLong),
...
new_module_tests = [
    ...
    dict(
        ...
        constructor=lambda: nn.EmbeddingBag(4, 3, None, 2.0, False, "sum", padding_idx=1),
        cpp_constructor_args="""torch::nn::EmbeddingBagOptions(4, 3)
    ...
    dict(
        ...
        constructor=lambda: nn.EmbeddingBag(4, 3, None, 2.0, False, "max", padding_idx=1),
        cpp_constructor_args="""torch::nn::EmbeddingBagOptions(4, 3)
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=None, scale_factor=4.0, mode="nearest"),
        cpp_options_args="""F::InterpolateFuncOptions()
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=None, scale_factor=4.0, mode="linear", align_corners=False),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=None, scale_factor=4.0, mode="linear", align_corners=True),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({4.}))
                            .mode(torch::kLinear)
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=(4, 6), scale_factor=None, mode="bilinear", align_corners=False
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=None, scale_factor=4.0, mode="bilinear", align_corners=False),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({4., 4.}))
                            .mode(torch::kBilinear)
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=None, scale_factor=(2.0, 2.0), mode="bilinear", align_corners=False
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=None, scale_factor=(2.0, 1.0), mode="bilinear", align_corners=False
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=None, scale_factor=(2.0, 1.0), mode="bilinear", align_corners=True
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({2., 1.}))
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=None, scale_factor=4.0, mode="bicubic", align_corners=False),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({4., 4.}))
                            .mode(torch::kBicubic)
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=None, scale_factor=(2.0, 2.0), mode="bicubic", align_corners=False
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({2., 2.}))
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=None, scale_factor=(2.0, 1.0), mode="bicubic", align_corners=False
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({2., 1.}))
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=None, scale_factor=(2.0, 1.0), mode="bicubic", align_corners=True
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({2., 1.}))
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=(4, 6, 6), scale_factor=None, mode="trilinear", align_corners=False
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=None, scale_factor=3.0, mode="trilinear", align_corners=False),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
    ...
    dict(
        constructor=wrap_functional(
            F.interpolate, size=(4, 6, 6), scale_factor=None, mode="trilinear", align_corners=True
        ),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(std::vector<int64_t>({4, 6, 6}))
                            .scale_factor(c10::nullopt)
    ...
    dict(
        constructor=wrap_functional(F.interpolate, size=None, scale_factor=3.0, mode="trilinear", align_corners=True),
        cpp_options_args="""F::InterpolateFuncOptions()
                            .size(c10::nullopt)
                            .scale_factor(std::vector<double>({3., 3., 3.}))
                            .mode(torch::kTrilinear)
    ...
    if reduction == "mean":
        if weight is not None:
            ...
            ret = (
                ...
                / weight.gather(0, target.masked_select(ignore_mask.logical_not()).flatten()).sum()
            )
        else:
...
def cross_entropy_loss_reference(input, target, weight=None, ignore_index=-100, reduction="mean", label_smoothing=0.0):
    if input.shape == target.shape:
        return cross_entropy_loss_prob_target_reference(
            input, target, weight=weight, reduction=reduction, label_smoothing=label_smoothing
        )
    else:
...
def tripletmarginloss_reference(anchor, positive, negative, margin=1.0, p=2, eps=1e-6, swap=False, reduction="mean"):
...
criterion_tests = [
    dict(
        ...
        reference_fn=lambda i, t, _: 1.0 / i.numel() * sum((a - b).abs().sum() for a, b in zip(i, t)),
        check_complex=True,
        default_dtype=torch.double,
    ),
    dict(
        ...
        reference_fn=lambda i, t, m: nllloss_reference(i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        check_bfloat16=True,
        default_dtype=torch.double,
    ),
    ...
    dict(
        ...
        input_fn=lambda: torch.rand(15, 10).add(1e-2).log(),
        target_fn=lambda: torch.empty(15).uniform_().mul(10).floor().long(),
        reference_fn=lambda i, t, m: nllloss_reference(i, t, weight=get_weight(m), ignore_index=2),
    ...
    dict(
        ...
        reference_fn=lambda i, t, m: nllloss_reference(i, t, weight=get_weight(m), ignore_index=-1),
    ...
    dict(
        ...
        reference_fn=lambda i, t, m: kldivloss_log_target_reference(i, t, get_reduction(m)),
        check_sum_reduction=True,
        desc="log_target",
        default_dtype=torch.double,
    ),
    dict(
        ...
        reference_fn=lambda i, t, m: ((i - t).abs().pow(2).sum() / (i.numel() if get_reduction(m) == "mean" else 1)),
        check_sum_reduction=True,
        default_dtype=torch.double,
    ),
    dict(
    ...
    dict(
        ...
        reference_fn=lambda i, t, m: hingeembeddingloss_reference(i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        default_dtype=torch.double,
    ),
    dict(
        ...
        input_size=(10,),
        target_fn=lambda: torch.randn(10).gt(0).to(torch.get_default_dtype()).mul_(2).sub(1),
        reference_fn=lambda i, t, m: hingeembeddingloss_reference(i, t, margin=0.5, reduction=get_reduction(m)),
        desc="margin",
        check_sum_reduction=True,
        default_dtype=torch.double,
    ),
    dict(
        ...
        reference_fn=lambda i, t, m: multilabelmarginloss_reference(i, t, reduction=get_reduction(m)),
        desc="1d",
        check_sum_reduction=True,
        check_gradgrad=False,
        check_bfloat16=True,
    ...
    dict(
        ...
        reference_fn=lambda i, t, m: multimarginloss_reference(i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        check_gradgrad=False,
        default_dtype=torch.double,
    ),
    ...
    dict(
        ...
        target_fn=lambda: torch.rand(5).mul(8).floor().long(),
        reference_fn=lambda i, t, m: multimarginloss_reference(i, t, p=2, reduction=get_reduction(m)),
        desc="p",
        check_sum_reduction=True,
        check_gradgrad=False,
        default_dtype=torch.double,
    ...
    dict(
        ...
        input_size=(5, 10),
        target_fn=lambda: torch.rand(5).mul(8).floor().long(),
        reference_fn=lambda i, t, m: multimarginloss_reference(i, t, margin=0.5, reduction=get_reduction(m)),
        desc="margin",
        check_sum_reduction=True,
        check_gradgrad=False,
        default_dtype=torch.double,
    ...
    dict(
        ...
        target_fn=lambda: torch.rand(5).mul(8).floor().long(),
        reference_fn=lambda i, t, m: multimarginloss_reference(i, t, weight=get_weight(m), reduction=get_reduction(m)),
        desc="weights",
        check_sum_reduction=True,
        check_gradgrad=False,
        default_dtype=torch.double,
    ...
    dict(
        ...
        check_sum_reduction=True,
        reference_fn=lambda i, t, m, b=1.0: smoothl1loss_reference(i, t, reduction=get_reduction(m), beta=b),
        default_dtype=torch.double,
    ),
    dict(
        ...
        check_half=True,
        check_bfloat16=True,
        reference_fn=lambda i, t, m: huberloss_reference(i, t, reduction=get_reduction(m)),
        default_dtype=torch.double,
    ),
    dict(
        ...
        reference_fn=lambda i, t, m: softmarginloss_reference(i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        default_dtype=torch.double,
    ),
    dict(
        ...
        reference_fn=lambda i, t, m: cosineembeddingloss_reference(i[0], i[1], t, reduction=get_reduction(m)),
        check_sum_reduction=True,
    ),
    dict(
        module_name="CosineEmbeddingLoss",
    ...
    dict(
        ...
        reference_fn=lambda i, t, m: marginrankingloss_reference(i[0], i[1], t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        default_dtype=torch.double,
    ),
    dict(
        ...
        input_fn=lambda: (torch.randn(50).mul(10), torch.randn(50).mul(10)),
        target_fn=lambda: torch.randn(50).sign(),
        reference_fn=lambda i, t, m: marginrankingloss_reference(i[0], i[1], t, margin=0.5, reduction=get_reduction(m)),
        desc="margin",
        check_sum_reduction=True,
        default_dtype=torch.double,
    ),
    ...
    dict(
        ...
        reference_fn=lambda i, t, m: loss_reference_fns["NLLLossNd"](i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        desc="2d",
        check_bfloat16=True,
        default_dtype=torch.double,
    ...
    dict(
        ...
        reference_fn=lambda i, t, m: loss_reference_fns["NLLLossNd"](i, t, weight=get_weight(m)),
        desc="2d_weights",
        check_bfloat16=True,
        default_dtype=torch.double,
    ),
    dict(
        ...
        input_size=(2, 3, 5, 5),
        target_fn=lambda: torch.rand(2, 5, 5).mul(3).floor().long(),
        reference_fn=lambda i, t, m: loss_reference_fns["NLLLossNd"](i, t, ignore_index=1),
    ...
    dict(
        ...
        input_size=(2, 3, 5, 5),
        target_fn=lambda: torch.rand(2, 5, 5).mul(3).floor().long(),
        reference_fn=lambda i, t, m: loss_reference_fns["CrossEntropyLoss"](i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        desc="2d",
    ...
    dict(
        ...
        input_size=(2, 3, 5, 5),
        target=torch.rand(2, 5, 5).mul(3).floor().long(),
        reference_fn=lambda i, t, m: loss_reference_fns["CrossEntropyLoss"](i, t, weight=get_weight(m)),
        desc="2d_weights",
        check_bfloat16=False,
        default_dtype=torch.double,
    ),
    dict(
        ...
        input_size=(2, 3, 5, 5),
        target_fn=lambda: torch.rand(2, 5, 5).mul(3).floor().long(),
        reference_fn=lambda i, t, m: loss_reference_fns["CrossEntropyLoss"](i, t, ignore_index=1),
        desc="2d_ignore_index",
        check_bfloat16=False,
        default_dtype=torch.double,
    ),
    ...
    dict(
        ...
        constructor=lambda *args, **kwargs: nn.CrossEntropyLoss(reduction="sum", label_smoothing=0.15),
    ...
    dict(
        ...
        constructor=lambda *args: nn.CrossEntropyLoss(reduction="sum", label_smoothing=0.15, ignore_index=1),
    ...
    dict(
        ...
        reference_fn=lambda i, t, _: (
            i.exp() - t.mul(i) + (t.mul(t.log()) - t + 0.5 * (2.0 * pi * t).log()).masked_fill(t <= 1, 0)
        ).mean(),
        desc="full_loss",
        default_dtype=torch.double,
    ),
    dict(
        ...
        target_fn=lambda: torch.randn(2, 3, 4, 5).floor_().abs_(),
        reference_fn=lambda i, t, _: (
            i - t.mul((i + 1e-8).log()) + (t.mul(t.log()) - t + 0.5 * (2.0 * pi * t).log()).masked_fill(t <= 1, 0)
        ).mean(),
    ...
    dict(
        ...
        reference_fn=lambda i, t, il, tl, m: ctcloss_reference(i, t, il, tl, blank=14, reduction=get_reduction(m)),
    ...
    dict(
        ...
        reference_fn=lambda i, t, il, tl, m: ctcloss_reference(i, t, il, tl, blank=0, reduction=get_reduction(m)),
        check_forward_only=True,
        check_sum_reduction=True,
        check_gradgrad=False,
        check_half=False,
...
regression_criterion_no_batch = ["L1Loss", "MSELoss", "PoissonNLLLoss", "HuberLoss", "SmoothL1Loss"]
...
reductions = ["none", "mean", "sum"]
for (name, input_fn, target_fn), reduction in product(classification_criterion_no_batch, reductions):
        ...
        with set_default_dtype(self.default_dtype):
            ...
            if self.check_gradgrad and not self.FIXME_no_cuda_gradgrad_comparison:
                ...
                cpu_gradInputs = torch.autograd.grad(
                    cpu_output, cpu_input_tuple + tuple(cpu_module.parameters()), cpu_gradOutput, create_graph=True
                )
                gpu_gradInputs = torch.autograd.grad(
                    gpu_output, gpu_input_tuple + tuple(gpu_module.parameters()), gpu_gradOutput, create_graph=True
                )
                ...
                cpu_gg = torch.autograd.grad(
                    outputs_cpu, cpu_input_tuple + (cpu_gradOutput,) + tuple(cpu_module.parameters()), retain_graph=True
                )
                gpu_gg = torch.autograd.grad(
                    outputs_gpu, gpu_input_tuple + (gpu_gradOutput,) + tuple(gpu_module.parameters()), retain_graph=True
                )
                test_case.assertEqual(cpu_gradInput, gpu_gradInput, atol=self.precision, rtol=0, exact_dtype=False)
