...
op_db: List[OpInfo] = [
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.hamming) if TEST_SCIPY else None,
    ...
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.bartlett) if TEST_SCIPY else None,
        sample_inputs_func=sample_inputs_window,
        reference_inputs_func=reference_inputs_window,
        error_inputs_func=error_inputs_window,
    ),
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.blackman) if TEST_SCIPY else None,
        sample_inputs_func=sample_inputs_window,
        reference_inputs_func=reference_inputs_window,
        error_inputs_func=error_inputs_window,
    ),
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.cosine) if TEST_SCIPY else None,
        sample_inputs_func=sample_inputs_window,
        reference_inputs_func=reference_inputs_window,
        error_inputs_func=error_inputs_window,
    ),
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.exponential) if TEST_SCIPY else None,
    ...
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.gaussian) if TEST_SCIPY else None,
    ...
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.kaiser) if TEST_SCIPY else None,
    ...
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.general_cosine) if TEST_SCIPY else None,
    ...
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.general_hamming) if TEST_SCIPY else None,
    ...
    make_signal_windows_opinfo(
        ...
        ref=reference_signal_window(scipy.signal.windows.nuttall) if TEST_SCIPY else None,
        sample_inputs_func=sample_inputs_window,
        reference_inputs_func=reference_inputs_window,
        error_inputs_func=error_inputs_window,
    ),
