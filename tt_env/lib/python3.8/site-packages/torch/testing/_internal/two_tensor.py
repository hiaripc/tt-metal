...
class TwoTensor(torch.Tensor):
    ...
    def __new__(cls, a, b):
        assert (
            a.device == b.device and a.layout == b.layout and a.requires_grad == b.requires_grad and a.dtype == b.dtype
        )
    ...
    def __torch_dispatch__(cls, func, types, args, kwargs):
        ...
        out_flat = [
            TwoTensor(o_a, o_b) if isinstance(o_a, torch.Tensor) else o_a for o_a, o_b in zip(out_a_flat, out_b_flat)
        ]
