...
def _generate_tensor_methods_for_privateuse1_backend(custom_backend_name: str) -> None:
    ...
    def wrap_tensor_to(
        self: torch.Tensor, device: Optional[Union[int, torch.device]] = None, non_blocking=False, **kwargs
    ) -> torch.Tensor:
...
def _generate_storage_methods_for_privateuse1_backend(
    ...
    def wrap_typed_storage_to(
        ...
        custom_backend_storage: torch.UntypedStorage = getattr(self._untyped_storage, custom_backend_name)(
