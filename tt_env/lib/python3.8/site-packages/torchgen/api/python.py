...
def signature(f: NativeFunction, *, method: bool = False, pyi: bool = False) -> PythonSignature:
    return signature_from_schema(f.func, category_override=f.category_override, method=method, pyi=pyi)
    ...
    if is_factory_function or is_like_or_new_function:
        ...
        tensor_options_args.append(
            PythonArgument(
                ...
                default="None",
                default_init=(None if is_like_or_new_function else topt_default_init("dtype")),
            )
        )
        tensor_options_args.append(
            PythonArgument(
                ...
                default="None",
                default_init=(None if is_like_or_new_function else topt_default_init("layout")),
            )
        )
        tensor_options_args.append(
            PythonArgument(
