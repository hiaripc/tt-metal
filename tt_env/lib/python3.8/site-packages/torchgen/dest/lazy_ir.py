    ...
    if isValueType(arg.lazy_type):
        if isinstance(arg.lazy_type, BaseCType):
            ...
            if arg.is_symint_or_list:
                ...
                return f"node_{arg.name}"
            return f"lazy_{arg.name} ? " f"c10::make_optional(lazy_{arg.name}->GetIrValue()) : " "c10::nullopt"
        else:
        ...
        if isinstance(arg.orig_type, ListType) and arg.orig_type.elem == BaseType(BaseTy.SymInt):
            if arg.symint:
