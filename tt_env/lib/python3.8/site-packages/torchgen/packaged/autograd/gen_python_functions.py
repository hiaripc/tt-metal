...
SKIP_PYTHON_BINDINGS = [re.compile(rf"^{pattern}$") for pattern in _SKIP_PYTHON_BINDINGS]
...
def create_python_bindings(
    ...
    *,
    ...
    fm.write_with_template(
        ...
        filename,
        lambda: {
            "generated_comment": "@" + f"generated from {fm.template_dir_for_comments()}/{filename}",
    ...
    *,
    ...
    if overload.outplace is not None:
        ...
        return PY_VARIABLE_OUT.substitute(
            ...
            call_dispatch=emit_single_dispatch(overload.signature, overload.base, namedtuple_typenames, symint=symint),
