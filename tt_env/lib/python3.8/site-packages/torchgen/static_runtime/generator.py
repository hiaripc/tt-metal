...
test_tensor_dim_ops_2_ = frozenset(("addmm", "mm", "nuclear_norm", "diag", "_addmm_activation", "matrix_H", "t"))
...
class GenOpTestCase:
    ...
    def out_variant_op_test_case_generator(self, g: NativeFunctionsGroup) -> str:
        ...
        arg_declarations = ", ".join(
            (arg_name if arg_type is None else f"{arg_name}: {arg_type}" for arg_name, arg_type in arg_types)
        )
