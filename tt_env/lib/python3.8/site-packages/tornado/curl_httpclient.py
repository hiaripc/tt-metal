...
class CurlAsyncHTTPClient(AsyncHTTPClient):
    def initialize(self, max_clients: int = 10, defaults: Optional[Dict[str, Any]] = None) -> None:  # type: ignore
    ...
    def _curl_setup_request(
        ...
        curl.setopt(
            ...
            functools.partial(self._curl_header_callback, headers, request.header_callback),
        )
