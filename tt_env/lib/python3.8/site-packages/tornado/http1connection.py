...
class HTTP1Connection(httputil.HTTPConnection):
    ...
    def __init__(
        ...
        self._max_body_size = (
            self.params.max_body_size if self.params.max_body_size is not None else self.stream.max_buffer_size
        )
    ...
    async def _read_message(self, delegate: httputil.HTTPMessageDelegate) -> bool:
        ...
        try:
            ...
            if self.is_client:
                ...
                start_line = resp_start_line  # type: Union[httputil.RequestStartLine, httputil.ResponseStartLine]
    ...
    def write_headers(
        ...
        if not self.is_client and (
            self._request_start_line.method == "HEAD" or cast(httputil.ResponseStartLine, start_line).code == 304
        ):
    ...
    def finish(self) -> None:
        ...
        if (
            ...
            raise httputil.HTTPOutputError(
                "Tried to write %d bytes less than Content-Length" % self._expected_content_remaining
            )
        if self._chunking_output:
