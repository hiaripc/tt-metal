...
class _StreamBuffer(object):
    ...
    def __init__(self) -> None:
        ...
        self._buffers = collections.deque()  # type: Deque[Tuple[bool, Union[bytearray, memoryview]]]
...
class BaseIOStream(object):
    ...
    def _find_read_pos(self) -> Optional[int]:
        ...
        if self._read_bytes is not None and (
            self._read_buffer_size >= self._read_bytes or (self._read_partial and self._read_buffer_size > 0)
        ):
