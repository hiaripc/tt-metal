...
class SimpleAsyncHTTPClient(AsyncHTTPClient):
    ...
    def initialize(  # type: ignore
        ...
        self.queue = collections.deque()  # type: Deque[Tuple[object, HTTPRequest, Callable[[HTTPResponse], None]]]
        self.active = {}  # type: Dict[object, Tuple[HTTPRequest, Callable[[HTTPResponse], None]]]
        self.waiting = {}  # type: Dict[object, Tuple[HTTPRequest, Callable[[HTTPResponse], None], object]]
        ...
        try:
            ...
            if username is not None:
                ...
                self.request.headers["Authorization"] = "Basic " + _unicode(
                    base64.b64encode(httputil.encode_username_password(username, password))
                )
            ...
            if not self.request.allow_nonstandard_methods:
                ...
                if (body_expected and not body_present) or (body_present and not body_expected):
                    raise ValueError(
                        ...
                        "allow_nonstandard_methods is true)" % ("not " if body_expected else "", self.request.method)
                    )
