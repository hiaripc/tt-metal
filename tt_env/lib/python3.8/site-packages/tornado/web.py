...
class RequestHandler(object):
    ...
    @overload
    def get_argument(self, name: str, default: None, strip: bool = True) -> Optional[str]:  # noqa: F811
        pass
    ...
    def _get_arguments(self, name: str, source: Dict[str, List[bytes]], strip: bool = True) -> List[str]:
        values = []
        ...
        **kwargs: Any,
        ...
        if kwargs:
            ...
            for k, v in kwargs.items():
                morsel[k] = v
            warnings.warn(
                f"Deprecated arguments to set_cookie: {set(kwargs.keys())} " "(should be lowercase)",
                DeprecationWarning,
            )
    ...
    def render_linked_css(self, css_files: Iterable[str]) -> str:
        ...
        return "".join(
            '<link href="' + escape.xhtml_escape(p) + '" ' 'type="text/css" rel="stylesheet"/>' for p in paths
        )
        ...
        if not self._headers_written:
            ...
            for transform in self._transforms:
                ...
                (
                    ...
                    self._headers,
                    chunk,
                ) = transform.transform_first_chunk(self._status_code, self._headers, chunk, include_footers)
    ...
    def write_error(self, status_code: int, **kwargs: Any) -> None:
        ...
        if self.settings.get("serve_traceback") and "exc_info" in kwargs:
            ...
            self.finish(
                ...
                "<body>%(code)d: %(message)s</body></html>" % {"code": status_code, "message": self._reason}
            )
    ...
    def check_etag_header(self) -> bool:
        ...
        etags = re.findall(rb'\*|(?:W/)?"[^"]*"', utf8(self.request.headers.get("If-None-Match", "")))
