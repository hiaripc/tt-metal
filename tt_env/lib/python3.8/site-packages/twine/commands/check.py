...
_REPORT_RE = re.compile(
    r"^<string>:(?P<line>(?:\d+)?): " r"\((?P<level>DEBUG|INFO|WARNING|ERROR|SEVERE)/(\d+)?\) " r"(?P<message>.*)",
...
def _check_file(filename: str, render_warning_stream: _WarningStream) -> Tuple[List[str], bool]:
