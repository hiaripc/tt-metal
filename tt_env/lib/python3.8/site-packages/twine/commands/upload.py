...
def skip_upload(response: requests.Response, skip_existing: bool, package: package_file.PackageFile) -> bool:
...
def upload(upload_settings: settings.Settings, dists: List[str]) -> None:
    ...
    packages_to_upload = [_make_package(filename, signatures, upload_settings) for filename in uploads]

    repository = upload_settings.create_repository()
    uploaded_packages = []

    for package in packages_to_upload:
        skip_message = f"Skipping {package.basefilename} because it appears to already exist"
