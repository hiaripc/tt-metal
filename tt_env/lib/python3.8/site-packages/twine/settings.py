...
class Settings:
    ...
    def _handle_package_signing(self, sign: bool, sign_with: str, identity: Optional[str]) -> None:
    ...
    def check_repository_url(self) -> None:
        ...
        if repository_url.startswith((repository.LEGACY_PYPI, repository.LEGACY_TEST_PYPI)):
