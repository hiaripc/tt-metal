...
class Request:
    ...
    def url(self) -> str:
        ...
        and query string."""
        return get_current_url(self.scheme, self.host, self.root_path, self.path, self.query_string)
    ...
    def host(self) -> str:
        ...
        """
        return get_host(self.scheme, self.headers.get("host"), self.server, self.trusted_hosts)
    ...
    def cookies(self) -> ImmutableMultiDict[str, str]:
        ...
        return parse_cookie(wsgi_combined_cookie, cls=self.dict_storage_class)  # type: ignore
