...
@pytest.hookspec(warn_on_impl=DeprecationWarning("rsync feature is deprecated and will be removed in pytest-xdist 4.0"))
...
@pytest.hookspec()
def pytest_xdist_node_collection_finished(node: WorkerController, ids: Sequence[str]) -> None:
...
@pytest.hookspec(firstresult=True)
def pytest_handlecrashitem(crashitem: str, report: pytest.TestReport, sched: Scheduling) -> None:
    """
