...
class LoadScopeScheduling:
    ...
    def remove_node(self, node: WorkerController) -> str | None:
        ...
        for work_unit in workload.values():
            ...
            raise RuntimeError("Unable to identify crashitem on a workload with pending items")
    ...
    def _assign_work_unit(self, node: WorkerController) -> None:
        ...
        nodeids_indexes = [worker_collection.index(nodeid) for nodeid, completed in work_unit.items() if not completed]
    ...
    def schedule(self) -> None:
        ...
        for scope, nodeids in sorted(unsorted_workqueue.items(), key=lambda item: -len(item[1])):
