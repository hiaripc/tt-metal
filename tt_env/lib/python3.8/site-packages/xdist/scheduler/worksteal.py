...
class WorkStealingScheduling:
    ...
    def check_schedule(self) -> None:
        ...
        nodes_up = [NodePending(node, pending) for node, pending in self.node2pending.items() if not node.shutting_down]
        ...
        steal_from = max(nodes_up, key=lambda node_pending: len(node_pending.pending), default=None)
