...
class Chart(xmlwriter.XMLwriter):
        ...
        if self.title_none:
            ...
            if self.title_formula is not None:
                self._write_title_formula(
                    self.title_formula, self.title_data_id, None, self.title_font, self.title_layout, self.title_overlay
                )
    ...
    def _write_cat_axis(self, args):
        ...
        if x_axis["formula"] is not None:
            self._write_title_formula(
                x_axis["formula"], x_axis["data_id"], is_y_axis, x_axis["name_font"], x_axis["name_layout"]
            )
    ...
    def _write_val_axis(self, args):
        ...
        if y_axis["formula"] is not None:
            self._write_title_formula(
                y_axis["formula"], y_axis["data_id"], is_y_axis, y_axis["name_font"], y_axis["name_layout"]
            )
    ...
    def _write_date_axis(self, args):
        ...
        if x_axis["formula"] is not None:
            self._write_title_formula(
                x_axis["formula"], x_axis["data_id"], None, x_axis["name_font"], x_axis["name_layout"]
            )
        elif x_axis["name"] is not None:
