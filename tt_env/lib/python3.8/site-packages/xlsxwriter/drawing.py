...
class Drawing(xmlwriter.XMLwriter):
    ...
    def _write_two_cell_anchor(self, index, drawing_properties):
        ...
        if anchor_type == 1:
            ...
            self._write_sp(
                index, col_absolute, row_absolute, width, height, shape, description, url_rel_index, tip, decorative
            )
    ...
    def _write_sp(
        self, index, col_absolute, row_absolute, width, height, shape, description, url_rel_index, tip, decorative
    ):
