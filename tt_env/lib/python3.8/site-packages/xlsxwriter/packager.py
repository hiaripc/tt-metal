        ...
        for chart in self.workbook.charts:
            ...
            if not chart.series:
                raise EmptyChartSeries(
                    "Chart%d must contain at least one " "data series. See chart.add_series()." % index
                )
        ...
        for worksheet in self.workbook.worksheets():
            ...
            if worksheet.has_vml:
                ...
                vml._assemble_xml_file(
                    worksheet.vml_data_id, worksheet.vml_shape_id, worksheet.comments_list, worksheet.buttons_list
                )
                index += 1
            ...
            if worksheet.has_header_vml:
                ...
                vml._set_xml_writer(self._filename("xl/drawings/vmlDrawing" + str(index) + ".vml"))
                vml._assemble_xml_file(
                    worksheet.vml_header_id, worksheet.vml_header_id * 1024, None, None, worksheet.header_images_list
                )
