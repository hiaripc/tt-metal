...
class Workbook(xmlwriter.XMLwriter):
    ...
    def _prepare_drawings(self):
        ...
        for sheet in self.worksheets():
            ...
            if not (
                chart_count or image_count or shape_count or header_image_count or footer_image_count or has_background
            ):
                continue
            ...
            if sheet.background_image:
                ...
                (image_type, width, height, name, x_dpi, y_dpi, digest) = self._get_image_properties(
                    filename, image_data
                )
            ...
            for index in range(footer_image_count):
                ...
                sheet._prepare_header_image(
                    image_ref_id, width, height, name, image_type, position, x_dpi, y_dpi, digest
                )
    ...
    def _process_jpg(self, data):
        ...
        while not end_marker and offset < data_length:
            ...
            if (marker & 0xFFF0) == 0xFFC0 and marker != 0xFFC4 and marker != 0xFFC8 and marker != 0xFFCC:
