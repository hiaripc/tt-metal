...
def test_bunch(
    ...
    return Bunch(
        ...
        bunched=Bunch(html_attr_provider=html_attr_provider, subdomain_provider=subdomain_provider),
    )
...
def test_flatten(basic_provider, retina_provider, silent_retina_provider, private_provider):
    nested_bunch = Bunch(
