...
def check(conf, comment):
    if (
        ...
        and comment.pointer - comment.token_before.end_mark.pointer < conf["min-spaces-from-content"]
    ):
        yield LintProblem(comment.line_no, comment.column_no, "too few spaces before comment")
